...
---
# <a name="breaking-changes-for-migration-from-version-22-to-31"></a>Przełomowe zmiany migracji z wersji 2.2 do 3.1

Jeśli przeprowadzasz migrację z wersji 2.2 do wersji 3.1 programu .NET Core, ASP.NET Core lub EF Core, zmiany dotyczące łamania wymienione w tym artykule mogą mieć wpływ na aplikację.
