...
---
# <a name="retargeting-changes-for-migration-from-net-framework-451-to-471"></a>Zmiany retargetingu migracji z systemu .NET Framework 4.5.1 lub 4.7.1

[!INCLUDE[versionselector](../../../../includes/migration-guide/retargeting/versionselector.md)]

[!INCLUDE[introduction](../../../../includes/migration-guide/retargeting/introduction.md)]

W przypadku migracji z programu .NET Framework 4.5.1 lub 4.7.1, należy przejrzeć następujące tematy dla problemów ze zgodnością aplikacji, które mogą wpływać na aplikację:
