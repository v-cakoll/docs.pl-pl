...
## <a name="parameters"></a>Parametry  
 `phEnum`  
 [in. out] Wskaźnik do modułu wyliczającego dla `rMethodSpecs`.  
 ...
 `cMax`  
 podczas Żądana Maksymalna liczba tokenów do umieszczenia w `rMethodSpecs`.  
...
|HRESULT|Opis|  
|-------------|-----------------|  
|`S_OK`|`EnumMethodSpecs` pomyślnie zwrócone.|  
