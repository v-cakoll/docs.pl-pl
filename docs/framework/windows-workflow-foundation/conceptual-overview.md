...
Ta sekcja zawiera zestaw tematów dyskutować większych pojęcia za Windows Workflow Foundation (WF).  
...
## <a name="in-this-section"></a>W tej sekcji  
 ...
 W tym artykule opisano podstawowe pojęcia używane w projektowania programu Windows Workflow Foundation, które mogą być nowe dla niektórych deweloperów.  
  
 [Architektura programu Windows Workflow](../../../docs/framework/windows-workflow-foundation/architecture.md)  
 W tym artykule opisano składniki używane do rozwoju Windows Workflow Foundation.
