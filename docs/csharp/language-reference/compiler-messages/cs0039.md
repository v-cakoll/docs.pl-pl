...
Typu "type1" nie można przekonwertować na typ "type2" za pomocą konwersji referencyjnej, pakującej, rozpakowującej, opakowującej ani konwersji typu null. 
 ...
 Konwersja z operatorem [as](../../../csharp/language-reference/keywords/as.md) jest dozwolona przez dziedziczenie oraz konwersje referencyjne i pakujące. Aby uzyskać więcej informacji, zobacz [Operatory konwersji](../../../csharp/programming-guide/statements-expressions-operators/conversion-operators.md).
