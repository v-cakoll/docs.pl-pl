...
## <a name="in-this-section"></a>W tej sekcji  
 [Instrukcje: Utwórz nowe ustawienie w czasie projektowania](../../../../docs/framework/winforms/advanced/how-to-create-a-new-setting-at-design-time.md)  
 ...
 [Instrukcje: Dodawanie wielu zestawów ustawień do aplikacji wC#](../../../../docs/framework/winforms/advanced/how-to-add-multiple-sets-of-settings-to-your-application-in-csharp.md)  
