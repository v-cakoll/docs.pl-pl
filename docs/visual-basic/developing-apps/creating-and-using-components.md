...
## <a name="see-also"></a>Zobacz też  
 [Porady: dostęp do obsługi w czasie projektowania w formularzach Windows Forms](../../framework/winforms/controls/developing-windows-forms-controls-at-design-time.md)  
