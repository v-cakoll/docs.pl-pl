...
## <a name="related-sections"></a>Sekcje pokrewne  
 ...
 Zawiera łącza do tematów w Obsługa i wywoływanie zdarzeń przy użyciu [!INCLUDE[dnprdnshort](../../../includes/dnprdnshort-md.md)].  
 ...
 Wyświetla listę typowych problemów, które występują w przypadku obsługi zdarzeń w składników odziedziczonych.
