...
## <a name="example"></a>Przykład  
 Poniższy kod kompiluje `T2.vb`, aby utworzyć plik. exe. Kompilator przeszukuje katalog roboczy, w katalogu głównym dysku C: i w nowym katalogu zestawów dysku C: na potrzeby odwołań do zestawu.  
