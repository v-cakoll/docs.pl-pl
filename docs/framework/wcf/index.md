...
Ta sekcja dokumentacji zawiera informacje na temat Windows Communication Foundation (WCF), który jest ujednoliconym modelem programistycznym do tworzenia aplikacji zorientowanych na usługę. Umożliwia ona deweloperom tworzenie bezpiecznych, niezawodnych, transakcyjnych rozwiązań, które integrują się między platformami i współdziałają z istniejącymi inwestycjami.

## <a name="in-this-section"></a>W tej sekcji

 [Co nowego w Windows Communication Foundation 4,5](whats-new.md)\
 Omawia funkcje nowe do Windows Communication Foundation.

 [Funkcje upraszczania programu WCF](wcf-simplification-features.md)\
 Omawia nowe funkcje, które ułatwiają zapisywanie aplikacji WCF.
 ...
 Podsumowuje informacje o systemie obsługi komunikatów Windows Communication Foundation (WCF) i klasach, które obsługują jego użycie.
 ...
 Przykłady, które zawierają instrukcje dotyczące różnych aspektów Windows Communication Foundation

 [Windows Communication Foundation słownik](glossary.md)\
 Pokazuje listę warunków specyficznych dla usługi WCF

 [Informacje ogólne](general-reference.md)\
 W sekcji opisano elementy, które są używane do konfigurowania Windows Communication Foundation klientów i usług.

 [Informacje o ochronie prywatności](privacy-information.md)\
 Informacje dotyczące WCF i prywatności
