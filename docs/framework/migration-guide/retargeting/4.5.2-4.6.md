...
---
# <a name="retargeting-changes-for-migration-from-net-framework-452-to-46"></a>Przekierowywanie zmian dotyczących migracji z .NET Framework 4.5.2 do 4,6

[!INCLUDE[versionselector](../../../../includes/migration-guide/retargeting/versionselector.md)]

W przypadku migrowania z .NET Framework 4.5.2 do 4,6 zapoznaj się z następującymi tematami dotyczącymi problemów ze zgodnością aplikacji, które mogą mieć wpływ na aplikację:
