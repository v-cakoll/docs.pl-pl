...
* <a name="support-vs"></a><span data-ttu-id="ca30a-119">[**Zachowaj oddzielne istniejących i nowych projektów .NET Core**][option-csproj-folder]</span><span class="sxs-lookup"><span data-stu-id="ca30a-119">[**Keep existing projects and new .NET Core projects separate**][option-csproj-folder]</span></span>
