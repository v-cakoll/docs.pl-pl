...
|privactyNoticeVersion|Liczba całkowita określająca wersję bieżącego powiadomienie dotyczące prywatności.|  
...
## <a name="remarks"></a>Uwagi  
 ...
 `wsFederationHttpBinding` Także atrybutem privactyNoticeAt do ustawiania i pobierania identyfikatora URI, w której znajduje się powiadomienie dotyczące prywatności.  
