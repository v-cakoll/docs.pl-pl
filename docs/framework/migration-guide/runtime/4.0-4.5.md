...
ms.locfileid: "42752273"
---
# <a name="runtime-changes-for-migration-from-net-framework-40-to-45"></a><span data-ttu-id="a2101-102">Zmiany środowiska uruchomieniowego w przypadku migracji z .NET Framework 4.0 lub 4.5</span><span class="sxs-lookup"><span data-stu-id="a2101-102">Runtime Changes for Migration from .NET Framework 4.0 to 4.5</span></span>

[!INCLUDE[versionselector](../../../../includes/migration-guide/runtime/versionselector.md)]

[!INCLUDE[introduction](../../../../includes/migration-guide/runtime/introduction.md)]

<span data-ttu-id="a2101-103">Jeśli są migrowane z programu .NET Framework 4.0, 4.5, przejrzyj problemy ze zgodnością aplikacji, które mogą wpływać na Twoją aplikację w poniższych tematach:</span><span class="sxs-lookup"><span data-stu-id="a2101-103">If you are migrating from the .NET Framework 4.0 to 4.5, review the following topics for application compatibility issues that may affect your app:</span></span>

## <a name="aspnet"></a><span data-ttu-id="a2101-104">ASP.NET</span><span class="sxs-lookup"><span data-stu-id="a2101-104">ASP.NET</span></span>
...
## <a name="core"></a><span data-ttu-id="a2101-105">Core</span><span class="sxs-lookup"><span data-stu-id="a2101-105">Core</span></span>
...
## <a name="data"></a><span data-ttu-id="a2101-106">Dane</span><span class="sxs-lookup"><span data-stu-id="a2101-106">Data</span></span>
...
## <a name="debugger"></a><span data-ttu-id="a2101-107">Debugger</span><span class="sxs-lookup"><span data-stu-id="a2101-107">Debugger</span></span>
...
## <a name="entity-framework"></a><span data-ttu-id="a2101-108">Entity Framework</span><span class="sxs-lookup"><span data-stu-id="a2101-108">Entity Framework</span></span>
...
## <a name="linq"></a><span data-ttu-id="a2101-109">LINQ</span><span class="sxs-lookup"><span data-stu-id="a2101-109">LINQ</span></span>
...
## <a name="managed-extensibility-framework-mef"></a><span data-ttu-id="a2101-110">Managed Extensibility Framework (MEF)</span><span class="sxs-lookup"><span data-stu-id="a2101-110">Managed Extensibility Framework (MEF)</span></span>
...
## <a name="networking"></a><span data-ttu-id="a2101-111">Obsługa sieci</span><span class="sxs-lookup"><span data-stu-id="a2101-111">Networking</span></span>
...
## <a name="printing"></a><span data-ttu-id="a2101-112">Drukowanie</span><span class="sxs-lookup"><span data-stu-id="a2101-112">Printing</span></span>
...
## <a name="serialization"></a><span data-ttu-id="a2101-113">Serializacja</span><span class="sxs-lookup"><span data-stu-id="a2101-113">Serialization</span></span>
...
## <a name="web-applications"></a><span data-ttu-id="a2101-114">Aplikacje internetowe</span><span class="sxs-lookup"><span data-stu-id="a2101-114">Web Applications</span></span>
...
## <a name="windows-communication-foundation-wcf"></a><span data-ttu-id="a2101-115">Windows Communication Foundation (WCF)</span><span class="sxs-lookup"><span data-stu-id="a2101-115">Windows Communication Foundation (WCF)</span></span>
...
## <a name="windows-forms"></a><span data-ttu-id="a2101-116">Windows Forms</span><span class="sxs-lookup"><span data-stu-id="a2101-116">Windows Forms</span></span>
...
## <a name="windows-presentation-foundation-wpf"></a><span data-ttu-id="a2101-117">Windows Presentation Foundation (WPF)</span><span class="sxs-lookup"><span data-stu-id="a2101-117">Windows Presentation Foundation (WPF)</span></span>
...
## <a name="windows-workflow-foundation-wf"></a><span data-ttu-id="a2101-118">Program Windows Workflow Foundation (WF)</span><span class="sxs-lookup"><span data-stu-id="a2101-118">Windows Workflow Foundation (WF)</span></span>
...
## <a name="xml-xslt"></a><span data-ttu-id="a2101-119">Języki XML, XSLT</span><span class="sxs-lookup"><span data-stu-id="a2101-119">XML, XSLT</span></span>
