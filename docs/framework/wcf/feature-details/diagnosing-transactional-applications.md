...
## <a name="performance-counters"></a>Liczniki wydajności  
 [!INCLUDE[indigo2](../../../../includes/indigo2-md.md)]zawiera standardowy zestaw liczników wydajności można mierzyć wydajność aplikacji transakcyjnej. [!INCLUDE[crdefault](../../../../includes/crdefault-md.md)][Liczniki wydajności](../../../../docs/framework/wcf/diagnostics/performance-counters/index.md).  
...
-   Standardowe [!INCLUDE[indigo2](../../../../includes/indigo2-md.md)] śledzenia  
     ...
     Ten rodzaj śledzenia jest taka sama jak śledzenie żadnego [!INCLUDE[indigo2](../../../../includes/indigo2-md.md)] aplikacji. [!INCLUDE[crdefault](../../../../includes/crdefault-md.md)][Konfigurowanie śledzenia](../../../../docs/framework/wcf/diagnostics/tracing/configuring-tracing.md).  
