...
| `WBEM_FLAG_OWNER_UPDATE` | 0x10000 | Dostawcy wypychania muszą określać tę flagę podczas wywoływania `PutClassWmi` , aby wskazać, że ta klasa została zmieniona. |
...
| `WBEM_E_ALREADY_EXISTS` | 0x80041019 | Określono `WBEM_FLAG_CREATE_ONLY` flagę, ale Klasa już istnieje. |
