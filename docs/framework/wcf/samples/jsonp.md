...
```  
 ...
 Przykład składa się z dwóch aplikacji sieci web programu ASP.NET: jedna z nich zawiera tylko usługi WCF, a inny zawiera strona sieci Web .aspx, który wywołuje usługę. Podczas uruchamiania rozwiązania [!INCLUDE[vs_current_long](../../../../includes/vs-current-long-md.md)] będzie obsługiwać dwie witryny sieci Web na inne porty, które tworzą środowisko, miejsca zamieszkania usługi i klienta w różnych domenach.  
