...
|[Instrukcje: Tworzenie przykładów LINQ to XML (C#)](../../../../csharp/programming-guide/concepts/linq/how-to-build-linq-to-xml-examples.md)|Zawiera `Using` dyrektyw, które są wymagane do utworzenia przykładów LINQ to XML.|  
