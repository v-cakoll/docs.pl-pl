...
### [Implementowanie ponownych prób niestandardowego wywołania HTTP wykonywanych przy użyciu wycofywania wykładniczego](implement-resilient-applications/implement-custom-http-call-retries-exponential-backoff.md)
