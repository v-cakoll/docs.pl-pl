...
---
# <a name="sample-xml-file-customers-and-orders-linq-to-xml"></a><span data-ttu-id="b8bbc-102">Przykładowy plik XML: klienci i zamówienia (LINQ to XML)</span><span class="sxs-lookup"><span data-stu-id="b8bbc-102">Sample XML File: Customers and Orders (LINQ to XML)</span></span>
<span data-ttu-id="b8bbc-103">Poniższy plik XML jest używany w [!INCLUDE[sqltecxlinq](~/includes/sqltecxlinq-md.md)] różnych przykładach w dokumentacji.</span><span class="sxs-lookup"><span data-stu-id="b8bbc-103">The following XML file is used in various examples in the [!INCLUDE[sqltecxlinq](~/includes/sqltecxlinq-md.md)] documentation.</span></span> <span data-ttu-id="b8bbc-104">Ten plik zawiera klientów i zamówienia.</span><span class="sxs-lookup"><span data-stu-id="b8bbc-104">This file contains customers and orders.</span></span>  
  
 <span data-ttu-id="b8bbc-105">Przykładowy [przykładowy plik XSD w temacie: Klienci i zamówienia](./sample-xsd-file-customers-and-orders1.md) zawierają xsd, który może służyć do sprawdzania poprawności tego dokumentu.</span><span class="sxs-lookup"><span data-stu-id="b8bbc-105">The topic [Sample XSD File: Customers and Orders](./sample-xsd-file-customers-and-orders1.md) contains an XSD that can be used to validate this document.</span></span> <span data-ttu-id="b8bbc-106">Używa `xs:key` `xs:keyref` i funkcje XSD, aby `CustomerID` ustalić, `Customer` że atrybut elementu jest kluczem i `CustomerID` ustanowić `Order` relację `CustomerID` między `Customer` elementem w każdym elemencie i atrybutu w każdym elemencie.</span><span class="sxs-lookup"><span data-stu-id="b8bbc-106">It uses the `xs:key` and `xs:keyref` features of XSD to establish that the `CustomerID` attribute of the `Customer` element is a key, and to establish a relationship between the `CustomerID` element in each `Order` element and the `CustomerID` attribute in each `Customer` element.</span></span>  
  
 <span data-ttu-id="b8bbc-107">Na przykład pisania zapytań LINQ, które korzystają `Join` z tej relacji przy użyciu klauzuli, zobacz [Jak dołączyć dwie kolekcje (LINQ do XML) (C#)](./how-to-join-two-collections-linq-to-xml.md).</span><span class="sxs-lookup"><span data-stu-id="b8bbc-107">For an example of writing LINQ queries that take advantage of this relationship using the `Join` clause, see [How to join two collections (LINQ to XML) (C#)](./how-to-join-two-collections-linq-to-xml.md).</span></span>  
  
## <a name="customersordersxml"></a><span data-ttu-id="b8bbc-108">KlienciOrders.xml</span><span class="sxs-lookup"><span data-stu-id="b8bbc-108">CustomersOrders.xml</span></span>  
