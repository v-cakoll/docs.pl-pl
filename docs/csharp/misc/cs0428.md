...
Nie można przekonwertować grupy metody "Identyfikator" na typ typu niedelegowanego.  Czy zamierzasz wywołać metodę?  
  
 Ten błąd występuje podczas konwertowania grupy metod na typ niedelegowany lub próby wywołania metody bez użycia nawiasów.  
