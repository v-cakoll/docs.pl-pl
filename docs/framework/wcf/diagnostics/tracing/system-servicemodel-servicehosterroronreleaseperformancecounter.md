...
## <a name="description"></a>Opis  
 Wystąpiły błędy na ServiceHost podczas wywołania metody ReleasePerformanceCounters. Ślad może służyć do określenia błędy podczas zwalniania liczników wydajności.  
