...
Nie można przekonwertować wartości null na "type", ponieważ jest typem wartości niedopuszczającym wartości  
 ...
 Poniższy przykład spowoduje wygenerowanie CS0037:  
