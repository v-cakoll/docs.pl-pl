...
W tym przykładzie `decimal` i [int](../../../csharp/language-reference/builtin-types/integral-numeric-types.md) są używane razem w jednym wyrażeniu. Wynik daje w wyniku `decimal` typu.
