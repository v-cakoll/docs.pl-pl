...
## <a name="implementing-the-iserializable-interface"></a>Implementowanie interfejsu ISerializable  
 ...
 Implementacja <xref:System.Runtime.Serialization.ISerializable> obejmuje`GetObjectData` implementację metody i konstruktora specjalnego, który jest używany podczas deserializacji obiektu. Poniższy przykładowy kod przedstawia sposób implementacji <xref:System.Runtime.Serialization.ISerializable> `MyObject` na klasie z poprzedniej sekcji.  
