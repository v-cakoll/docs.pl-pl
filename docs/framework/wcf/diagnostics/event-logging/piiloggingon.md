...
## <a name="description"></a>Opis  
 To zdarzenie oznacza, włączone rejestrowanie danych osobowych. Poufne informacje będą rejestrowane. Zdarzenie Wyświetla nazwę procesu i identyfikatora procesu.  
