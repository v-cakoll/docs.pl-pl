...
- [Zestawy odwołań](../standard/assembly/reference-assemblies.md) — Dodawanie zestawów odwołań — temat
- [System. IO. potoki na platformie .NET](../standard/io/pipelines.md) — dokument potoku —
