...
Jeden z parametrów operatora binarnego musi być typem zawierającym  
 ...
 Deklaracja metody dla [przeciążenia operatora](../../../csharp/programming-guide/statements-expressions-operators/overloadable-operators.md) musi być zgodna z zasadami.  
