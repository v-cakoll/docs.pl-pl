...
ms.locfileid: "73127309"
---
# <a name="retargeting-changes-for-migration-from-net-framework-461-to-47"></a><span data-ttu-id="be3bd-102">Przekierowywanie zmian dotyczących migracji z .NET Framework 4.6.1 do 4,7</span><span class="sxs-lookup"><span data-stu-id="be3bd-102">Retargeting Changes for Migration from .NET Framework 4.6.1 to 4.7</span></span>

[!INCLUDE[versionselector](../../../../includes/migration-guide/retargeting/versionselector.md)]

[!INCLUDE[introduction](../../../../includes/migration-guide/retargeting/introduction.md)]

<span data-ttu-id="be3bd-103">W przypadku migrowania z .NET Framework 4.6.1 do 4,7 zapoznaj się z następującymi tematami dotyczącymi problemów ze zgodnością aplikacji, które mogą mieć wpływ na aplikację:</span><span class="sxs-lookup"><span data-stu-id="be3bd-103">If you are migrating from the .NET Framework 4.6.1 to 4.7, review the following topics for application compatibility issues that may affect your app:</span></span>

## <a name="aspnet"></a><span data-ttu-id="be3bd-104">Platforma ASP.NET</span><span class="sxs-lookup"><span data-stu-id="be3bd-104">ASP.NET</span></span>
...
## <a name="core"></a><span data-ttu-id="be3bd-105">Core</span><span class="sxs-lookup"><span data-stu-id="be3bd-105">Core</span></span>
...
## <a name="networking"></a><span data-ttu-id="be3bd-106">Obsługa sieci</span><span class="sxs-lookup"><span data-stu-id="be3bd-106">Networking</span></span>
...
## <a name="security"></a><span data-ttu-id="be3bd-107">Zabezpieczenia</span><span class="sxs-lookup"><span data-stu-id="be3bd-107">Security</span></span>
...
## <a name="windows-communication-foundation-wcf"></a><span data-ttu-id="be3bd-108">Windows Communication Foundation (WCF)</span><span class="sxs-lookup"><span data-stu-id="be3bd-108">Windows Communication Foundation (WCF)</span></span>
...
## <a name="windows-forms"></a><span data-ttu-id="be3bd-109">Windows Forms</span><span class="sxs-lookup"><span data-stu-id="be3bd-109">Windows Forms</span></span>
...
## <a name="windows-presentation-foundation-wpf"></a><span data-ttu-id="be3bd-110">Windows Presentation Foundation (WPF)</span><span class="sxs-lookup"><span data-stu-id="be3bd-110">Windows Presentation Foundation (WPF)</span></span>
...
## <a name="windows-workflow-foundation-wf"></a><span data-ttu-id="be3bd-111">Program Windows Workflow Foundation (WF)</span><span class="sxs-lookup"><span data-stu-id="be3bd-111">Windows Workflow Foundation (WF)</span></span>
