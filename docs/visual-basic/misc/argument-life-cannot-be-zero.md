...
---
# <a name="argument-39life39-cannot-be-zero"></a>Argument &#39; Life &#39; nie może być zerem

Argument dla `Life`, który musi być `Double` i który określa długość eksploatacji środka trwałego, jest nieprawidłowy.
