...
Generuje plik bazowej kodu, który zawiera kod podstawowy załadowanych obecnie do tego [ICeeGen](../../../../docs/framework/unmanaged-api/metadata/iceegen-interface.md) interfejsu.  
