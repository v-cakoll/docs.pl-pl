...
## <a name="in-this-section"></a>W tej sekcji  
 [TrackBar, kontrolka — omówienie](../../../../docs/framework/winforms/controls/trackbar-control-overview-windows-forms.md)  
 Ogólne pojęcia związane z `TrackBar` kontroli, co umożliwi użytkownikom przeglądanie informacji wizualnie dostosowując liczbowych ustawienie.  
  
## <a name="reference"></a>Tematy pomocy  
 <xref:System.Windows.Forms.TrackBar> Klasy  
