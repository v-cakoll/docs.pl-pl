...
## <a name="related-sections"></a>Sekcje pokrewne  
 ...
 Zawiera łącza do sekcje, w których opisano różne właściwości dostępu do XML.  
 ...
 Pokazuje, jak dostęp do części — element XML lub dokumentu w języku Visual Basic.  
