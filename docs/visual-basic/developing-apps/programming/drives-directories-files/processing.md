...
## <a name="in-this-section"></a>W tej sekcji  
 ...
 W tym artykule omówiono sposób użycia `My.Computer.FileSystem` obiekt do pracy z plikami, dyski i foldery.  
 ...
 Pokazuje, jak używać `My.Computer.FileSystem` obiekt do manipulowania pliki i foldery.  
...
## <a name="related-sections"></a>Sekcje pokrewne  
 ...
 Wskazówki dla struktury fizyczne i wygląd programów.  
  
 <xref:Microsoft.VisualBasic.FileIO.FileSystem>  
 Odwołanie dokumentacji `My.Computer.FileSystem` obiekt i jego elementów członkowskich.
