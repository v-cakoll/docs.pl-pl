...
---
# <a name="how-to-find-an-element-with-a-specific-child-element-c"></a>Porady: Wyszukiwanie elementu o określonym elemencie podrzędnym (C#)
...
## <a name="example"></a>Przykład  
 ...
 W tym przykładzie użyto następujący dokument XML: [przykładowy plik XML: Konfiguracja testu w Namespace](../../../../csharp/programming-guide/concepts/linq/sample-xml-file-test-configuration-in-a-namespace1.md).  
