...
ms.locfileid: "61977416"
---
# <a name="runtime-changes-for-migration-from-net-framework-40-to-46"></a><span data-ttu-id="e2346-102">Zmiany środowiska uruchomieniowego do migracji z .NET Framework 4.0 – 4.6</span><span class="sxs-lookup"><span data-stu-id="e2346-102">Runtime Changes for Migration from .NET Framework 4.0 to 4.6</span></span>

[!INCLUDE[versionselector](../../../../includes/migration-guide/runtime/versionselector.md)]

[!INCLUDE[introduction](../../../../includes/migration-guide/runtime/introduction.md)]

<span data-ttu-id="e2346-103">Jeśli są migrowane z programu .NET Framework 4.0, 4.6, przejrzyj problemy ze zgodnością aplikacji, które mogą wpływać na Twoją aplikację w poniższych tematach:</span><span class="sxs-lookup"><span data-stu-id="e2346-103">If you are migrating from the .NET Framework 4.0 to 4.6, review the following topics for application compatibility issues that may affect your app:</span></span>

## <a name="adonet"></a><span data-ttu-id="e2346-104">ADO.NET</span><span class="sxs-lookup"><span data-stu-id="e2346-104">ADO.NET</span></span>
...
## <a name="aspnet"></a><span data-ttu-id="e2346-105">ASP.NET</span><span class="sxs-lookup"><span data-stu-id="e2346-105">ASP.NET</span></span>
...
## <a name="core"></a><span data-ttu-id="e2346-106">Core</span><span class="sxs-lookup"><span data-stu-id="e2346-106">Core</span></span>
...
## <a name="data"></a><span data-ttu-id="e2346-107">Dane</span><span class="sxs-lookup"><span data-stu-id="e2346-107">Data</span></span>
...
## <a name="entity-framework"></a><span data-ttu-id="e2346-108">Entity Framework</span><span class="sxs-lookup"><span data-stu-id="e2346-108">Entity Framework</span></span>
...
## <a name="linq"></a><span data-ttu-id="e2346-109">LINQ</span><span class="sxs-lookup"><span data-stu-id="e2346-109">LINQ</span></span>
...
## <a name="managed-extensibility-framework-mef"></a><span data-ttu-id="e2346-110">Managed Extensibility Framework (MEF)</span><span class="sxs-lookup"><span data-stu-id="e2346-110">Managed Extensibility Framework (MEF)</span></span>
...
## <a name="networking"></a><span data-ttu-id="e2346-111">Obsługa sieci</span><span class="sxs-lookup"><span data-stu-id="e2346-111">Networking</span></span>
...
## <a name="printing"></a><span data-ttu-id="e2346-112">Drukowanie</span><span class="sxs-lookup"><span data-stu-id="e2346-112">Printing</span></span>
...
## <a name="serialization"></a><span data-ttu-id="e2346-113">Serializacja</span><span class="sxs-lookup"><span data-stu-id="e2346-113">Serialization</span></span>
...
## <a name="setup-and-deployment"></a><span data-ttu-id="e2346-114">Instalacja i wdrożenie</span><span class="sxs-lookup"><span data-stu-id="e2346-114">Setup and Deployment</span></span>
...
## <a name="web-applications"></a><span data-ttu-id="e2346-115">Aplikacje internetowe</span><span class="sxs-lookup"><span data-stu-id="e2346-115">Web Applications</span></span>
...
## <a name="windows-communication-foundation-wcf"></a><span data-ttu-id="e2346-116">Windows Communication Foundation (WCF)</span><span class="sxs-lookup"><span data-stu-id="e2346-116">Windows Communication Foundation (WCF)</span></span>
...
## <a name="windows-forms"></a><span data-ttu-id="e2346-117">Windows Forms</span><span class="sxs-lookup"><span data-stu-id="e2346-117">Windows Forms</span></span>
...
## <a name="windows-presentation-foundation-wpf"></a><span data-ttu-id="e2346-118">Windows Presentation Foundation (WPF)</span><span class="sxs-lookup"><span data-stu-id="e2346-118">Windows Presentation Foundation (WPF)</span></span>
...
## <a name="windows-workflow-foundation-wf"></a><span data-ttu-id="e2346-119">Program Windows Workflow Foundation (WF)</span><span class="sxs-lookup"><span data-stu-id="e2346-119">Windows Workflow Foundation (WF)</span></span>
...
## <a name="xml-xslt"></a><span data-ttu-id="e2346-120">Języki XML, XSLT</span><span class="sxs-lookup"><span data-stu-id="e2346-120">XML, XSLT</span></span>
