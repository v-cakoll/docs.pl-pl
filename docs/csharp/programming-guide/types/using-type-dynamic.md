...
|[Przewodnik: Tworzenie obiektów dynamicznych i posługiwanie](walkthrough-creating-and-using-dynamic-objects.md)|Instrukcje krok po kroku do tworzenia niestandardowych obiektów dynamicznych i do tworzenia projektu, który uzyskuje dostęp do `IronPython` biblioteki.|
