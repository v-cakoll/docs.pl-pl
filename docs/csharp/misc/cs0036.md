...
Parametrze wyjściowym nie może mieć atrybutu "[In]"  
  
 Obecnie **w** atrybut nie jest dozwolona w [się](../../csharp/language-reference/keywords/out-parameter-modifier.md) parametru.  
  
 Poniższy przykład spowoduje wygenerowanie CS0036:  
