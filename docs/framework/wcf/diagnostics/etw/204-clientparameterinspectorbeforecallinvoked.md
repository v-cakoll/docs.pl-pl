...
## <a name="description"></a>Opis  
 To zdarzenie jest emitowane po modelu usługi zostało wywołane `BeforeCall` metody w Inspektorze parametru klienta.  
  
## <a name="message"></a>Komunikat  
 Dyspozytor wywoływane "BeforeCall" na ClientParameterInspector typu "%1".  
