...
Za pomocą jednego przeciążenia metody <xref:System.Printing.PrintQueue.AddJob%2A> można drukować pliki specyfikacji XML Paper Specification (XPS) bez konieczności otwierania <xref:System.Windows.Controls.PrintDialog> lub, w zasadzie, wszelkich [!INCLUDE[TLA#tla_ui](../../../../includes/tlasharptla-ui-md.md)] w ogóle.
