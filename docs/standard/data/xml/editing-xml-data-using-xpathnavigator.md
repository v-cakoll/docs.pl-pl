...
## <a name="in-this-section"></a>W tej sekcji  
 ...
 Opisuje sposób wstawić element równorzędny, podrzędny, atrybut węzłów i wartości w celu <xref:System.Xml.XmlDocument> przy użyciu <xref:System.Xml.XPath.XPathNavigator> klasy.  
 ...
 Opisuje sposób usuwania węzłów i wartości z <xref:System.Xml.XmlDocument> przy użyciu <xref:System.Xml.XPath.XPathNavigator> klasy.  
