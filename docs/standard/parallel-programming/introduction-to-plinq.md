...
|<xref:System.Linq.ParallelEnumerable.AsOrdered%2A>|Określa, że PLINQ powinno zachować kolejność sekwencji źródłowej rest zapytania lub do momentu kolejność ulegnie zmianie, na przykład przy użyciu klauzuli orderby (Order By Basic Vlsual).|  
