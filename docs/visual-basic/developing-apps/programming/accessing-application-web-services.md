...
|Asynchroniczne wywoływanie usługi sieci Web i obsługi zdarzenia po jego ukończeniu|[Porady: asynchroniczne wywoływanie usługi sieci Web](../../../visual-basic/developing-apps/programming/how-to-call-a-web-service-asynchronously.md)|  
