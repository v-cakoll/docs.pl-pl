...
---
# <a name="runtime-changes-for-migration-from-net-framework-451-to-452"></a>Zmiany środowiska uruchomieniowego w przypadku migracji z .NET Framework 4.5.1 i 4.5.2
