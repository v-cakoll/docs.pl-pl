...
#### <a name="reducing-the-size-of-type-hints"></a>Zmniejszenie rozmiaru wskazówek typu  
 Aby zmniejszyć rozmiar JSON komunikaty, prefiks przestrzeni nazw kontraktu danych domyślne (http://schemas.datacontract.org/2004/07/) zastępuje się od znaku "#". (Aby zamiany odwracalny, ucieczki reguła jest używana: Jeśli przestrzeń nazw rozpoczyna się od znaku "#" lub "\\" znaki, są dołączony dodatkowy "\\" znaków). W związku z tym jeśli "Okrąg" jest typem w przestrzeni nazw .NET "MyApp.Shapes", jest jego domyślnej przestrzeni nazw kontraktu danych http://schemas.datacontract.org/2004/07/MyApp. Kształty i reprezentacja JSON ma następującą składnię.  
  
```json  
{"__type":"Circle:#MyApp.Shapes","x":50,"y":70,"radius":10}  
```  
  
 Zarówno skróconą (#MyApp.Shapes) oraz pełny (http://schemas.datacontract.org/2004/07/MyApp.Shapes) nazwy jest rozpoznawany przy deserializacji.  
