...
Brak przeciążenia dla metody "metoda" przyjmuje argumenty "liczba"  
  
 Wywołanie zostało wykonane do metody klasy, ale nie definicji metody ma określoną liczbę argumentów.  
