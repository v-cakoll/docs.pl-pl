...
Podczas próby wykonania akcji związanych z folderu są określania pliku.  
  
## <a name="to-correct-this-error"></a>Aby poprawić ten błąd  
  
-   Sprawdź ścieżkę są dostarczanie, aby upewnić się, że określasz folder zamiast pliku.  
...
## <a name="see-also"></a>Zobacz też  
 ...
 [Plik, katalogu i właściwości dysku w języku Visual Basic](http://msdn.microsoft.com/library/131593e9-d1b0-4c89-9c03-ae8afc458829)  
 [Porady: określić bezwzględną ścieżkę pliku w Visual Basic](http://msdn.microsoft.com/library/4c6769df-e9b9-4b69-bfdf-ce4cfbda30ff)
