...
## <a name="description"></a>Opis  
 To zdarzenie wskazuje, czy żądanie GetObject usługi WMI nie została przetworzona. Wyświetla zdarzenia obiektu WMI, wyjątków, nazwa procesu i procesu identyfikatora.  
