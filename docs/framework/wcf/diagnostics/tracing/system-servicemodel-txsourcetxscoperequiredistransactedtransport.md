...
Określonej transakcji zostało odebrane dla określonej operacji usługi transportu, takich jak usługi MSMQ.  
  
## <a name="description"></a>Opis  
 Śledzone, jeśli transakcja dostępna dla kodu użytkownika została utworzona przez dot.  
