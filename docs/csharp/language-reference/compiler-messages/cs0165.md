...
Użycie nieprzypisanej zmiennej lokalnej "name"  
 ...
 Aby uzyskać więcej informacji, zobacz [dlaczego cykliczne lambda powodują wystąpienie błędu przypisania?](https://docs.microsoft.com/archive/blogs/ericlippert/why-does-a-recursive-lambda-cause-a-definite-assignment-error).  
