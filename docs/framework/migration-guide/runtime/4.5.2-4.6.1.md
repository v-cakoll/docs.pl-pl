---
title: Zmiany w czasie wykonywania migracji z .NET Framework 4.5.2 do 4.6.1
description: Znajdź informacje o problemach ze zgodnością aplikacji w czasie wykonywania, które mogą mieć wpływ na aplikację podczas migrowania z .NET Framework 4.5.2 do 4.6.1.
ms.date: 07/10/2019
...
ms.locfileid: "86443445"
---
# <a name="runtime-changes-for-migration-from-net-framework-452-to-461"></a><span data-ttu-id="2a0ef-103">Zmiany w czasie wykonywania migracji z .NET Framework 4.5.2 do 4.6.1</span><span class="sxs-lookup"><span data-stu-id="2a0ef-103">Runtime Changes for Migration from .NET Framework 4.5.2 to 4.6.1</span></span>

[!INCLUDE[versionselector](../../../../includes/migration-guide/runtime/versionselector.md)]

<span data-ttu-id="2a0ef-104">W przypadku migrowania z .NET Framework 4.5.2 do 4.6.1 zapoznaj się z następującymi tematami dotyczącymi problemów ze zgodnością aplikacji, które mogą mieć wpływ na aplikację:</span><span class="sxs-lookup"><span data-stu-id="2a0ef-104">If you are migrating from the .NET Framework 4.5.2 to 4.6.1, review the following topics for application compatibility issues that may affect your app:</span></span>

## <a name="aspnet"></a><span data-ttu-id="2a0ef-105">ASP.NET</span><span class="sxs-lookup"><span data-stu-id="2a0ef-105">ASP.NET</span></span>
...
## <a name="core"></a><span data-ttu-id="2a0ef-106">Core</span><span class="sxs-lookup"><span data-stu-id="2a0ef-106">Core</span></span>
...
## <a name="data"></a><span data-ttu-id="2a0ef-107">Dane</span><span class="sxs-lookup"><span data-stu-id="2a0ef-107">Data</span></span>
...
## <a name="debugger"></a><span data-ttu-id="2a0ef-108">Debuger</span><span class="sxs-lookup"><span data-stu-id="2a0ef-108">Debugger</span></span>
...
## <a name="networking"></a><span data-ttu-id="2a0ef-109">Sieć</span><span class="sxs-lookup"><span data-stu-id="2a0ef-109">Networking</span></span>
...
## <a name="serialization"></a><span data-ttu-id="2a0ef-110">Serializacja</span><span class="sxs-lookup"><span data-stu-id="2a0ef-110">Serialization</span></span>
...
## <a name="setup-and-deployment"></a><span data-ttu-id="2a0ef-111">Instalacja i wdrożenie</span><span class="sxs-lookup"><span data-stu-id="2a0ef-111">Setup and Deployment</span></span>
...
## <a name="tools"></a><span data-ttu-id="2a0ef-112">Narzędzia</span><span class="sxs-lookup"><span data-stu-id="2a0ef-112">Tools</span></span>

[!INCLUDE[Contract.Invariant or Contract.Requires\<TException> do not consider String.IsNullOrEmpty to be pure](~/includes/migration-guide/runtime/tools/contractinvariant-contractrequirestexception-do-not-consider.md)]

## <a name="windows-communication-foundation-wcf"></a><span data-ttu-id="2a0ef-113">Windows Communication Foundation (WCF)</span><span class="sxs-lookup"><span data-stu-id="2a0ef-113">Windows Communication Foundation (WCF)</span></span>
...
## <a name="windows-presentation-foundation-wpf"></a><span data-ttu-id="2a0ef-114">Windows Presentation Foundation (WPF)</span><span class="sxs-lookup"><span data-stu-id="2a0ef-114">Windows Presentation Foundation (WPF)</span></span>
