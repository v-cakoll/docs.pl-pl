...
Wynikiem obliczenia wyrażenia używane argumentu atrybutu jest różne od odpowiedniego parametru atrybutu typu danych i [!INCLUDE[vbprvb](~/includes/vbprvb-md.md)] nie zezwala na wymagany typ konwersji do argumentów atrybutu.  
