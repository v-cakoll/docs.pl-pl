...
## <a name="see-also"></a>Zobacz też  
 ...
 [Porady: Zapobieganie dodawaniu i usuwaniu w oknach formantu DataGridView, przy użyciu narzędzia Projektant formularzy](../../../../docs/framework/winforms/controls/prevent-row-addition-and-deletion-in-the-datagrid-using-the-designer.md)  
