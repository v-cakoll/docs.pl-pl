...
ms.locfileid: "61871062"
---
# <a name="retargeting-changes-for-migration-from-net-framework-40-to-45"></a><span data-ttu-id="80151-102">Zmiany retargetingu w przypadku migracji z .NET Framework 4.0 lub 4.5</span><span class="sxs-lookup"><span data-stu-id="80151-102">Retargeting Changes for Migration from .NET Framework 4.0 to 4.5</span></span>

[!INCLUDE[versionselector](../../../../includes/migration-guide/retargeting/versionselector.md)]

[!INCLUDE[introduction](../../../../includes/migration-guide/retargeting/introduction.md)]

<span data-ttu-id="80151-103">Jeśli są migrowane z programu .NET Framework 4.0, 4.5, przejrzyj problemy ze zgodnością aplikacji, które mogą wpływać na Twoją aplikację w poniższych tematach:</span><span class="sxs-lookup"><span data-stu-id="80151-103">If you are migrating from the .NET Framework 4.0 to 4.5, review the following topics for application compatibility issues that may affect your app:</span></span>

## <a name="aspnet"></a><span data-ttu-id="80151-104">ASP.NET</span><span class="sxs-lookup"><span data-stu-id="80151-104">ASP.NET</span></span>
...
## <a name="clickonce"></a><span data-ttu-id="80151-105">ClickOnce</span><span class="sxs-lookup"><span data-stu-id="80151-105">ClickOnce</span></span>
...
## <a name="core"></a><span data-ttu-id="80151-106">Core</span><span class="sxs-lookup"><span data-stu-id="80151-106">Core</span></span>
...
## <a name="entity-framework"></a><span data-ttu-id="80151-107">Entity Framework</span><span class="sxs-lookup"><span data-stu-id="80151-107">Entity Framework</span></span>
...
## <a name="windows-forms"></a><span data-ttu-id="80151-108">Windows Forms</span><span class="sxs-lookup"><span data-stu-id="80151-108">Windows Forms</span></span>
...
## <a name="windows-presentation-foundation-wpf"></a><span data-ttu-id="80151-109">Windows Presentation Foundation (WPF)</span><span class="sxs-lookup"><span data-stu-id="80151-109">Windows Presentation Foundation (WPF)</span></span>
...
## <a name="windows-workflow-foundation-wf"></a><span data-ttu-id="80151-110">Program Windows Workflow Foundation (WF)</span><span class="sxs-lookup"><span data-stu-id="80151-110">Windows Workflow Foundation (WF)</span></span>
...
## <a name="xml-xslt"></a><span data-ttu-id="80151-111">Języki XML, XSLT</span><span class="sxs-lookup"><span data-stu-id="80151-111">XML, XSLT</span></span>
