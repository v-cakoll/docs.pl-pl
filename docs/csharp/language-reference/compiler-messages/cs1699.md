...
Użyj opcji wiersza polecenia "compiler_option" lub odpowiednich ustawień projektu zamiast "attribute_name"  
 ...
 Aby podpisać zestaw, należy określić plik klucza. Przed C# 2.0, określony plik klucza stosując atrybuty CLR w kodzie źródłowym. Te atrybuty są one przestarzałe.  
  
 Począwszy od C# 2.0, należy użyć **strony podpisywania** z **projektanta projektu** lub Assembly Linker, aby określić plik klucza.  
 ...
 **Strony podpisywania** z **projektanta projektu** jest preferowaną metodą; Aby uzyskać więcej informacji, zobacz [strona podpisywania, Projektant projektu](/visualstudio/ide/reference/signing-page-project-designer) i [Zarządzanie Zestawem i podpisywanie manifestu](/visualstudio/ide/managing-assembly-and-manifest-signing).  
 ...
 [Jak: Podpisywanie zestawu za pomocą silnej nazwy](../../../framework/app-domains/how-to-sign-an-assembly-with-a-strong-name.md) korzysta z następujących opcji kompilatora:  
