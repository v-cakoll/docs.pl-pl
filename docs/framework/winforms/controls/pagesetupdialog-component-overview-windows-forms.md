...
## <a name="key-properties-and-methods"></a>Kluczowe właściwości i metody  
 ...
 Gdy zostanie dodany do formularza, <xref:System.Windows.Forms.PageSetupDialog> składnika, który pojawia się na pasku w dolnej części projektanta Windows Forms.  
