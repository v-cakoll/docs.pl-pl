...
## <a name="related-sections"></a>Sekcje pokrewne  
 ...
 [Porady: licencja składników i formantów](http://msdn.microsoft.com/library/8e66c1ed-a445-4b26-8185-990b6e2bbd57)  
 Opisuje sposób wdrożenia licencjonowania w kontroli lub składnika.  
  
 Zobacz też [opracowywanie formantów formularzy systemu Windows w czasie projektowania](http://msdn.microsoft.com/library/w29y3h59\(v=vs.110\)).
