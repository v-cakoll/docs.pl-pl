...
ms.locfileid: "67858554"
---
# <a name="runtime-changes-for-migration-from-net-framework-452-to-47"></a><span data-ttu-id="02dda-102">Zmiany środowiska uruchomieniowego w przypadku migracji z .NET Framework 4.5.2 i 4.7</span><span class="sxs-lookup"><span data-stu-id="02dda-102">Runtime Changes for Migration from .NET Framework 4.5.2 to 4.7</span></span>

[!INCLUDE[versionselector](../../../../includes/migration-guide/runtime/versionselector.md)]

[!INCLUDE[introduction](../../../../includes/migration-guide/runtime/introduction.md)]

<span data-ttu-id="02dda-103">Migracji z programu .NET Framework 4.5.2 i 4.7, przejrzyj problemy ze zgodnością aplikacji, które mogą wpływać na Twoją aplikację w poniższych tematach:</span><span class="sxs-lookup"><span data-stu-id="02dda-103">If you are migrating from the .NET Framework 4.5.2 to 4.7, review the following topics for application compatibility issues that may affect your app:</span></span>

## <a name="aspnet"></a><span data-ttu-id="02dda-104">ASP.NET</span><span class="sxs-lookup"><span data-stu-id="02dda-104">ASP.NET</span></span>
...
## <a name="core"></a><span data-ttu-id="02dda-105">Core</span><span class="sxs-lookup"><span data-stu-id="02dda-105">Core</span></span>
...
## <a name="data"></a><span data-ttu-id="02dda-106">Dane</span><span class="sxs-lookup"><span data-stu-id="02dda-106">Data</span></span>
...
## <a name="debugger"></a><span data-ttu-id="02dda-107">Debuger</span><span class="sxs-lookup"><span data-stu-id="02dda-107">Debugger</span></span>
...
## <a name="globalization"></a><span data-ttu-id="02dda-108">Globalizacja</span><span class="sxs-lookup"><span data-stu-id="02dda-108">Globalization</span></span>
...
## <a name="jit"></a><span data-ttu-id="02dda-109">JIT</span><span class="sxs-lookup"><span data-stu-id="02dda-109">JIT</span></span>
...
## <a name="networking"></a><span data-ttu-id="02dda-110">Obsługa sieci</span><span class="sxs-lookup"><span data-stu-id="02dda-110">Networking</span></span>
...
## <a name="security"></a><span data-ttu-id="02dda-111">Zabezpieczenia</span><span class="sxs-lookup"><span data-stu-id="02dda-111">Security</span></span>
...
## <a name="serialization"></a><span data-ttu-id="02dda-112">Serializacja</span><span class="sxs-lookup"><span data-stu-id="02dda-112">Serialization</span></span>
...
## <a name="setup-and-deployment"></a><span data-ttu-id="02dda-113">Instalacja i wdrożenie</span><span class="sxs-lookup"><span data-stu-id="02dda-113">Setup and Deployment</span></span>
...
## <a name="tools"></a><span data-ttu-id="02dda-114">Narzędzia</span><span class="sxs-lookup"><span data-stu-id="02dda-114">Tools</span></span>

[!INCLUDE[Contract.Invariant or Contract.Requires\<TException> do not consider String.IsNullOrEmpty to be pure](~/includes/migration-guide/runtime/tools/contractinvariant-contractrequirestexception-do-not-consider.md)]

## <a name="windows-communication-foundation-wcf"></a><span data-ttu-id="02dda-115">Windows Communication Foundation (WCF)</span><span class="sxs-lookup"><span data-stu-id="02dda-115">Windows Communication Foundation (WCF)</span></span>
...
## <a name="windows-presentation-foundation-wpf"></a><span data-ttu-id="02dda-116">Windows Presentation Foundation (WPF)</span><span class="sxs-lookup"><span data-stu-id="02dda-116">Windows Presentation Foundation (WPF)</span></span>
...
## <a name="windows-workflow-foundation-wf"></a><span data-ttu-id="02dda-117">Program Windows Workflow Foundation (WF)</span><span class="sxs-lookup"><span data-stu-id="02dda-117">Windows Workflow Foundation (WF)</span></span>
