...
-   <xref:System.ServiceModel.InstanceContextMode.Single>: Jedno wystąpienie klasy usługi obsługuje wszystkie żądania klienta przez okres istnienia aplikacji.  
