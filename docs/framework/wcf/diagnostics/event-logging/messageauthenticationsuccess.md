...
## <a name="description"></a>Opis  
 To zdarzenie oznacza uwierzytelniania wiadomości zakończyło się pomyślnie. Wyświetla zdarzenia, usługi, działania, tożsamość klienta i identyfikator działania.  
