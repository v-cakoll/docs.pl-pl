...
---
# <a name="runtime-changes-for-migration-from-net-framework-45-to-452"></a><span data-ttu-id="5ac62-102">Zmiany środowiska uruchomieniowego do migracji z platformy .NET Framework 4.5 do 4.5.2</span><span class="sxs-lookup"><span data-stu-id="5ac62-102">Runtime Changes for Migration from .NET Framework 4.5 to 4.5.2</span></span>

[!include[versionselector](../../../../includes/migration-guide/runtime/versionselector.md)]

[!include[introduction](../../../../includes/migration-guide/runtime/introduction.md)]

<span data-ttu-id="5ac62-103">Jeśli w przypadku migracji z programu .NET Framework 4.5 do 4.5.2, należy przejrzeć następujące tematy dla problemów ze zgodnością aplikacji, które mogą wpływać na aplikację:</span><span class="sxs-lookup"><span data-stu-id="5ac62-103">If you are migrating from the .NET Framework 4.5 to 4.5.2, review the following topics for application compatibility issues that may affect your app:</span></span>

## <a name="adonet"></a><span data-ttu-id="5ac62-104">ADO.NET</span><span class="sxs-lookup"><span data-stu-id="5ac62-104">ADO.NET</span></span>
...
## <a name="aspnet"></a><span data-ttu-id="5ac62-105">ASP.NET</span><span class="sxs-lookup"><span data-stu-id="5ac62-105">ASP.NET</span></span>
...
## <a name="core"></a><span data-ttu-id="5ac62-106">Core</span><span class="sxs-lookup"><span data-stu-id="5ac62-106">Core</span></span>
...
## <a name="data"></a><span data-ttu-id="5ac62-107">Dane</span><span class="sxs-lookup"><span data-stu-id="5ac62-107">Data</span></span>
...
## <a name="entity-framework"></a><span data-ttu-id="5ac62-108">Entity Framework</span><span class="sxs-lookup"><span data-stu-id="5ac62-108">Entity Framework</span></span>
...
## <a name="serialization"></a><span data-ttu-id="5ac62-109">Serializacja</span><span class="sxs-lookup"><span data-stu-id="5ac62-109">Serialization</span></span>
...
## <a name="windows-communication-foundation-wcf"></a><span data-ttu-id="5ac62-110">Windows Communication Foundation (WCF)</span><span class="sxs-lookup"><span data-stu-id="5ac62-110">Windows Communication Foundation (WCF)</span></span>
...
## <a name="windows-presentation-foundation-wpf"></a><span data-ttu-id="5ac62-111">Windows Presentation Foundation (WPF)</span><span class="sxs-lookup"><span data-stu-id="5ac62-111">Windows Presentation Foundation (WPF)</span></span>
