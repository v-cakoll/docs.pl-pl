...
|Termin|Definicja|  
|---|---|  
|`id`|Wymagany. Kompilator używa strony kodowej określonej przez `id` program, aby interpretować Kodowanie plików źródłowych.|  
...
> [!NOTE]
> `-codepage` Opcja jest niedostępna w środowisku deweloperskim programu Visual Studio; jest on dostępny tylko w przypadku kompilowania z wiersza polecenia.  
