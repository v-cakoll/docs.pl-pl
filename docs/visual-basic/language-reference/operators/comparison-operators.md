...
## <a name="parts"></a>Części
 `result`  
 Wymagany. A `Boolean` value representing the result of the comparison.

 `expression1`, `expression2`  
 Wymagany. Any expression.

 `comparisonoperator`  
 Wymagany. Any relational comparison operator.

 `object1`, `object2`  
 Wymagany. Any reference object names.

 `string`  
 Wymagany. Any `String` expression.

 `pattern`  
 Wymagany. Any `String` expression or range of characters.
