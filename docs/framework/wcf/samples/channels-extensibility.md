...
## <a name="in-this-section"></a>W tej sekcji  
 ...
 Pokazuje lokalnego kanału [!INCLUDE[indigo2](../../../../includes/indigo2-md.md)] kanał transportu, który jest używany do komunikacji w obrębie tej samej domenie aplikacji.  
  
 [Niezawodny bezpieczny profil](../../../../docs/framework/wcf/samples/reliable-secure-profile.md)  
 Pokazuje, jak utworzyć [!INCLUDE[indigo2](../../../../includes/indigo2-md.md)] i niezawodny bezpieczny profil (źródło).  
 ...
 Pokazuje, jak ograniczyć ilość pamięci użytej do zbuforowania dużych komunikatów wysyłanych za pomocą [!INCLUDE[indigo2](../../../../includes/indigo2-md.md)].  
 ...
 [Niestandardowy element przechwytujący](../../../../docs/framework/wcf/samples/custom-message-interceptor.md)  
