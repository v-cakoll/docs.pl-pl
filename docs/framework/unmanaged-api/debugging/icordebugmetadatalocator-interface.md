...
|Metoda|Opis|  
|------------|-----------------|  
|[GetMetaData, metoda](icordebugmetadatalocator-getmetadata-method.md)|Prosi debugera o zwrócenie pełnej ścieżki do modułu, którego metadane są wymagane do ukończenia operacji wymaganej przez debuger.|  
