...
|Otwieranie połączenia z bazą danych|Umiarkowane<sup>1</sup>|Zgodnie z wymaganiami.|Ponieważ otwarte połączenie z bazą danych zużywa cenny zasób, [!INCLUDE[adonet_ef](../../../../../includes/adonet-ef-md.md)] otwiera i zamyka połączenie z bazą danych tylko w razie potrzeby. Możesz również jawnie otworzyć połączenie. Aby uzyskać więcej informacji, zobacz [Zarządzanie połączeniami i transakcjami](https://docs.microsoft.com/previous-versions/dotnet/netframework-4.0/bb896325(v=vs.100)).|  
