...
Powiadamia profilera, że klient wysyła żądanie do serwera.  
...
#### <a name="parameters"></a>Parametry  
 `pCookie`  
 [in] Wartość uniemożliwiająca z podanej wartości w [ICorProfilerCallback::RemotingServerReceivingMessage](../../../../docs/framework/unmanaged-api/profiling/icorprofilercallback-remotingserverreceivingmessage-method.md) w tych warunkach:  
