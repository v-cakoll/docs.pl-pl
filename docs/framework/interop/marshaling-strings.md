...
|Przez odwołanie.|Przekazuje ciągi jako parametry wejściowe/out przy użyciu polecenia <xref:System.Text.StringBuilder> .|[Ręczny](https://docs.microsoft.com/previous-versions/dotnet/netframework-4.0/x3txb6xc(v=vs.100))|  
