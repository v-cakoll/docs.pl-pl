...
## <a name="description"></a>Opis  
 To zdarzenie jest emitowane po przetwarzania przychodzących żądań obsługi komunikatów Http.  
  
## <a name="message"></a>Komunikat  
 Program obsługi komunikatów HTTP pracę, przetwarza żądanie przychodzące.  
