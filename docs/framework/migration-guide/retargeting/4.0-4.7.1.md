...
ms.locfileid: "86444407"
---
# <a name="retargeting-changes-for-migration-from-net-framework-40-to-471"></a><span data-ttu-id="3578c-103">Przekierowywanie zmian dotyczących migracji z .NET Framework 4,0 do 4.7.1</span><span class="sxs-lookup"><span data-stu-id="3578c-103">Retargeting Changes for Migration from .NET Framework 4.0 to 4.7.1</span></span>

[!INCLUDE[versionselector](../../../../includes/migration-guide/retargeting/versionselector.md)]

<span data-ttu-id="3578c-104">W przypadku migrowania z .NET Framework 4,0 do usługi 4.7.1 zapoznaj się z następującymi tematami dotyczącymi problemów ze zgodnością aplikacji, które mogą mieć wpływ na aplikację:</span><span class="sxs-lookup"><span data-stu-id="3578c-104">If you are migrating from the .NET Framework 4.0 to 4.7.1, review the following topics for application compatibility issues that may affect your app:</span></span>

## <a name="adonet"></a><span data-ttu-id="3578c-105">ADO.NET</span><span class="sxs-lookup"><span data-stu-id="3578c-105">ADO.NET</span></span>
...
## <a name="aspnet"></a><span data-ttu-id="3578c-106">ASP.NET</span><span class="sxs-lookup"><span data-stu-id="3578c-106">ASP.NET</span></span>
...
## <a name="clickonce"></a><span data-ttu-id="3578c-107">ClickOnce</span><span class="sxs-lookup"><span data-stu-id="3578c-107">ClickOnce</span></span>
...
## <a name="core"></a><span data-ttu-id="3578c-108">Core</span><span class="sxs-lookup"><span data-stu-id="3578c-108">Core</span></span>
...
## <a name="entity-framework"></a><span data-ttu-id="3578c-109">Entity Framework</span><span class="sxs-lookup"><span data-stu-id="3578c-109">Entity Framework</span></span>
...
## <a name="jit"></a><span data-ttu-id="3578c-110">JIT</span><span class="sxs-lookup"><span data-stu-id="3578c-110">JIT</span></span>
...
## <a name="msbuild"></a><span data-ttu-id="3578c-111">MSBuild</span><span class="sxs-lookup"><span data-stu-id="3578c-111">MSBuild</span></span>
...
## <a name="networking"></a><span data-ttu-id="3578c-112">Sieć</span><span class="sxs-lookup"><span data-stu-id="3578c-112">Networking</span></span>
...
## <a name="security"></a><span data-ttu-id="3578c-113">Zabezpieczenia</span><span class="sxs-lookup"><span data-stu-id="3578c-113">Security</span></span>
...
## <a name="visual-basic-net"></a><span data-ttu-id="3578c-114">Visual Basic .NET</span><span class="sxs-lookup"><span data-stu-id="3578c-114">Visual Basic .NET</span></span>

[!INCLUDE[VB.NET no longer supports partial namespace qualification for System.Windows APIs](~/includes/migration-guide/retargeting/vb/vbnet-no-longer-supports-partial-namespace-qualification-for-systemwindows.md)]

## <a name="windows-communication-foundation-wcf"></a><span data-ttu-id="3578c-115">Windows Communication Foundation (WCF)</span><span class="sxs-lookup"><span data-stu-id="3578c-115">Windows Communication Foundation (WCF)</span></span>
...
## <a name="windows-forms"></a><span data-ttu-id="3578c-116">Windows Forms</span><span class="sxs-lookup"><span data-stu-id="3578c-116">Windows Forms</span></span>
...
## <a name="windows-presentation-foundation-wpf"></a><span data-ttu-id="3578c-117">Windows Presentation Foundation (WPF)</span><span class="sxs-lookup"><span data-stu-id="3578c-117">Windows Presentation Foundation (WPF)</span></span>
...
## <a name="windows-workflow-foundation-wf"></a><span data-ttu-id="3578c-118">Program Windows Workflow Foundation (WF)</span><span class="sxs-lookup"><span data-stu-id="3578c-118">Windows Workflow Foundation (WF)</span></span>
...
## <a name="xml-xslt"></a><span data-ttu-id="3578c-119">Języki XML, XSLT</span><span class="sxs-lookup"><span data-stu-id="3578c-119">XML, XSLT</span></span>
