...
Poniższe linki odwoływać się do przestrzeni nazw, która zawiera [!INCLUDE[TLA#tla_winclient](../../../includes/tlasharptla-winclient-md.md)] [!INCLUDE[TLA#tla_api#plural](../../../includes/tlasharptla-apisharpplural-md.md)].  
...
## <a name="xaml-support-in-net-4"></a>Obsługa języka XAML w programie .NET 4  
 Następujące przestrzenie nazw zawierają typy z System.Xaml zestawu. System.Xaml zapewnia wsparcie XAML dla struktur, takich jak WPF, które są oparte na [!INCLUDE[net_v40_long](../../../includes/net-v40-long-md.md)].  
