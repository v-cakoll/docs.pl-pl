...
## <a name="to-correct-this-error"></a><span data-ttu-id="3bc4a-106">Aby poprawić ten błąd</span><span class="sxs-lookup"><span data-stu-id="3bc4a-106">To correct this error</span></span>  
  
-   <span data-ttu-id="3bc4a-107">Sprawdź i respecify ścieżki.</span><span class="sxs-lookup"><span data-stu-id="3bc4a-107">Verify and respecify the path.</span></span>  
  
## <a name="see-also"></a><span data-ttu-id="3bc4a-108">Zobacz też</span><span class="sxs-lookup"><span data-stu-id="3bc4a-108">See Also</span></span>  
 [<span data-ttu-id="3bc4a-109">Typy błędów</span><span class="sxs-lookup"><span data-stu-id="3bc4a-109">Error Types</span></span>](../../../visual-basic/programming-guide/language-features/error-types.md)
