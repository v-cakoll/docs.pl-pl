...
## <a name="in-this-section"></a>W tej sekcji  
 ...
 [Instrukcje: Tworzenie obsługi zdarzeń przy użyciu narzędzia Projektant](https://docs.microsoft.com/previous-versions/visualstudio/visual-studio-2010/zwwsdtbk(v=vs.100))  
 W tym artykule opisano, jak utworzyć procedury obsługi zdarzeń za pomocą programu Windows Forms Designer.  
