...
> [!NOTE]
>  Należy dostarczyć właściciela do obsługi [!INCLUDE[TLA#tla_ui](../../../../includes/tlasharptla-ui-md.md)] automatyzacji dla okien dialogowych (zobacz [Przegląd automatyzacji interfejsu użytkownika](../../ui-automation/ui-automation-overview.md)).  
