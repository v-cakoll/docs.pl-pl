...
|Sugestia|W większości przypadków te zmiany nie będzie mieć wpływ na kod użytkownika. Kod, który jest zależny od określoną liczbę elementów znajdujących się <xref:System.Enum.GetNames(System.Type)> lub <xref:System.Enum.GetValues(System.Type)> wywołuje <xref:System.Windows.Controls.PageRangeSelection?displayProperty=name> typ powinien być modyfikowany, natomiast.|
|Zakres|Krawędź|
|Wersja|4.5|
