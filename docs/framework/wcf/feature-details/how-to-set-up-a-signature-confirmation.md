...
5. Opcjonalna. Aby włączyć potwierdzenia podpisu podczas uruchamiania, należy dodać [ \<secureConversationBootstrap >](../../../../docs/framework/configure-apps/file-schema/wcf/secureconversationbootstrap.md) element podrzędny i ustaw `requireSignatureConfirmation` atrybutu `true`.
