...
ms.locfileid: "33596583"
---
# <a name="mycomputeraudio-object"></a>My.Computer.Audio — Obiekt
Udostępnia metody dla odtwarzanie dźwięków.  
  
## <a name="remarks"></a>Uwagi  
 Informacje dotyczące metod i właściwości `My.Computer.Audio` obiektów, zobacz <xref:Microsoft.VisualBasic.Devices.Audio>.  
 ...
 **Klasy:** <xref:Microsoft.VisualBasic.Devices.Audio>  
