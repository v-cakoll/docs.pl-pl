...
---
# <a name="compiler-error-cs0428"></a><span data-ttu-id="ee0c2-102">CS0428 błąd kompilatora</span><span class="sxs-lookup"><span data-stu-id="ee0c2-102">Compiler Error CS0428</span></span>
<span data-ttu-id="ee0c2-103">Nie można przekonwertować grupy metod "identyfikator' na typ 'type' Niedelegowany.</span><span class="sxs-lookup"><span data-stu-id="ee0c2-103">Cannot convert method group 'Identifier' to non-delegate type 'type'.</span></span>  <span data-ttu-id="ee0c2-104">Czy zamierzasz wywołać metodę?</span><span class="sxs-lookup"><span data-stu-id="ee0c2-104">Did you  intend to invoke the method?</span></span>  
  
 <span data-ttu-id="ee0c2-105">Ten błąd występuje podczas konwertowania na typ niedelegowany lub próba wywołania metody bez użycia nawiasów grupy metod.</span><span class="sxs-lookup"><span data-stu-id="ee0c2-105">This error occurs when converting a method group to a non-delegate type, or attempting to invoke a method without using parentheses.</span></span>  
  
## <a name="example"></a><span data-ttu-id="ee0c2-106">Przykład</span><span class="sxs-lookup"><span data-stu-id="ee0c2-106">Example</span></span>  
 <span data-ttu-id="ee0c2-107">Poniższy przykład generuje CS0428:</span><span class="sxs-lookup"><span data-stu-id="ee0c2-107">The following sample generates CS0428:</span></span>  
