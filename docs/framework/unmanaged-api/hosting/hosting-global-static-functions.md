...
W tej sekcji opisano funkcje hostingu niezarządzane, używany przez program .NET Framework hostingu interfejsów API.  
...
## <a name="in-this-section"></a>W tej sekcji  
 ...
 Opisuje funkcje wprowadzone w .NET Framework 4.  
  
 [Przestarzałe funkcje hostingu środowiska CLR](../../../../docs/framework/unmanaged-api/hosting/deprecated-clr-hosting-functions.md)  
 Opisuje funkcje wprowadzone w .NET Framework 1.1 i 2.0, które nie są używane w [!INCLUDE[net_v40_long](../../../../includes/net-v40-long-md.md)].  
