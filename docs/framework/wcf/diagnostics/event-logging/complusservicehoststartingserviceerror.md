...
## <a name="description"></a>Opis  
 To zdarzenie oznacza, że wystąpił błąd podczas uruchamiania usług COM +. Zdarzenie Wyświetla identyfikator ClsID, zastępczy, wyjątków, nazwa procesu i identyfikatora procesu.  
