...
---
# <a name="accessing-xml-data-using-xpathnavigator"></a>Uzyskiwanie dostępu do danych XML przy użyciu parametrem XPathNavigator
<xref:System.Xml.XPath.XPathNavigator> Klasa dostarcza metody do nawigowania węzłów, wyodrębnić dane XML i dostępu jednoznacznie danych XML w <xref:System.Xml.XPath.XPathDocument> lub <xref:System.Xml.XmlDocument> obiektu.  
...
## <a name="in-this-section"></a>W tej sekcji  
 ...
 Opisuje węzeł zestawu nawigacji metody <xref:System.Xml.XPath.XPathNavigator> klasy służące do węzłów nawigacji <xref:System.Xml.XPath.XPathDocument> lub <xref:System.Xml.XmlDocument> obiektu.  
 ...
 Zawiera opis atrybutu i przestrzeni nazw węzła nawigacji metody <xref:System.Xml.XPath.XPathNavigator> klasy.  
 ...
 W tym artykule opisano, uzyskiwanie dostępu do silnie typizowane dane XML w <xref:System.Xml.XPath.XPathDocument> lub <xref:System.Xml.XmlDocument> przy użyciu <xref:System.Xml.XPath.XPathNavigator> klasy.  
  
 [Funkcje i zmienne zdefiniowane przez użytkownika](../../../../docs/standard/data/xml/user-defined-functions-and-variables.md)  
 Opisano Implementowanie niestandardowego <xref:System.Xml.Xsl.XsltContext> klasy wraz z interfejsów <xref:System.Xml.Xsl.IXsltContextFunction> i <xref:System.Xml.Xsl.IXsltContextVariable> obsługujących rozszerzenia funkcje i zmienne.  
