---
title: "Jak konwertować BitmapSource na format indeksowanych pikseli"
ms.custom: 
ms.date: 03/30/2017
...
---
# <a name="how-to-convert-a-bitmapsource-to-an-indexed-pixel-format"></a><span data-ttu-id="16878-102">Jak konwertować BitmapSource na format indeksowanych pikseli</span><span class="sxs-lookup"><span data-stu-id="16878-102">How to: Convert a BitmapSource to an Indexed Pixel Format</span></span>
<span data-ttu-id="16878-103">W tym przykładzie pokazano, jak przekonwertować <xref:System.Windows.Media.Imaging.BitmapSource> do formatu piksela indeksowanego.</span><span class="sxs-lookup"><span data-stu-id="16878-103">This example shows how to convert a <xref:System.Windows.Media.Imaging.BitmapSource> to an indexed pixel format.</span></span>  
  
## <a name="example"></a><span data-ttu-id="16878-104">Przykład</span><span class="sxs-lookup"><span data-stu-id="16878-104">Example</span></span>  
