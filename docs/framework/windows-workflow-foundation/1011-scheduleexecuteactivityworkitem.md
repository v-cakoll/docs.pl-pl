...
## <a name="description"></a>Opis  
 Wskazuje, że zaplanowano element roboczy ExecuteActivityWorkItem.  
  
## <a name="message"></a>Komunikat  
 Zaplanowano element roboczy ExecuteActivityWorkItem dla działania %1, nazwa wyświetlana: %2, identyfikator wystąpienia: '%3'.  
