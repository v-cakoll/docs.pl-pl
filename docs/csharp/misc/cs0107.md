...
Więcej niż jeden modyfikator ochrony  
 ...
 Modyfikator dostępu tylko jeden ([publicznych](../../csharp/language-reference/keywords/public.md), [prywatnej](../../csharp/language-reference/keywords/private.md), [chronione](../../csharp/language-reference/keywords/protected.md), lub [wewnętrzny](../../csharp/language-reference/keywords/internal.md)) jest dozwolona dla składowej klasy, z wyjątkiem produktów z wyjątkiem **chronionych wewnętrznych**.  
  
 Poniższy przykład spowoduje wygenerowanie CS0107:  
