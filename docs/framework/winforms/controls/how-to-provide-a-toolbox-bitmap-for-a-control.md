...
1.  Dodaj <xref:System.Drawing.ToolboxBitmapAttribute> deklaracji klasy z formantu przed `Class` — słowo kluczowe dla [!INCLUDE[vbprvb](../../../../includes/vbprvb-md.md)]i powyżej deklaracji klasy [!INCLUDE[csprcs](../../../../includes/csprcs-md.md)].  
