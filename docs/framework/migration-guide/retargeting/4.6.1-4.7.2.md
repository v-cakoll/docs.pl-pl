...
---
# <a name="retargeting-changes-for-migration-from-net-framework-461-to-472"></a>Zmiany retargetingu migracji z systemu .NET Framework 4.6.1 do 4.7.2

[!INCLUDE[versionselector](../../../../includes/migration-guide/retargeting/versionselector.md)]

[!INCLUDE[introduction](../../../../includes/migration-guide/retargeting/introduction.md)]

W przypadku migracji z programu .NET Framework 4.6.1 do 4.7.2, należy przejrzeć następujące tematy dla problemów ze zgodnością aplikacji, które mogą wpływać na aplikację:
