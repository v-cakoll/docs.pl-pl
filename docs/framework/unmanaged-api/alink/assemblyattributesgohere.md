...
---
# <a name="assemblyattributesgohere-class"></a>Klasa AssemblyAttributesGoHere
...
Odwołania do tego typu wskazują atrybuty niestandardowe, które nie są powiązane z zabezpieczeniami i nie są wielokrotnym użyciem.
