...
Usługa protokołu transakcyjnych WS-AT została zainicjowana.  
  
## <a name="description"></a>Opis  
 Śledzony podczas uruchamiania Menedżera transakcji, aby wskazać, który protokół został pomyślnie zainicjowany.  
