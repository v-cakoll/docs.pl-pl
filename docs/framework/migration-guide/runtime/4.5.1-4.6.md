...
---
# <a name="runtime-changes-for-migration-from-net-framework-451-to-46"></a>Zmiany środowiska uruchomieniowego do migracji z .NET Framework 4.5.1 — 4.6

[!INCLUDE[versionselector](../../../../includes/migration-guide/runtime/versionselector.md)]

[!INCLUDE[introduction](../../../../includes/migration-guide/runtime/introduction.md)]

Migracji z programu .NET Framework 4.5.1, 4.6, przejrzyj problemy ze zgodnością aplikacji, które mogą wpływać na Twoją aplikację w poniższych tematach:
