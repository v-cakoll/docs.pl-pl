...
Ten przykład kompiluje się w poprzednim przykładzie, [pobierając akapity i ich style (Visual Basic)](retrieving-the-paragraphs-and-their-styles.md). Ten nowy przykład pobiera tekst każdego akapitu w postaci ciągu.  
 ...
 Te zapytania, które są powiązane ze sobą, wykorzystują model przetwarzania, który jest szczegółowo rozpatrywany w [samouczku tematu: wykonywanie odroczone (Visual Basic)](tutorial-deferred-execution.md).  
