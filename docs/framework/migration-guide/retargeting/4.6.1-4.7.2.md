...
---
# <a name="retargeting-changes-for-migration-from-net-framework-461-to-472"></a>Przekierowywanie zmian dotyczących migracji z .NET Framework 4.6.1 do 4.7.2

[!INCLUDE[versionselector](../../../../includes/migration-guide/retargeting/versionselector.md)]

Jeśli przeprowadzasz migrację z .NET Framework 4.6.1 do 4.7.2, zapoznaj się z następującymi tematami dotyczącymi problemów ze zgodnością aplikacji, które mogą mieć wpływ na aplikację:
