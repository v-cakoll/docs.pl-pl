...
---
# <a name="plinq-data-sample"></a><span data-ttu-id="bf335-102">Próbka danych PLINQ</span><span class="sxs-lookup"><span data-stu-id="bf335-102">PLINQ Data Sample</span></span>
<span data-ttu-id="bf335-103">Ten przykład zawiera przykładowe dane w formacie CSV, wraz z metod, które przekształcenia go w kolekcji w pamięci klientów, produktów, zleceń i szczegółów zamówienia.</span><span class="sxs-lookup"><span data-stu-id="bf335-103">This sample contains example data in .csv format, together with methods that transform it into in-memory collections of Customers, Products, Orders, and Order Details.</span></span> <span data-ttu-id="bf335-104">Do dalszych eksperymentów z PLINQ, przykłady kodu z niektórych innych tematów należy wkleić kod w tym temacie i wywołać go z `Main` metody.</span><span class="sxs-lookup"><span data-stu-id="bf335-104">To further experiment with PLINQ, you can paste code examples from certain other topics into the code in this topic and invoke it from the `Main` method.</span></span> <span data-ttu-id="bf335-105">Umożliwia także te dane z zapytania PLINQ.</span><span class="sxs-lookup"><span data-stu-id="bf335-105">You can also use this data with your own PLINQ queries.</span></span>  
  
 <span data-ttu-id="bf335-106">Dane reprezentuje podzbiór danych Northwind.</span><span class="sxs-lookup"><span data-stu-id="bf335-106">The data represents a subset of the Northwind database.</span></span> <span data-ttu-id="bf335-107">Rekordy klientów pięćdziesiąt (50) są uwzględnione, ale nie wszystkie pola.</span><span class="sxs-lookup"><span data-stu-id="bf335-107">Fifty (50) customer records are included, but not all fields.</span></span> <span data-ttu-id="bf335-108">Dołączono podzbiór wierszy z zamówień i odpowiadające im dane Order_Detail dla każdego klienta.</span><span class="sxs-lookup"><span data-stu-id="bf335-108">A subset of the rows from the Orders and corresponding Order_Detail data for every Customer is included.</span></span> <span data-ttu-id="bf335-109">Uwzględniane są wszystkie produkty.</span><span class="sxs-lookup"><span data-stu-id="bf335-109">All Products are included.</span></span>  
  
> [!NOTE]
>  <span data-ttu-id="bf335-110">Zestaw danych nie jest wystarczająco duży, aby wykazać, że PLINQ jest szybciej niż LINQ do obiektów dla zapytań, które zawierają tylko podstawowe `where` i `select` klauzul.</span><span class="sxs-lookup"><span data-stu-id="bf335-110">The data set is not large enough to demonstrate that PLINQ is faster than LINQ to Objects for queries that contain just basic `where` and `select` clauses.</span></span> <span data-ttu-id="bf335-111">Aby przyjrzeć się zwiększa szybkość dla małych zestawów danych, takich jak ta, użyj zapytań, które zawierają praktyce kosztowne operacje na każdym elementem w zestawie danych.</span><span class="sxs-lookup"><span data-stu-id="bf335-111">To observe speed increases for small data sets such as this, use queries that contain computationally expensive operations on every element in the data set.</span></span>  
  
### <a name="to-set-up-this-sample"></a><span data-ttu-id="bf335-112">Aby skonfigurować ten przykład</span><span class="sxs-lookup"><span data-stu-id="bf335-112">To set up this sample</span></span>  
  
1.  <span data-ttu-id="bf335-113">Utwórz projekt aplikacji konsoli języka Visual Basic lub Visual C#.</span><span class="sxs-lookup"><span data-stu-id="bf335-113">Create a Visual Basic or Visual C# console application project.</span></span>  
  
2.  <span data-ttu-id="bf335-114">Zamień zawartość Module1.vb lub Program.cs przy użyciu kodu, który obejmuje następujące kroki.</span><span class="sxs-lookup"><span data-stu-id="bf335-114">Replace the contents of Module1.vb or Program.cs by using the code that follows these steps.</span></span>  
  
3.  <span data-ttu-id="bf335-115">Na **projektu** menu, kliknij przycisk **Dodaj nowy element**.</span><span class="sxs-lookup"><span data-stu-id="bf335-115">On the **Project** menu, click **Add New Item**.</span></span> <span data-ttu-id="bf335-116">Wybierz **pliku tekstowego** , a następnie kliknij przycisk **OK**.</span><span class="sxs-lookup"><span data-stu-id="bf335-116">Select **Text File** and then click **OK**.</span></span> <span data-ttu-id="bf335-117">Skopiuj dane w tym temacie, a następnie wklej go w nowym pliku tekstowego.</span><span class="sxs-lookup"><span data-stu-id="bf335-117">Copy the data in this topic and then paste it in the new text file.</span></span> <span data-ttu-id="bf335-118">Na **pliku** menu, kliknij przycisk **zapisać**, nazwij plik Plinqdata.csv, a następnie zapisz go w folderze, który zawiera pliki kodu źródłowego.</span><span class="sxs-lookup"><span data-stu-id="bf335-118">On the **File** menu, click **Save**, name the file Plinqdata.csv, and then save it in the folder that contains your source code files.</span></span>  
  
4.  <span data-ttu-id="bf335-119">Naciśnij klawisz F5, aby sprawdzić, czy projekt kompilacje i działa poprawnie.</span><span class="sxs-lookup"><span data-stu-id="bf335-119">Press F5 to verify that the project builds and runs correctly.</span></span> <span data-ttu-id="bf335-120">Następujące dane wyjściowe powinien być wyświetlany w oknie konsoli.</span><span class="sxs-lookup"><span data-stu-id="bf335-120">The following output should be displayed in the console window.</span></span>  
...
## <a name="data"></a><span data-ttu-id="bf335-121">Dane</span><span class="sxs-lookup"><span data-stu-id="bf335-121">Data</span></span>  
...
## <a name="see-also"></a><span data-ttu-id="bf335-122">Zobacz też</span><span class="sxs-lookup"><span data-stu-id="bf335-122">See Also</span></span>  
 [<span data-ttu-id="bf335-123">Równoległe LINQ (PLINQ)</span><span class="sxs-lookup"><span data-stu-id="bf335-123">Parallel LINQ (PLINQ)</span></span>](../../../docs/standard/parallel-programming/parallel-linq-plinq.md)
