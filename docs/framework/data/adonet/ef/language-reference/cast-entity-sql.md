...
## <a name="remarks"></a>Uwagi  
 Wyrażenie cast przypomina semantykę z wyrażeniem konwersji języka Transact-SQL. Wyrażenie cast jest używana do konwersji wartości z jednego typu na wartość z zakresu innego typu.  
