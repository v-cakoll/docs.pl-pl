...
ms.locfileid: "86443250"
---
# <a name="runtime-changes-for-migration-from-net-framework-40-to-47"></a><span data-ttu-id="53e99-103">Zmiany w czasie wykonywania migracji z .NET Framework 4,0 do 4,7</span><span class="sxs-lookup"><span data-stu-id="53e99-103">Runtime Changes for Migration from .NET Framework 4.0 to 4.7</span></span>

[!INCLUDE[versionselector](../../../../includes/migration-guide/runtime/versionselector.md)]

<span data-ttu-id="53e99-104">W przypadku migrowania z .NET Framework 4,0 do 4,7 zapoznaj się z następującymi tematami dotyczącymi problemów ze zgodnością aplikacji, które mogą mieć wpływ na aplikację:</span><span class="sxs-lookup"><span data-stu-id="53e99-104">If you are migrating from the .NET Framework 4.0 to 4.7, review the following topics for application compatibility issues that may affect your app:</span></span>

## <a name="adonet"></a><span data-ttu-id="53e99-105">ADO.NET</span><span class="sxs-lookup"><span data-stu-id="53e99-105">ADO.NET</span></span>
...
## <a name="aspnet"></a><span data-ttu-id="53e99-106">ASP.NET</span><span class="sxs-lookup"><span data-stu-id="53e99-106">ASP.NET</span></span>
...
## <a name="core"></a><span data-ttu-id="53e99-107">Core</span><span class="sxs-lookup"><span data-stu-id="53e99-107">Core</span></span>
...
## <a name="data"></a><span data-ttu-id="53e99-108">Dane</span><span class="sxs-lookup"><span data-stu-id="53e99-108">Data</span></span>
...
## <a name="entity-framework"></a><span data-ttu-id="53e99-109">Entity Framework</span><span class="sxs-lookup"><span data-stu-id="53e99-109">Entity Framework</span></span>
...
## <a name="globalization"></a><span data-ttu-id="53e99-110">Globalizacja</span><span class="sxs-lookup"><span data-stu-id="53e99-110">Globalization</span></span>
...
## <a name="jit"></a><span data-ttu-id="53e99-111">JIT</span><span class="sxs-lookup"><span data-stu-id="53e99-111">JIT</span></span>
...
## <a name="linq"></a><span data-ttu-id="53e99-112">LINQ</span><span class="sxs-lookup"><span data-stu-id="53e99-112">LINQ</span></span>
...
## <a name="managed-extensibility-framework-mef"></a><span data-ttu-id="53e99-113">Managed Extensibility Framework (MEF)</span><span class="sxs-lookup"><span data-stu-id="53e99-113">Managed Extensibility Framework (MEF)</span></span>
...
## <a name="networking"></a><span data-ttu-id="53e99-114">Sieć</span><span class="sxs-lookup"><span data-stu-id="53e99-114">Networking</span></span>
...
## <a name="printing"></a><span data-ttu-id="53e99-115">Drukowanie</span><span class="sxs-lookup"><span data-stu-id="53e99-115">Printing</span></span>
...
## <a name="security"></a><span data-ttu-id="53e99-116">Zabezpieczenia</span><span class="sxs-lookup"><span data-stu-id="53e99-116">Security</span></span>
...
## <a name="serialization"></a><span data-ttu-id="53e99-117">Serializacja</span><span class="sxs-lookup"><span data-stu-id="53e99-117">Serialization</span></span>
...
## <a name="setup-and-deployment"></a><span data-ttu-id="53e99-118">Instalacja i wdrożenie</span><span class="sxs-lookup"><span data-stu-id="53e99-118">Setup and Deployment</span></span>
...
## <a name="tools"></a><span data-ttu-id="53e99-119">Narzędzia</span><span class="sxs-lookup"><span data-stu-id="53e99-119">Tools</span></span>

[!INCLUDE[Contract.Invariant or Contract.Requires\<TException> do not consider String.IsNullOrEmpty to be pure](~/includes/migration-guide/runtime/tools/contractinvariant-contractrequirestexception-do-not-consider.md)]

## <a name="web-applications"></a><span data-ttu-id="53e99-120">Aplikacje internetowe</span><span class="sxs-lookup"><span data-stu-id="53e99-120">Web Applications</span></span>
...
## <a name="windows-communication-foundation-wcf"></a><span data-ttu-id="53e99-121">Windows Communication Foundation (WCF)</span><span class="sxs-lookup"><span data-stu-id="53e99-121">Windows Communication Foundation (WCF)</span></span>
...
## <a name="windows-forms"></a><span data-ttu-id="53e99-122">Windows Forms</span><span class="sxs-lookup"><span data-stu-id="53e99-122">Windows Forms</span></span>
...
## <a name="windows-presentation-foundation-wpf"></a><span data-ttu-id="53e99-123">Windows Presentation Foundation (WPF)</span><span class="sxs-lookup"><span data-stu-id="53e99-123">Windows Presentation Foundation (WPF)</span></span>
...
## <a name="windows-workflow-foundation-wf"></a><span data-ttu-id="53e99-124">Program Windows Workflow Foundation (WF)</span><span class="sxs-lookup"><span data-stu-id="53e99-124">Windows Workflow Foundation (WF)</span></span>
...
## <a name="xml-xslt"></a><span data-ttu-id="53e99-125">Języki XML, XSLT</span><span class="sxs-lookup"><span data-stu-id="53e99-125">XML, XSLT</span></span>
