...
Transakcja określona dla określonej operacji została wykonana z powodu `OperationBehaviorAttribute.TransactionAutoComplete` element członkowski jest ustawiany `true`.  
