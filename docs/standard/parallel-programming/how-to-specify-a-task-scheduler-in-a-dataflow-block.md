...
2.  W formularzu projektanta dla tego formularza, pliku Form1.cs (Form1.vb dla [!INCLUDE[vbprvb](../../../includes/vbprvb-md.md)]), dodaj cztery <xref:System.Windows.Forms.CheckBox> kontrolki. Ustaw <xref:System.Windows.Forms.Control.Text%2A> właściwości **1 czytnika** dla `checkBox1`, **2 czytnika** dla `checkBox2`, **3 czytnika** dla `checkBox3`, i  **Moduł zapisujący** dla `checkBox4`. Ustaw <xref:System.Windows.Forms.Control.Enabled%2A> właściwości dla każdego formantu do `False`.  
