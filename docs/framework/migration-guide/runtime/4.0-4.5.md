---
title: Zmiany w czasie wykonywania migracji z .NET Framework 4,0 do 4,5
description: Znajdź informacje o problemach ze zgodnością aplikacji w czasie wykonywania, które mogą mieć wpływ na aplikację podczas migracji z .NET Framework 4,0 do 4,5.
ms.date: 07/10/2019
...
ms.locfileid: "86443627"
---
# <a name="runtime-changes-for-migration-from-net-framework-40-to-45"></a><span data-ttu-id="42bb6-103">Zmiany w czasie wykonywania migracji z .NET Framework 4,0 do 4,5</span><span class="sxs-lookup"><span data-stu-id="42bb6-103">Runtime Changes for Migration from .NET Framework 4.0 to 4.5</span></span>

[!INCLUDE[versionselector](../../../../includes/migration-guide/runtime/versionselector.md)]

<span data-ttu-id="42bb6-104">W przypadku migrowania z .NET Framework 4,0 do 4,5 zapoznaj się z następującymi tematami dotyczącymi problemów ze zgodnością aplikacji, które mogą mieć wpływ na aplikację:</span><span class="sxs-lookup"><span data-stu-id="42bb6-104">If you are migrating from the .NET Framework 4.0 to 4.5, review the following topics for application compatibility issues that may affect your app:</span></span>

## <a name="aspnet"></a><span data-ttu-id="42bb6-105">ASP.NET</span><span class="sxs-lookup"><span data-stu-id="42bb6-105">ASP.NET</span></span>
...
## <a name="core"></a><span data-ttu-id="42bb6-106">Core</span><span class="sxs-lookup"><span data-stu-id="42bb6-106">Core</span></span>
...
## <a name="data"></a><span data-ttu-id="42bb6-107">Dane</span><span class="sxs-lookup"><span data-stu-id="42bb6-107">Data</span></span>
...
## <a name="debugger"></a><span data-ttu-id="42bb6-108">Debuger</span><span class="sxs-lookup"><span data-stu-id="42bb6-108">Debugger</span></span>
...
## <a name="entity-framework"></a><span data-ttu-id="42bb6-109">Entity Framework</span><span class="sxs-lookup"><span data-stu-id="42bb6-109">Entity Framework</span></span>
...
## <a name="linq"></a><span data-ttu-id="42bb6-110">LINQ</span><span class="sxs-lookup"><span data-stu-id="42bb6-110">LINQ</span></span>
...
## <a name="managed-extensibility-framework-mef"></a><span data-ttu-id="42bb6-111">Managed Extensibility Framework (MEF)</span><span class="sxs-lookup"><span data-stu-id="42bb6-111">Managed Extensibility Framework (MEF)</span></span>
...
## <a name="networking"></a><span data-ttu-id="42bb6-112">Sieć</span><span class="sxs-lookup"><span data-stu-id="42bb6-112">Networking</span></span>
...
## <a name="printing"></a><span data-ttu-id="42bb6-113">Drukowanie</span><span class="sxs-lookup"><span data-stu-id="42bb6-113">Printing</span></span>
...
## <a name="serialization"></a><span data-ttu-id="42bb6-114">Serializacja</span><span class="sxs-lookup"><span data-stu-id="42bb6-114">Serialization</span></span>
...
## <a name="web-applications"></a><span data-ttu-id="42bb6-115">Aplikacje internetowe</span><span class="sxs-lookup"><span data-stu-id="42bb6-115">Web Applications</span></span>
...
## <a name="windows-communication-foundation-wcf"></a><span data-ttu-id="42bb6-116">Windows Communication Foundation (WCF)</span><span class="sxs-lookup"><span data-stu-id="42bb6-116">Windows Communication Foundation (WCF)</span></span>
...
## <a name="windows-forms"></a><span data-ttu-id="42bb6-117">Windows Forms</span><span class="sxs-lookup"><span data-stu-id="42bb6-117">Windows Forms</span></span>
...
## <a name="windows-presentation-foundation-wpf"></a><span data-ttu-id="42bb6-118">Windows Presentation Foundation (WPF)</span><span class="sxs-lookup"><span data-stu-id="42bb6-118">Windows Presentation Foundation (WPF)</span></span>
...
## <a name="windows-workflow-foundation-wf"></a><span data-ttu-id="42bb6-119">Program Windows Workflow Foundation (WF)</span><span class="sxs-lookup"><span data-stu-id="42bb6-119">Windows Workflow Foundation (WF)</span></span>
...
## <a name="xml-xslt"></a><span data-ttu-id="42bb6-120">Języki XML, XSLT</span><span class="sxs-lookup"><span data-stu-id="42bb6-120">XML, XSLT</span></span>
