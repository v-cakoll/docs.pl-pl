...
-   Można przekierować aplikację do uruchamiania w [!INCLUDE[net_v40_long](../../../includes/net-v40-long-md.md)]. Trwa przekierowywanie wymaga dodania [ \<supportedRuntime >](../../../docs/framework/configure-apps/file-schema/startup/supportedruntime-element.md) elementu do pliku konfiguracji aplikacji, który umożliwia jego uruchomienie w ramach [!INCLUDE[net_v40_short](../../../includes/net-v40-short-md.md)]. Taki plik konfiguracyjny ma następującą postać:  
...
-   Można ponownie skompilować aplikację za pomocą kompilatora, który jest przeznaczony dla [!INCLUDE[net_v40_short](../../../includes/net-v40-short-md.md)]. Jeśli początkowo używano programu Visual Studio 2003 do utworzenia i skompilowania rozwiązania, możesz otworzyć rozwiązanie w [!INCLUDE[vs_dev10_long](../../../includes/vs-dev10-long-md.md)] i użyj **zgodności projektu** konwersji plików rozwiązania i projektu z formatów używanych przez okno dialogowe Program Visual Studio 2003 na format aparatu Microsoft Build Engine (MSBuild) używany przez [!INCLUDE[vs_dev10_long](../../../includes/vs-dev10-long-md.md)].  
