...
Jeśli używasz innych `dnx` jest przeznaczony dla, takie jak `dnx451` , musisz również zmienić te. `dnx451` należy je zmienić `net451`. Zapoznaj się [.NET Standard](../../standard/net-standard.md) tematu, aby uzyskać więcej informacji. 
