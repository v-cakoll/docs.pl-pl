...
- [Elementy tablicy w prostej tablicy](#array-elements-in-a-simple-array)  
  
- [Tworzenie tablicy](#creating-an-array)  
  
- [Przechowywanie wartości w tablicy](#storing-values-in-an-array)  
  
- [Wypełnianie tablicy przy użyciu literałów tablicy](#populating-an-array-with-array-literals)  
  
- [Iterowanie przez tablicę](#iterating-through-an-array)  
  
- [Rozmiar tablicy](#BKMK_ArraySize)  

- [Typ tablicy](#the-array-type)  
  
- [Tablice jako wartości zwracane i parametry](#arrays-as-return-values-and-parameters)  
...
- [Kolekcje jako alternatywa dla tablic](#collections-as-an-alternative-to-arrays)  
...
##  <a name="iterating-through-an-array"></a>Iterowanie przez tablicę  
 ...
 W poniższym przykładzie użyto [For Each... Następna instrukcja](../../../../visual-basic/language-reference/statements/for-each-next-statement.md)do iteracji przez tablicę jednowymiarową i dwuwymiarową tablicę.  
...
> Tablice nieregularne nie obejmuje tej dyskusji rozmiar tablicy. Aby uzyskać informacje na temat Tablice nieregularne i określenie rozmiaru tablicy nieregularnej, zobacz [nierówne tablic](#jagged-arrays) sekcji.
 ...
 Możesz zmienić rozmiar zmiennej tablicy, przypisując do niej nowy obiekt tablicy lub za pomocą [ `ReDim` instrukcji](../../../../visual-basic/language-reference/statements/redim-statement.md) instrukcji. W poniższym przykładzie użyto `ReDim` instrukcję, aby zmienić 100-elementowej tablicy 51-elementowej tablicy.
...
Ponadto [instrukcji ReDim](../../../../visual-basic/language-reference/statements/redim-statement.md) nie może działać na zmiennej zadeklarowanej jako typ `Array`. Z tych powodów i dla zabezpieczeń typów zaleca się deklarować każdą tablicę jako określonego typu.  
...
##  <a name="arrays-as-return-values-and-parameters"></a>Tablice jako wartości zwracane i parametry  
 Aby zwrócić tablicę z `Function` procedury, określ typ danych tablicy i liczbę wymiarów jako typ zwracany [Function — instrukcja](../../../../visual-basic/language-reference/statements/function-statement.md). Wewnątrz funkcji Zadeklaruj zmienną lokalnej tablicy przy użyciu tego samego typu danych i liczbie wymiarów. W [instrukcji Return](../../../../visual-basic/language-reference/statements/return-statement.md), obejmują zmienną lokalnej tablicy bez nawiasów.  
...
- Użyj [ `ReDim Preserve` ](../../../../visual-basic/language-reference/statements/redim-statement.md) instrukcję, aby dynamicznie rozwiń tablicy przed dodaniem nowych elementów. Jest to najprostszy technika, ale może powodować spadek wydajności i zużycia zbyt dużej ilości pamięci, kopiując duże tablice.
...
|Termin|Definicja|  
|----------|----------------|  
|[Wymiary tablic w języku Visual Basic](../../../../visual-basic/programming-guide/language-features/arrays/array-dimensions.md)|Wyjaśnia rangę i wymiary w tablicach.|  
|[Porady: inicjowanie zmiennej tablicy w języku Visual Basic](../../../../visual-basic/programming-guide/language-features/arrays/how-to-initialize-an-array-variable.md)|Zawiera opis sposobu wypełniania tablic z wartościami początkowymi.|  
|[Porady: Sortowanie tablicy w języku Visual Basic](../../../../visual-basic/programming-guide/language-features/arrays/how-to-sort-an-array.md)|Pokazuje jak alfabetycznie sortować elementy tablicy.|  
|[Instrukcje: przypisywanie tablicy do innej tablicy](../../../../visual-basic/programming-guide/language-features/arrays/how-to-assign-one-array-to-another-array.md)|W tym artykule opisano zasady i czynności podczas przypisywania tablicy do innej zmiennej tablicy.|  
