...
|[Porady: filtr w elemencie opcjonalne (Visual Basic)](../../../../visual-basic/programming-guide/concepts/linq/how-to-filter-on-an-optional-element.md)|Pokazuje, jak można znaleźć węzłów w drzewie nieregularnych uformowany.|  
|[Porady: znajdowanie wszystkich węzłów w Namespace (Visual Basic)](../../../../visual-basic/programming-guide/concepts/linq/how-to-find-all-nodes-in-a-namespace.md)|Pokazuje, jak można znaleźć wszystkie węzły, które znajdują się w określonej przestrzeni nazw.|  
...
|[Porady: sortowanie elementów na wielu kluczy (Visual Basic)](../../../../visual-basic/programming-guide/concepts/linq/how-to-sort-elements-on-multiple-keys.md)|Pokazuje, jak można sortować według wielu kluczy.|  
|[Porady: obliczanie wartości pośredniego (Visual Basic)](../../../../visual-basic/programming-guide/concepts/linq/how-to-calculate-intermediate-values.md)|Przedstawia sposób użycia `Let` klauzuli obliczania wartości pośrednich [!INCLUDE[sqltecxlinq](~/includes/sqltecxlinq-md.md)] zapytania.|  
|[Porady: Napisz zapytanie, które wyszukuje elementy na podstawie kontekstu (Visual Basic)](../../../../visual-basic/programming-guide/concepts/linq/how-to-write-a-query-that-finds-elements-based-on-context.md)|Pokazuje sposób wybierania elementów oparte na inne elementy w drzewie.|  
|[Porady: debugowanie zestawów wyników zapytania pusty (Visual Basic)](../../../../visual-basic/programming-guide/concepts/linq/how-to-debug-empty-query-results-sets.md)|Zawiera odpowiednią poprawkę podczas debugowania zapytania na języku XML, który znajduje się w domyślnej przestrzeni nazw.|  
