...
- [Instrukcje: ustawienie formatu dla kontrolki NumericUpDown formularzy systemu Windows](how-to-set-the-format-for-the-windows-forms-numericupdown-control.md)
