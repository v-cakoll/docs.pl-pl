...
---
# <a name="how-to-drag-and-drop-ink"></a>Jak przeciągnąć i opuścić atrament
## <a name="example"></a>Przykład  
 Poniższy przykład tworzy aplikację, która umożliwia użytkownikowi przeciągnij wybranych pociągnięć z jednego <xref:System.Windows.Controls.InkCanvas> do drugiego.  
