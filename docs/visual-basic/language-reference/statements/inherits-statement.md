...
|Termin|Definicja|  
|---|---|  
|`basetypenames`|Wymagana. Nazwa klasy, z której pochodzi ta klasa.<br /><br /> —lub—<br /><br /> Nazwy interfejsów, z których pochodzi ten interfejs. Użyj przecinków do oddzielenia wielu nazw.|  
