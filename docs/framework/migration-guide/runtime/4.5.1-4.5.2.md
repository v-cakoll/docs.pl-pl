...
---
# <a name="runtime-changes-for-migration-from-net-framework-451-to-452"></a>Zmiany środowiska uruchomieniowego do migracji z platformy .NET Framework 4.5.1 lub 4.5.2
