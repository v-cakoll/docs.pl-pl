...
## <a name="remarks"></a>Uwagi  
 Aby uzyskać informacje dotyczące metod i właściwości `My.Computer.Keyword` obiektu, zobacz <xref:Microsoft.VisualBasic.Devices.Keyboard>.  
