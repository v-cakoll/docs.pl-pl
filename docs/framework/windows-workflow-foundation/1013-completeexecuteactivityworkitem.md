...
## <a name="description"></a>Opis  
 Wskazuje, że Ukończono element roboczy ExecuteActivityWorkItem  
  
## <a name="message"></a>Komunikat  
 Ukończono element roboczy ExecuteActivityWorkItem dla działania %1, nazwa wyświetlana: %2, identyfikator wystąpienia: '%3'.  
