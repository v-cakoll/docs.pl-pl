...
---
# <a name="runtime-changes-for-migration-from-net-framework-451-to-471"></a>Zmiany środowiska uruchomieniowego do migracji z platformy .NET Framework 4.5.1 — 4.7.1
