...
## <a name="description"></a>Opis  
 Operacja żądania/odpowiedzi nie zawiera wiadomości odpowiedzi.  
  
 Jest to operacja dwukierunkowe; jednak nie ma odpowiedzi, aby wysłać do klienta. Ślad służy do debugowania w czasie projektowania.  
