...
W GDI + kolor, który jest wartością 32-bitowych 8 bitów dla alpha, czerwony, zielony i niebieski. Wartość alfa odpowiadającą wskazuje Przezroczystość koloru — zakres, do których kolor jest zmieszana kolorem tła. Wartości alfa z zakresu od 0 do 255, gdzie 0 reprezentuje w pełni przezroczyste kolor, a 255 reprezentuje kolor, który całkowicie nieprzezroczyste.  
