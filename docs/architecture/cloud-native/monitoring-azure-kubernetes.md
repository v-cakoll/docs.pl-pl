...
---
# <a name="monitoring-in-azure-kubernetes-services"></a>Monitorowanie w usłudze Azure Kubernetes Services
...
**rysunek 7-7**.  Zużywanie dzienników z różnych kontenerów
...
![Przykładowy pulpit nawigacyjny przedstawiający rejestrowanie i informacje o metrykach z wielu uruchomionych kontenerów. **Rysunek 7-8**. ](./media/containers-dashboard.png)
 Przykładowy pulpit nawigacyjny przedstawiający rejestrowanie i informacje o metrykach z wielu uruchomionych kontenerów.
