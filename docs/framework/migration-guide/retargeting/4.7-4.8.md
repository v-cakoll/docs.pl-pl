...
ms.locfileid: "86444121"
---
# <a name="retargeting-changes-for-migration-from-net-framework-47-to-48"></a><span data-ttu-id="12a7b-103">Przekierowywanie zmian dotyczących migracji z .NET Framework 4,7 do 4,8</span><span class="sxs-lookup"><span data-stu-id="12a7b-103">Retargeting Changes for Migration from .NET Framework 4.7 to 4.8</span></span>

[!INCLUDE[versionselector](../../../../includes/migration-guide/retargeting/versionselector.md)]

<span data-ttu-id="12a7b-104">W przypadku migrowania z .NET Framework 4,7 do 4,8 zapoznaj się z następującymi tematami dotyczącymi problemów ze zgodnością aplikacji, które mogą mieć wpływ na aplikację:</span><span class="sxs-lookup"><span data-stu-id="12a7b-104">If you are migrating from the .NET Framework 4.7 to 4.8, review the following topics for application compatibility issues that may affect your app:</span></span>

## <a name="aspnet"></a><span data-ttu-id="12a7b-105">ASP.NET</span><span class="sxs-lookup"><span data-stu-id="12a7b-105">ASP.NET</span></span>
...
## <a name="core"></a><span data-ttu-id="12a7b-106">Core</span><span class="sxs-lookup"><span data-stu-id="12a7b-106">Core</span></span>
...
## <a name="security"></a><span data-ttu-id="12a7b-107">Zabezpieczenia</span><span class="sxs-lookup"><span data-stu-id="12a7b-107">Security</span></span>
...
## <a name="windows-communication-foundation-wcf"></a><span data-ttu-id="12a7b-108">Windows Communication Foundation (WCF)</span><span class="sxs-lookup"><span data-stu-id="12a7b-108">Windows Communication Foundation (WCF)</span></span>
...
## <a name="windows-forms"></a><span data-ttu-id="12a7b-109">Windows Forms</span><span class="sxs-lookup"><span data-stu-id="12a7b-109">Windows Forms</span></span>
...
## <a name="windows-presentation-foundation-wpf"></a><span data-ttu-id="12a7b-110">Windows Presentation Foundation (WPF)</span><span class="sxs-lookup"><span data-stu-id="12a7b-110">Windows Presentation Foundation (WPF)</span></span>
...
## <a name="windows-workflow-foundation-wf"></a><span data-ttu-id="12a7b-111">Program Windows Workflow Foundation (WF)</span><span class="sxs-lookup"><span data-stu-id="12a7b-111">Windows Workflow Foundation (WF)</span></span>
