...
Niejednoznaczność między metodą "metoda" a metodą nieprzyokiego "metodą". Korzystanie z grupy metod.  
  
 Odziedziczone elementy członkowskie z różnych interfejsów, które mają ten sam podpis spowodować błąd niejednoznaczności.  
