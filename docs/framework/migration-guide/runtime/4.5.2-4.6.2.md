...
---
# <a name="runtime-changes-for-migration-from-net-framework-452-to-462"></a>Zmiany w środowisku uruchomieniowym dotyczące migracji z .NET Framework 4.5.2 do 4.6.2

[!INCLUDE[versionselector](../../../../includes/migration-guide/runtime/versionselector.md)]

W przypadku migrowania z .NET Framework 4.5.2 do 4.6.2 zapoznaj się z następującymi tematami dotyczącymi problemów ze zgodnością aplikacji, które mogą mieć wpływ na aplikację:
