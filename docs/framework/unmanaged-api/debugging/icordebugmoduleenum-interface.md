...
|Metoda|Opis|  
|------------|-----------------|  
|[Next, metoda](../../../../docs/framework/unmanaged-api/debugging/icordebugmoduleenum-next-method.md)|Pobiera określoną liczbę `ICorDebugModule` wystąpień z wyliczenia, zaczynając od bieżącej pozycji.|  
