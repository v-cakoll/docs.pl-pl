...
[Metoda osi](linq-to-xml-axes-overview.md) XML pobiera kolekcję elementów XML z dokumentu XML lub elementu nadrzędnego. Można napisać własne metody osi, aby pobierać kolekcje z drzewa XML. Najlepszym sposobem, aby to zrobić, jest zapisanie metody rozszerzającej zwracającej kolekcję elementów lub atrybutów. Można napisać metodę rozszerzenia w celu zwrócenia określonych podzbiorów elementów lub atrybutów na podstawie wymagań aplikacji.  
