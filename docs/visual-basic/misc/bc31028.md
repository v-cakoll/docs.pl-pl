...
- [SignTool.exe (Narzędzie podpisu)](../../framework/tools/signtool-exe.md)
- [Instrukcje: Podpisywanie manifestów wdrożenia i aplikacji](/visualstudio/ide/how-to-sign-application-and-deployment-manifests)
