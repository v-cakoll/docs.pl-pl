...
---
# <a name="runtime-changes-for-migration-from-net-framework-451-to-471"></a>Zmiany środowiska uruchomieniowego do migracji z systemu .NET Framework 4.5.1 lub 4.7.1
