...
## <a name="methods"></a>Metody  
 Klasa NamedPipeTransportBindingElement nie definiuje żadnych metod.  
  
## <a name="properties"></a>Właściwości  
 Klasa NamedPipeTransportBindingElement ma następującą właściwość:  
  
### <a name="connectionpoolsettings"></a>ConnectionPoolSettings  
 Typ danych: NamedPipeConnectionPoolSettings  
