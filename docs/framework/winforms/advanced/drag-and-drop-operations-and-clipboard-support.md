...
## <a name="related-sections"></a>Sekcje pokrewne  
 ...
 W tym artykule opisano metody, zdarzenia i klas używany do implementowania zachowanie przeciągnij i upuść.  
  
 <xref:System.Windows.Forms.Control.QueryContinueDrag>  
 W tym artykule opisano niewymagającego zdarzenia, które prosi zgody na kontynuowanie działania operacji przeciągania.  
