---
title: Przekierowywanie zmian dotyczących migracji z .NET Framework 4,0 do 4,5
description: Znajdź informacje o problemach ze zgodnością aplikacji, które mogą mieć wpływ na aplikację podczas migracji z .NET Framework 4,0 do 4,5.
ms.date: 07/10/2019
...
ms.locfileid: "86444446"
---
# <a name="retargeting-changes-for-migration-from-net-framework-40-to-45"></a><span data-ttu-id="df548-103">Przekierowywanie zmian dotyczących migracji z .NET Framework 4,0 do 4,5</span><span class="sxs-lookup"><span data-stu-id="df548-103">Retargeting Changes for Migration from .NET Framework 4.0 to 4.5</span></span>

[!INCLUDE[versionselector](../../../../includes/migration-guide/retargeting/versionselector.md)]

<span data-ttu-id="df548-104">W przypadku migrowania z .NET Framework 4,0 do 4,5 zapoznaj się z następującymi tematami dotyczącymi problemów ze zgodnością aplikacji, które mogą mieć wpływ na aplikację:</span><span class="sxs-lookup"><span data-stu-id="df548-104">If you are migrating from the .NET Framework 4.0 to 4.5, review the following topics for application compatibility issues that may affect your app:</span></span>

## <a name="aspnet"></a><span data-ttu-id="df548-105">ASP.NET</span><span class="sxs-lookup"><span data-stu-id="df548-105">ASP.NET</span></span>
...
## <a name="clickonce"></a><span data-ttu-id="df548-106">ClickOnce</span><span class="sxs-lookup"><span data-stu-id="df548-106">ClickOnce</span></span>
...
## <a name="core"></a><span data-ttu-id="df548-107">Core</span><span class="sxs-lookup"><span data-stu-id="df548-107">Core</span></span>
...
## <a name="entity-framework"></a><span data-ttu-id="df548-108">Entity Framework</span><span class="sxs-lookup"><span data-stu-id="df548-108">Entity Framework</span></span>
...
## <a name="windows-forms"></a><span data-ttu-id="df548-109">Windows Forms</span><span class="sxs-lookup"><span data-stu-id="df548-109">Windows Forms</span></span>
...
## <a name="windows-presentation-foundation-wpf"></a><span data-ttu-id="df548-110">Windows Presentation Foundation (WPF)</span><span class="sxs-lookup"><span data-stu-id="df548-110">Windows Presentation Foundation (WPF)</span></span>
...
## <a name="windows-workflow-foundation-wf"></a><span data-ttu-id="df548-111">Program Windows Workflow Foundation (WF)</span><span class="sxs-lookup"><span data-stu-id="df548-111">Windows Workflow Foundation (WF)</span></span>
...
## <a name="xml-xslt"></a><span data-ttu-id="df548-112">Języki XML, XSLT</span><span class="sxs-lookup"><span data-stu-id="df548-112">XML, XSLT</span></span>
