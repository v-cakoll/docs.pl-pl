...
|`Reference Paths`|[Zarządzanie odwołaniami w projekcie](https://msdn.microsoft.com/library/ez524kew.aspx)|Pozwala określić, gdzie do wyszukiwania zestawów, która zależy od kodu.|
