...
---
# <a name="how-to-rotate-an-image"></a>Instrukcje: Obracanie obrazu
W tym przykładzie pokazano, jak obrócić obraz o 90 stopni przy użyciu <xref:System.Windows.Media.Imaging.BitmapImage.Rotation%2A> właściwość <xref:System.Windows.Media.Imaging.BitmapImage>.  
