...
## <a name="description"></a>Opis  
 Na elementu ServiceHost wystąpiły błędy podczas wywoływania metody ReleasePerformanceCounters. Ślad może służyć do określenia błędów podczas zwalniania liczników wydajności.  
