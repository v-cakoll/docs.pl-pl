---
title: 'Instrukcje: Kopiowanie formantów pomiędzy formularzami Windows'
ms.date: 03/30/2017
helpviewer_keywords:
...
ms.locfileid: "54722064"
---
# <a name="how-to-copy-controls-between-windows-forms"></a>Instrukcje: Kopiowanie formantów pomiędzy formularzami Windows
Kontrolki mogą być kopiowane na tym samym formularzu, na innej formy w projekcie lub do Schowka do użycia w innych rozwiązaniach.  
  
### <a name="to-copy-a-control"></a>Aby skopiować kontrolki  
  
1.  Wybierz kontrolkę i z **Edytuj** menu wybierz opcję **kopiowania**.  
  
 Teraz można wkleić ten formant do dowolnej formie, który akceptuje tego typu kontrolki. Ponadto formant został dodany do Schowka.  
...
- [Instrukcje: Dodawanie formantów bez interfejsu użytkownika do formularzy Windows Forms](../../../../docs/framework/winforms/controls/how-to-add-controls-without-a-user-interface-to-windows-forms.md)
