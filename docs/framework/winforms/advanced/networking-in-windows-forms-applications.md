...
## <a name="reference"></a>Tematy pomocy  
 <xref:System.Net>  
 Przestrzeń nazw korzenia dla klas w programie .NET Framework tego dojścia łączność sieciową.  
  
 <xref:System.Net.WebClient>  
 Klasa wygodny programowo pobierania sieci Web lub zawartości oparte na protokole HTTP.  
  
 <xref:System.Net.FtpWebRequest>  
 Klasa do pobierania i wysyłanie plików przy użyciu FTP.  
  
 <xref:System.Windows.Forms.WebBrowser>  
 Zarządzany otok klasę `WebBrowser` formant, który jest dołączony do systemu Windows.  
