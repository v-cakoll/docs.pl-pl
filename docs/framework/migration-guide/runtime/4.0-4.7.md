...
ms.locfileid: "58465662"
---
# <a name="runtime-changes-for-migration-from-net-framework-40-to-47"></a><span data-ttu-id="a4538-102">Zmiany środowiska uruchomieniowego do migracji z .NET Framework 4.0 do 4.7</span><span class="sxs-lookup"><span data-stu-id="a4538-102">Runtime Changes for Migration from .NET Framework 4.0 to 4.7</span></span>

[!INCLUDE[versionselector](../../../../includes/migration-guide/runtime/versionselector.md)]

[!INCLUDE[introduction](../../../../includes/migration-guide/runtime/introduction.md)]

<span data-ttu-id="a4538-103">Migracji z programu .NET Framework 4.0 do 4.7, przejrzyj problemy ze zgodnością aplikacji, które mogą wpływać na Twoją aplikację w poniższych tematach:</span><span class="sxs-lookup"><span data-stu-id="a4538-103">If you are migrating from the .NET Framework 4.0 to 4.7, review the following topics for application compatibility issues that may affect your app:</span></span>

## <a name="adonet"></a><span data-ttu-id="a4538-104">ADO.NET</span><span class="sxs-lookup"><span data-stu-id="a4538-104">ADO.NET</span></span>
...
## <a name="aspnet"></a><span data-ttu-id="a4538-105">ASP.NET</span><span class="sxs-lookup"><span data-stu-id="a4538-105">ASP.NET</span></span>
...
## <a name="core"></a><span data-ttu-id="a4538-106">Core</span><span class="sxs-lookup"><span data-stu-id="a4538-106">Core</span></span>
...
## <a name="data"></a><span data-ttu-id="a4538-107">Dane</span><span class="sxs-lookup"><span data-stu-id="a4538-107">Data</span></span>
...
## <a name="entity-framework"></a><span data-ttu-id="a4538-108">Entity Framework</span><span class="sxs-lookup"><span data-stu-id="a4538-108">Entity Framework</span></span>
...
## <a name="globalization"></a><span data-ttu-id="a4538-109">Globalizacja</span><span class="sxs-lookup"><span data-stu-id="a4538-109">Globalization</span></span>
...
## <a name="jit"></a><span data-ttu-id="a4538-110">JIT</span><span class="sxs-lookup"><span data-stu-id="a4538-110">JIT</span></span>
...
## <a name="linq"></a><span data-ttu-id="a4538-111">LINQ</span><span class="sxs-lookup"><span data-stu-id="a4538-111">LINQ</span></span>
...
## <a name="managed-extensibility-framework-mef"></a><span data-ttu-id="a4538-112">Managed Extensibility Framework (MEF)</span><span class="sxs-lookup"><span data-stu-id="a4538-112">Managed Extensibility Framework (MEF)</span></span>
...
## <a name="networking"></a><span data-ttu-id="a4538-113">Obsługa sieci</span><span class="sxs-lookup"><span data-stu-id="a4538-113">Networking</span></span>
...
## <a name="printing"></a><span data-ttu-id="a4538-114">Drukowanie</span><span class="sxs-lookup"><span data-stu-id="a4538-114">Printing</span></span>
...
## <a name="security"></a><span data-ttu-id="a4538-115">Zabezpieczenia</span><span class="sxs-lookup"><span data-stu-id="a4538-115">Security</span></span>
...
## <a name="serialization"></a><span data-ttu-id="a4538-116">Serializacja</span><span class="sxs-lookup"><span data-stu-id="a4538-116">Serialization</span></span>
...
## <a name="setup-and-deployment"></a><span data-ttu-id="a4538-117">Instalacja i wdrożenie</span><span class="sxs-lookup"><span data-stu-id="a4538-117">Setup and Deployment</span></span>
...
## <a name="tools"></a><span data-ttu-id="a4538-118">Narzędzia</span><span class="sxs-lookup"><span data-stu-id="a4538-118">Tools</span></span>

[!INCLUDE[Contract.Invariant or Contract.Requires\<TException> do not consider String.IsNullOrEmpty to be pure](~/includes/migration-guide/runtime/tools/contractinvariant-contractrequirestexception-do-not-consider.md)]

## <a name="web-applications"></a><span data-ttu-id="a4538-119">Aplikacje internetowe</span><span class="sxs-lookup"><span data-stu-id="a4538-119">Web Applications</span></span>
...
## <a name="windows-communication-foundation-wcf"></a><span data-ttu-id="a4538-120">Windows Communication Foundation (WCF)</span><span class="sxs-lookup"><span data-stu-id="a4538-120">Windows Communication Foundation (WCF)</span></span>
...
## <a name="windows-forms"></a><span data-ttu-id="a4538-121">Windows Forms</span><span class="sxs-lookup"><span data-stu-id="a4538-121">Windows Forms</span></span>
...
## <a name="windows-presentation-foundation-wpf"></a><span data-ttu-id="a4538-122">Windows Presentation Foundation (WPF)</span><span class="sxs-lookup"><span data-stu-id="a4538-122">Windows Presentation Foundation (WPF)</span></span>
...
## <a name="windows-workflow-foundation-wf"></a><span data-ttu-id="a4538-123">Program Windows Workflow Foundation (WF)</span><span class="sxs-lookup"><span data-stu-id="a4538-123">Windows Workflow Foundation (WF)</span></span>
...
## <a name="xml-xslt"></a><span data-ttu-id="a4538-124">Języki XML, XSLT</span><span class="sxs-lookup"><span data-stu-id="a4538-124">XML, XSLT</span></span>
