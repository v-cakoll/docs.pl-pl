...
-   `MyPerson`zawiera tylko elementy członkowskie ciągu. [CharSet](../../../docs/framework/interop/specifying-a-character-set.md) pola ustawia ciągi do formatu ANSI przekazany do funkcji niezarządzanej.  
