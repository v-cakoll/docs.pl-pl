---
title: SetFakeActiveWindow, funkcja (niezarządzany wykaz interfejsów API WPF.)
ms.date: 03/30/2017
dev_langs:
- cpp
api_name:
...
ms.locfileid: "59168405"
---
# <a name="setfakeactivewindow-function-wpf-unmanaged-api-reference"></a>SetFakeActiveWindow, funkcja (niezarządzany wykaz interfejsów API WPF.)
 ...
 **Wersja programu .NET framework:** [!INCLUDE[net_current_v40plus](../../../../includes/net-current-v40plus-md.md)]  
