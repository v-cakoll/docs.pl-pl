...
---
# <a name="picturebox-control-windows-forms"></a>PictureBox — Formant (Formularze systemu Windows)
Formularze systemu Windows `PictureBox` formant jest używany do wyświetlania grafiki w formacie mapy bitowej, GIF, JPEG, metaplik lub ikonę.  
...
## <a name="in-this-section"></a>W tej sekcji  
 ...
 Informacje o <xref:System.Windows.Forms.PictureBox.SizeMode%2A> właściwość czy i jak ustawić go.  
 ...
 Opisuje sposób wyświetlania i usuń zaznaczenie obrazu w czasie wykonywania.  
 ...
 Opisuje sposób załadować i wyświetlić obraz w formularzu w czasie projektowania.  
