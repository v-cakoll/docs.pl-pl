...
## <a name="in-this-section"></a>W tej sekcji  
 ...
 Pokazuje, jak wykonać transakcyjnych w kolejce komunikacji przy użyciu usługi kolejkowania komunikatów (MSMQ).  
 ...
 Pokazuje, jak wykonać Trująca wiadomość została obsługa w usłudze przy użyciu usługi MSMQ 4.0.  
  
 [Sesje i kolejki](../../../../docs/framework/wcf/samples/sessions-and-queues.md)  
 Pokazuje, jak wysyłać i odbierać zestaw powiązane komunikaty w kolejce komunikacji za pomocą transportu usługi kolejkowania komunikatów (MSMQ).  
 ...
 Pokazuje przydatność <xref:System.ServiceModel.Channels.ReceiveContext>— włączone kanały programu WCF.
