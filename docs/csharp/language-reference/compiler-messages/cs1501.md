...
Żadna metoda przeciążenia metody „metoda” nie pobiera takiej liczby argumentów: liczba  
  
 Wykonano wywołanie do metody klasy, dla żadna definicja metody nie pobiera określonej liczby argumentów.   
  
## <a name="example"></a>Przykład  
 Poniższy przykład spowoduje wygenerowanie CS1501.  
