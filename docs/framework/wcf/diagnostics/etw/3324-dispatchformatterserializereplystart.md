...
## <a name="description"></a>Opis  
 To zdarzenie jest emitowane, podczas uruchamiania dyspozytora serializacji komunikatu odpowiedzi.  
  
## <a name="message"></a>Komunikat  
 Dyspozytor pracę serializacji komunikatu odpowiedzi.  
