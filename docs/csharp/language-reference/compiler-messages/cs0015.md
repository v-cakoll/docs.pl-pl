...
---
# <a name="compiler-error-cs0015"></a><span data-ttu-id="5cb79-102">Błąd kompilatora CS0015</span><span class="sxs-lookup"><span data-stu-id="5cb79-102">Compiler Error CS0015</span></span>

<span data-ttu-id="5cb79-103">Nazwa typu "typ" jest za długa</span><span class="sxs-lookup"><span data-stu-id="5cb79-103">The name of type 'type' is too long</span></span>

 <span data-ttu-id="5cb79-104">W pełni kwalifikowana nazwa typu zdefiniowanego przez użytkownika musi mieć mniej niż 1024 znaki, łącznie z kropkami.</span><span class="sxs-lookup"><span data-stu-id="5cb79-104">The fully qualified name of a user-defined type must have fewer than 1024 characters, including the periods.</span></span>

 <span data-ttu-id="5cb79-105">Poniższy przykład generuje CS0015:</span><span class="sxs-lookup"><span data-stu-id="5cb79-105">The following sample generates CS0015:</span></span>
