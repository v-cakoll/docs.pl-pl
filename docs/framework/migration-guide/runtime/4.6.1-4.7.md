...
---
# <a name="runtime-changes-for-migration-from-net-framework-461-to-47"></a><span data-ttu-id="f191c-102">Zmiany w czasie wykonywania migracji z .NET Framework 4.6.1 do 4,7</span><span class="sxs-lookup"><span data-stu-id="f191c-102">Runtime Changes for Migration from .NET Framework 4.6.1 to 4.7</span></span>

[!INCLUDE[versionselector](../../../../includes/migration-guide/runtime/versionselector.md)]

<span data-ttu-id="f191c-103">W przypadku migrowania z .NET Framework 4.6.1 do 4,7 zapoznaj się z następującymi tematami dotyczącymi problemów ze zgodnością aplikacji, które mogą mieć wpływ na aplikację:</span><span class="sxs-lookup"><span data-stu-id="f191c-103">If you are migrating from the .NET Framework 4.6.1 to 4.7, review the following topics for application compatibility issues that may affect your app:</span></span>

## <a name="data"></a><span data-ttu-id="f191c-104">Dane</span><span class="sxs-lookup"><span data-stu-id="f191c-104">Data</span></span>
...
## <a name="globalization"></a><span data-ttu-id="f191c-105">Globalizacja</span><span class="sxs-lookup"><span data-stu-id="f191c-105">Globalization</span></span>
...
## <a name="jit"></a><span data-ttu-id="f191c-106">JIT</span><span class="sxs-lookup"><span data-stu-id="f191c-106">JIT</span></span>
...
## <a name="security"></a><span data-ttu-id="f191c-107">Zabezpieczenia</span><span class="sxs-lookup"><span data-stu-id="f191c-107">Security</span></span>
...
## <a name="windows-communication-foundation-wcf"></a><span data-ttu-id="f191c-108">Windows Communication Foundation (WCF)</span><span class="sxs-lookup"><span data-stu-id="f191c-108">Windows Communication Foundation (WCF)</span></span>
...
## <a name="windows-presentation-foundation-wpf"></a><span data-ttu-id="f191c-109">Windows Presentation Foundation (WPF)</span><span class="sxs-lookup"><span data-stu-id="f191c-109">Windows Presentation Foundation (WPF)</span></span>
...
## <a name="windows-workflow-foundation-wf"></a><span data-ttu-id="f191c-110">Program Windows Workflow Foundation (WF)</span><span class="sxs-lookup"><span data-stu-id="f191c-110">Windows Workflow Foundation (WF)</span></span>
