...
|Zadanie|Zobacz|  
|--------|---------|  
|Zaktualizuj wartość ustawienia użytkownika|[Porady: zmiana ustawień użytkownika w języku Visual Basic](../../../../visual-basic/developing-apps/programming/app-settings/how-to-change-user-settings.md)|  
...
|Zapisz zaktualizowane ustawienia wartości|[Porady: utrwalanie ustawień użytkownika w języku Visual Basic](../../../../visual-basic/developing-apps/programming/app-settings/how-to-persist-user-settings.md)|  
