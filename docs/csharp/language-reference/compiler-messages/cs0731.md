...
Typ forwarder dla typu "typ" w złożeniu złożenia powoduje cykl  
  
 Ten błąd może wystąpić tylko w przypadku nieprawidłowo utworzonych metadanych importowanych. Nie może wystąpić tylko ze źródłem Języka C#.  
...
## <a name="example"></a>Przykład  
 ...
 Najpierw skompiluj . IL plików jako biblioteki, a następnie skompilować kod .cs odwołujący się do dwóch plików.  
