...
ms.locfileid: "85621850"
---
# <a name="runtime-changes-for-migration-from-net-framework-40-to-471"></a><span data-ttu-id="0ed5a-102">Zmiany w środowisku uruchomieniowym dotyczące migracji z .NET Framework 4,0 do 4.7.1</span><span class="sxs-lookup"><span data-stu-id="0ed5a-102">Runtime Changes for Migration from .NET Framework 4.0 to 4.7.1</span></span>

[!INCLUDE[versionselector](../../../../includes/migration-guide/runtime/versionselector.md)]

<span data-ttu-id="0ed5a-103">W przypadku migrowania z .NET Framework 4,0 do usługi 4.7.1 zapoznaj się z następującymi tematami dotyczącymi problemów ze zgodnością aplikacji, które mogą mieć wpływ na aplikację:</span><span class="sxs-lookup"><span data-stu-id="0ed5a-103">If you are migrating from the .NET Framework 4.0 to 4.7.1, review the following topics for application compatibility issues that may affect your app:</span></span>

## <a name="adonet"></a><span data-ttu-id="0ed5a-104">ADO.NET</span><span class="sxs-lookup"><span data-stu-id="0ed5a-104">ADO.NET</span></span>
...
## <a name="aspnet"></a><span data-ttu-id="0ed5a-105">ASP.NET</span><span class="sxs-lookup"><span data-stu-id="0ed5a-105">ASP.NET</span></span>
...
## <a name="core"></a><span data-ttu-id="0ed5a-106">Core</span><span class="sxs-lookup"><span data-stu-id="0ed5a-106">Core</span></span>
...
## <a name="data"></a><span data-ttu-id="0ed5a-107">Dane</span><span class="sxs-lookup"><span data-stu-id="0ed5a-107">Data</span></span>
...
## <a name="entity-framework"></a><span data-ttu-id="0ed5a-108">Entity Framework</span><span class="sxs-lookup"><span data-stu-id="0ed5a-108">Entity Framework</span></span>
...
## <a name="globalization"></a><span data-ttu-id="0ed5a-109">Globalizacja</span><span class="sxs-lookup"><span data-stu-id="0ed5a-109">Globalization</span></span>
...
## <a name="linq"></a><span data-ttu-id="0ed5a-110">LINQ</span><span class="sxs-lookup"><span data-stu-id="0ed5a-110">LINQ</span></span>
...
## <a name="managed-extensibility-framework-mef"></a><span data-ttu-id="0ed5a-111">Managed Extensibility Framework (MEF)</span><span class="sxs-lookup"><span data-stu-id="0ed5a-111">Managed Extensibility Framework (MEF)</span></span>
...
## <a name="networking"></a><span data-ttu-id="0ed5a-112">Networking</span><span class="sxs-lookup"><span data-stu-id="0ed5a-112">Networking</span></span>
...
## <a name="printing"></a><span data-ttu-id="0ed5a-113">Drukowanie</span><span class="sxs-lookup"><span data-stu-id="0ed5a-113">Printing</span></span>
...
## <a name="security"></a><span data-ttu-id="0ed5a-114">Zabezpieczenia</span><span class="sxs-lookup"><span data-stu-id="0ed5a-114">Security</span></span>
...
## <a name="serialization"></a><span data-ttu-id="0ed5a-115">Serializacja</span><span class="sxs-lookup"><span data-stu-id="0ed5a-115">Serialization</span></span>
...
## <a name="setup-and-deployment"></a><span data-ttu-id="0ed5a-116">Instalacja i wdrożenie</span><span class="sxs-lookup"><span data-stu-id="0ed5a-116">Setup and Deployment</span></span>
...
## <a name="tools"></a><span data-ttu-id="0ed5a-117">narzędzia</span><span class="sxs-lookup"><span data-stu-id="0ed5a-117">Tools</span></span>

[!INCLUDE[Contract.Invariant or Contract.Requires\<TException> do not consider String.IsNullOrEmpty to be pure](~/includes/migration-guide/runtime/tools/contractinvariant-contractrequirestexception-do-not-consider.md)]

## <a name="web-applications"></a><span data-ttu-id="0ed5a-118">Aplikacje internetowe</span><span class="sxs-lookup"><span data-stu-id="0ed5a-118">Web Applications</span></span>
...
## <a name="windows-communication-foundation-wcf"></a><span data-ttu-id="0ed5a-119">Windows Communication Foundation (WCF)</span><span class="sxs-lookup"><span data-stu-id="0ed5a-119">Windows Communication Foundation (WCF)</span></span>
...
## <a name="windows-forms"></a><span data-ttu-id="0ed5a-120">Windows Forms</span><span class="sxs-lookup"><span data-stu-id="0ed5a-120">Windows Forms</span></span>
...
## <a name="windows-presentation-foundation-wpf"></a><span data-ttu-id="0ed5a-121">Windows Presentation Foundation (WPF)</span><span class="sxs-lookup"><span data-stu-id="0ed5a-121">Windows Presentation Foundation (WPF)</span></span>
...
## <a name="windows-workflow-foundation-wf"></a><span data-ttu-id="0ed5a-122">Program Windows Workflow Foundation (WF)</span><span class="sxs-lookup"><span data-stu-id="0ed5a-122">Windows Workflow Foundation (WF)</span></span>
...
## <a name="xml-xslt"></a><span data-ttu-id="0ed5a-123">Języki XML, XSLT</span><span class="sxs-lookup"><span data-stu-id="0ed5a-123">XML, XSLT</span></span>
