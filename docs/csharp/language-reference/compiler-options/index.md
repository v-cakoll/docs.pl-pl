...
## <a name="related-sections"></a>Sekcje pokrewne  
 [Tworzenie strony, Projektant projektu](/visualstudio/ide/reference/build-page-project-designer-csharp)  
 Ustawienie właściwości, które kontrolują sposób kompilowania projektu wbudowanych i debugowania. Zawiera informacje na temat niestandardowe kroki procesu kompilacji w projektach Visual C#.  
  
 [Domyślnej i niestandardowej kompilacji](/visualstudio/ide/compiling-and-building-in-visual-studio)  
 Informacje o typach kompilacji i konfiguracji.  
  
 [Przygotowywanie i Zarządzanie kompilacjami](/visualstudio/ide/building-and-cleaning-projects-and-solutions-in-visual-studio)  
 Procedury tworzenia w środowisku programowania Visual Studio.
