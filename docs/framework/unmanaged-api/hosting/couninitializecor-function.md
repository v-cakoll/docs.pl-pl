...
`CoUninitializeCor`jest przestarzała.  
...
## <a name="remarks"></a>Uwagi  
 Środowisko uruchomieniowe języka wspólnego nie może być zwolniony z procesem. Aby całkowicie usunąć środowiska uruchomieniowego z uruchomionego procesu, należy zamknąć ten proces.  
