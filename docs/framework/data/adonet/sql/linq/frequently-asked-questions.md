...
3.  Przejrzyj domyślne <xref:System.Data.Linq.Mapping.UpdateCheck> wartość (<xref:System.Data.Linq.Mapping.UpdateCheck.Never>), aby ustalić, czy jest poprawny dla aplikacji.  
    ...
    > [!CAUTION]
    >  Jeśli używasz [!INCLUDE[vs_ordesigner_long](../../../../../../includes/vs-ordesigner-long-md.md)] w [!INCLUDE[vs_current_short](../../../../../../includes/vs-current-short-md.md)], zmiany mogą zostać zastąpione.  
