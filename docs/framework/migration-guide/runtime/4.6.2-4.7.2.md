...
---
# <a name="runtime-changes-for-migration-from-net-framework-462-to-472"></a>Zmiany środowiska uruchomieniowego dla migracji z programu .NET Framework 4.6.2 do 4.7.2

[!INCLUDE[versionselector](../../../../includes/migration-guide/runtime/versionselector.md)]

W przypadku migracji z programu .NET Framework 4.6.2 do 4.7.2 zapoznaj się z następującymi tematami dotyczącymi problemów ze zgodnością aplikacji, które mogą mieć wpływ na aplikację:
