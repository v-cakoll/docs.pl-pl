...
Śledzenie zdarzeń systemu Windows (ETW) to system wysokiej wydajności, narzut na małej, skalowalna śledzenia podany przez systemy operacyjne Windows. Uzupełnia profilowania i debugowania wsparcie w programie .NET Framework, a może służyć do rozwiązywania z szerokiej gamy scenariuszy.  
 ...
 W programie .NET Framework jest dostępna dla środowisko uruchomieniowe języka wspólnego (CLR), śledzenie zdarzeń ETW [Biblioteka zadań równoległych](../../../docs/standard/parallel-programming/task-parallel-library-tpl.md), i [równoległe LINQ (PLINQ)](../../../docs/standard/parallel-programming/parallel-linq-plinq.md).  
