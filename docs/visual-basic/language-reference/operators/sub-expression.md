...
|Termin|Definicja|  
|---|---|  
|`parameterlist`|Opcjonalny. Lista nazwy zmiennych lokalnych, które reprezentują parametry procedury. Nawiasy musi być obecny, nawet wtedy, gdy lista jest pusta. Aby uzyskać więcej informacji, zobacz [listy parametrów](../../../visual-basic/language-reference/statements/parameter-list.md).|  
|`statement`|Wymagany. Jednej instrukcji.|  
