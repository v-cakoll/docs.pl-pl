...
---
# <a name="full-code-listings"></a>Listy pełnego kodu
Ten temat zawiera całego kodu dla aplikacji, która używa [manipulacji i bezwładności](../../../docs/framework/common-client-technologies/manipulations-and-inertia.md) procesorów.  
  
## <a name="gamepiece-class"></a>Klasy GamePiece  
 Poniższy kod przedstawia całą **GamePiece** klasy.  
...
## <a name="gamepiececollection-class"></a>Klasy GamePieceCollection  
 Poniższy kod przedstawia całą **GamePieceCollection** klasy.  
...
## <a name="game1-class"></a>Klasy Game1  
 Poniższy kod przedstawia całą **Game1** klasy.  
