...
## <a name="in-this-section"></a>W tej sekcji  
 [Działanie](../../../../../docs/framework/wcf/diagnostics/tracing/activity.md): opisuje działania śledzenia w modelu śledzenia usług Windows Communication Foundation (WCF).  
  
 [Transfer](../../../../../docs/framework/wcf/diagnostics/tracing/transfer.md): opisano transfer w modelu śledzenia usług Windows Communication Foundation (WCF) oraz przy użyciu transferu do skorelowania działań w ramach punktów końcowych.  
  
 [Propagacja](../../../../../docs/framework/wcf/diagnostics/tracing/propagation.md): opisuje działania propagacji w systemie Windows Communication Foundation (WCF) śledzenie modelu i przy użyciu propagacji służące do skorelowania działań w obrębie punktów końcowych.  
