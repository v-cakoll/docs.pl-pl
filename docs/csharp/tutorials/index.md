...
ms.openlocfilehash: a201a9be79072870e2f75d74fa7f649621478cb3
...
* [Aplikacja konsolowa](console-teleprompter.md): Pokazuje konsoli operacji We/Wy, struktury aplikacji konsoli i podstawy zadań na podstawie modelu programowania asynchronicznego.
* [Klient REST](console-webapiclient.md): przedstawia komunikacji w sieci web, serializacji JSON i obiektowo funkcje w języku C#.
...
* [Ciąg interpolacji](string-interpolation.md): pokazano wiele zastosowania `$` ciągu interpolacji w języku C#.

* [Przy użyciu atrybutów](attributes.md): tworzenie i używać atrybutów w języku C#.
