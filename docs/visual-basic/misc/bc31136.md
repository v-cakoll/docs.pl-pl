...
Deklaracja musi zawierać `AddHandler` `As` lub `RemoveHandler` deklaracje, z których każdy przyjmuje jeden parametr typu delegata określonego przez klauzulę zdarzenia niestandardowego. `Custom Event`  
