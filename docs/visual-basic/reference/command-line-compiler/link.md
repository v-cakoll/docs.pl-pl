...
[!code-vb[VbLinkCompiler#4](~/samples/snippets/visualbasic/VS_Snippets_VBCSharp/vblinkcompiler/vb/utility.vb#4)]  
 ...
 W poniższym przykładzie kod klienta może wywołać metodę, która zwraca interfejs <xref:System.Collections.IList> generyczny bez błędu.  
  
 [!code-vb[VbLinkCompiler#5](~/samples/snippets/visualbasic/VS_Snippets_VBCSharp/vblinkcompiler/vb/module1.vb#5)]  
  
## <a name="example"></a>Przykład  
 Poniższy wiersz `OfficeApp.vb` polecenia kompiluje pliki źródłowe i zestawy odwołań z `COMData1.dll` i `COMData2.dll` do produkcji `OfficeApp.exe`.  
