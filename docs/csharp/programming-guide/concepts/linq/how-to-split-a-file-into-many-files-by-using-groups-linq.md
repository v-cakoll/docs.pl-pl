...
---
# <a name="how-to-split-a-file-into-many-files-by-using-groups-linq-c"></a>Porady: dzielenie pliku na kilka plików za pomocą grup (LINQ) (C#)
...
2.  Skopiuj te nazwy do pliku tekstowego, który nosi nazwę names2.txt, a następnie zapisz go w folderze projektu: należy pamiętać, że te dwa pliki mają niektóre nazwy w typowych.  
