...
|Termin|Definicja|  
|---|---|  
|`result`|Wymagany. Any `Boolean` expression. The result is the `Boolean` result of comparison of the two expressions.|  
|`expression1`|Wymagany. Any `Boolean` expression.|  
|`expression2`|Wymagany. Any `Boolean` expression.|  
