---
title: Elementy członkowskie biblioteki środowiska uruchomieniowego
ms.date: 07/20/2015
f1_keywords:
- VisualBasic
helpviewer_keywords:
...
---
# <a name="visual-basic-runtime-library-members"></a><span data-ttu-id="803fb-102">Elementy członkowskie biblioteki wykonawczej programu Visual Basic</span><span class="sxs-lookup"><span data-stu-id="803fb-102">Visual Basic Runtime Library Members</span></span>

<span data-ttu-id="803fb-103">Przestrzeń nazw `Microsoft.VisualBasic` zawiera klasy, moduły, stałe i wyliczenia stanowiące bibliotekę środowiska uruchomieniowego Visual Basic.</span><span class="sxs-lookup"><span data-stu-id="803fb-103">The `Microsoft.VisualBasic` namespace contains the classes, modules, constants, and enumerations that constitute the Visual Basic runtime library.</span></span> <span data-ttu-id="803fb-104">Te elementy członkowskie biblioteki udostępniają procedury, właściwości i wartości stałe, których można użyć w kodzie.</span><span class="sxs-lookup"><span data-stu-id="803fb-104">These library members provide procedures, properties, and constant values you can use in your code.</span></span> <span data-ttu-id="803fb-105">Każdy moduł i Klasa przedstawiają określoną kategorię funkcji.</span><span class="sxs-lookup"><span data-stu-id="803fb-105">Each module and class represents a particular category of functionality.</span></span>  
  
## <a name="microsoftvisualbasiccollection-class"></a><span data-ttu-id="803fb-106">Microsoft. VisualBasic. Collection — Klasa</span><span class="sxs-lookup"><span data-stu-id="803fb-106">Microsoft.VisualBasic.Collection Class</span></span>  
...
## <a name="microsoftvisualbasiccomclassattribute-class"></a><span data-ttu-id="803fb-107">Microsoft. VisualBasic. ComClassAttribute — Klasa</span><span class="sxs-lookup"><span data-stu-id="803fb-107">Microsoft.VisualBasic.ComClassAttribute Class</span></span>  
...
## <a name="microsoftvisualbasiccontrolchars-class"></a><span data-ttu-id="803fb-108">Microsoft. VisualBasic. ControlChars, Klasa</span><span class="sxs-lookup"><span data-stu-id="803fb-108">Microsoft.VisualBasic.ControlChars Class</span></span>  
...
## <a name="microsoftvisualbasicconstants-class"></a><span data-ttu-id="803fb-109">Microsoft. VisualBasic. stałe — Klasa</span><span class="sxs-lookup"><span data-stu-id="803fb-109">Microsoft.VisualBasic.Constants Class</span></span>  
...
## <a name="microsoftvisualbasicconversion-module"></a><span data-ttu-id="803fb-110">Moduł Microsoft. VisualBasic. Conversion</span><span class="sxs-lookup"><span data-stu-id="803fb-110">Microsoft.VisualBasic.Conversion Module</span></span>  
...
## <a name="microsoftvisualbasicdateandtime-module"></a><span data-ttu-id="803fb-111">Microsoft. VisualBasic. DateAndTime — moduł</span><span class="sxs-lookup"><span data-stu-id="803fb-111">Microsoft.VisualBasic.DateAndTime Module</span></span>  
...
## <a name="microsoftvisualbasicerrobject-class"></a><span data-ttu-id="803fb-112">Microsoft.VisualBasic.ErrObject Class</span><span class="sxs-lookup"><span data-stu-id="803fb-112">Microsoft.VisualBasic.ErrObject Class</span></span>  
...
## <a name="microsoftvisualbasicfilesystem-module"></a><span data-ttu-id="803fb-113">Microsoft.VisualBasic.FileSystem Module</span><span class="sxs-lookup"><span data-stu-id="803fb-113">Microsoft.VisualBasic.FileSystem Module</span></span>  
...
## <a name="microsoftvisualbasicfinancial-module"></a><span data-ttu-id="803fb-114">Microsoft. VisualBasic. Financial — moduł</span><span class="sxs-lookup"><span data-stu-id="803fb-114">Microsoft.VisualBasic.Financial Module</span></span>  
...
## <a name="microsoftvisualbasicglobals-module"></a><span data-ttu-id="803fb-115">Microsoft. VisualBasic. Globals — moduł</span><span class="sxs-lookup"><span data-stu-id="803fb-115">Microsoft.VisualBasic.Globals Module</span></span>  
...
## <a name="microsoftvisualbasichidemodulenameattribute-class"></a><span data-ttu-id="803fb-116">Microsoft. VisualBasic. HideModuleNameAttribute, Klasa</span><span class="sxs-lookup"><span data-stu-id="803fb-116">Microsoft.VisualBasic.HideModuleNameAttribute Class</span></span>  
  
|||||  
|---|---|---|---|  
|<xref:Microsoft.VisualBasic.HideModuleNameAttribute>||||  
  
## <a name="microsoftvisualbasicinformation-module"></a><span data-ttu-id="803fb-117">Microsoft. VisualBasic. Information — moduł</span><span class="sxs-lookup"><span data-stu-id="803fb-117">Microsoft.VisualBasic.Information Module</span></span>  
...
## <a name="microsoftvisualbasicinteraction-module"></a><span data-ttu-id="803fb-118">Moduł Microsoft. VisualBasic. Interaction</span><span class="sxs-lookup"><span data-stu-id="803fb-118">Microsoft.VisualBasic.Interaction Module</span></span>  
...
## <a name="microsoftvisualbasicmygroupcollectionattribute-class"></a><span data-ttu-id="803fb-119">Microsoft.VisualBasic.MyGroupCollectionAttribute Class</span><span class="sxs-lookup"><span data-stu-id="803fb-119">Microsoft.VisualBasic.MyGroupCollectionAttribute Class</span></span>  
...
## <a name="microsoftvisualbasicstrings-module"></a><span data-ttu-id="803fb-120">Microsoft.VisualBasic.Strings Module</span><span class="sxs-lookup"><span data-stu-id="803fb-120">Microsoft.VisualBasic.Strings Module</span></span>  
...
## <a name="microsoftvisualbasicvbfixedarrayattribute-class"></a><span data-ttu-id="803fb-121">Microsoft. VisualBasic. VBFixedArrayAttribute, Klasa</span><span class="sxs-lookup"><span data-stu-id="803fb-121">Microsoft.VisualBasic.VBFixedArrayAttribute Class</span></span>  
  
|||||  
|---|---|---|---|  
|<xref:Microsoft.VisualBasic.VBFixedArrayAttribute.Bounds%2A>|<xref:Microsoft.VisualBasic.VBFixedArrayAttribute.Length%2A>|||  
  
## <a name="microsoftvisualbasicvbfixedstringattribute-class"></a><span data-ttu-id="803fb-122">Microsoft. VisualBasic. VBFixedStringAttribute, Klasa</span><span class="sxs-lookup"><span data-stu-id="803fb-122">Microsoft.VisualBasic.VBFixedStringAttribute Class</span></span>  
  
|||||  
|---|---|---|---|  
|<xref:Microsoft.VisualBasic.VBFixedStringAttribute.Length%2A>||||  
  
## <a name="microsoftvisualbasicvbmath-module"></a><span data-ttu-id="803fb-123">Microsoft. VisualBasic. VbMath — moduł</span><span class="sxs-lookup"><span data-stu-id="803fb-123">Microsoft.VisualBasic.VbMath Module</span></span>  
  
|||||  
|---|---|---|---|  
|<xref:Microsoft.VisualBasic.VBMath.Randomize%2A>|<xref:Microsoft.VisualBasic.VBMath.Rnd%2A>|||  
  
## <a name="microsoftvisualbasic-constants-and-enumerations"></a><span data-ttu-id="803fb-124">Stałe i wyliczenia Microsoft. VisualBasic</span><span class="sxs-lookup"><span data-stu-id="803fb-124">Microsoft.VisualBasic Constants and Enumerations</span></span>  

 <span data-ttu-id="803fb-125">Przestrzeń nazw `Microsoft.VisualBasic` zawiera stałe i wyliczenia w ramach Visual Basic biblioteki wykonawczej.</span><span class="sxs-lookup"><span data-stu-id="803fb-125">The `Microsoft.VisualBasic` namespace provides constants and enumerations as part of the Visual Basic run-time library.</span></span> <span data-ttu-id="803fb-126">Możesz użyć tych stałych wartości w kodzie.</span><span class="sxs-lookup"><span data-stu-id="803fb-126">You can use these constant values in your code.</span></span> <span data-ttu-id="803fb-127">Każde Wyliczenie reprezentuje konkretną kategorię funkcji.</span><span class="sxs-lookup"><span data-stu-id="803fb-127">Each enumeration represents a particular category of functionality.</span></span> <span data-ttu-id="803fb-128">Aby uzyskać więcej informacji, zobacz [stałe i wyliczenia](../../visual-basic/language-reference/constants-and-enumerations.md).</span><span class="sxs-lookup"><span data-stu-id="803fb-128">For more information, see [Constants and Enumerations](../../visual-basic/language-reference/constants-and-enumerations.md).</span></span>  
  
## <a name="see-also"></a><span data-ttu-id="803fb-129">Zobacz także</span><span class="sxs-lookup"><span data-stu-id="803fb-129">See also</span></span>

- [<span data-ttu-id="803fb-130">Stałe i wyliczenia</span><span class="sxs-lookup"><span data-stu-id="803fb-130">Constants and Enumerations</span></span>](../../visual-basic/language-reference/constants-and-enumerations.md)
- [<span data-ttu-id="803fb-131">Słowa kluczowe</span><span class="sxs-lookup"><span data-stu-id="803fb-131">Keywords</span></span>](../../visual-basic/language-reference/keywords/index.md)
