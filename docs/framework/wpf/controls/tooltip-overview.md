...
## <a name="using-the-properties-of-the-tooltip-and-tooltipservice-classes"></a>Za pomocą właściwości klasy ToolTipService i etykietki narzędzi  
 ...
 Na przykład sposób ustawiania właściwości, aby określić położenie tooltip zawartości przy użyciu <xref:System.Windows.Controls.ToolTip> i <xref:System.Windows.Controls.ToolTipService> właściwości, zobacz [położenie ToolTip](how-to-position-a-tooltip.md).  
