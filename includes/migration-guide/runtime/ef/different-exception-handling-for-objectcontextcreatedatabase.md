...
|   |   |
|---|---|
|Szczegóły|W programie .NET Framework 4.5, w przypadku niepowodzenia tworzenia bazy danych <code>CreateDatabase</code> metody podejmie próbę porzucić pustej bazy danych. Jeśli ta operacja zakończy się powodzeniem, oryginalny <xref:System.Data.SqlClient.SqlException?displayProperty=name> będzie propagowane (zamiast <xref:System.InvalidOperationException?displayProperty=name> który zawsze zgłosiła wyjątek .NET Framework 4.0)|
