...
## <a name="description"></a>Opis  
 To zdarzenie jest emitowany po uruchomieniu sprawdzania poprawności obiektu SecurityToken.  
  
## <a name="message"></a>Komunikat  
 Rozpoczęto weryfikację SecurityToken (typu '%1' i identyfikatorze "%2").  
