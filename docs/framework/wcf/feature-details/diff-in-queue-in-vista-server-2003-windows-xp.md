...
- Usługa MSMQ w systemie Windows Vista obsługuje Potwierdzanie negatywne, natomiast systemy Windows Server 2003 i Windows XP nie. Negatywne potwierdzenie od Menedżera kolejki odbiorczej powoduje, że Menedżer kolejki wysyłania umieszcza odrzucony komunikat w kolejce utraconych wiadomości. W związku z tym `ReceiveErrorHandling.Reject` nie jest dozwolone w przypadku systemów Windows Server 2003 i Windows XP.  
