...
## <a name="parameters"></a>Parametry  
 `ppRegisters`  
 określoną Wskaźnik do adresu obiektu [ICorDebugRegisterSet](../../../../docs/framework/unmanaged-api/debugging/icordebugregisterset-interface.md) , który reprezentuje zestaw rejestru dla tej ramki stosu.  
