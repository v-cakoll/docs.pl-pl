...
Rozmiaru tablicy nie można określić w deklaracji zmiennej (spróbuj przeprowadzić inicjowanie przy użyciu wyrażenia „new”)  
 ...
 Ten błąd występuje, gdy rozmiar jest określony jako część deklaracji tablicy. Aby rozwiązać problem, należy użyć [operatora new](../operators/new-operator.md) wyrażenia.  
