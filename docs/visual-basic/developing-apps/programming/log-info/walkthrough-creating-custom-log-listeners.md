...
-   W aplikacji, Utwórz klasę o nazwie `SimpleListener` dziedziczący po <xref:System.Diagnostics.TraceListener>.  
 ...
 Następna procedura zawiera kilku prostych czynności tworzenia zestawu o silnej nazwie odbiornika dziennika. Aby uzyskać więcej informacji, zobacz [tworzenie i zestawy Using Strong-Named](https://msdn.microsoft.com/library/xwb8f617).  
