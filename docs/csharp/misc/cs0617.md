...
"odwołanie" nie jest prawidłowym nazwanym argumentem atrybutu, ponieważ nie jest prawidłowym typem parametru atrybutu  
  
 Podjęto próbę uzyskania dostępu do [prywatnego](../language-reference/keywords/private.md) członka klasy atrybutu.  
