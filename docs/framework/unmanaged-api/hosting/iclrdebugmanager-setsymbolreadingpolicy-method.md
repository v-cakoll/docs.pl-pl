...
Ustawia zasady do odczytywania plików bazy danych (PDB) programu. Zasady określają, czy informacje o numery wierszy i pliki są uwzględniane w stosy wywołań.  
...
|HRESULT|Opis|  
|-------------|-----------------|  
|S_OK|`SetSymbolReadingPolicy` pomyślnie zwrócił.|  
