...
## <a name="see-also"></a>Zobacz też  
 ...
 [Najlepsze rozwiązania dotyczące korzystania z wstawek kodu](/visualstudio/ide/best-practices-for-using-code-snippets)  
 [Obsługa wyjątków](https://msdn.microsoft.com/library/dd997415)  
