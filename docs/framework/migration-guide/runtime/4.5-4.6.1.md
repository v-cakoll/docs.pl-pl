...
---
# <a name="runtime-changes-for-migration-from-net-framework-45-to-461"></a>Zmiany środowiska uruchomieniowego do migracji z programu .NET Framework 4.5, 4.6.1

[!INCLUDE[versionselector](../../../../includes/migration-guide/runtime/versionselector.md)]

[!INCLUDE[introduction](../../../../includes/migration-guide/runtime/introduction.md)]

Jeśli są migrowane z programu .NET Framework 4.5, aby 4.6.1, należy zapoznać się w poniższych tematach problemy ze zgodnością aplikacji, które mogą wpływać na Twoją aplikację:
