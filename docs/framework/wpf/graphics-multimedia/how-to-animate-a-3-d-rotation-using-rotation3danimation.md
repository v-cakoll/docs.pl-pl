...
---
# <a name="how-to-animate-a-3-d-rotation-using-rotation3danimation"></a>Instrukcje: Animowanie obrotu 3D przy użyciu elementu Rotation3DAnimation
Poniższy przykład pokazuje, jak należy obrócić podczas jego "wobbles" przy użyciu obiektu 3D <xref:System.Windows.Media.Animation.Rotation3DAnimation> animować <xref:System.Windows.Media.Media3D.RotateTransform3D.Rotation%2A> właściwość <xref:System.Windows.Media.Media3D.RotateTransform3D> obiektu zastosowany do obiektu 3D.  
