...
|[\<mechanizm rozpoznawania >](../../../../../docs/framework/configure-apps/file-schema/wcf/resolver.md)|Określa program rozpoznawania elementów równorzędnych używany przez to powiązanie do rozpoznawania elementu równorzędnego ID siatki adresy IP punktu końcowego węzłach w obrębie siatki elementów równorzędnych.|  
...
## <a name="example"></a>Przykład  
 W poniższym przykładzie pokazano, za pomocą tego powiązania NetPeerTcpBinding, która zapewnia wielopartyjnej komunikacji przy użyciu kanału równorzędnego. Szczegółowe scenariusz użycia tego powiązania, zobacz [Net TCP równorzędnej](http://msdn.microsoft.com/en-us/31f4db66-edb2-40a6-b92a-14098e92acae).  
...
## <a name="see-also"></a>Zobacz też  
 ...
 [NET elementów równorzędnych protokołu TCP](http://msdn.microsoft.com/en-us/31f4db66-edb2-40a6-b92a-14098e92acae)  
