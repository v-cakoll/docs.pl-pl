...
ms.locfileid: "33497402"
---
# <a name="security-concepts"></a>Pojęcia dotyczące zabezpieczeń
Ta sekcja zawiera krótkie opisy pojęć związanych z zabezpieczeniami usług Windows Communication Foundation (WCF).  
...
## <a name="in-this-section"></a>W tej sekcji  
 ...
 Przegląd sposobu WCF zapewnia bezpieczeństwo i topografii aplikacji rozproszonej.  
  
 [Terminologia dotycząca zabezpieczeń](../../../../docs/framework/wcf/feature-details/wcf-security-terminology.md)  
 Słownik terminów używanych w opisach zabezpieczeń WCF.  
