...
- Jeśli typ T implementuje interfejs <xref:System.IEquatable%601> ogólny, to <xref:System.IEquatable%601.Equals%2A> metoda porównania równości jest metodą tego interfejsu.
...
Ponadto niektóre przeciążenia konstruktorów dla kolekcji słowników akceptują <xref:System.Collections.Generic.IEqualityComparer%601> implementację, która jest używana do porównywania kluczy pod kątem równości. Aby zapoznać się z przykładem <xref:System.Collections.Generic.Dictionary%602.%23ctor%2A> , zobacz Konstruktor.
...
- Jeśli typ T implementuje interfejs <xref:System.IComparable%601?displayProperty=nameWithType> generyczny, domyślną <xref:System.IComparable%601.CompareTo%28%600%29?displayProperty=nameWithType> metodą porównującą jest metoda tego interfejsu

- Jeśli typ T implementuje interfejs nieogólny <xref:System.IComparable?displayProperty=nameWithType> , wówczas domyślną <xref:System.IComparable.CompareTo%28System.Object%29?displayProperty=nameWithType> metodą porównującą jest metoda tego interfejsu.
