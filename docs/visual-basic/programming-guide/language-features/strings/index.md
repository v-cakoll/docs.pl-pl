...
## <a name="in-this-section"></a>W tej sekcji  
 ...
 Wyświetla listę tematów opisujących sposób konwertowania ciągów na inne typy danych.  
 ...
 Wyświetla listę tematów, w których opisano, jak sprawdzanie poprawności ciągów.  
  
 [Wskazówki: Szyfrowanie i odszyfrowywanie ciągów w Visual Basic](../../../../visual-basic/programming-guide/language-features/strings/walkthrough-encrypting-and-decrypting-strings.md)  
 Pokazuje, jak szyfrowanie i odszyfrowywanie ciągów za pomocą wersji dostawcy usług kryptograficznych algorytm Triple Data Encryption Standard.  
