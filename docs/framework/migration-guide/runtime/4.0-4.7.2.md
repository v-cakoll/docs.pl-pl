---
title: Zmiany środowiska uruchomieniowego do migracji z systemu .NET Framework 4.0 do 4.7.2
ms.date: 04/05/2018
...
---
# <a name="runtime-changes-for-migration-from-net-framework-40-to-472"></a><span data-ttu-id="19982-102">Zmiany środowiska uruchomieniowego do migracji z systemu .NET Framework 4.0 do 4.7.2</span><span class="sxs-lookup"><span data-stu-id="19982-102">Runtime Changes for Migration from .NET Framework 4.0 to 4.7.2</span></span>

[!include[versionselector](../../../../includes/migration-guide/runtime/versionselector.md)]

[!include[introduction](../../../../includes/migration-guide/runtime/introduction.md)]

<span data-ttu-id="19982-103">Jeśli w przypadku migracji z programu .NET Framework 4.0 do 4.7.2, należy przejrzeć następujące tematy dla problemów ze zgodnością aplikacji, które mogą wpływać na aplikację:</span><span class="sxs-lookup"><span data-stu-id="19982-103">If you are migrating from the .NET Framework 4.0 to 4.7.2, review the following topics for application compatibility issues that may affect your app:</span></span>

## <a name="adonet"></a><span data-ttu-id="19982-104">ADO.NET</span><span class="sxs-lookup"><span data-stu-id="19982-104">ADO.NET</span></span>
...
## <a name="aspnet"></a><span data-ttu-id="19982-105">ASP.NET</span><span class="sxs-lookup"><span data-stu-id="19982-105">ASP.NET</span></span>
...
## <a name="core"></a><span data-ttu-id="19982-106">Core</span><span class="sxs-lookup"><span data-stu-id="19982-106">Core</span></span>
...
## <a name="data"></a><span data-ttu-id="19982-107">Dane</span><span class="sxs-lookup"><span data-stu-id="19982-107">Data</span></span>
...
## <a name="entity-framework"></a><span data-ttu-id="19982-108">Entity Framework</span><span class="sxs-lookup"><span data-stu-id="19982-108">Entity Framework</span></span>
...
## <a name="globalization"></a><span data-ttu-id="19982-109">Globalizacja</span><span class="sxs-lookup"><span data-stu-id="19982-109">Globalization</span></span>
...
## <a name="linq"></a><span data-ttu-id="19982-110">LINQ</span><span class="sxs-lookup"><span data-stu-id="19982-110">LINQ</span></span>
...
## <a name="managed-extensibility-framework-mef"></a><span data-ttu-id="19982-111">Managed Extensibility Framework (MEF)</span><span class="sxs-lookup"><span data-stu-id="19982-111">Managed Extensibility Framework (MEF)</span></span>
...
## <a name="networking"></a><span data-ttu-id="19982-112">Obsługa sieci</span><span class="sxs-lookup"><span data-stu-id="19982-112">Networking</span></span>
...
## <a name="printing"></a><span data-ttu-id="19982-113">Drukowanie</span><span class="sxs-lookup"><span data-stu-id="19982-113">Printing</span></span>
...
## <a name="runtime"></a><span data-ttu-id="19982-114">Środowisko uruchomieniowe</span><span class="sxs-lookup"><span data-stu-id="19982-114">Runtime</span></span>

[!include[Improved WCF chain trust certificate validation for Net.Tcp certificate authentication](~/includes/migration-guide/runtime/runtime/improved-wcf-chain-trust-certificate-validation-for-nettcp-authentication.md)]

## <a name="security"></a><span data-ttu-id="19982-115">Zabezpieczenia</span><span class="sxs-lookup"><span data-stu-id="19982-115">Security</span></span>
...
## <a name="serialization"></a><span data-ttu-id="19982-116">Serializacja</span><span class="sxs-lookup"><span data-stu-id="19982-116">Serialization</span></span>
...
## <a name="setup-and-deployment"></a><span data-ttu-id="19982-117">Instalacji i wdrażania</span><span class="sxs-lookup"><span data-stu-id="19982-117">Setup and Deployment</span></span>
...
## <a name="tools"></a><span data-ttu-id="19982-118">Narzędzia</span><span class="sxs-lookup"><span data-stu-id="19982-118">Tools</span></span>

[!include[Contract.Invariant or Contract.Requires<TException> do not consider String.IsNullOrEmpty to be pure](~/includes/migration-guide/runtime/tools/contractinvariant-contractrequirestexception-do-not-consider.md)]

## <a name="web-application"></a><span data-ttu-id="19982-119">Aplikacja sieci Web</span><span class="sxs-lookup"><span data-stu-id="19982-119">Web Application</span></span>
...
## <a name="web-applications"></a><span data-ttu-id="19982-120">Aplikacje sieci Web</span><span class="sxs-lookup"><span data-stu-id="19982-120">Web Applications</span></span>
...
## <a name="windows-communication-foundation-wcf"></a><span data-ttu-id="19982-121">Windows Communication Foundation (WCF)</span><span class="sxs-lookup"><span data-stu-id="19982-121">Windows Communication Foundation (WCF)</span></span>
...
## <a name="windows-forms"></a><span data-ttu-id="19982-122">Windows Forms</span><span class="sxs-lookup"><span data-stu-id="19982-122">Windows Forms</span></span>
...
## <a name="windows-presentation-foundation-wpf"></a><span data-ttu-id="19982-123">Windows Presentation Foundation (WPF)</span><span class="sxs-lookup"><span data-stu-id="19982-123">Windows Presentation Foundation (WPF)</span></span>
...
## <a name="windows-workflow-foundation-wf"></a><span data-ttu-id="19982-124">Program Windows Workflow Foundation (WF)</span><span class="sxs-lookup"><span data-stu-id="19982-124">Windows Workflow Foundation (WF)</span></span>
...
## <a name="xml-xslt"></a><span data-ttu-id="19982-125">Języki XML, XSLT</span><span class="sxs-lookup"><span data-stu-id="19982-125">XML, XSLT</span></span>
