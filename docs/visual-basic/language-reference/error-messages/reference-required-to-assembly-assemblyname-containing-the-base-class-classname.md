...
---
# <a name="reference-required-to-assembly-assemblyname-containing-the-base-class-classname"></a>Wymagane odwołanie do zestawu "\<nazwa_zestawu >" z klasą bazową\<nazwa_klasy > "
