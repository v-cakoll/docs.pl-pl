...
## <a name="ui-automation-control-pattern-components"></a>UI Automation Control Pattern Components  
...
## <a name="ui-automation-providers-and-clients"></a>UI Automation Providers and Clients  
...
## <a name="dynamic-control-patterns"></a>Dynamic Control Patterns  
...
## <a name="control-pattern-classes-and-interfaces"></a>Control Pattern Classes and Interfaces  
...
|Control Pattern Class|Provider Interface|Opis|  
|---------------------------|------------------------|-----------------|  
