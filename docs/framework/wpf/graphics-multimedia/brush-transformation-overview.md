...
## <a name="prerequisites"></a>Wymagania wstępne  
 Aby zrozumieć, w tym temacie, musisz zrozumieć funkcje pędzla, który jest przekształcany. Aby uzyskać <xref:System.Windows.Media.LinearGradientBrush> i <xref:System.Windows.Media.RadialGradientBrush>, zobacz [malowanie jednolitymi kolorami i gradientami — Przegląd](../../../../docs/framework/wpf/graphics-multimedia/painting-with-solid-colors-and-gradients-overview.md). Aby uzyskać <xref:System.Windows.Media.ImageBrush>, <xref:System.Windows.Media.DrawingBrush>, lub <xref:System.Windows.Media.VisualBrush>, zobacz [malowanie obrazami, rysowaniem i Visual](../../../../docs/framework/wpf/graphics-multimedia/painting-with-images-drawings-and-visuals.md). Należy także zapoznać się z przekształceń 2D, opisanego w [przekształca Przegląd](../../../../docs/framework/wpf/graphics-multimedia/transforms-overview.md).  
...
1.  Projekt pędzla zawartość (<xref:System.Windows.Media.TileBrush.Viewbox%2A>) na jego podstawowy Kafelek (<xref:System.Windows.Media.TileBrush.Viewport%2A>) przy użyciu pędzli <xref:System.Windows.Media.TileBrush.Stretch%2A> ustawienie.  
     ...
     ![Rozciąganie Viewbox, aby dopasować okienka ekranu](../../../../docs/framework/wpf/graphics-multimedia/media/graphicsmm-reltransform-2-viewbox-to-viewport.png "graphicsmm_reltransform_2_viewbox_to_viewport")  
...
## <a name="example-rotate-an-imagebrush-45-degrees"></a>Przykład: Obracanie ImageBrush 45 stopni  
 ...
 W tym przykładzie jest częścią większego przykładu. Aby uzyskać pełny przykład, zobacz [przykład pędzle](https://go.microsoft.com/fwlink/?LinkID=159973). Aby uzyskać więcej informacji na temat pędzle, zobacz [pędzle WPF — Przegląd](../../../../docs/framework/wpf/graphics-multimedia/wpf-brushes-overview.md).  
