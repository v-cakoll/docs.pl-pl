...
## <a name="methods"></a>Metody  
 Klasa CompositeDuplexBindingElement nie definiuje żadnych metod.  
  
## <a name="properties"></a>Właściwości  
 Klasa CompositeDuplexBindingElement ma następującą właściwość:  
