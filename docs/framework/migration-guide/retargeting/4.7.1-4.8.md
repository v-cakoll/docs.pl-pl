...
ms.locfileid: "59982179"
---
# <a name="retargeting-changes-for-migration-from-net-framework-471-to-48"></a><span data-ttu-id="82f4e-102">Zmiany retargetingu migracji z .NET Framework 4.7.1 do 4.8</span><span class="sxs-lookup"><span data-stu-id="82f4e-102">Retargeting Changes for Migration from .NET Framework 4.7.1 to 4.8</span></span>

[!INCLUDE[versionselector](../../../../includes/migration-guide/retargeting/versionselector.md)]

[!INCLUDE[introduction](../../../../includes/migration-guide/retargeting/introduction.md)]

<span data-ttu-id="82f4e-103">Migracji z programu .NET Framework 4.7.1 do 4,8, zobacz następujące tematy dla problemów ze zgodnością aplikacji, które mogą wpływać na Twoją aplikację:</span><span class="sxs-lookup"><span data-stu-id="82f4e-103">If you are migrating from the .NET Framework 4.7.1 to 4.8, review the following topics for application compatibility issues that may affect your app:</span></span>

## <a name="core"></a><span data-ttu-id="82f4e-104">Core</span><span class="sxs-lookup"><span data-stu-id="82f4e-104">Core</span></span>
...
## <a name="windows-forms"></a><span data-ttu-id="82f4e-105">Windows Forms</span><span class="sxs-lookup"><span data-stu-id="82f4e-105">Windows Forms</span></span>
...
## <a name="windows-presentation-foundation-wpf"></a><span data-ttu-id="82f4e-106">Windows Presentation Foundation (WPF)</span><span class="sxs-lookup"><span data-stu-id="82f4e-106">Windows Presentation Foundation (WPF)</span></span>
...
## <a name="windows-workflow-foundation-wf"></a><span data-ttu-id="82f4e-107">Program Windows Workflow Foundation (WF)</span><span class="sxs-lookup"><span data-stu-id="82f4e-107">Windows Workflow Foundation (WF)</span></span>
