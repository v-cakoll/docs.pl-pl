...
-   Containerize aplikacji przy użyciu [2017 Visual Studio Tools for Docker](https://docs.microsoft.com/dotnet/core/docker/visual-studio-tools-for-docker) (Visual Studio 2017 lub nowszy).
