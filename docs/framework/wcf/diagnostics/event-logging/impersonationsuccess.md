...
## <a name="description"></a>Opis  
 To zdarzenie oznacza, że personifikacja zakończyła się pomyślnie, wyświetlanie nazwy metody, tożsamość klienta i identyfikatora działania  
