...
## <a name="channel-factories"></a>Fabryk kanałów  
 ...
 [!INCLUDE[crabout](../../../../includes/crabout-md.md)]problemy dotyczące różnych [!INCLUDE[indigo2](../../../../includes/indigo2-md.md)] obiekty klienta i [!INCLUDE[indigo2](../../../../includes/indigo2-md.md)] kanałów klienta, zobacz [dostęp do usług za pomocą klienta WCF](../../../../docs/framework/wcf/feature-details/accessing-services-using-a-client.md).  
