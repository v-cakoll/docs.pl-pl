...
> [!NOTE]
>  <xref:System.Xml.Xsl.XslCompiledTransform> Klasy zachowuje białe miejsca domyślnie. Jest to zgodnie z zaleceniem W3C specyfikacji XSLT 1.0 w sekcji 3.4 (sekcji 3.4, http://www.w3.org/TR/xslt.html#strip).  
