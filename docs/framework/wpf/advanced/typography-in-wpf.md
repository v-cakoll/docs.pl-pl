...
## <a name="improved-quality-and-performance-of-text"></a>Poprawy jakości i wydajności tekstu  
 ...
 ![Tekst z ClearType y&#45;kierunek ochrony przed złośliwym&#45;aliasów](../../../../docs/framework/wpf/advanced/media/typographyinwpf02.gif "TypographyInWPF02")  
...
## <a name="rich-typography"></a>Rozbudowane typografii  
 ...
 ![Tekst stylistyczne alternatywne symbole OpenType](../../../../docs/framework/wpf/advanced/media/opentypefont02.gif "opentypefont02")  
Tekst stylistyczne alternatywne symbole OpenType  
 ...
 ![Tekst z użyciem glifów standardowe i kaligraficzne OpenType](../../../../docs/framework/wpf/advanced/media/opentypefont08.gif "opentypefont08")  
Tekst z użyciem glifów standardowe i kaligraficzne OpenType  
  
 Aby uzyskać szczegółowe informacje na temat [!INCLUDE[TLA2#tla_opentype](../../../../includes/tla2sharptla-opentype-md.md)] funkcje, zobacz [funkcje czcionki OpenType](../../../../docs/framework/wpf/advanced/opentype-font-features.md).  
...
-   Obsługi szerokiej gamy międzynarodowych tekstu. Aby uzyskać więcej informacji, zobacz [globalizacja dla WPF](../../../../docs/framework/wpf/advanced/globalization-for-wpf.md).  
...
Tekst z efektem Rozmycie  
 ...
 ![Tekst skalowane za pomocą ScaleTransform](../../../../docs/framework/wpf/advanced/media/transformedtext02.jpg "TransformedText02")  
Tekst przy użyciu ScaleTransform  
  
 Poniższy przykład pokazuje tekst skośny wzdłuż osi x.  
  
 ![Tekst skośny przy użyciu metody SkewTransform](../../../../docs/framework/wpf/advanced/media/transformedtext03.jpg "TransformedText03")  
...
#### <a name="using-flow-documents"></a>Używanie dokumentów przepływu  
 ...
 ![Przykład użycia czcionek OpenType zrzut ekranu przedstawiający](../../../../docs/framework/wpf/advanced/media/typographyinwpf-03.png "TypographyInWPF_03")  
Tekst hostowanych w FlowDocumentReader  
  
 Aby uzyskać więcej informacji, zobacz [dokumenty w WPF](../../../../docs/framework/wpf/advanced/documents-in-wpf.md).  
...
### <a name="lightweight-text-drawing"></a>Rysowanie tekstu lekkie  
 ...
 ![Tekst wyświetlany za pomocą obiektu FormattedText](../../../../docs/framework/wpf/advanced/media/formattedtext01.jpg "FormattedText01")  
...
Przykład ImageBrush stosowane do obrysu i wyróżnienia  
 ...
 Aby uzyskać więcej informacji na temat <xref:System.Windows.Media.FormattedText> obiektu, zobacz [Rysowanie tekstu w formacie](../../../../docs/framework/wpf/advanced/drawing-formatted-text.md).  
...
Interakcja między aplikacją i obiekt TextFormatter  
 ...
 Aby uzyskać więcej informacji na temat tworzenia układu niestandardowego tekstu, zobacz [zaawansowane formatowanie tekstu](../../../../docs/framework/wpf/advanced/advanced-text-formatting.md).  
...
## <a name="see-also"></a>Zobacz też  
 ...
 [Typografia firmy Microsoft](https://www.microsoft.com/typography/default.mspx)
