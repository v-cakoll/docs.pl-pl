...
ms.locfileid: "37071253"
---
# <a name="runtime-changes-for-migration-from-net-framework-461-to-47"></a><span data-ttu-id="fd34f-102">Zmiany środowiska uruchomieniowego do migracji z systemu .NET Framework 4.6.1 do 4.7</span><span class="sxs-lookup"><span data-stu-id="fd34f-102">Runtime Changes for Migration from .NET Framework 4.6.1 to 4.7</span></span>

[!INCLUDE[versionselector](../../../../includes/migration-guide/runtime/versionselector.md)]

[!INCLUDE[introduction](../../../../includes/migration-guide/runtime/introduction.md)]

<span data-ttu-id="fd34f-103">W przypadku migracji z programu .NET Framework 4.6.1 do 4.7, należy przejrzeć następujące tematy dla problemów ze zgodnością aplikacji, które mogą wpływać na aplikację:</span><span class="sxs-lookup"><span data-stu-id="fd34f-103">If you are migrating from the .NET Framework 4.6.1 to 4.7, review the following topics for application compatibility issues that may affect your app:</span></span>

## <a name="data"></a><span data-ttu-id="fd34f-104">Dane</span><span class="sxs-lookup"><span data-stu-id="fd34f-104">Data</span></span>
...
## <a name="globalization"></a><span data-ttu-id="fd34f-105">Globalizacja</span><span class="sxs-lookup"><span data-stu-id="fd34f-105">Globalization</span></span>
...
## <a name="jit"></a><span data-ttu-id="fd34f-106">JIT</span><span class="sxs-lookup"><span data-stu-id="fd34f-106">JIT</span></span>
...
## <a name="security"></a><span data-ttu-id="fd34f-107">Zabezpieczenia</span><span class="sxs-lookup"><span data-stu-id="fd34f-107">Security</span></span>
...
## <a name="windows-communication-foundation-wcf"></a><span data-ttu-id="fd34f-108">Windows Communication Foundation (WCF)</span><span class="sxs-lookup"><span data-stu-id="fd34f-108">Windows Communication Foundation (WCF)</span></span>
...
## <a name="windows-presentation-foundation-wpf"></a><span data-ttu-id="fd34f-109">Program Windows Presentation Foundation (WPF)</span><span class="sxs-lookup"><span data-stu-id="fd34f-109">Windows Presentation Foundation (WPF)</span></span>
...
## <a name="windows-workflow-foundation-wf"></a><span data-ttu-id="fd34f-110">Program Windows Workflow Foundation (WF)</span><span class="sxs-lookup"><span data-stu-id="fd34f-110">Windows Workflow Foundation (WF)</span></span>
