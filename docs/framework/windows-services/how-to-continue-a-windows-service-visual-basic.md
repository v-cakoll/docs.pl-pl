...
## <a name="net-framework-security"></a>Zabezpieczenia.NET Framework  
 Kontrola usług na komputerze może być ograniczona przy użyciu wyliczenia, <xref:System.ServiceProcess.ServiceControllerPermissionAccess> aby ustawić uprawnienia w <xref:System.ServiceProcess.ServiceControllerPermission> klasie.  
...
- [Porady: wstrzymywanie usług systemu Windows (Visual Basic)](how-to-pause-a-windows-service-visual-basic.md)
