---
title: Pojęcia i terminologia (przekształcenie funkcjonalne) (Visual Basic)
ms.date: 07/20/2015
 ...
 *Programowanie funkcjonalne* jest podejściem programistycznym, które bezpośrednio obsługuje funkcję czystego przekształcania funkcjonalności.  
 ...
 Aby uzyskać więcej informacji na temat programowania funkcjonalnego, zobacz [programowanie funkcjonalne a Programowanie bezwzględne (](../../../../visual-basic/programming-guide/concepts/linq/functional-programming-vs-imperative-programming.md)Visual Basic).  
