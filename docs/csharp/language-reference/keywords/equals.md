...
ms.locfileid: "37028191"
---
# <a name="equals-c-reference"></a>equals (odwołanie w C#)

`equals` Kontekstowe słowo kluczowe jest używane w `join` klauzuli w wyrażeniu zapytania do porównania elementy dwóch sekwencji. Aby uzyskać więcej informacji, zobacz [klauzuli join](join-clause.md).
