...
Windows Communication Foundation (WCF) pozwala na rejestrowanie zdarzeń zabezpieczeń w dzienniku zdarzeń systemu Windows można wyświetlić za pomocą Podglądu zdarzeń systemu Windows. W tym temacie wyjaśniono, jak skonfigurować aplikację tak, aby go dzienniki zdarzeń zabezpieczeń. Aby uzyskać więcej informacji na temat inspekcji WCF, zobacz [inspekcji](../../../../docs/framework/wcf/feature-details/auditing-security-events.md).  
