...
## <a name="example"></a>Przykład  
 Następująca Klasa zawiera trzy definicje właściwości: jeden dla `TotalItems` i dwóch dla `Item`, który jest przeciążony.  
...
```  
 ...
 Właściwość `TotalItems` nie wymaga żadnych argumentów i może zostać zainicjowana na liście inicjalizacji obiektów, jak pokazano w poniższej deklaracji.  
