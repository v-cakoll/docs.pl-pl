...
ms.locfileid: "86443224"
---
# <a name="runtime-changes-for-migration-from-net-framework-45-to-452"></a><span data-ttu-id="476ec-103">Zmiany w czasie wykonywania migracji z .NET Framework 4,5 do 4.5.2</span><span class="sxs-lookup"><span data-stu-id="476ec-103">Runtime Changes for Migration from .NET Framework 4.5 to 4.5.2</span></span>

[!INCLUDE[versionselector](../../../../includes/migration-guide/runtime/versionselector.md)]

<span data-ttu-id="476ec-104">W przypadku migrowania z .NET Framework 4,5 do 4.5.2 zapoznaj się z następującymi tematami dotyczącymi problemów ze zgodnością aplikacji, które mogą mieć wpływ na aplikację:</span><span class="sxs-lookup"><span data-stu-id="476ec-104">If you are migrating from the .NET Framework 4.5 to 4.5.2, review the following topics for application compatibility issues that may affect your app:</span></span>

## <a name="adonet"></a><span data-ttu-id="476ec-105">ADO.NET</span><span class="sxs-lookup"><span data-stu-id="476ec-105">ADO.NET</span></span>
...
## <a name="aspnet"></a><span data-ttu-id="476ec-106">ASP.NET</span><span class="sxs-lookup"><span data-stu-id="476ec-106">ASP.NET</span></span>
...
## <a name="core"></a><span data-ttu-id="476ec-107">Core</span><span class="sxs-lookup"><span data-stu-id="476ec-107">Core</span></span>
...
## <a name="data"></a><span data-ttu-id="476ec-108">Dane</span><span class="sxs-lookup"><span data-stu-id="476ec-108">Data</span></span>
...
## <a name="entity-framework"></a><span data-ttu-id="476ec-109">Entity Framework</span><span class="sxs-lookup"><span data-stu-id="476ec-109">Entity Framework</span></span>
...
## <a name="serialization"></a><span data-ttu-id="476ec-110">Serializacja</span><span class="sxs-lookup"><span data-stu-id="476ec-110">Serialization</span></span>
...
## <a name="windows-communication-foundation-wcf"></a><span data-ttu-id="476ec-111">Windows Communication Foundation (WCF)</span><span class="sxs-lookup"><span data-stu-id="476ec-111">Windows Communication Foundation (WCF)</span></span>
...
## <a name="windows-presentation-foundation-wpf"></a><span data-ttu-id="476ec-112">Windows Presentation Foundation (WPF)</span><span class="sxs-lookup"><span data-stu-id="476ec-112">Windows Presentation Foundation (WPF)</span></span>
