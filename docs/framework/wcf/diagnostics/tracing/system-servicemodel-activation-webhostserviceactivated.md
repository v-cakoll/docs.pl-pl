...
## <a name="description"></a>Opis  
 Występuje, gdy usługa, która znajduje się na Internet Information Services (IIS) lub usługi aktywacji procesów systemu Windows (WAS) pełni jest aktywowana i rozpoczyna nasłuchiwanie dla wiadomości.  
