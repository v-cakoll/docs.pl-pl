...
-   Aby uzyskać dodatkowe materiały dotyczące [!INCLUDE[TLA2#tla_gdi](../../../../includes/tla2sharptla-gdi-md.md)] drukować ścieżki i różnych [!INCLUDE[TLA2#tla_metro](../../../../includes/tla2sharptla-metro-md.md)] opcje konwersji, zobacz [Microsoft XPS dokumentu konwerter (MXDC)](https://msdn.microsoft.com/library/windows/desktop/ff686803.aspx) i "XPSDrv" w [Windows Driver Kit](https://msdn.microsoft.com/library/windows/hardware/ff557573.aspx).  
