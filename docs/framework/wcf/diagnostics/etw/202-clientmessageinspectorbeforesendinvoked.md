...
## <a name="description"></a>Opis  
 To zdarzenie jest emitowane po modelu usługi zostało wywołane `BeforeSendRequest` metody w Inspektorze komunikat klienta.  
  
## <a name="message"></a>Komunikat  
 Dyspozytor wywoływane "BeforeSendRequest" na ClientMessageInspector typu "%1".  
