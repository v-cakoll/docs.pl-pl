---
title: Przekierowywanie zmian dotyczących migracji z .NET Framework 4.6.1 do 4.6.2
description: Znajdź informacje o problemach ze zgodnością aplikacji, które mogą mieć wpływ na aplikację podczas migrowania z .NET Framework 4.6.1 do 4.6.2.
ms.date: 07/10/2019
...
ms.locfileid: "86444095"
---
# <a name="retargeting-changes-for-migration-from-net-framework-461-to-462"></a><span data-ttu-id="2a9d2-103">Przekierowywanie zmian dotyczących migracji z .NET Framework 4.6.1 do 4.6.2</span><span class="sxs-lookup"><span data-stu-id="2a9d2-103">Retargeting Changes for Migration from .NET Framework 4.6.1 to 4.6.2</span></span>

[!INCLUDE[versionselector](../../../../includes/migration-guide/retargeting/versionselector.md)]

<span data-ttu-id="2a9d2-104">Jeśli przeprowadzasz migrację z .NET Framework 4.6.1 do 4.6.2, zapoznaj się z następującymi tematami dotyczącymi problemów ze zgodnością aplikacji, które mogą mieć wpływ na aplikację:</span><span class="sxs-lookup"><span data-stu-id="2a9d2-104">If you are migrating from the .NET Framework 4.6.1 to 4.6.2, review the following topics for application compatibility issues that may affect your app:</span></span>

## <a name="aspnet"></a><span data-ttu-id="2a9d2-105">ASP.NET</span><span class="sxs-lookup"><span data-stu-id="2a9d2-105">ASP.NET</span></span>
...
## <a name="core"></a><span data-ttu-id="2a9d2-106">Core</span><span class="sxs-lookup"><span data-stu-id="2a9d2-106">Core</span></span>
...
## <a name="security"></a><span data-ttu-id="2a9d2-107">Zabezpieczenia</span><span class="sxs-lookup"><span data-stu-id="2a9d2-107">Security</span></span>
...
## <a name="windows-communication-foundation-wcf"></a><span data-ttu-id="2a9d2-108">Windows Communication Foundation (WCF)</span><span class="sxs-lookup"><span data-stu-id="2a9d2-108">Windows Communication Foundation (WCF)</span></span>
...
## <a name="windows-forms"></a><span data-ttu-id="2a9d2-109">Windows Forms</span><span class="sxs-lookup"><span data-stu-id="2a9d2-109">Windows Forms</span></span>
...
## <a name="windows-presentation-foundation-wpf"></a><span data-ttu-id="2a9d2-110">Windows Presentation Foundation (WPF)</span><span class="sxs-lookup"><span data-stu-id="2a9d2-110">Windows Presentation Foundation (WPF)</span></span>
