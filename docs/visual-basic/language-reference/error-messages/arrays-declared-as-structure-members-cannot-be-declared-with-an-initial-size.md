...
---
# <a name="arrays-declared-as-structure-members-cannot-be-declared-with-an-initial-size"></a>Tablice deklarowane jako elementy członkowskie struktury nie mogą być deklarowane z rozmiarem początkowym
