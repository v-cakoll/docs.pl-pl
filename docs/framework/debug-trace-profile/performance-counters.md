...
ms.locfileid: "43525312"
---
# <a name="performance-counters-in-the-net-framework"></a>Liczniki wydajności w oprogramowaniu .NET Framework
Ten temat zawiera listę liczników wydajności można znaleźć w [monitora wydajności](https://technet.microsoft.com/library/cc749249.aspx).  
