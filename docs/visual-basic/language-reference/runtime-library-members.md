...
## <a name="microsoftvisualbasiccollection-class"></a><span data-ttu-id="81c24-106">Klasa Microsoft.VisualBasic.Collection</span><span class="sxs-lookup"><span data-stu-id="81c24-106">Microsoft.VisualBasic.Collection Class</span></span>  
...
## <a name="microsoftvisualbasiccomclassattribute-class"></a><span data-ttu-id="81c24-107">Klasa Microsoft.VisualBasic.ComClassAttribute</span><span class="sxs-lookup"><span data-stu-id="81c24-107">Microsoft.VisualBasic.ComClassAttribute Class</span></span>  
...
## <a name="microsoftvisualbasiccontrolchars-class"></a><span data-ttu-id="81c24-108">Klasa Microsoft.VisualBasic.ControlChars</span><span class="sxs-lookup"><span data-stu-id="81c24-108">Microsoft.VisualBasic.ControlChars Class</span></span>  
...
## <a name="microsoftvisualbasicconstants-class"></a><span data-ttu-id="81c24-109">Klasa Microsoft.VisualBasic.Constants</span><span class="sxs-lookup"><span data-stu-id="81c24-109">Microsoft.VisualBasic.Constants Class</span></span>  
...
## <a name="microsoftvisualbasicconversion-module"></a><span data-ttu-id="81c24-110">Moduł Microsoft.VisualBasic.Conversion</span><span class="sxs-lookup"><span data-stu-id="81c24-110">Microsoft.VisualBasic.Conversion Module</span></span>  
...
## <a name="microsoftvisualbasicdateandtime-module"></a><span data-ttu-id="81c24-111">Moduł Microsoft.VisualBasic.DateAndTime</span><span class="sxs-lookup"><span data-stu-id="81c24-111">Microsoft.VisualBasic.DateAndTime Module</span></span>  
...
## <a name="microsoftvisualbasicerrobject-class"></a><span data-ttu-id="81c24-112">Klasa Microsoft.VisualBasic.ErrObject</span><span class="sxs-lookup"><span data-stu-id="81c24-112">Microsoft.VisualBasic.ErrObject Class</span></span>  
...
## <a name="microsoftvisualbasicfilesystem-module"></a><span data-ttu-id="81c24-113">Moduł Microsoft.VisualBasic.FileSystem</span><span class="sxs-lookup"><span data-stu-id="81c24-113">Microsoft.VisualBasic.FileSystem Module</span></span>  
...
## <a name="microsoftvisualbasicfinancial-module"></a><span data-ttu-id="81c24-114">Moduł Microsoft.VisualBasic.Financial</span><span class="sxs-lookup"><span data-stu-id="81c24-114">Microsoft.VisualBasic.Financial Module</span></span>  
...
## <a name="microsoftvisualbasicglobals-module"></a><span data-ttu-id="81c24-115">Moduł Microsoft.VisualBasic.Globals</span><span class="sxs-lookup"><span data-stu-id="81c24-115">Microsoft.VisualBasic.Globals Module</span></span>  
...
## <a name="microsoftvisualbasichidemodulenameattribute-class"></a><span data-ttu-id="81c24-116">Klasa Microsoft.VisualBasic.HideModuleNameAttribute</span><span class="sxs-lookup"><span data-stu-id="81c24-116">Microsoft.VisualBasic.HideModuleNameAttribute Class</span></span>  
  
|||||  
|---|---|---|---|  
|<xref:Microsoft.VisualBasic.HideModuleNameAttribute>||||  
  
## <a name="microsoftvisualbasicinformation-module"></a><span data-ttu-id="81c24-117">Moduł Microsoft.VisualBasic.Information</span><span class="sxs-lookup"><span data-stu-id="81c24-117">Microsoft.VisualBasic.Information Module</span></span>  
...
## <a name="microsoftvisualbasicinteraction-module"></a><span data-ttu-id="81c24-118">Moduł Microsoft.VisualBasic.Interaction</span><span class="sxs-lookup"><span data-stu-id="81c24-118">Microsoft.VisualBasic.Interaction Module</span></span>  
...
## <a name="microsoftvisualbasicmygroupcollectionattribute-class"></a><span data-ttu-id="81c24-119">Klasa Microsoft.VisualBasic.MyGroupCollectionAttribute</span><span class="sxs-lookup"><span data-stu-id="81c24-119">Microsoft.VisualBasic.MyGroupCollectionAttribute Class</span></span>  
...
## <a name="microsoftvisualbasicstrings-module"></a><span data-ttu-id="81c24-120">Moduł Microsoft.VisualBasic.Strings</span><span class="sxs-lookup"><span data-stu-id="81c24-120">Microsoft.VisualBasic.Strings Module</span></span>  
...
## <a name="microsoftvisualbasicvbfixedarrayattribute-class"></a><span data-ttu-id="81c24-121">Klasa Microsoft.VisualBasic.VBFixedArrayAttribute</span><span class="sxs-lookup"><span data-stu-id="81c24-121">Microsoft.VisualBasic.VBFixedArrayAttribute Class</span></span>  
  
|||||  
|---|---|---|---|  
|<xref:Microsoft.VisualBasic.VBFixedArrayAttribute.Bounds%2A>|<xref:Microsoft.VisualBasic.VBFixedArrayAttribute.Length%2A>|||  
  
## <a name="microsoftvisualbasicvbfixedstringattribute-class"></a><span data-ttu-id="81c24-122">Klasa Microsoft.VisualBasic.VBFixedStringAttribute</span><span class="sxs-lookup"><span data-stu-id="81c24-122">Microsoft.VisualBasic.VBFixedStringAttribute Class</span></span>  
  
|||||  
|---|---|---|---|  
|<xref:Microsoft.VisualBasic.VBFixedStringAttribute.Length%2A>||||  
  
## <a name="microsoftvisualbasicvbmath-module"></a><span data-ttu-id="81c24-123">Moduł Microsoft.VisualBasic.VbMath</span><span class="sxs-lookup"><span data-stu-id="81c24-123">Microsoft.VisualBasic.VbMath Module</span></span>  
  
|||||  
|---|---|---|---|  
|<xref:Microsoft.VisualBasic.VBMath.Randomize%2A>|<xref:Microsoft.VisualBasic.VBMath.Rnd%2A>|||  
  
## <a name="microsoftvisualbasic-constants-and-enumerations"></a><span data-ttu-id="81c24-124">Microsoft.VisualBasic stałe i wyliczenia</span><span class="sxs-lookup"><span data-stu-id="81c24-124">Microsoft.VisualBasic Constants and Enumerations</span></span>  
 <span data-ttu-id="81c24-125">`Microsoft.VisualBasic` Przestrzeń nazw zawiera stałe i wyliczenia w ramach biblioteki wykonawczej języka Visual Basic.</span><span class="sxs-lookup"><span data-stu-id="81c24-125">The `Microsoft.VisualBasic` namespace provides constants and enumerations as part of the Visual Basic run-time library.</span></span> <span data-ttu-id="81c24-126">Te wartości stałych można użyć w kodzie.</span><span class="sxs-lookup"><span data-stu-id="81c24-126">You can use these constant values in your code.</span></span> <span data-ttu-id="81c24-127">Każde wyliczenie reprezentuje określonej kategorii funkcji.</span><span class="sxs-lookup"><span data-stu-id="81c24-127">Each enumeration represents a particular category of functionality.</span></span> <span data-ttu-id="81c24-128">Aby uzyskać więcej informacji, zobacz [stałe i wyliczenia](../../visual-basic/language-reference/constants-and-enumerations.md).</span><span class="sxs-lookup"><span data-stu-id="81c24-128">For more information, see [Constants and Enumerations](../../visual-basic/language-reference/constants-and-enumerations.md).</span></span>  
  
## <a name="see-also"></a><span data-ttu-id="81c24-129">Zobacz też</span><span class="sxs-lookup"><span data-stu-id="81c24-129">See Also</span></span>  
 [<span data-ttu-id="81c24-130">Stałe i wyliczenia</span><span class="sxs-lookup"><span data-stu-id="81c24-130">Constants and Enumerations</span></span>](../../visual-basic/language-reference/constants-and-enumerations.md)  
 [<span data-ttu-id="81c24-131">Słowa kluczowe</span><span class="sxs-lookup"><span data-stu-id="81c24-131">Keywords</span></span>](../../visual-basic/language-reference/keywords/index.md)
