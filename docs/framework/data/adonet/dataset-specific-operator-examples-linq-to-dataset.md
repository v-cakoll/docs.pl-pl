...
W przykładach w tym temacie pokazano, jak używać <xref:System.Data.DataTableExtensions.CopyToDataTable%2A> metody <xref:System.Data.DataRowComparer> i klasy.  
...
### <a name="example"></a>Przykład  
 Ten przykład ładuje <xref:System.Data.DataTable> wyniki zapytania przy <xref:System.Data.DataTableExtensions.CopyToDataTable%2A> użyciu metody.  
...
### <a name="example"></a>Przykład  
 Ten przykład porównuje dwa różne wiersze danych przy <xref:System.Data.DataRowComparer>użyciu.  
