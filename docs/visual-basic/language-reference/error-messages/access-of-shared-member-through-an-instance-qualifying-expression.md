...
---
# <a name="access-of-shared-member-through-an-instance-qualifying-expression-will-not-be-evaluated"></a>Dostęp do udostępnionej składowej przez wystąpienie; wyrażenie kwalifikujące nie zostanie obliczone
