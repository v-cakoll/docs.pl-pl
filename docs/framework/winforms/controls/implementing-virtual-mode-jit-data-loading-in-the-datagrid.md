...
## <a name="see-also"></a>Zobacz też  
 ...
 [Porady: Implementowanie trybu wirtualnego przy użyciu ładowania danych Just In Time w oknach formantu DataGridView formularzy](../../../../docs/framework/winforms/controls/virtual-mode-with-just-in-time-data-loading-in-the-datagrid.md)
