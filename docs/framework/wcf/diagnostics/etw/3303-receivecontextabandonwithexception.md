...
## <a name="description"></a>Opis  
 To zdarzenie jest emitowany, gdy porzucenia kontekstu odbierania nie powiodło się z powodu wyjątku.  
  
## <a name="message"></a>Komunikat  
 %1 został porzucony z powodu wyjątku %2.  
