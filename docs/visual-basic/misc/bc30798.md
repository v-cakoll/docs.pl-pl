...
[Importy — instrukcja (.NET Namespace i Type)](../../visual-basic/language-reference/statements/imports-statement-net-namespace-and-type.md) określa elementu programistycznego, którego nie można zaimportować.  
 ...
 Aby uzyskać więcej informacji, zobacz "Importowanie zawierających elementy" w [NOTINBUILD: Rozpoznawanie odwołania gdy wiele zmiennych mają taką samą nazwę](http://msdn.microsoft.com/en-us/9601e39f-1911-44e1-ace5-3f6e090408b9).  
