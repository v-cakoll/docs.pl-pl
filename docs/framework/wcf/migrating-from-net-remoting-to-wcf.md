...
4. Musimy zmodyfikować plik konfiguracji serwera, wykonując następujące dwie czynności, jak pokazano w poniższym przykładzie:  
    ...
    1. Zadeklaruj \<client> sekcję opisującą punkt końcowy dla obiektu sesji. Jest to konieczne, ponieważ serwer działa również jako klient w takiej sytuacji.  
