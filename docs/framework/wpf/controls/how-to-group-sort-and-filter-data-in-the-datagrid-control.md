...
3. W języku XAML Utwórz wystąpienie klasy <xref:System.Windows.Data.CollectionViewSource>, ustaw [dyrektywę x:Key](../../../desktop-wpf/xaml-services/xkey-directive.md)i ustaw wystąpienie klasy kolekcji jako <xref:System.Windows.Data.CollectionViewSource.Source%2A>.
