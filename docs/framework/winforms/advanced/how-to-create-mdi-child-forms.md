...
9. Wstawianie kodu podobne do następujących czynności, aby utworzyć nowy formularz podrzędny MDI, gdy użytkownik kliknie **New** elementu menu.
   ...
   W C++, Dodaj następujący kod `#include` dyrektywę w górnej części Form1.h:
...
11. Naciśnij klawisz **F5** do uruchomienia aplikacji. Wybierając **New** z **pliku** menu, można utworzyć nowych formularzy podrzędnych MDI, które są przechowywane informacje o w **okna** elementu menu.
