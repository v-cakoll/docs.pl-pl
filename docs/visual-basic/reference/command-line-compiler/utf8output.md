...
## <a name="arguments"></a>Argumenty  
 `+` &#124; `-`  
 Opcjonalna. Wartość domyślna dla tej opcji to `-utf8output-`, co oznacza, że wyjście kompilatora nie używa kodowania UTF-8. Określanie `-utf8output` jest takie samo jak określanie `-utf8output+`.  
