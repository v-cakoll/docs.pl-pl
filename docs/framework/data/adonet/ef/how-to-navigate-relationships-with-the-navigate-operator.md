...
---
# <a name="how-to-navigate-relationships-with-the-navigate-operator"></a>Porady: nawigowanie po relacjach za pomocą Przejdź — Operator
...
## <a name="example"></a>Przykład  
 Poniższy przykład przedstawia sposób nawigowanie po relacjach w [!INCLUDE[esql](../../../../../includes/esql-md.md)] za pomocą [Nawigacja](../../../../../docs/framework/data/adonet/ef/language-reference/navigate-entity-sql.md) operatora. `Navigate` Operator przyjmuje następujące parametry: wystąpienie jednostki, typu relacji, zakończenie relacji i początku relacji. Opcjonalnie można przekazać tylko wystąpienia jednostki i typ relacji do `Navigate` operatora.  
