...
## <a name="introduction-to-element-positioning"></a>Wprowadzenie do pozycjonowania elementu  
 ...
 ![WPF, na przykład właściwości pozycjonowania](./media/layout-margins-padding-alignment-graphic1.PNG "layout_margins_padding_alignment_graphic1")  
 ...
 ![Właściwości pozycjonowania z ekranu wywołać&#45;szczegółowymi informacjami dotyczącymi](./media/layout-margins-padding-alignment-graphic2.PNG "layout_margins_padding_alignment_graphic2")  
...
|<xref:System.Windows.HorizontalAlignment.Stretch> (Ustawienie domyślne)|Elementy podrzędne są rozciągnięte do wypełnienia elementu nadrzędnego układu przydzielonego miejsca. Jawne <xref:System.Windows.FrameworkElement.Width%2A> i <xref:System.Windows.FrameworkElement.Height%2A> wartości mają pierwszeństwo.|  
 ...
 ![Właściwości HorizontalAlignment](./media/layout-horizontal-alignment-graphic.PNG "layout_horizontal_alignment_graphic")  
