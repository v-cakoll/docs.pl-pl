...
---
# <a name="runtime-changes-for-migration-from-net-framework-462-to-472"></a>Zmiany środowiska uruchomieniowego do migracji z .NET Framework 4.6.2 — 4.7.2

[!INCLUDE[versionselector](../../../../includes/migration-guide/runtime/versionselector.md)]

[!INCLUDE[introduction](../../../../includes/migration-guide/runtime/introduction.md)]

Migracji z programu .NET Framework 4.6.2 — 4.7.2, zobacz następujące tematy dla problemów ze zgodnością aplikacji, które mogą wpływać na Twoją aplikację:
