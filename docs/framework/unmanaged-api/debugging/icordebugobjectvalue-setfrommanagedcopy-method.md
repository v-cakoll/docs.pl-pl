...
---
# <a name="icordebugobjectvaluesetfrommanagedcopy-method"></a>ICorDebugObjectValue::SetFromManagedCopy — Metoda
`SetFromManagedCopy` jest przestarzały. Nie wywołuj tej metody.  
