...
Transakcja określona otrzymano dla określonej operacji w transakcji InstanceContext.  
  
## <a name="description"></a>Opis  
 Śledzone Jeśli transakcji udostępnione do kodu użytkownika zostało pozostawione przez autouzupełniania = false metoda wywoływana przed tym wywołaniem.  
