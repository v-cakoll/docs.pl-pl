...
-   [Delegaty z metodami nazwanymi lub Metody anonimowe](../../../csharp/programming-guide/delegates/delegates-with-named-vs-anonymous-methods.md)  
...
-   [Instrukcje: Deklarowanie, tworzenie wystąpień i użycie delegata](../../../csharp/programming-guide/delegates/how-to-declare-instantiate-and-use-a-delegate.md)  
