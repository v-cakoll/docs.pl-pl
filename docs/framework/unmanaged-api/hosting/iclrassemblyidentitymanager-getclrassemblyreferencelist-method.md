...
Pobiera wskaźnik interfejsu do wystąpienia [ICLRAssemblyReferenceList](iclrassemblyreferencelist-interface.md) z podanej listy tożsamości zestawów częściowych.  
...
## <a name="parameters"></a>Parametry  
 ...
 `ppReferenceList`  
 określoną Wskaźnik interfejsu do `ICLRAssemblyReferenceList` obiektu, który zawiera dane tożsamości zestawu dla listy zestawów określonych w `ppwzAssemblyReferences` .  
