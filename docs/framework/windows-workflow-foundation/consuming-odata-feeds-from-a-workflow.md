...
> [!NOTE]
> Aby uzyskać więcej informacji, zobacz [Generowanie biblioteki klienta usługi danych (WCF Data Services)](../data/wcf/generating-the-data-service-client-library-wcf-data-services.md).
...
> [!NOTE]
> Aby uzyskać więcej informacji na temat stronicowania w usługach danych programu WCF zobacz [jak: Ładowanie stronicowanych wyników (WCF Data Services)](../data/wcf/how-to-load-paged-results-wcf-data-services.md).
...
## <a name="consuming-an-odata-feed-without-using-the-client-libraries"></a>Korzystanie ze źródłem danych OData źródła danych bez korzystania z bibliotek klienckich
