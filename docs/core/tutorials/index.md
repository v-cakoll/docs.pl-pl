...
- [Kompilowanie C# aplikacji Hello World](with-visual-studio.md)
...
- [Kompilowanie C# biblioteki klas](library-with-visual-studio.md)
...
## <a name="building-applications-with-visual-studio-for-mac"></a>Tworzenie aplikacji za pomocą Visual Studio dla komputerów Mac
