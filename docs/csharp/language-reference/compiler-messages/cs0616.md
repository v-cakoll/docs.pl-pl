...
"class" nie jest klasą atrybutu  
 ...
 Próbowano użyć klasy bez atrybutów w bloku atrybutu. Wszystkie typy atrybutów muszą być dziedziczone z <xref:System.Attribute?displayProperty=nameWithType>.  
