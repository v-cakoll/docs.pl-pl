...
## <a name="accessing-wmi-information"></a>Uzyskiwanie dostępu do informacji WMI  
 Dostęp do danych usługi WMI można uzyskać na wiele różnych sposobów. Firma Microsoft udostępnia interfejsy API usługi WMI dla skryptów, C++ aplikacji Visual Basic, aplikacji i .NET Framework (https://docs.microsoft.com/windows/desktop/wmisdk/using-wmi).  
