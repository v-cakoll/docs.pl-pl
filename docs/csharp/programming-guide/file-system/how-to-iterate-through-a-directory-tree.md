...
> [!NOTE]
> W systemie Windows terminy "katalog" i "folder" są używane zamiennie. Większość dokumentacji i tekstu interfejsu użytkownika używa terminu "folder", ale biblioteki klas .NET używają terminu "Directory".  
