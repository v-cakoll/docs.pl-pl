...
Tylko przypisania, wywołanie, inkrementacja, dekrementacja i wyrażenia nowego obiektu może służyć jako instrukcji  
 ...
 Kompilator generuje błąd, po napotkaniu nieprawidłowa instrukcja. Nieprawidłowa instrukcja jest dowolnym wierszu lub szeregu wiersze kończące się średnikiem, który nie reprezentuje przypisania ([=](../operators/assignment-operator.md)), wywołanie metody [()](../operators/invocation-operator.md), [nowe](../keywords/new.md), [ -- ](../operators/arithmetic-operators.md#decrement-operator---) lub [ ++ ](../operators/arithmetic-operators.md#increment-operator-) operacji. Aby uzyskać więcej informacji, zobacz [instrukcje, wyrażenia i operatory](../../programming-guide/statements-expressions-operators/index.md).  
