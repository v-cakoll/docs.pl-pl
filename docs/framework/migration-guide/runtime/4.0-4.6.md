...
ms.locfileid: "85622432"
---
# <a name="runtime-changes-for-migration-from-net-framework-40-to-46"></a><span data-ttu-id="b284b-102">Zmiany w czasie wykonywania migracji z .NET Framework 4,0 do 4,6</span><span class="sxs-lookup"><span data-stu-id="b284b-102">Runtime Changes for Migration from .NET Framework 4.0 to 4.6</span></span>

[!INCLUDE[versionselector](../../../../includes/migration-guide/runtime/versionselector.md)]

<span data-ttu-id="b284b-103">W przypadku migrowania z .NET Framework 4,0 do 4,6 zapoznaj się z następującymi tematami dotyczącymi problemów ze zgodnością aplikacji, które mogą mieć wpływ na aplikację:</span><span class="sxs-lookup"><span data-stu-id="b284b-103">If you are migrating from the .NET Framework 4.0 to 4.6, review the following topics for application compatibility issues that may affect your app:</span></span>

## <a name="adonet"></a><span data-ttu-id="b284b-104">ADO.NET</span><span class="sxs-lookup"><span data-stu-id="b284b-104">ADO.NET</span></span>
...
## <a name="aspnet"></a><span data-ttu-id="b284b-105">ASP.NET</span><span class="sxs-lookup"><span data-stu-id="b284b-105">ASP.NET</span></span>
...
## <a name="core"></a><span data-ttu-id="b284b-106">Core</span><span class="sxs-lookup"><span data-stu-id="b284b-106">Core</span></span>
...
## <a name="data"></a><span data-ttu-id="b284b-107">Dane</span><span class="sxs-lookup"><span data-stu-id="b284b-107">Data</span></span>
...
## <a name="entity-framework"></a><span data-ttu-id="b284b-108">Entity Framework</span><span class="sxs-lookup"><span data-stu-id="b284b-108">Entity Framework</span></span>
...
## <a name="linq"></a><span data-ttu-id="b284b-109">LINQ</span><span class="sxs-lookup"><span data-stu-id="b284b-109">LINQ</span></span>
...
## <a name="managed-extensibility-framework-mef"></a><span data-ttu-id="b284b-110">Managed Extensibility Framework (MEF)</span><span class="sxs-lookup"><span data-stu-id="b284b-110">Managed Extensibility Framework (MEF)</span></span>
...
## <a name="networking"></a><span data-ttu-id="b284b-111">Networking</span><span class="sxs-lookup"><span data-stu-id="b284b-111">Networking</span></span>
...
## <a name="printing"></a><span data-ttu-id="b284b-112">Drukowanie</span><span class="sxs-lookup"><span data-stu-id="b284b-112">Printing</span></span>
...
## <a name="serialization"></a><span data-ttu-id="b284b-113">Serializacja</span><span class="sxs-lookup"><span data-stu-id="b284b-113">Serialization</span></span>
...
## <a name="setup-and-deployment"></a><span data-ttu-id="b284b-114">Instalacja i wdrożenie</span><span class="sxs-lookup"><span data-stu-id="b284b-114">Setup and Deployment</span></span>
...
## <a name="web-applications"></a><span data-ttu-id="b284b-115">Aplikacje internetowe</span><span class="sxs-lookup"><span data-stu-id="b284b-115">Web Applications</span></span>
...
## <a name="windows-communication-foundation-wcf"></a><span data-ttu-id="b284b-116">Windows Communication Foundation (WCF)</span><span class="sxs-lookup"><span data-stu-id="b284b-116">Windows Communication Foundation (WCF)</span></span>
...
## <a name="windows-forms"></a><span data-ttu-id="b284b-117">Windows Forms</span><span class="sxs-lookup"><span data-stu-id="b284b-117">Windows Forms</span></span>
...
## <a name="windows-presentation-foundation-wpf"></a><span data-ttu-id="b284b-118">Windows Presentation Foundation (WPF)</span><span class="sxs-lookup"><span data-stu-id="b284b-118">Windows Presentation Foundation (WPF)</span></span>
...
## <a name="windows-workflow-foundation-wf"></a><span data-ttu-id="b284b-119">Program Windows Workflow Foundation (WF)</span><span class="sxs-lookup"><span data-stu-id="b284b-119">Windows Workflow Foundation (WF)</span></span>
...
## <a name="xml-xslt"></a><span data-ttu-id="b284b-120">Języki XML, XSLT</span><span class="sxs-lookup"><span data-stu-id="b284b-120">XML, XSLT</span></span>
