...
5.  W tym momencie masz kolekcję punktów końcowych usługi. [!INCLUDE[crabout](../../../../includes/crabout-md.md)]Importowanie metadanych, zobacz [porady: Importowanie metadanych do punktów końcowych usług](../../../../docs/framework/wcf/feature-details/how-to-import-metadata-into-service-endpoints.md).  
