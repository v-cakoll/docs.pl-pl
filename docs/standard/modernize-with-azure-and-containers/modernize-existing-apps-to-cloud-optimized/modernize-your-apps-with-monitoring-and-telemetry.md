...
description: Modernizacji istniejących aplikacji .NET z kontenerami chmury Azure i systemu Windows | Modernizacji aplikacjami za pomocą monitorowania i telemetrii
