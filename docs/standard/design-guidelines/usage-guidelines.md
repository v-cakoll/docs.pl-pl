...
Ta sekcja zawiera wskazówki dotyczące korzystania z popularnych typów w publicznie dostępne interfejsy API. Dotyczy on bezpośredniego użycia wbudowanych typów Framework (np. serializacji atrybutów) i przeciążanie operatorów wspólnej.
