...
W tym temacie `My.Computer.Ports` opisano sposób wysyłania ciągów do portów szeregowych komputera w języku Visual Basic.  
  
## <a name="example"></a>Przykład  

 W tym przykładzie wysyła ciąg do portu szeregowego COM1. Może być konieczne użycie innego portu szeregowego na komputerze.  
 ...
 Blok `Using` umożliwia aplikacji, aby zamknąć port szeregowy, nawet jeśli generuje wyjątek. Cały kod, który manipuluje portem szeregowym powinny pojawić się w tym bloku lub w `Try...Catch...Finally` bloku.  
