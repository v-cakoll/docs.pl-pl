...
---
# <a name="runtime-changes-for-migration-from-net-framework-46-to-48"></a>Zmiany w czasie wykonywania migracji z programu .NET Framework 4.6 do 4.8

[!INCLUDE[versionselector](../../../../includes/migration-guide/runtime/versionselector.md)]

W przypadku migracji z programu .NET Framework 4.6 do 4.8 zapoznaj się z następującymi tematami dotyczącymi problemów ze zgodnością aplikacji, które mogą mieć wpływ na aplikację:
