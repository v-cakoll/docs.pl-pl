...
|**/Serialization:**  *opcja\<>*|Generuje klasy, które można serializować.<br /><br /> *Prawidłowe\<> opcji*: Brak, jednokierunkowe. Wartość domyślna: Brak.<br /><br /> Aby uzyskać więcej informacji, zobacz [serializacji](../data/adonet/sql/linq/serialization.md).|  
...
- [Instrukcje: Generuj model obiektów w Visual Basic lubC#](../data/adonet/sql/linq/how-to-generate-the-object-model-in-visual-basic-or-csharp.md)
