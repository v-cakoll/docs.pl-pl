...
"class" nie jest klasą atrybutu  
  
 Próbowano użyć klasy bez atrybutów w bloku attribute. Wszystkie typy atrybutów muszą być dziedziczone z <xref:System.Attribute?displayProperty=nameWithType>.  
...
## <a name="example"></a>Przykład  
 Poniższy przykład pokazuje, jak można zdefiniować atrybutu:  
