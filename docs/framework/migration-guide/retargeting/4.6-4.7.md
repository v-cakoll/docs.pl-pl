...
---
# <a name="retargeting-changes-for-migration-from-net-framework-46-to-47"></a>Przekierowywanie zmian dotyczących migracji z .NET Framework 4,6 do 4,7

[!INCLUDE[versionselector](../../../../includes/migration-guide/retargeting/versionselector.md)]

W przypadku migrowania z .NET Framework 4,6 do 4,7 zapoznaj się z następującymi tematami dotyczącymi problemów ze zgodnością aplikacji, które mogą mieć wpływ na aplikację:
