...
## <a name="description"></a>Opis  
 To zdarzenie wskazuje, czy żądanie usługi WMI, którym nie została przetworzona. Zdarzenie Wyświetla listę wyjątków, nazwa procesu i identyfikatora procesu.  
