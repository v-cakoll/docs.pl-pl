...
---
# <a name="runtime-changes-for-migration-from-net-framework-451-to-452"></a><span data-ttu-id="c9e78-102">Zmiany w środowisku uruchomieniowym dotyczące migracji z .NET Framework 4.5.1 do 4.5.2</span><span class="sxs-lookup"><span data-stu-id="c9e78-102">Runtime Changes for Migration from .NET Framework 4.5.1 to 4.5.2</span></span>

[!INCLUDE[versionselector](../../../../includes/migration-guide/runtime/versionselector.md)]

<span data-ttu-id="c9e78-103">W przypadku migrowania z .NET Framework 4.5.1 do 4.5.2 zapoznaj się z następującymi tematami dotyczącymi problemów ze zgodnością aplikacji, które mogą mieć wpływ na aplikację:</span><span class="sxs-lookup"><span data-stu-id="c9e78-103">If you are migrating from the .NET Framework 4.5.1 to 4.5.2, review the following topics for application compatibility issues that may affect your app:</span></span>

## <a name="aspnet"></a><span data-ttu-id="c9e78-104">Platforma ASP.NET</span><span class="sxs-lookup"><span data-stu-id="c9e78-104">ASP.NET</span></span>
...
## <a name="data"></a><span data-ttu-id="c9e78-105">Dane</span><span class="sxs-lookup"><span data-stu-id="c9e78-105">Data</span></span>
...
## <a name="entity-framework"></a><span data-ttu-id="c9e78-106">Entity Framework</span><span class="sxs-lookup"><span data-stu-id="c9e78-106">Entity Framework</span></span>
...
## <a name="windows-presentation-foundation-wpf"></a><span data-ttu-id="c9e78-107">Windows Presentation Foundation (WPF)</span><span class="sxs-lookup"><span data-stu-id="c9e78-107">Windows Presentation Foundation (WPF)</span></span>
