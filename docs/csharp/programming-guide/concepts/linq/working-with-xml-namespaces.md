...
|[Porady: Tworzenie dokumentu z przestrzeniami nazw (C#) (LINQ to XML)](../../../../csharp/programming-guide/concepts/linq/how-to-create-a-document-with-namespaces-linq-to-xml.md)|Pokazuje, jak tworzyć dokumenty z przestrzeni nazw.|  
|[Porady: kontrolowanie prefiksów Namespace (C#) (LINQ to XML)](../../../../csharp/programming-guide/concepts/linq/how-to-control-namespace-prefixes-linq-to-xml.md)|Pokazuje, jak kontrolowanie prefiksów przestrzeni nazw przez wstawienie atrybutów obszaru nazw do drzewa XML.|  
