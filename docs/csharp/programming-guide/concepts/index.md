...
|[Zapytanie zintegrowane z językiem (LINQ)C#()](./linq/index.md)|Omawia zaawansowane możliwości zapytań w składni języka programu C#oraz model służący do wykonywania zapytań dotyczących relacyjnych baz danych, dokumentów XML, zestawów danych i kolekcji w pamięci.|  
...
|[OdbicieC#()](./reflection.md)|Wyjaśnia, jak używać odbicia do dynamicznego tworzenia wystąpienia typu, powiązać typ z istniejącym obiektem lub uzyskać typ z istniejącego obiektu i wywołać jego metody lub uzyskać dostęp do jego pól i właściwości.|  
