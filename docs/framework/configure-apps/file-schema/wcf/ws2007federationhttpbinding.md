...
|`privacyNoticeAt`|Identyfikator URI, w której znajduje się powiadomienie dotyczące prywatności.|
|`privacyNoticeVersion`|Wersja bieżąca powiadomienie dotyczące prywatności.|
