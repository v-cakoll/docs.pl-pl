...
---
# <a name="runtime-changes-for-migration-from-net-framework-45-to-46"></a>Zmiany środowiska uruchomieniowego w przypadku migracji z .NET Framework 4.5 i 4.6

[!INCLUDE[versionselector](../../../../includes/migration-guide/runtime/versionselector.md)]

[!INCLUDE[introduction](../../../../includes/migration-guide/runtime/introduction.md)]

Jeśli są migrowane z programu .NET Framework 4.5, 4.6, przejrzyj problemy ze zgodnością aplikacji, które mogą wpływać na Twoją aplikację w poniższych tematach:
