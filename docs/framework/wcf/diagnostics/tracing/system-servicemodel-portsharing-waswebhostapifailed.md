...
## <a name="description"></a>Opis  
 Podczas wywoływania określonego Windows Process Activation Service (WAS) interfejsu API nie powiodło się, podając mu kod błędu określony.  
