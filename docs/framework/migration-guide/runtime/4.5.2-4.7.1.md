---
title: Zmiany w środowisku uruchomieniowym dotyczące migracji z .NET Framework 4.5.2 do 4.7.1
description: Znajdź informacje o problemach ze zgodnością aplikacji w czasie wykonywania, które mogą mieć wpływ na aplikację podczas migrowania z .NET Framework 4.5.2 do 4.7.1.
ms.date: 07/10/2019
...
ms.locfileid: "86442223"
---
# <a name="runtime-changes-for-migration-from-net-framework-452-to-471"></a><span data-ttu-id="a525e-103">Zmiany w środowisku uruchomieniowym dotyczące migracji z .NET Framework 4.5.2 do 4.7.1</span><span class="sxs-lookup"><span data-stu-id="a525e-103">Runtime Changes for Migration from .NET Framework 4.5.2 to 4.7.1</span></span>

[!INCLUDE[versionselector](../../../../includes/migration-guide/runtime/versionselector.md)]

<span data-ttu-id="a525e-104">W przypadku migrowania z .NET Framework 4.5.2 do 4.7.1 zapoznaj się z następującymi tematami dotyczącymi problemów ze zgodnością aplikacji, które mogą mieć wpływ na aplikację:</span><span class="sxs-lookup"><span data-stu-id="a525e-104">If you are migrating from the .NET Framework 4.5.2 to 4.7.1, review the following topics for application compatibility issues that may affect your app:</span></span>

## <a name="aspnet"></a><span data-ttu-id="a525e-105">ASP.NET</span><span class="sxs-lookup"><span data-stu-id="a525e-105">ASP.NET</span></span>
...
## <a name="core"></a><span data-ttu-id="a525e-106">Core</span><span class="sxs-lookup"><span data-stu-id="a525e-106">Core</span></span>
...
## <a name="data"></a><span data-ttu-id="a525e-107">Dane</span><span class="sxs-lookup"><span data-stu-id="a525e-107">Data</span></span>
...
## <a name="debugger"></a><span data-ttu-id="a525e-108">Debuger</span><span class="sxs-lookup"><span data-stu-id="a525e-108">Debugger</span></span>
...
## <a name="globalization"></a><span data-ttu-id="a525e-109">Globalizacja</span><span class="sxs-lookup"><span data-stu-id="a525e-109">Globalization</span></span>
...
## <a name="networking"></a><span data-ttu-id="a525e-110">Sieć</span><span class="sxs-lookup"><span data-stu-id="a525e-110">Networking</span></span>
...
## <a name="security"></a><span data-ttu-id="a525e-111">Zabezpieczenia</span><span class="sxs-lookup"><span data-stu-id="a525e-111">Security</span></span>
...
## <a name="serialization"></a><span data-ttu-id="a525e-112">Serializacja</span><span class="sxs-lookup"><span data-stu-id="a525e-112">Serialization</span></span>
...
## <a name="setup-and-deployment"></a><span data-ttu-id="a525e-113">Instalacja i wdrożenie</span><span class="sxs-lookup"><span data-stu-id="a525e-113">Setup and Deployment</span></span>
...
## <a name="tools"></a><span data-ttu-id="a525e-114">Narzędzia</span><span class="sxs-lookup"><span data-stu-id="a525e-114">Tools</span></span>

[!INCLUDE[Contract.Invariant or Contract.Requires\<TException> do not consider String.IsNullOrEmpty to be pure](~/includes/migration-guide/runtime/tools/contractinvariant-contractrequirestexception-do-not-consider.md)]

## <a name="windows-communication-foundation-wcf"></a><span data-ttu-id="a525e-115">Windows Communication Foundation (WCF)</span><span class="sxs-lookup"><span data-stu-id="a525e-115">Windows Communication Foundation (WCF)</span></span>
...
## <a name="windows-presentation-foundation-wpf"></a><span data-ttu-id="a525e-116">Windows Presentation Foundation (WPF)</span><span class="sxs-lookup"><span data-stu-id="a525e-116">Windows Presentation Foundation (WPF)</span></span>
...
## <a name="windows-workflow-foundation-wf"></a><span data-ttu-id="a525e-117">Program Windows Workflow Foundation (WF)</span><span class="sxs-lookup"><span data-stu-id="a525e-117">Windows Workflow Foundation (WF)</span></span>
