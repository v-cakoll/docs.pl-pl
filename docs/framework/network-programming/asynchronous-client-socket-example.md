---
title: Przykład gniazda asynchroniczne klienta
ms.date: 03/30/2017
dev_langs:
- csharp
- vb
...
## <a name="see-also"></a><span data-ttu-id="25991-106">Zobacz też</span><span class="sxs-lookup"><span data-stu-id="25991-106">See Also</span></span>  
 [<span data-ttu-id="25991-107">Przykład asynchronicznego gniazda serwera</span><span class="sxs-lookup"><span data-stu-id="25991-107">Asynchronous Server Socket Example</span></span>](../../../docs/framework/network-programming/asynchronous-server-socket-example.md)  
 [<span data-ttu-id="25991-108">Używanie synchronicznego gniazda serwera</span><span class="sxs-lookup"><span data-stu-id="25991-108">Using a Synchronous Server Socket</span></span>](../../../docs/framework/network-programming/using-a-synchronous-server-socket.md)  
 [<span data-ttu-id="25991-109">Przykłady kodu gniazd</span><span class="sxs-lookup"><span data-stu-id="25991-109">Socket Code Examples</span></span>](../../../docs/framework/network-programming/socket-code-examples.md)
