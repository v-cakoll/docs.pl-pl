...
## <a name="description"></a>Opis  
 To zdarzenie oznacza, że wystąpił błąd podczas uruchamiania inicjatora DllHost. Zdarzenia wyświetlane AppID, wyjątek, nazwa procesu i identyfikatora procesu.  
