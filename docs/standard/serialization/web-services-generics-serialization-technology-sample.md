...
## <a name="remarks"></a>Uwagi  
 Przykład przedstawia domyślnej strony ASP.NET, która zawiera łącza do definicji usługi sieci Web. Można dostosować wyświetlanie oprócz zmodyfikowanie kodu źródłowego dla usługi sieci Web. Aby uzyskać więcej informacji, zobacz [klientami usługi sieci Web XML budynku](http://msdn.microsoft.com/library/c606f3cb-4111-45b4-ae42-9300420fa16c).  
