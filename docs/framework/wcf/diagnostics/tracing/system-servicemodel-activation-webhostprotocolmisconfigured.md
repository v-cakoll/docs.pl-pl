...
Protokół jest niepoprawnie skonfigurowany w Windows Process Activation Service (WAS).  
  
## <a name="description"></a>Opis  
 Ten błąd występuje, gdy protokół transportu jest niepoprawnie skonfigurowany.  
  
## <a name="troubleshooting"></a>Rozwiązywanie problemów  
 Sprawdź i napraw transportu parametry konfiguracji w pliku web.config.  
