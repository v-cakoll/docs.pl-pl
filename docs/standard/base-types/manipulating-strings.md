...
## <a name="in-this-section"></a>W tej sekcji  
 ...
 Sprawdza, czy sortowanie ciągów, porównania i metod wielkość liter w .NET i zawiera zalecenia dotyczące wybierania metody obsługi ciągów.  
  
 [Wyrażeń regularnych programu .NET](../../../docs/standard/base-types/regular-expressions.md)  
 Zawiera szczegółowe informacje o wyrażeniach regularnych programu .NET, w tym elementy języka, zachowania wyrażeń regularnych i przykłady.  
...
## <a name="related-sections"></a>Sekcje pokrewne  
 ...
 Zawiera opis sposobu zainicjowania obiekty do wartości opisanego przez ciąg reprezentacje tych obiektów. Analiza jest odwrotny operacji formatowania.
