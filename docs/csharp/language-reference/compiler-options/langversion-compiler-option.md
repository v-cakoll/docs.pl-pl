...
|latest|Kompilator akceptuje całą poprawną składnię języka od najnowszej wersji (w tym wydań pomocniczych), którą może obsłużyć.|
...
|C#6,0|[Link](/dotnet/csharp/language-reference/language-specification/introduction)|C#Specyfikacja języka w wersji 6 — nieoficjalne wersje robocze: .NET Foundation|
