...
> [!NOTE]
> [!INCLUDE[vbtecdlinq](../../../../../../includes/vbtecdlinq-md.md)]nie rozpoznaje operacji kaskadowego usuwania. Jeśli chcesz usunąć wiersz z tabeli zawierającej ograniczenia, zobacz [How to: Usuń wiersze z bazy danych](how-to-delete-rows-from-the-database.md).  
