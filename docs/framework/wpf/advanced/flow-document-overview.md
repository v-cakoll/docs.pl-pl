...
## <a name="what-is-a-flow-document"></a>Co to jest dokument usługi Flow  
 ...
 ![Przepływ zawartości przepełnieniem dokumentu](./media/edocs-flowdocument.png "eDocs_FlowDocument")  
...
### <a name="richtextbox"></a>RichTextBox  
 Możesz użyć <xref:System.Windows.Controls.RichTextBox> kiedy chcesz umożliwić użytkownikowi edytować zawartość usługi flow. Na przykład, jeśli chcesz utworzyć Edytor który może użytkownika do manipulowania rzeczy, takich jak tabele, kursywa i bold formatowanie itp, należy użyć <xref:System.Windows.Controls.RichTextBox>. Zobacz [RichTextBox — Przegląd](../controls/richtextbox-overview.md) Aby uzyskać więcej informacji.  
 ...
 **zakres**  
 ...
 ![Zrzut ekranu: Renderowany przykład zakresu](./media/flow-spanexample.gif "Flow_SpanExample")  
 ...
 **Ilustracja i Floater**  
 ...
 ![Zrzut ekranu: Przykład rysunek](./media/flow-ovw-figure-example.png "Flow_Ovw_Figure_Example")  
 ...
 **Uwaga:** Trzeci typ kolekcji używane z zawartości przepływu <xref:System.Windows.Documents.ListItemCollection>, ale ta kolekcja jest używana tylko z <xref:System.Windows.Documents.List>. Ponadto, istnieje kilka kolekcje używane z <xref:System.Windows.Documents.Table>. Zobacz [Omówienie tabel](table-overview.md) Aby uzyskać więcej informacji.  
...
### <a name="text-decorations"></a>Dekoracje tekstu  
 ...
 ![Zrzut ekranu: Tekst domyślny przekreślenia efekt](./media/inline-textdec-strike.png "Inline_TextDec_Strike")  
  
 Następujące wartości Pokaż sposób, w jaki **Nadkreślenia**, **linii bazowej**, i **Underline** dekoracje renderowania, odpowiednio.  
  
 ![Zrzut ekranu: Overline TextDecorator](./media/inline-textdec-over.png "Inline_TextDec_Over")  
  
 ![Zrzut ekranu: Domyślny punkt odniesienia wpływu na tekst](./media/inline-textdec-base.png "Inline_TextDec_Base")  
