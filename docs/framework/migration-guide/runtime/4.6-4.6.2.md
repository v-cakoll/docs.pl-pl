---
title: Zmiany w środowisku uruchomieniowym dotyczące migracji z .NET Framework 4,6 do 4.6.2
description: Znajdź informacje o problemach ze zgodnością aplikacji w czasie wykonywania, które mogą mieć wpływ na aplikację podczas migracji z .NET Framework 4,6 do 4.6.2.
ms.date: 07/10/2019
...
ms.locfileid: "86444043"
---
# <a name="runtime-changes-for-migration-from-net-framework-46-to-462"></a><span data-ttu-id="a962b-103">Zmiany w środowisku uruchomieniowym dotyczące migracji z .NET Framework 4,6 do 4.6.2</span><span class="sxs-lookup"><span data-stu-id="a962b-103">Runtime Changes for Migration from .NET Framework 4.6 to 4.6.2</span></span>

[!INCLUDE[versionselector](../../../../includes/migration-guide/runtime/versionselector.md)]

<span data-ttu-id="a962b-104">W przypadku migrowania z .NET Framework 4,6 do usługi 4.6.2 zapoznaj się z następującymi tematami dotyczącymi problemów ze zgodnością aplikacji, które mogą mieć wpływ na aplikację:</span><span class="sxs-lookup"><span data-stu-id="a962b-104">If you are migrating from the .NET Framework 4.6 to 4.6.2, review the following topics for application compatibility issues that may affect your app:</span></span>

## <a name="data"></a><span data-ttu-id="a962b-105">Dane</span><span class="sxs-lookup"><span data-stu-id="a962b-105">Data</span></span>
...
## <a name="globalization"></a><span data-ttu-id="a962b-106">Globalizacja</span><span class="sxs-lookup"><span data-stu-id="a962b-106">Globalization</span></span>
...
## <a name="security"></a><span data-ttu-id="a962b-107">Zabezpieczenia</span><span class="sxs-lookup"><span data-stu-id="a962b-107">Security</span></span>
...
## <a name="tools"></a><span data-ttu-id="a962b-108">Narzędzia</span><span class="sxs-lookup"><span data-stu-id="a962b-108">Tools</span></span>

[!INCLUDE[Contract.Invariant or Contract.Requires\<TException> do not consider String.IsNullOrEmpty to be pure](~/includes/migration-guide/runtime/tools/contractinvariant-contractrequirestexception-do-not-consider.md)]

## <a name="windows-communication-foundation-wcf"></a><span data-ttu-id="a962b-109">Windows Communication Foundation (WCF)</span><span class="sxs-lookup"><span data-stu-id="a962b-109">Windows Communication Foundation (WCF)</span></span>
...
## <a name="windows-presentation-foundation-wpf"></a><span data-ttu-id="a962b-110">Windows Presentation Foundation (WPF)</span><span class="sxs-lookup"><span data-stu-id="a962b-110">Windows Presentation Foundation (WPF)</span></span>
