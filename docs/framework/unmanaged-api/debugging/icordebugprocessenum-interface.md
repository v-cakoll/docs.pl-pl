...
|Metoda|Opis|  
|------------|-----------------|  
|[Next, metoda](../../../../docs/framework/unmanaged-api/debugging/icordebugprocessenum-next-method.md)|Pobiera określoną liczbę `ICorDebugProcess` wystąpień z wyliczenia, rozpoczynając od bieżącego położenia.|  
