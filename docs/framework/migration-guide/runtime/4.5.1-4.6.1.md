...
---
# <a name="runtime-changes-for-migration-from-net-framework-451-to-461"></a>Zmiany środowiska uruchomieniowego do migracji z systemu .NET Framework 4.5.1 wersji 4.6.1

[!INCLUDE[versionselector](../../../../includes/migration-guide/runtime/versionselector.md)]

[!INCLUDE[introduction](../../../../includes/migration-guide/runtime/introduction.md)]

W przypadku migracji z programu .NET Framework 4.5.1 lub 4.6.1, należy przejrzeć następujące tematy dla problemów ze zgodnością aplikacji, które mogą wpływać na aplikację:
