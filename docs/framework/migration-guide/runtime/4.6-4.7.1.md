...
---
# <a name="runtime-changes-for-migration-from-net-framework-46-to-471"></a>Zmiany środowiska uruchomieniowego do migracji z platformy .NET Framework 4.6 lub 4.7.1
