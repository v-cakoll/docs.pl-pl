...
"Metoda": nie wszystkie ścieżki kodu zwracają wartość
 ...
 Metoda zwracająca wartość musi mieć instrukcję `return` we wszystkich ścieżkach kodu. Aby uzyskać więcej informacji, zobacz [metody](../programming-guide/classes-and-structs/methods.md).
