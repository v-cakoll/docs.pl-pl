...
### <a name="localization"></a>Lokalizacja  
 W przypadku zasobów, które mają być lokalizowane izolowane słowników, które została scalona z podstawowego słowników i przechowywane jako luźne [!INCLUDE[TLA2#tla_xaml](../../../../includes/tla2sharptla-xaml-md.md)], te pliki, które może być lokalizowana oddzielnie. Ta technika jest uproszczone alternatywą do lokalizowania zestawów zasobów satelickich. Aby uzyskać więcej informacji, zobacz [Przegląd lokalizacja i globalizacja WPF](../../../../docs/framework/wpf/advanced/wpf-globalization-and-localization-overview.md).  
