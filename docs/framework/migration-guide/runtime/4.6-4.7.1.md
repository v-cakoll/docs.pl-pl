...
ms.locfileid: "73086752"
---
# <a name="runtime-changes-for-migration-from-net-framework-46-to-471"></a><span data-ttu-id="98191-102">Zmiany w środowisku uruchomieniowym dotyczące migracji z .NET Framework 4,6 do 4.7.1</span><span class="sxs-lookup"><span data-stu-id="98191-102">Runtime Changes for Migration from .NET Framework 4.6 to 4.7.1</span></span>

[!INCLUDE[versionselector](../../../../includes/migration-guide/runtime/versionselector.md)]

[!INCLUDE[introduction](../../../../includes/migration-guide/runtime/introduction.md)]

<span data-ttu-id="98191-103">W przypadku migrowania z .NET Framework 4,6 do usługi 4.7.1 zapoznaj się z następującymi tematami dotyczącymi problemów ze zgodnością aplikacji, które mogą mieć wpływ na aplikację:</span><span class="sxs-lookup"><span data-stu-id="98191-103">If you are migrating from the .NET Framework 4.6 to 4.7.1, review the following topics for application compatibility issues that may affect your app:</span></span>

## <a name="data"></a><span data-ttu-id="98191-104">Dane</span><span class="sxs-lookup"><span data-stu-id="98191-104">Data</span></span>
...
## <a name="globalization"></a><span data-ttu-id="98191-105">Globalizacja</span><span class="sxs-lookup"><span data-stu-id="98191-105">Globalization</span></span>
...
## <a name="security"></a><span data-ttu-id="98191-106">Zabezpieczenia</span><span class="sxs-lookup"><span data-stu-id="98191-106">Security</span></span>
...
## <a name="tools"></a><span data-ttu-id="98191-107">Narzędzia</span><span class="sxs-lookup"><span data-stu-id="98191-107">Tools</span></span>

[!INCLUDE[Contract.Invariant or Contract.Requires\<TException> do not consider String.IsNullOrEmpty to be pure](~/includes/migration-guide/runtime/tools/contractinvariant-contractrequirestexception-do-not-consider.md)]

## <a name="windows-communication-foundation-wcf"></a><span data-ttu-id="98191-108">Windows Communication Foundation (WCF)</span><span class="sxs-lookup"><span data-stu-id="98191-108">Windows Communication Foundation (WCF)</span></span>
...
## <a name="windows-presentation-foundation-wpf"></a><span data-ttu-id="98191-109">Windows Presentation Foundation (WPF)</span><span class="sxs-lookup"><span data-stu-id="98191-109">Windows Presentation Foundation (WPF)</span></span>
...
## <a name="windows-workflow-foundation-wf"></a><span data-ttu-id="98191-110">Program Windows Workflow Foundation (WF)</span><span class="sxs-lookup"><span data-stu-id="98191-110">Windows Workflow Foundation (WF)</span></span>
