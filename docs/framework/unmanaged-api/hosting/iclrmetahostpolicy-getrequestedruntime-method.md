...
|ERROR_INSUFFICIENT_BUFFER|Pamięć przydzielona do `pwzVerison` jest niewystarczająca.<br /><br /> —lub—<br /><br /> Pamięć przydzielona do `pwzImageVerison` jest niewystarczająca.|  
