...
Tematy w tej sekcji opisano funkcje transakcyjne przez Windows Communication Foundation (WCF).  
...
## <a name="in-this-section"></a>W tej sekcji  
 ...
 W tym artykule opisano dwa standardowe <xref:System.ServiceModel> atrybuty, które umożliwiają konfigurowanie zachowania transakcji usługi WCF.  
  
 [Konfiguracja transakcji modelu ServiceModel](../../../../docs/framework/wcf/feature-details/servicemodel-transaction-configuration.md)  
 W tym artykule opisano różne ustawienia konfiguracji, których można użyć do włączenia transakcji dla usługi.  
 ...
 Pokazuje, jak tworzenie usługi transakcyjnej w programie WCF.  
  
 [Diagnozowanie aplikacji transakcyjnych](../../../../docs/framework/wcf/feature-details/diagnosing-transactional-applications.md)  
 Informacje dotyczące używania funkcji diagnostyki i zarządzania w programie WCF Rozwiązywanie problemów z aplikacją transakcyjnych.  
 ...
 Opisuje sposób integrowania usługi WCF z kodem, który korzysta z usługi enterprise.
