...
---
# <a name="eclrassemblyidentityflags-enumeration"></a>ECLRAssemblyIdentityFlags — Wyliczenie
...
|------------|-----------------|  
|`CLR_ASSEMBLY_IDENTITY_FLAGS_DEFAULT`|Tożsamość jest w postaci kanonicznej.|  
