...
ms.locfileid: "74349834"
---
# <a name="directories-and-files-summary-visual-basic"></a>Katalogi i pliki — Podsumowanie (Visual Basic)
Visual Basic language keywords and run-time library members are organized by purpose and use.  
  
 Using the `My` feature gives you greater productivity and performance in file I/O operations than using these members. Aby uzyskać więcej informacji, zobacz <xref:Microsoft.VisualBasic.FileIO.FileSystem>.  
