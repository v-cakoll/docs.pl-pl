...
A *cykliczne* procedura jest taki, który wywołuje sam siebie. Ogólnie rzecz biorąc, nie jest to najbardziej efektywny sposób zapisu [!INCLUDE[vbprvb](~/includes/vbprvb-md.md)] kodu.  
