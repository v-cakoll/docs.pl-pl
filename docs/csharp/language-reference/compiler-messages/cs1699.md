...
Użyj opcji wiersza polecenia "compiler_option" lub odpowiednich ustawień projektu zamiast "ATTRIBUTE_NAME"  
 ...
 [Instrukcje: Podpisz zestaw silną nazwą](../../../framework/app-domains/how-to-sign-an-assembly-with-a-strong-name.md) , korzystając z następujących opcji kompilatora:  
  
- [/keyfile (C# opcje kompilatora)](../compiler-options/keyfile-compiler-option.md) zamiast <xref:System.Reflection.AssemblyKeyFileAttribute> atrybutu.  
  
- [/KEYCONTAINER (C# opcje kompilatora)](../compiler-options/keycontainer-compiler-option.md) <xref:System.Reflection.AssemblyKeyNameAttribute>zamiast.  
  
- [/delaysign (C# opcje kompilatora)](../compiler-options/delaysign-compiler-option.md) <xref:System.Reflection.AssemblyDelaySignAttribute>zamiast.  
