---
title: Klasy coclass debugowania
ms.date: 03/30/2017
helpviewer_keywords:
...
---
# <a name="debugging-coclasses"></a>Klasy coclass debugowania
W tej sekcji opisano niezarządzane klasy coclass, które używa interfejsu API debugowania.  
