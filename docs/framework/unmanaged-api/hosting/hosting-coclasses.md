...
ms.locfileid: "33430518"
---
# <a name="hosting-coclasses"></a>Klasy coclass hostingu
W tej sekcji opisano niezarządzane klasy coclass interfejsu API, używanych do obsługi interfejsu API.  
...
## <a name="in-this-section"></a>W tej sekcji  
 ...
 [ComCallUnmarshal, klasa coclass](../../../../docs/framework/unmanaged-api/hosting/comcallunmarshal-coclass.md)  
 ...
 [TypeNameFactory, klasa coclass](../../../../docs/framework/unmanaged-api/hosting/typenamefactory-coclass.md)  
 Interfejs zarządzania deconstruction nazwy typu.  
