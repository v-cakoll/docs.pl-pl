...
W tym temacie porównano oś XPath `preceding-sibling` z podrzędną osią <xref:System.Xml.Linq.XNode.ElementsBeforeSelf%2A?displayProperty=nameWithType> [!INCLUDE[sqltecxlinq](~/includes/sqltecxlinq-md.md)].  
