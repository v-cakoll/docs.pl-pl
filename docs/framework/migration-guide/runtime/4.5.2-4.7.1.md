---
title: Zmiany środowiska uruchomieniowego dla migracji z programu .NET Framework 4.5.2 do 4.7.1
ms.date: 07/10/2019
...
ms.locfileid: "73196502"
---
# <a name="runtime-changes-for-migration-from-net-framework-452-to-471"></a><span data-ttu-id="a7582-102">Zmiany środowiska uruchomieniowego dla migracji z programu .NET Framework 4.5.2 do 4.7.1</span><span class="sxs-lookup"><span data-stu-id="a7582-102">Runtime Changes for Migration from .NET Framework 4.5.2 to 4.7.1</span></span>

[!INCLUDE[versionselector](../../../../includes/migration-guide/runtime/versionselector.md)]

<span data-ttu-id="a7582-103">W przypadku migracji z programu .NET Framework 4.5.2 do 4.7.1 zapoznaj się z następującymi tematami dotyczącymi problemów ze zgodnością aplikacji, które mogą mieć wpływ na aplikację:</span><span class="sxs-lookup"><span data-stu-id="a7582-103">If you are migrating from the .NET Framework 4.5.2 to 4.7.1, review the following topics for application compatibility issues that may affect your app:</span></span>

## <a name="aspnet"></a><span data-ttu-id="a7582-104">ASP.NET</span><span class="sxs-lookup"><span data-stu-id="a7582-104">ASP.NET</span></span>
...
## <a name="core"></a><span data-ttu-id="a7582-105">Podstawowe</span><span class="sxs-lookup"><span data-stu-id="a7582-105">Core</span></span>
...
## <a name="data"></a><span data-ttu-id="a7582-106">Dane</span><span class="sxs-lookup"><span data-stu-id="a7582-106">Data</span></span>
...
## <a name="debugger"></a><span data-ttu-id="a7582-107">Debuger</span><span class="sxs-lookup"><span data-stu-id="a7582-107">Debugger</span></span>
...
## <a name="globalization"></a><span data-ttu-id="a7582-108">Globalizacja</span><span class="sxs-lookup"><span data-stu-id="a7582-108">Globalization</span></span>
...
## <a name="networking"></a><span data-ttu-id="a7582-109">Networking</span><span class="sxs-lookup"><span data-stu-id="a7582-109">Networking</span></span>
...
## <a name="security"></a><span data-ttu-id="a7582-110">Zabezpieczenia</span><span class="sxs-lookup"><span data-stu-id="a7582-110">Security</span></span>
...
## <a name="serialization"></a><span data-ttu-id="a7582-111">Serializacja</span><span class="sxs-lookup"><span data-stu-id="a7582-111">Serialization</span></span>
...
## <a name="setup-and-deployment"></a><span data-ttu-id="a7582-112">Konfiguracja i wdrażanie</span><span class="sxs-lookup"><span data-stu-id="a7582-112">Setup and Deployment</span></span>
...
## <a name="tools"></a><span data-ttu-id="a7582-113">narzędzia</span><span class="sxs-lookup"><span data-stu-id="a7582-113">Tools</span></span>

[!INCLUDE[Contract.Invariant or Contract.Requires\<TException> do not consider String.IsNullOrEmpty to be pure](~/includes/migration-guide/runtime/tools/contractinvariant-contractrequirestexception-do-not-consider.md)]

## <a name="windows-communication-foundation-wcf"></a><span data-ttu-id="a7582-114">Windows Communication Foundation (WCF)</span><span class="sxs-lookup"><span data-stu-id="a7582-114">Windows Communication Foundation (WCF)</span></span>
...
## <a name="windows-presentation-foundation-wpf"></a><span data-ttu-id="a7582-115">Windows Presentation Foundation (WPF)</span><span class="sxs-lookup"><span data-stu-id="a7582-115">Windows Presentation Foundation (WPF)</span></span>
...
## <a name="windows-workflow-foundation-wf"></a><span data-ttu-id="a7582-116">Program Windows Workflow Foundation (WF)</span><span class="sxs-lookup"><span data-stu-id="a7582-116">Windows Workflow Foundation (WF)</span></span>
