...
'Funkcja': nie można jawnie wywołać operatora lub metody dostępu  
 ...
 Niektóre operatory mają nazwy wewnętrzne. Na przykład **op_Increment** to nazwa wewnętrzna operatora ++. Takich nazw metod nie należy używać ani jawnie wywoływać.  
  
 Poniższy przykład spowoduje wygenerowanie CS0571:  
