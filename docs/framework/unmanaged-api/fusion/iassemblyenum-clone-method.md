...
ms.locfileid: "57499852"
---
# <a name="iassemblyenumclone-method"></a>IAssemblyEnum::Clone — Metoda
Tworzy kopię pobieżną to [iassemblyenum —](../../../../docs/framework/unmanaged-api/fusion/iassemblyenum-interface.md) obiektu.  
