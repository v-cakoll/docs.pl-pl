...
## <a name="working-with-tabcontrol"></a>Praca z TabControl  
 Najważniejsze właściwości <xref:System.Windows.Forms.TabControl> jest <xref:System.Windows.Forms.TabControl.TabPages%2A>, który zawiera poszczególnych kart. Każda pojedyncza karta jest <xref:System.Windows.Forms.TabPage> obiektu. Po kliknięciu karty zgłasza <xref:System.Windows.Forms.Control.Click> zdarzeń, dla którego <xref:System.Windows.Forms.TabPage> obiektu.  
