...
Nie można utworzyć delegata z "method", ponieważ ma on atrybut Conditional.  
 ...
 Nie można utworzyć delegata za pomocą metody warunkowego, ponieważ nie istnieje metoda w niektórych wersjach.  
  
 Poniższy przykład spowoduje wygenerowanie CS1618:  
