...
<span data-ttu-id="1db2a-142">Ustawienia używane podczas uruchamiania testów.</span><span class="sxs-lookup"><span data-stu-id="1db2a-142">Settings to use when running tests.</span></span>
