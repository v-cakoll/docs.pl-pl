...
<xref:Microsoft.VisualBasic.Devices.Network.IsAvailable> Właściwości może służyć do określenia, czy komputer ma pracy sieć lub połączenie internetowe.  
  
[!INCLUDE[note_settings_general](~/includes/note-settings-general-md.md)]  
  
### <a name="to-check-whether-a-computer-has-a-working-connection"></a>Aby sprawdzić, czy komputer ma połączenie pracy  
  
-   Określić, czy `IsAvailable` właściwość jest `True` lub `False`. Poniższy kod umożliwia sprawdzenie stanu właściwości i zgłasza:  
