...
## <a name="description"></a>Opis  
 To zdarzenie jest emitowany, gdy usługa routingu odsyła komunikat odpowiedzi fault.  
  
## <a name="message"></a>Komunikat  
 Usługa routingu odsyła komunikat odpowiedzi Fault z akcją "%1".  
