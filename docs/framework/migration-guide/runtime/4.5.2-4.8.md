---
title: Zmiany w czasie wykonywania migracji z .NET Framework 4.5.2 do 4,8
description: Znajdź informacje o problemach ze zgodnością aplikacji w czasie wykonywania, które mogą mieć wpływ na aplikację podczas migracji z .NET Framework 4.5.2 do 4,8.
ms.date: 07/10/2019
...
ms.locfileid: "86444082"
---
# <a name="runtime-changes-for-migration-from-net-framework-452-to-48"></a><span data-ttu-id="fc6c5-103">Zmiany w czasie wykonywania migracji z .NET Framework 4.5.2 do 4,8</span><span class="sxs-lookup"><span data-stu-id="fc6c5-103">Runtime Changes for Migration from .NET Framework 4.5.2 to 4.8</span></span>

[!INCLUDE[versionselector](../../../../includes/migration-guide/runtime/versionselector.md)]

<span data-ttu-id="fc6c5-104">W przypadku migrowania z .NET Framework 4.5.2 do 4,8 zapoznaj się z następującymi tematami dotyczącymi problemów ze zgodnością aplikacji, które mogą mieć wpływ na aplikację:</span><span class="sxs-lookup"><span data-stu-id="fc6c5-104">If you are migrating from the .NET Framework 4.5.2 to 4.8, review the following topics for application compatibility issues that may affect your app:</span></span>

## <a name="aspnet"></a><span data-ttu-id="fc6c5-105">ASP.NET</span><span class="sxs-lookup"><span data-stu-id="fc6c5-105">ASP.NET</span></span>
...
## <a name="core"></a><span data-ttu-id="fc6c5-106">Core</span><span class="sxs-lookup"><span data-stu-id="fc6c5-106">Core</span></span>
...
## <a name="data"></a><span data-ttu-id="fc6c5-107">Dane</span><span class="sxs-lookup"><span data-stu-id="fc6c5-107">Data</span></span>
...
## <a name="debugger"></a><span data-ttu-id="fc6c5-108">Debuger</span><span class="sxs-lookup"><span data-stu-id="fc6c5-108">Debugger</span></span>
...
## <a name="globalization"></a><span data-ttu-id="fc6c5-109">Globalizacja</span><span class="sxs-lookup"><span data-stu-id="fc6c5-109">Globalization</span></span>
...
## <a name="networking"></a><span data-ttu-id="fc6c5-110">Sieć</span><span class="sxs-lookup"><span data-stu-id="fc6c5-110">Networking</span></span>
...
## <a name="runtime"></a><span data-ttu-id="fc6c5-111">Środowisko uruchomieniowe</span><span class="sxs-lookup"><span data-stu-id="fc6c5-111">Runtime</span></span>

[!INCLUDE[Improved WCF chain trust certificate validation for Net.Tcp certificate authentication](~/includes/migration-guide/runtime/runtime/improved-wcf-chain-trust-certificate-validation-for-nettcp-authentication.md)]

## <a name="security"></a><span data-ttu-id="fc6c5-112">Zabezpieczenia</span><span class="sxs-lookup"><span data-stu-id="fc6c5-112">Security</span></span>
...
## <a name="serialization"></a><span data-ttu-id="fc6c5-113">Serializacja</span><span class="sxs-lookup"><span data-stu-id="fc6c5-113">Serialization</span></span>
...
## <a name="setup-and-deployment"></a><span data-ttu-id="fc6c5-114">Instalacja i wdrożenie</span><span class="sxs-lookup"><span data-stu-id="fc6c5-114">Setup and Deployment</span></span>
...
## <a name="tools"></a><span data-ttu-id="fc6c5-115">Narzędzia</span><span class="sxs-lookup"><span data-stu-id="fc6c5-115">Tools</span></span>

[!INCLUDE[Contract.Invariant or Contract.Requires\<TException> do not consider String.IsNullOrEmpty to be pure](~/includes/migration-guide/runtime/tools/contractinvariant-contractrequirestexception-do-not-consider.md)]

## <a name="web-applications"></a><span data-ttu-id="fc6c5-116">Aplikacje internetowe</span><span class="sxs-lookup"><span data-stu-id="fc6c5-116">Web Applications</span></span>

[!INCLUDE["dataAnnotations:dataTypeAttribute:disableRegEx" app setting is on by default in .NET Framework 4.7.2](~/includes/migration-guide/runtime/web/dataannotationsdatatypeattributedisableregex-app-setting-on-by-default-net.md)]

## <a name="windows-communication-foundation-wcf"></a><span data-ttu-id="fc6c5-117">Windows Communication Foundation (WCF)</span><span class="sxs-lookup"><span data-stu-id="fc6c5-117">Windows Communication Foundation (WCF)</span></span>
...
## <a name="windows-presentation-foundation-wpf"></a><span data-ttu-id="fc6c5-118">Windows Presentation Foundation (WPF)</span><span class="sxs-lookup"><span data-stu-id="fc6c5-118">Windows Presentation Foundation (WPF)</span></span>
...
## <a name="windows-workflow-foundation-wf"></a><span data-ttu-id="fc6c5-119">Program Windows Workflow Foundation (WF)</span><span class="sxs-lookup"><span data-stu-id="fc6c5-119">Windows Workflow Foundation (WF)</span></span>
