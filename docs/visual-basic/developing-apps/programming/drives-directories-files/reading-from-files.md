...
W tej sekcji wyjaśniono, jak wykonywać zadania skojarzone z odczytem z plików.  
...
## <a name="in-this-section"></a>W tej sekcji  
 ...
 Pokazuje, jak odczytać z pliku binarnego.  
 ...
 Pokazuje, jak używać <xref:System.IO.StreamReader> a do odczytu z pliku.  
...
## <a name="reference"></a>Dokumentacja  
 ...
 Opisuje `ReadAllText` metodę.  
  
 <xref:Microsoft.VisualBasic.FileIO.FileSystem.ReadAllBytes%2A>  
 Opisuje `ReadAllBytes` metodę.  
  
 <xref:Microsoft.VisualBasic.FileIO.FileSystem.OpenTextFieldParser%2A>  
 Opisuje `OpenTextFieldParser` metodę.  
  
 <xref:Microsoft.VisualBasic.FileIO.FileSystem.OpenTextFileReader%2A>  
 Opisuje `OpenTextFileReader` metodę.  
...
## <a name="related-sections"></a>Sekcje pokrewne  
 ...
 Zawiera przegląd odczytywania plików `TextFieldParser` tekstowych z obiektem.  
 ...
 Pokazuje, jak korzystać z `My` funkcji z plikami i katalogami.  
 ...
 Pokazuje, jak używać metod programu .NET Framework z plikami i katalogami.
