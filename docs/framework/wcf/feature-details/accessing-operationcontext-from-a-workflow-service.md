...
### <a name="implement-the-client-side-isendmessagecallback"></a>Implementowanie ISendMessageCallback po stronie klienta  
  
1.  Dodaj nową aplikację konsoli o nazwie `Service` do rozwiązania.  
