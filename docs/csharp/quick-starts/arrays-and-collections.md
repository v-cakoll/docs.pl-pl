...
Ta opcja szybkiego startu zawiera wprowadzenie do języka C# i podstawy <xref:System.Collections.Generic.List%601> klasy.
...
Gratulacje, zakończeniu procedury szybkiego startu listy. Można kontynuować [wprowadzenie do klasy](introduction-to-classes.md) szybkiego startu w środowisku projektowania.
