...
## <a name="in-this-section"></a>W tej sekcji  
 ...
 Pokazuje, jak używać <xref:System.Activities.Statements.TryCatch> działanie obsługi wyjątków w przepływie pracy.  
 ...
 Opisuje sposób wykonywania anulowania obsługi w przepływach pracy przy użyciu działań wbudowanych, jak również działań niestandardowych.  
  
 [Debugowanie przepływów pracy](../../../docs/framework/windows-workflow-foundation/debugging-workflows.md)  
