...
## <a name="binding-data-to-windows-presentation-foundation-elements"></a>Powiązywanie danych z Windows Presentation Foundation elementami  
 ...
 Aby uzyskać więcej informacji, zobacz [jak: Powiąż dane z elementami](bind-data-to-wpf-elements-wcf-data-services.md)Windows Presentation Foundation.  
...
## <a name="binding-paged-data"></a>Powiązywanie danych stronicowanych  
 ...
 Powiązane obiekty są ładowane w podobny sposób. Aby uzyskać więcej informacji, zobacz [jak: Powiąż dane z elementami](bind-data-to-wpf-elements-wcf-data-services.md)Windows Presentation Foundation.  
...
> [!INCLUDE[ssAstoria](../../../../includes/ssastoria-md.md)]nie sprawdza poprawności zachowań niestandardowych zaimplementowanych w tych delegatach.  
 ...
 Aby uzyskać więcej informacji, zobacz [jak: Dostosuj zachowania](how-to-customize-data-binding-behaviors-wcf-data-services.md)powiązań danych.  
...
- [Instrukcje: Ręcznie Generuj klasy usługi danych klienta](how-to-manually-generate-client-data-service-classes-wcf-data-services.md)
