---
title: 'Instrukcje: Konwertowanie elementu BitmapSource na format indeksowanych pikseli'
ms.date: 03/30/2017
dev_langs:
- csharp
- vb
...
ms.locfileid: "61910016"
---
# <a name="how-to-convert-a-bitmapsource-to-an-indexed-pixel-format"></a><span data-ttu-id="3a90c-102">Instrukcje: Konwertowanie elementu BitmapSource na format indeksowanych pikseli</span><span class="sxs-lookup"><span data-stu-id="3a90c-102">How to: Convert a BitmapSource to an Indexed Pixel Format</span></span>
<span data-ttu-id="3a90c-103">Ten przykład pokazuje sposób konwertowania <xref:System.Windows.Media.Imaging.BitmapSource> na format indeksowanych pikseli.</span><span class="sxs-lookup"><span data-stu-id="3a90c-103">This example shows how to convert a <xref:System.Windows.Media.Imaging.BitmapSource> to an indexed pixel format.</span></span>  
  
## <a name="example"></a><span data-ttu-id="3a90c-104">Przykład</span><span class="sxs-lookup"><span data-stu-id="3a90c-104">Example</span></span>  
