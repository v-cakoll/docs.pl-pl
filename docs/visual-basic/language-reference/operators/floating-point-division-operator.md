...
## <a name="result"></a>Wynik  
 Wynikiem jest pełny iloraz `expression1` podzielona przez `expression2`, w tym wszelkie reszty.  
...
|------------------------|---------------------------------------|  
|Zmiennoprzecinkowe (`Single` lub `Double`)|Zwraca nieskończoność (<xref:System.Double.PositiveInfinity> lub <xref:System.Double.NegativeInfinity>) lub <xref:System.Double.NaN> (nie liczbę), jeśli `expression1` jest również zerem|  
...
## <a name="example"></a>Przykład  
 Ten przykład używa operatora `/`, aby wykonać dzielenie zmiennoprzecinkowe. Wynik jest ilorazem dwóch operandów.  
