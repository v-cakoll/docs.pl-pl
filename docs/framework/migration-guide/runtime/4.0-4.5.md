---
title: Zmiany środowiska uruchomieniowego w przypadku migracji z .NET Framework 4.0 lub 4.5
ms.date: 04/05/2018
...
ms.locfileid: "66379678"
---
# <a name="runtime-changes-for-migration-from-net-framework-40-to-45"></a>Zmiany środowiska uruchomieniowego w przypadku migracji z .NET Framework 4.0 lub 4.5

[!INCLUDE[versionselector](../../../../includes/migration-guide/runtime/versionselector.md)]

[!INCLUDE[introduction](../../../../includes/migration-guide/runtime/introduction.md)]

Jeśli są migrowane z programu .NET Framework 4.0, 4.5, przejrzyj problemy ze zgodnością aplikacji, które mogą wpływać na Twoją aplikację w poniższych tematach:
