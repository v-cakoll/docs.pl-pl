...
ms.locfileid: "61916022"
---
# <a name="reliable-messaging-sessions-faulted"></a>Błędne sesje komunikacji niezawodnej
Nazwa komputera: Błędne sesje niezawodnej obsługi komunikatów.  
  
## <a name="description"></a>Opis  
 Liczba sesje niezawodnej obsługi komunikatów, które są umieszczone w tej usłudze.
