...
Alias 'alias' using występowała wcześniej w tej przestrzeni nazw  
 ...
 Symbol jest zdefiniowane dwa razy jako alias dla przestrzeni nazw. Symbol może zostać zdefiniowany tylko jeden raz.  
  
 Poniższy przykład spowoduje wygenerowanie CS1537:  
