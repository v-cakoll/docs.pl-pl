...
Zdefiniowany przez użytkownika operator 'operator' musi być zadeklarowany jako statyczny i publiczny  
 ...
 Zarówno **statyczne** i **publicznych** dostępu [Modyfikatory](../../csharp/language-reference/keywords/modifiers.md) musi zostać określony w operatory zdefiniowane przez użytkownika.  
  
 Poniższy przykład spowoduje wygenerowanie CS0558:  
