...
description: Dowiedz się, jak zmniejszyć liczbę ponownych uruchomień systemu podczas instalacji programu .NET 4,5. Jeśli aplikacja .NET 4 jest używana podczas instalacji programu .NET 4,5, może być wymagane ponowne uruchomienie komputera.
ms.date: 03/30/2017
helpviewer_keywords:
