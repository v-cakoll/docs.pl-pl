...
ms.locfileid: "59768764"
---
# <a name="runtime-changes-for-migration-from-net-framework-452-to-461"></a><span data-ttu-id="84864-102">Zmiany środowiska uruchomieniowego do migracji z programu .NET Framework 4.5.2 i 4.6.1</span><span class="sxs-lookup"><span data-stu-id="84864-102">Runtime Changes for Migration from .NET Framework 4.5.2 to 4.6.1</span></span>

[!INCLUDE[versionselector](../../../../includes/migration-guide/runtime/versionselector.md)]

[!INCLUDE[introduction](../../../../includes/migration-guide/runtime/introduction.md)]

<span data-ttu-id="84864-103">Migracji z programu .NET Framework 4.5.2, 4.6.1, przejrzyj problemy ze zgodnością aplikacji, które mogą wpływać na Twoją aplikację w poniższych tematach:</span><span class="sxs-lookup"><span data-stu-id="84864-103">If you are migrating from the .NET Framework 4.5.2 to 4.6.1, review the following topics for application compatibility issues that may affect your app:</span></span>

## <a name="aspnet"></a><span data-ttu-id="84864-104">ASP.NET</span><span class="sxs-lookup"><span data-stu-id="84864-104">ASP.NET</span></span>
...
## <a name="core"></a><span data-ttu-id="84864-105">Core</span><span class="sxs-lookup"><span data-stu-id="84864-105">Core</span></span>
...
## <a name="data"></a><span data-ttu-id="84864-106">Dane</span><span class="sxs-lookup"><span data-stu-id="84864-106">Data</span></span>
...
## <a name="debugger"></a><span data-ttu-id="84864-107">Debuger</span><span class="sxs-lookup"><span data-stu-id="84864-107">Debugger</span></span>
...
## <a name="networking"></a><span data-ttu-id="84864-108">Obsługa sieci</span><span class="sxs-lookup"><span data-stu-id="84864-108">Networking</span></span>
...
## <a name="serialization"></a><span data-ttu-id="84864-109">Serializacja</span><span class="sxs-lookup"><span data-stu-id="84864-109">Serialization</span></span>
...
## <a name="setup-and-deployment"></a><span data-ttu-id="84864-110">Instalacja i wdrożenie</span><span class="sxs-lookup"><span data-stu-id="84864-110">Setup and Deployment</span></span>
...
## <a name="tools"></a><span data-ttu-id="84864-111">Narzędzia</span><span class="sxs-lookup"><span data-stu-id="84864-111">Tools</span></span>

[!INCLUDE[Contract.Invariant or Contract.Requires\<TException> do not consider String.IsNullOrEmpty to be pure](~/includes/migration-guide/runtime/tools/contractinvariant-contractrequirestexception-do-not-consider.md)]

## <a name="windows-communication-foundation-wcf"></a><span data-ttu-id="84864-112">Windows Communication Foundation (WCF)</span><span class="sxs-lookup"><span data-stu-id="84864-112">Windows Communication Foundation (WCF)</span></span>
...
## <a name="windows-presentation-foundation-wpf"></a><span data-ttu-id="84864-113">Windows Presentation Foundation (WPF)</span><span class="sxs-lookup"><span data-stu-id="84864-113">Windows Presentation Foundation (WPF)</span></span>
