...
---
# <a name="data-types-of-the-type-parameters-in-extension-method-ltmethodnamegt-defined-in-lttypenamegt-cannot-be-inferred-from-these-arguments-because-more-than-one-type-is-possible"></a>Typów danych parametrów typu w metodzie rozszerzenia "&lt;methodname&gt;"zdefiniowane w"&lt;typename&gt;" nie można wywnioskować na podstawie tych argumentów, ponieważ możliwe jest użycie więcej niż jeden typ
