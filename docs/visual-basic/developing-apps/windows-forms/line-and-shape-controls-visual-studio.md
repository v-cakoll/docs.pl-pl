...
## <a name="in-this-section"></a>W tej sekcji  
 ...
 Wprowadza i w tym artykule omówiono formanty linii i kształtu w tym artykule opisano model obiektów.  
 ...
 Pokazuje sposób użycia <xref:Microsoft.VisualBasic.PowerPacks.LineShape> formantu, aby rysować linie w czasie projektowania i w czasie wykonywania.  
 ...
 Pokazuje sposób użycia <xref:Microsoft.VisualBasic.PowerPacks.OvalShape> i <xref:Microsoft.VisualBasic.PowerPacks.RectangleShape> formanty do rysowania kształtów w czasie projektowania i w czasie wykonywania.  
 ...
 Pokazuje, jak umożliwić użytkownikom przechodzenie między kształtami za pomocą klawiatury.  
