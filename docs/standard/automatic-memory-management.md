...
## <a name="generations-and-performance"></a>Generacje i wydajność  
 ...
 Po moduł zbierający elementy bezużyteczne wykonuje kolekcję generacji 0, kompaktypamięci dla obiektów osiągalnych, jak [wyjaśniono](#cpconautomaticmemorymanagementreleasingmemoryanchor1) w zwalnianiu pamięci wcześniej w tym temacie. Następnie podwyższa tym obiektom poziom i uznaje tę część zarządzanego stosu za generację 1. Ponieważ obiekty, które pozostały po procesie wyrzucania elementów, zwykle mają dłuższe okresy istnienia, podwyższenie im poziomu o generację jest jak najbardziej uzasadnione. W rezultacie moduł odśmiecania pamięci nie musi badać obiektów w generacjach 1 i 2 podczas każdej sesji odśmiecania generacji 0.  
