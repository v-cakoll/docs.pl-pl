...
|Termin|Definicja|  
|----------|----------------|  
|`Preserve`|Opcjonalna. Modyfikator używane w celu zachowania danych w istniejącej tablicy po zmianie rozmiaru tylko ostatniego wymiaru.|  
...
|`boundlist`|Wymagana. Lista granic dla każdego wymiaru tablicy ponownie zdefiniowany.|  
