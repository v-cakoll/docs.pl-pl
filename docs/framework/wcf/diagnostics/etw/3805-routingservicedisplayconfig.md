...
## <a name="description"></a>Opis  
 To zdarzenie jest emitowany, gdy usługi routingu skonfigurowano RouteOnHeadersOnly.  
  
## <a name="message"></a>Komunikat  
 Usługi routingu skonfigurowano RouteOnHeadersOnly: %1, SoapProcessingEnabled: %2, EnsureOrderedDispatch: %3.  
