...
---
# <a name="runtime-changes-for-migration-from-net-framework-461-to-471"></a>Zmiany w czasie wykonywania migracji z .NET Framework 4.6.1 do 4.7.1

[!INCLUDE[versionselector](../../../../includes/migration-guide/runtime/versionselector.md)]

Jeśli przeprowadzasz migrację z .NET Framework 4.6.1 do 4.7.1, zapoznaj się z następującymi tematami dotyczącymi problemów ze zgodnością aplikacji, które mogą mieć wpływ na aplikację:
