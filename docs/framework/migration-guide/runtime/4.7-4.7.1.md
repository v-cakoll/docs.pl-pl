...
---
# <a name="runtime-changes-for-migration-from-net-framework-47-to-471"></a>Zmiany środowiska uruchomieniowego dla migracji z programu .NET Framework 4.7 na 4.7.1

[!INCLUDE[versionselector](../../../../includes/migration-guide/runtime/versionselector.md)]

W przypadku migracji z programu .NET Framework 4.7 do 4.7.1 zapoznaj się z następującymi tematami dotyczącymi problemów ze zgodnością aplikacji, które mogą mieć wpływ na aplikację:
