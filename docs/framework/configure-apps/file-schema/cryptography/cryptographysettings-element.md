...
---
# <a name="cryptographysettings-element"></a>\<kryptografiaWuchnia> element
...
|[\<>oidMap](oidmap-element.md)|Zawiera mapowania identyfikatora obiektu ASN.1 (OID) do klas.|  
...
## <a name="example"></a>Przykład  
 Poniższy przykład pokazuje, jak używać ** \<kryptografiiSzepcje>** element do przechowywania mapowań nazw kryptografii i mapowań OID. W tym przykładzie konfiguruje środowisko wykonawcze tak, aby <xref:System.Security.Cryptography.HashAlgorithm.Create%2A?displayProperty=nameWithType> zwraca `MyHashClass` obiekt i `MyCryptoClass` klasy mapuje do identyfikatora obiektu 1.3.36.2.1.  
