...
---
# <a name="compiler-error-cs0015"></a><span data-ttu-id="3daaf-102">Błąd kompilatora CS0015</span><span class="sxs-lookup"><span data-stu-id="3daaf-102">Compiler Error CS0015</span></span>
<span data-ttu-id="3daaf-103">Nazwa typu "type" jest za długa</span><span class="sxs-lookup"><span data-stu-id="3daaf-103">The name of type 'type' is too long</span></span>  
  
 <span data-ttu-id="3daaf-104">W pełni kwalifikowana nazwa typu zdefiniowanego przez użytkownika musi mieć mniej niż 1024 znaków, w tym okresy.</span><span class="sxs-lookup"><span data-stu-id="3daaf-104">The fully qualified name of a user-defined type must have fewer than 1024 characters, including the periods.</span></span>  
  
 <span data-ttu-id="3daaf-105">Poniższy przykład generuje CS0015:</span><span class="sxs-lookup"><span data-stu-id="3daaf-105">The following sample generates CS0015:</span></span>  
