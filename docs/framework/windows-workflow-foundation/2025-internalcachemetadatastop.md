...
## <a name="description"></a>Opis  
 Wskazuje zakończenia wykonywanie metody InternalCacheMetadata w działaniu.  
  
## <a name="message"></a>Komunikat  
 Zatrzymano wykonywanie metody InternalCacheMetadata w działaniu '%1'.  
