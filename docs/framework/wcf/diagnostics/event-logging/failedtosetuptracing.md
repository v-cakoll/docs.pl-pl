...
## <a name="description"></a>Opis  
 Próba ustawienia śledzenia nie powiodła się. Śledzenie jest wyłączone.  
  
 Zdarzenie Wyświetla listę wyjątków, nazwa procesu i identyfikatora procesu.  
