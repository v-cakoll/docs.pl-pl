...
## <a name="protected"></a>Protected  
 [Chronione](../../../../visual-basic/language-reference/modifiers/protected.md) — słowo kluczowe w instrukcji deklaracji określa, czy element jest możliwy tylko z należące do tej samej klasy lub z klasy pochodzącej od tej klasy. Poniższy kod przedstawia przykład `Protected` deklaracji.  
...
## <a name="friend"></a>Friend  
 [Friend](../../../../visual-basic/language-reference/modifiers/friend.md) — słowo kluczowe w instrukcji deklaracji określa, czy element jest dostępny z wewnątrz tego samego zestawu, ale nie z poza zestaw. Poniższy kod przedstawia przykład `Friend` deklaracji.  
...
## <a name="protected-friend"></a>Friend chronionych  
 `Protected` i `Friend` słowa kluczowe w instrukcji deklaracji określają, czy element jest dostępny z klasy pochodnej lub z poziomu tego samego zestawu, lub obie. Poniższy kod przedstawia przykład `Protected Friend` deklaracji.  
...
## <a name="private"></a>Private  
 [Prywatnej](../../../../visual-basic/language-reference/modifiers/private.md) — słowo kluczowe w instrukcji deklaracji określa, czy element jest dostępny tylko z wewnątrz tego samego modułu, klasy lub struktury. Poniższy kod przedstawia przykład `Private` deklaracji.  
...
## <a name="private-protected"></a>Prywatne chronione

[Prywatne chronione](../../../language-reference/modifiers/private-protected.md) — słowo kluczowe w instrukcji deklaracji określa, czy element jest dostępna tylko w tej samej klasie, a także z klas pochodnych w skład zestawu zawierającego klasę. `Private Protected` Modyfikator dostępu jest obsługiwana w programie Visual Basic 15,5 cala.
...
Można zadeklarować `Private Protected` elementu tylko wewnątrz klasy. Nie można zadeklarować go w obrębie interfejsu lub struktury nie mogą należy zadeklarować go na poziomie pliku źródłowego lub obszaru nazw, wewnątrz interfejsem ani strukturą lub w procedurze.

`Private Protected` Modyfikator dostępu jest obsługiwane przez 15,5 cala Visual Basic i nowszych. Aby go użyć, Dodaj następujący element do pliku projektu (*.vbproj) języka Visual Basic. Jak długo jako 15,5 cala Visual Basic lub nowszy jest zainstalowany w systemie, umożliwia ona korzystać z funkcji języka obsługiwane w najnowszej wersji kompilatora Visual Basic:
...
Aby użyć `Private Protected` modyfikator dostępu, należy dodać następujący element do pliku projektu (*.vbproj) Visual Basic:
...
|`Private Protected`|Kod w klasie, który deklaruje prywatnego elementu chronionych lub kod w klasie pochodnej, w tym samym zestawie co klasa bas.|Interfejsy<br /><br /> Klasy<br /><br /> Struktury<br /><br /> Procedury<br /><br /> Właściwości<br /><br /> Zmienne Członkowskie<br /><br /> Stałe<br /><br /> Wyliczenia<br /><br /> Zdarzenia<br /><br /> Deklaracje zewnętrzne<br /><br /> Delegaty|Class|
