...
Można również ustawić tryb konfiguracji przy użyciu atrybutu `revocationMode` obu [\<authentication >](../../../../docs/framework/configure-apps/file-schema/wcf/authentication-of-clientcertificate-element.md) ( [\<serviceBehaviors >](../../../../docs/framework/configure-apps/file-schema/wcf/servicebehaviors.md)) i [\<authentication](../../../../docs/framework/configure-apps/file-schema/wcf/authentication-of-clientcertificate-element.md) > [(\<endpointBehaviors >](../../../../docs/framework/configure-apps/file-schema/wcf/endpointbehaviors.md)).
...
W przypadku korzystania z [!INCLUDE[netfx35_long](../../../../includes/netfx35-long-md.md)] lub nowszych usługa WCF gwarantuje, że certyfikat jest zgodny z zasadami domeny, zanim zostanie zmapowany na konto systemu Windows.
