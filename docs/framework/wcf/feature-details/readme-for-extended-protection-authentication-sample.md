...
2.  Włącz uwierzytelnianie Windows w funkcji Windows: Internet Information Services -> usługi World Wide Web -> Zabezpieczenia -> uwierzytelniania Windows.  
...
11. Otwórz plik konfiguracji klienta i podaj nazwę maszyny pełną \<klienta >- \<punktu końcowego >-atrybut adresu, zastępując << full_machine_name >>.  
