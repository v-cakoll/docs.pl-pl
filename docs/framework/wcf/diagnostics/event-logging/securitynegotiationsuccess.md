...
## <a name="description"></a>Opis  
 To zdarzenie oznacza, że negocjacji zabezpieczeń zakończyła się pomyślnie, nazwę usługi, działania, tożsamość klienta, ActivityId i negocjacji.  
