...
---
# <a name="retargeting-changes-for-migration-from-net-framework-40-to-451"></a><span data-ttu-id="dd190-102">Zmiany retargetingu migracji z systemu .NET Framework 4.0 do 4.5.1</span><span class="sxs-lookup"><span data-stu-id="dd190-102">Retargeting Changes for Migration from .NET Framework 4.0 to 4.5.1</span></span>

[!INCLUDE[versionselector](../../../../includes/migration-guide/retargeting/versionselector.md)]

[!INCLUDE[introduction](../../../../includes/migration-guide/retargeting/introduction.md)]

<span data-ttu-id="dd190-103">Jeśli w przypadku migracji z programu .NET Framework 4.0 do 4.5.1, należy przejrzeć następujące tematy dla problemów ze zgodnością aplikacji, które mogą wpływać na aplikację:</span><span class="sxs-lookup"><span data-stu-id="dd190-103">If you are migrating from the .NET Framework 4.0 to 4.5.1, review the following topics for application compatibility issues that may affect your app:</span></span>

## <a name="adonet"></a><span data-ttu-id="dd190-104">ADO.NET</span><span class="sxs-lookup"><span data-stu-id="dd190-104">ADO.NET</span></span>
...
## <a name="aspnet"></a><span data-ttu-id="dd190-105">ASP.NET</span><span class="sxs-lookup"><span data-stu-id="dd190-105">ASP.NET</span></span>
...
## <a name="clickonce"></a><span data-ttu-id="dd190-106">ClickOnce</span><span class="sxs-lookup"><span data-stu-id="dd190-106">ClickOnce</span></span>
...
## <a name="core"></a><span data-ttu-id="dd190-107">Core</span><span class="sxs-lookup"><span data-stu-id="dd190-107">Core</span></span>
...
## <a name="entity-framework"></a><span data-ttu-id="dd190-108">Entity Framework</span><span class="sxs-lookup"><span data-stu-id="dd190-108">Entity Framework</span></span>
...
## <a name="msbuild"></a><span data-ttu-id="dd190-109">MSBuild</span><span class="sxs-lookup"><span data-stu-id="dd190-109">MSBuild</span></span>
...
## <a name="windows-forms"></a><span data-ttu-id="dd190-110">Windows Forms</span><span class="sxs-lookup"><span data-stu-id="dd190-110">Windows Forms</span></span>
...
## <a name="windows-presentation-foundation-wpf"></a><span data-ttu-id="dd190-111">Windows Presentation Foundation (WPF)</span><span class="sxs-lookup"><span data-stu-id="dd190-111">Windows Presentation Foundation (WPF)</span></span>
...
## <a name="windows-workflow-foundation-wf"></a><span data-ttu-id="dd190-112">Program Windows Workflow Foundation (WF)</span><span class="sxs-lookup"><span data-stu-id="dd190-112">Windows Workflow Foundation (WF)</span></span>
...
## <a name="xml-xslt"></a><span data-ttu-id="dd190-113">Języki XML, XSLT</span><span class="sxs-lookup"><span data-stu-id="dd190-113">XML, XSLT</span></span>
