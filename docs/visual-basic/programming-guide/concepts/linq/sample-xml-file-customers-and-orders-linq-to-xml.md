...
ms.locfileid: "84413326"
---
# <a name="sample-xml-file-customers-and-orders-linq-to-xml"></a><span data-ttu-id="2a577-102">Przykładowy plik XML: klienci i zamówienia (LINQ to XML)</span><span class="sxs-lookup"><span data-stu-id="2a577-102">Sample XML File: Customers and Orders (LINQ to XML)</span></span>
<span data-ttu-id="2a577-103">Następujący plik XML jest używany w różnych przykładach w [!INCLUDE[sqltecxlinq](~/includes/sqltecxlinq-md.md)] dokumentacji.</span><span class="sxs-lookup"><span data-stu-id="2a577-103">The following XML file is used in various examples in the [!INCLUDE[sqltecxlinq](~/includes/sqltecxlinq-md.md)] documentation.</span></span> <span data-ttu-id="2a577-104">Ten plik zawiera klientów i zamówienia.</span><span class="sxs-lookup"><span data-stu-id="2a577-104">This file contains customers and orders.</span></span>  
  
 <span data-ttu-id="2a577-105">[Przykładowy plik XSD tematu: klienci i zamówienia](sample-xsd-file-customers-and-orders.md) zawierają XSD, których można użyć do zweryfikowania tego dokumentu.</span><span class="sxs-lookup"><span data-stu-id="2a577-105">The topic [Sample XSD File: Customers and Orders](sample-xsd-file-customers-and-orders.md) contains an XSD that can be used to validate this document.</span></span> <span data-ttu-id="2a577-106">Używa `xs:key` i `xs:keyref` funkcji XSD, aby określić, że `CustomerID` atrybut `Customer` elementu jest kluczem i aby ustanowić relację między `CustomerID` elementem w każdym `Order` elemencie a `CustomerID` atrybutem w każdym `Customer` elemencie.</span><span class="sxs-lookup"><span data-stu-id="2a577-106">It uses the `xs:key` and `xs:keyref` features of XSD to establish that the `CustomerID` attribute of the `Customer` element is a key, and to establish a relationship between the `CustomerID` element in each `Order` element and the `CustomerID` attribute in each `Customer` element.</span></span>  
  
 <span data-ttu-id="2a577-107">Przykład pisania zapytań LINQ, które wykorzystują tę relację przy użyciu `Join` klauzuli, można znaleźć w temacie [How to: join dwie kolekcje (LINQ to XML) (Visual Basic)](how-to-join-two-collections-linq-to-xml.md).</span><span class="sxs-lookup"><span data-stu-id="2a577-107">For an example of writing LINQ queries that take advantage of this relationship using the `Join` clause, see [How to: Join Two Collections (LINQ to XML) (Visual Basic)](how-to-join-two-collections-linq-to-xml.md).</span></span>  
  
## <a name="customersordersxml"></a><span data-ttu-id="2a577-108">CustomersOrders. XML</span><span class="sxs-lookup"><span data-stu-id="2a577-108">CustomersOrders.xml</span></span>  
...
## <a name="see-also"></a><span data-ttu-id="2a577-109">Zobacz też</span><span class="sxs-lookup"><span data-stu-id="2a577-109">See also</span></span>

- [<span data-ttu-id="2a577-110">Przykładowe dokumenty XML (LINQ to XML)</span><span class="sxs-lookup"><span data-stu-id="2a577-110">Sample XML Documents (LINQ to XML)</span></span>](sample-xml-documents-linq-to-xml.md)
