...
Zainstaluj [zestaw .NET Core SDK](https://www.microsoft.com/net/core). Zestaw .NET Core SDK zawiera najnowszą wersję programu .NET Core Framework i środowiska uruchomieniowego.
