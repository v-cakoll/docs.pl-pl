...
Ta sekcja zawiera następujące operacje wskaźnika:  
 ...
 [Inkrementacja i dekrementacja](../../../csharp/programming-guide/unsafe-code-pointers/how-to-increment-and-decrement-pointers.md)  
  
 [Operacje arytmetyczne](../../../csharp/programming-guide/unsafe-code-pointers/arithmetic-operations-on-pointers.md)  
  
 [Porównanie](../../../csharp/programming-guide/unsafe-code-pointers/pointer-comparison.md)  
