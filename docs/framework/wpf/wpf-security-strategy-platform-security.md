...
#### <a name="user-account-control-uac"></a>Kontrola konta użytkownika (UAC)  
 Obecnie [!INCLUDE[TLA2#tla_win](../../../includes/tla2sharptla-win-md.md)] użytkownicy często uruchomione z uprawnieniami administratora, ponieważ wiele aplikacji wymaga ich instalacji lub wykonywania, lub obie. Możliwość zapisu domyślne ustawienia aplikacji w rejestrze jest jednym z przykładów.  
