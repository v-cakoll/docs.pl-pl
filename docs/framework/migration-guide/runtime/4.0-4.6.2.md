...
---
# <a name="runtime-changes-for-migration-from-net-framework-40-to-462"></a>Zmiany środowiska uruchomieniowego do migracji z systemu .NET Framework 4.0 do 4.6.2
