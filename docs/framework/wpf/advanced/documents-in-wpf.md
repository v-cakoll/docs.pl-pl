...
> [!NOTE]
>  Aby uzyskać szczegółowe informacje na temat funkcji dokument przepływu i jak je utworzyć, zobacz [Przegląd dokumentu przepływu](flow-document-overview.md).  
