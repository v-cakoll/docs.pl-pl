...
## <a name="remarks"></a>Uwagi  
 Niektóre klasy .NET Framework zawierają pola publiczne tylko do odczytu, które zawierają parametry graniczne specyficzne dla platformy.  Na przykład pole <xref:System.IO.Path.InvalidPathChars> jest tablicą opisującą znaki, które nie są dozwolone w ciągu ścieżki do pliku.  W .NET Framework są obecne wiele podobnych pól.  
