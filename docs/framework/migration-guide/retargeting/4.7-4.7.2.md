...
---
# <a name="retargeting-changes-for-migration-from-net-framework-47-to-472"></a>Zmiany retargetingu migracji z systemu .NET Framework 4.7 lub 4.7.2

[!INCLUDE[versionselector](../../../../includes/migration-guide/retargeting/versionselector.md)]

[!INCLUDE[introduction](../../../../includes/migration-guide/retargeting/introduction.md)]

Jeśli .NET Framework 4.7 są migrowane do 4.7.2, przejrzyj następujące tematy dotyczące problemów ze zgodnością aplikacji, które mogą wpływać na aplikację:
