...
## <a name="in-this-section"></a>W tej sekcji  
 ...
 [Instrukcje: Dodawanie tabel i kolumn do formantu DataGrid formularzy Windows przy użyciu narzędzia Projektant](add-tables-and-columns-to-wf-datagrid-control-using-the-designer.md)  
 ...
 [Instrukcje: Tworzenie list wzorzec szczegół za pomocą formantu DataGrid formularzy Windows przy użyciu narzędzia Projektant](create-master-details-lists-with-wf-datagrid-control-using-the-designer.md)  
 ...
 [Instrukcje: Formatowanie kontrolki DataGrid formularzy Windows przy użyciu narzędzia Projektant](how-to-format-the-windows-forms-datagrid-control-using-the-designer.md)  
 ...
 [Instrukcje: Sprawdzanie poprawności danych wejściowych za pomocą kontrolki DataGrid formularzy Windows Forms](how-to-validate-input-with-the-windows-forms-datagrid-control.md)  
