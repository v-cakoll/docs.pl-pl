...
|Temat|Opis|  
|-----------|-----------------|  
|[Wykonanie odroczone i obliczanie z opóźnieniem w LINQ to XML (C#)](../../../../csharp/programming-guide/concepts/linq/deferred-execution-and-lazy-evaluation-in-linq-to-xml.md)|Opis pojęć dotyczących wykonanie odroczone i obliczanie z opóźnieniem.|  
|[Przykład wykonania odroczonego (C#)](../../../../csharp/programming-guide/concepts/linq/deferred-execution-example.md)|Przykład wykonania odroczonego.|  
|[Przykład łączenia łańcuchowego zapytań (C#)](../../../../csharp/programming-guide/concepts/linq/chaining-queries-example.md)|Pokazuje, jak odroczonego wykonania działa, gdy Łączenie łańcuchowe zapytań.|  
