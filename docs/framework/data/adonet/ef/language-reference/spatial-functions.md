...
```  
 ...
 [Metody SpatialEdmFunctions](https://msdn.microsoft.com/library/hh749531.aspx) strona zawiera listę wszystkich metod programu Entity Framework canonical przestrzennych. Kliknij metodę, aby wyświetlić parametry powinien zostać przekazany do funkcji.
