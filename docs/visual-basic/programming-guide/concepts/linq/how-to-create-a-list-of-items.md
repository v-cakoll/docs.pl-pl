...
## <a name="example"></a>Przykład  
 Jeśli pracujesz nad tym przewodnikiem, można użyć tego kodu Module1.vb pliku projektu, który jest tworzony istnieje. Po prostu zastąpić wierszy oznaczonych *** w `Main` metody za pomocą zapytań i wykonania zapytania, które znajdują się w tym przewodnikiem.  
