...
---
# <a name="security-of-msmqintegrationbinding"></a>\<> zabezpieczeń \<msmqIntegrationBinding >
...
|Element|Opis|  
|-------------|-----------------|  
|[> powiązań \<](bindings.md)|Element powiązania [\<msmqIntegrationBinding >](msmqintegrationbinding.md).|  
