...
ms.locfileid: "85622448"
---
# <a name="retargeting-changes-for-migration-from-net-framework-471-to-472"></a><span data-ttu-id="1135d-102">Przekierowywanie zmian dotyczących migracji z .NET Framework 4.7.1 do 4.7.2</span><span class="sxs-lookup"><span data-stu-id="1135d-102">Retargeting Changes for Migration from .NET Framework 4.7.1 to 4.7.2</span></span>

[!INCLUDE[versionselector](../../../../includes/migration-guide/retargeting/versionselector.md)]

<span data-ttu-id="1135d-103">Jeśli przeprowadzasz migrację z .NET Framework 4.7.1 do 4.7.2, zapoznaj się z następującymi tematami dotyczącymi problemów ze zgodnością aplikacji, które mogą mieć wpływ na aplikację:</span><span class="sxs-lookup"><span data-stu-id="1135d-103">If you are migrating from the .NET Framework 4.7.1 to 4.7.2, review the following topics for application compatibility issues that may affect your app:</span></span>

## <a name="core"></a><span data-ttu-id="1135d-104">Core</span><span class="sxs-lookup"><span data-stu-id="1135d-104">Core</span></span>
...
## <a name="windows-forms"></a><span data-ttu-id="1135d-105">Windows Forms</span><span class="sxs-lookup"><span data-stu-id="1135d-105">Windows Forms</span></span>
...
## <a name="windows-presentation-foundation-wpf"></a><span data-ttu-id="1135d-106">Windows Presentation Foundation (WPF)</span><span class="sxs-lookup"><span data-stu-id="1135d-106">Windows Presentation Foundation (WPF)</span></span>
...
## <a name="windows-workflow-foundation-wf"></a><span data-ttu-id="1135d-107">Program Windows Workflow Foundation (WF)</span><span class="sxs-lookup"><span data-stu-id="1135d-107">Windows Workflow Foundation (WF)</span></span>
