...
## <a name="in-this-section"></a>W tej sekcji  
 ...
 Zawiera krótkie opisy, że model zabezpieczeń .NET Framework i podstawowe kroki niezbędne do zapewnienia formularzy Windows w aplikacji są bezpieczne.  
 ...
 Zawiera opis sposobu uzyskania dostępu do funkcji drukowania w częściowo zaufanym środowisku.  
...
## <a name="related-sections"></a>Sekcje pokrewne  
 ...
 [Niebezpieczne uprawnienia i administrowanie zasadami](../misc/dangerous-permissions-and-policy-administration.md)  
 W tym artykule omówiono, niektóre środowiska.NET Framework uprawnienia, które umożliwia system zabezpieczeń obejść.  
 ...
 [Główne pojęcia dotyczące zabezpieczeń](../../standard/security/key-security-concepts.md)  
 Zawiera łącza do tematów, które obejmują podstawowe aspekty zabezpieczeń kodu.  
