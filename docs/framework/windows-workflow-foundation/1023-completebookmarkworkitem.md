...
## <a name="description"></a>Opis  
 Wskazuje, że element roboczy BookmarkWorkItem została ukończona.  
  
## <a name="message"></a>Komunikat  
 Ukończono element roboczy BookmarkWorkItem dla działania %1, nazwa wyświetlana: %2, identyfikator wystąpienia: '%3'. Nazwa zakładki: %4, zakres zakładek: %5.  
