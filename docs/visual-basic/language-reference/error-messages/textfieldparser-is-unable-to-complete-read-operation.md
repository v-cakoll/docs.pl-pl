...
Nie można ukończyć operacji, ponieważ przekroczono maksymalny rozmiar buforu (10 000 000 bajtów).  
  
## <a name="to-correct-this-error"></a>Aby poprawić ten błąd  
  
-   Upewnij się, że nie ma żadnych pól źle sformułowane w pliku.  
