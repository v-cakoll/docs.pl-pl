...
Kolejność operacji DrawingGroup  
 ...
 Aby uzyskać więcej informacji, zobacz [Przegląd obiektów rysowania](drawing-objects-overview.md).  
...
### <a name="profiling-visual-performance"></a>Profilowanie wydajności Visual  
 ...
 ![Profiler wizualny wyświetlić dane wyjściowe](./media/wpfperf-visualprofiler-04.png "WPFPerf_VisualProfiler_04")  
...
### <a name="about-resolution-and-device-independent-graphics"></a>Rozdzielczość i niezależny od urządzenia grafiki — informacje  
 ...
 ![Grafika i tekstowych w miejscach występowania różne ustawienia DPI](./media/graphicsmm-dpi-setting-examples.png "graphicsmm_dpi_setting_examples")  
...
### <a name="hit-testing"></a>Test trafienia  
 ...
 Aby uzyskać więcej informacji na temat testowania trafień, zobacz [trafień testowania w warstwie wizualnej](hit-testing-in-the-visual-layer.md).  
