...
Możesz użyć metody, `My.Settings.Save` Aby zachować zmiany ustawień użytkownika.  
 ...
 Aby uzyskać więcej informacji, zobacz [My. Settings Object](../../../language-reference/objects/my-settings-object.md).  
...
## <a name="example"></a>Przykład  
 ...
 Ten przykład zmienia wartość `LastChanged` Ustawienia użytkownika i zapisuje tę zmianę przez wywołanie `My.Settings.Save` metody.  
