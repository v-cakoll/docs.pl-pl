...
---
# <a name="retargeting-changes-for-migration-from-net-framework-46-to-471"></a>Przekierowywanie zmian dotyczących migracji z .NET Framework 4,6 do 4.7.1

[!INCLUDE[versionselector](../../../../includes/migration-guide/retargeting/versionselector.md)]

W przypadku migrowania z .NET Framework 4,6 do usługi 4.7.1 zapoznaj się z następującymi tematami dotyczącymi problemów ze zgodnością aplikacji, które mogą mieć wpływ na aplikację:
