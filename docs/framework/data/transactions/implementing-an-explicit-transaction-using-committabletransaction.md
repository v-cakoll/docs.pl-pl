---
title: Implementowanie transakcji jawnej przy użyciu Commitabletransakction
ms.date: 03/30/2017
dev_langs:
- csharp
- vb
...
ms.locfileid: "54713141"
---
# <a name="implementing-an-explicit-transaction-using-committabletransaction"></a>Implementowanie transakcji jawnej przy użyciu Commitabletransakction
