...
|[\<activityStateQueries>](activitystatequeries.md)|Reprezentuje kolekcję zapytań, które są używane do śledzenia zmian cyklem życia działań, które tworzą wystąpienie przepływu pracy. Na przykład można śledzić za każdym razem, gdy działanie "Wyślij e-mail" zostanie ukończone w wystąpieniu przepływu pracy. To zapytanie jest niezbędne do śledzenia uczestnika do subskrybowania obiektów rekordu stanu działania. Stany do subskrybowania są wyszczególnione w ActivityStates.|  
...
## <a name="remarks"></a>Uwagi  
 ...
 Profile śledzenia mają strukturę jako deklaratywne subskrypcji dla śledzenia rekordy, które umożliwiają zapytania dla rekordów śledzenie wersję wykonawczą przepływu pracy. Istnieje kilka typów zapytań, które umożliwiają subskrybowanie różnych klas rekordów śledzenia. Aby uzyskać pełną listę zapytań, zobacz listę elementów podrzędnych tego tematu i [profile śledzenia](../../../windows-workflow-foundation/tracking-profiles.md).  
