...
Rozszerza logicznie icordebugappdomain — interfejs można pobrać obiektu zarządzanego z wywołalne opakowanie COM.  
  
## <a name="method"></a>Metoda  
  
|Metoda|Opis|  
|------------|-----------------|  
|[GetObjectForCCW, metoda](../../../../docs/framework/unmanaged-api/debugging/icordebugappdomain4-getobjectforccw-method.md)|Pobiera obiekt zarządzany ze wskaźnika wywoływalnej otoki (CCW) COM.|  
