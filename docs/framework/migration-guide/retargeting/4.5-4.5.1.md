...
---
# <a name="retargeting-changes-for-migration-from-net-framework-45-to-451"></a><span data-ttu-id="10160-103">Przekierowywanie zmian dotyczących migracji z .NET Framework 4,5 do 4.5.1</span><span class="sxs-lookup"><span data-stu-id="10160-103">Retargeting Changes for Migration from .NET Framework 4.5 to 4.5.1</span></span>

[!INCLUDE[versionselector](../../../../includes/migration-guide/retargeting/versionselector.md)]

<span data-ttu-id="10160-104">W przypadku migrowania z .NET Framework 4,5 do wersji 4.5.1 zapoznaj się z następującymi tematami dotyczącymi problemów ze zgodnością aplikacji, które mogą mieć wpływ na aplikację:</span><span class="sxs-lookup"><span data-stu-id="10160-104">If you are migrating from the .NET Framework 4.5 to 4.5.1, review the following topics for application compatibility issues that may affect your app:</span></span>

## <a name="adonet"></a><span data-ttu-id="10160-105">ADO.NET</span><span class="sxs-lookup"><span data-stu-id="10160-105">ADO.NET</span></span>
...
## <a name="core"></a><span data-ttu-id="10160-106">Core</span><span class="sxs-lookup"><span data-stu-id="10160-106">Core</span></span>
...
## <a name="entity-framework"></a><span data-ttu-id="10160-107">Entity Framework</span><span class="sxs-lookup"><span data-stu-id="10160-107">Entity Framework</span></span>
...
## <a name="msbuild"></a><span data-ttu-id="10160-108">MSBuild</span><span class="sxs-lookup"><span data-stu-id="10160-108">MSBuild</span></span>
...
## <a name="windows-presentation-foundation-wpf"></a><span data-ttu-id="10160-109">Windows Presentation Foundation (WPF)</span><span class="sxs-lookup"><span data-stu-id="10160-109">Windows Presentation Foundation (WPF)</span></span>
