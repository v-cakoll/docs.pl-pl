...
Ta sekcja zawiera przykłady ilustrujące niestandardowe zabezpieczeń w systemie Windows Communication Foundation (WCF).  
  
## <a name="in-this-section"></a>W tej sekcji  
 [Niezawodny dostawca wystawionych tokenów](../../../../docs/framework/wcf/samples/durable-issued-token-provider.md)  
 Pokazuje, jak do implementowania dostawcy niestandardowego klienta wystawiony token.  
  
 [Dostawca tokenów SAML](../../../../docs/framework/wcf/samples/saml-token-provider.md)  
 Pokazuje, jak do zaimplementowania niestandardowego klienta dostawcy tokenu SAML.  
 ...
 Pokazuje, jak wdrożyć niestandardowy moduł weryfikacji certyfikatów X.509.  
  
 [Zasady autoryzacji](../../../../docs/framework/wcf/samples/authorization-policy.md)  
 Pokazuje, jak wdrożyć zasady autoryzacji oświadczeń i skojarzona usługa niestandardowych Menedżera autoryzacji.  
  
 [Token niestandardowy](../../../../docs/framework/wcf/samples/custom-token.md)  
 Przedstawiono sposób dodawania niestandardowych implementacji token do aplikacji Windows Communication Foundation (WCF).  
