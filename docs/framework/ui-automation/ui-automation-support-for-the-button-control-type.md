...
|------------------|------------------|  
|Przycisk<br /><br /> -   Image (0 or more)<br />-   Text (0 or more)|Przycisk|  
...
|<xref:System.Windows.Automation.AutomationElementIdentifiers.ControlTypeProperty>|Przycisk|This value is the same for all UI frameworks.|  
