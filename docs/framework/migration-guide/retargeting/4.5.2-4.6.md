---
title: Przekierowywanie zmian dotyczących migracji z .NET Framework 4.5.2 do 4,6
description: Znajdź informacje o problemach ze zgodnością aplikacji, które mogą mieć wpływ na aplikację podczas migracji z .NET Framework 4.5.2 do 4,6.
ms.date: 07/10/2019
...
ms.locfileid: "86443744"
---
# <a name="retargeting-changes-for-migration-from-net-framework-452-to-46"></a><span data-ttu-id="5ff87-103">Przekierowywanie zmian dotyczących migracji z .NET Framework 4.5.2 do 4,6</span><span class="sxs-lookup"><span data-stu-id="5ff87-103">Retargeting Changes for Migration from .NET Framework 4.5.2 to 4.6</span></span>

[!INCLUDE[versionselector](../../../../includes/migration-guide/retargeting/versionselector.md)]

<span data-ttu-id="5ff87-104">W przypadku migrowania z .NET Framework 4.5.2 do 4,6 zapoznaj się z następującymi tematami dotyczącymi problemów ze zgodnością aplikacji, które mogą mieć wpływ na aplikację:</span><span class="sxs-lookup"><span data-stu-id="5ff87-104">If you are migrating from the .NET Framework 4.5.2 to 4.6, review the following topics for application compatibility issues that may affect your app:</span></span>

## <a name="aspnet"></a><span data-ttu-id="5ff87-105">ASP.NET</span><span class="sxs-lookup"><span data-stu-id="5ff87-105">ASP.NET</span></span>
...
## <a name="clickonce"></a><span data-ttu-id="5ff87-106">ClickOnce</span><span class="sxs-lookup"><span data-stu-id="5ff87-106">ClickOnce</span></span>
...
## <a name="core"></a><span data-ttu-id="5ff87-107">Core</span><span class="sxs-lookup"><span data-stu-id="5ff87-107">Core</span></span>
...
## <a name="entity-framework"></a><span data-ttu-id="5ff87-108">Entity Framework</span><span class="sxs-lookup"><span data-stu-id="5ff87-108">Entity Framework</span></span>
...
## <a name="jit"></a><span data-ttu-id="5ff87-109">JIT</span><span class="sxs-lookup"><span data-stu-id="5ff87-109">JIT</span></span>
...
## <a name="networking"></a><span data-ttu-id="5ff87-110">Sieć</span><span class="sxs-lookup"><span data-stu-id="5ff87-110">Networking</span></span>
...
## <a name="windows-communication-foundation-wcf"></a><span data-ttu-id="5ff87-111">Windows Communication Foundation (WCF)</span><span class="sxs-lookup"><span data-stu-id="5ff87-111">Windows Communication Foundation (WCF)</span></span>
...
## <a name="windows-forms"></a><span data-ttu-id="5ff87-112">Windows Forms</span><span class="sxs-lookup"><span data-stu-id="5ff87-112">Windows Forms</span></span>
...
## <a name="windows-presentation-foundation-wpf"></a><span data-ttu-id="5ff87-113">Windows Presentation Foundation (WPF)</span><span class="sxs-lookup"><span data-stu-id="5ff87-113">Windows Presentation Foundation (WPF)</span></span>
...
## <a name="xml-xslt"></a><span data-ttu-id="5ff87-114">Języki XML, XSLT</span><span class="sxs-lookup"><span data-stu-id="5ff87-114">XML, XSLT</span></span>
