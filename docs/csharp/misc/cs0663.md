...
Nie można definiować przeciążonych metod, które różnią się jedynie parametrami ref i out.  
 ...
 Metody, które różnią się tylko na ich użycie [ref](../../csharp/language-reference/keywords/ref.md) i [limit](../../csharp/language-reference/keywords/out.md) nie są dozwolone w parametrze.  
