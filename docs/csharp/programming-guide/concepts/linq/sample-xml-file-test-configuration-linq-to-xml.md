...
Poniższy plik XML jest używany w [!INCLUDE[sqltecxlinq](~/includes/sqltecxlinq-md.md)] różnych przykładach w dokumentacji. Jest to plik konfiguracji testu.  
  
## <a name="testconfigxml"></a>Plik TestConfig.xml  
