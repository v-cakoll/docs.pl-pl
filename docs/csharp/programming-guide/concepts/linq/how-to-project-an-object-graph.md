...
ms.locfileid: "70253481"
---
# <a name="how-to-project-an-object-graph-c"></a><span data-ttu-id="d06e3-102">Instrukcje: Tworzenie projektu grafu obiektówC#()</span><span class="sxs-lookup"><span data-stu-id="d06e3-102">How to: Project an Object Graph (C#)</span></span>
<span data-ttu-id="d06e3-103">W tym temacie pokazano, jak projektować i wypełniać Graf obiektów z pliku XML.</span><span class="sxs-lookup"><span data-stu-id="d06e3-103">This topic illustrates how to project, or populate, an object graph from XML.</span></span>  
  
## <a name="example"></a><span data-ttu-id="d06e3-104">Przykład</span><span class="sxs-lookup"><span data-stu-id="d06e3-104">Example</span></span>  
 <span data-ttu-id="d06e3-105">Poniższy kod wypełnia wykres `Address`obiektu przy użyciu klas, `PurchaseOrder`i `PurchaseOrderItem` z [przykładowego pliku XML: Typowy dokument XML zamówienia zakupu (](./sample-xml-file-typical-purchase-order-linq-to-xml-1.md) LINQ to XML).</span><span class="sxs-lookup"><span data-stu-id="d06e3-105">The following code populates an object graph with the `Address`, `PurchaseOrder`, and `PurchaseOrderItem` classes from the [Sample XML File: Typical Purchase Order (LINQ to XML)](./sample-xml-file-typical-purchase-order-linq-to-xml-1.md) XML document.</span></span>  
...
```  
 ...
 <span data-ttu-id="d06e3-106">W tym przykładzie wynik [!INCLUDE[vbteclinq](~/includes/vbteclinq-md.md)] zapytania jest zwracany <xref:System.Collections.Generic.IEnumerable%601> jako z `PurchaseOrderItem`.</span><span class="sxs-lookup"><span data-stu-id="d06e3-106">In this example, the result of the [!INCLUDE[vbteclinq](~/includes/vbteclinq-md.md)] query is returned as an <xref:System.Collections.Generic.IEnumerable%601> of `PurchaseOrderItem`.</span></span> <span data-ttu-id="d06e3-107">Elementy w `PurchaseOrder` klasie są <xref:System.Collections.Generic.IEnumerable%601> `PurchaseOrderItem`typu.</span><span class="sxs-lookup"><span data-stu-id="d06e3-107">The items in the `PurchaseOrder` class are of type <xref:System.Collections.Generic.IEnumerable%601> of `PurchaseOrderItem`.</span></span> <span data-ttu-id="d06e3-108">Kod używa metody rozszerzającej, <xref:System.Linq.Enumerable.ToList%2A> aby <xref:System.Collections.Generic.List%601> utworzyć kolekcję na podstawie wyników zapytania.</span><span class="sxs-lookup"><span data-stu-id="d06e3-108">The code uses the <xref:System.Linq.Enumerable.ToList%2A> extension method to create a <xref:System.Collections.Generic.List%601> collection from the results of the query.</span></span>  
  
 <span data-ttu-id="d06e3-109">Przykład generuje następujące dane wyjściowe:</span><span class="sxs-lookup"><span data-stu-id="d06e3-109">The example produces the following output:</span></span>  
...
## <a name="see-also"></a><span data-ttu-id="d06e3-110">Zobacz także</span><span class="sxs-lookup"><span data-stu-id="d06e3-110">See also</span></span>
