---
title: 'Instrukcje: Konwertuj BitmapSource na format indeksowanych pikseli'
ms.date: 03/30/2017
dev_langs:
- csharp
- vb
...
ms.locfileid: "57360722"
---
# <a name="how-to-convert-a-bitmapsource-to-an-indexed-pixel-format"></a><span data-ttu-id="8672d-102">Instrukcje: Konwertuj BitmapSource na format indeksowanych pikseli</span><span class="sxs-lookup"><span data-stu-id="8672d-102">How to: Convert a BitmapSource to an Indexed Pixel Format</span></span>
<span data-ttu-id="8672d-103">Ten przykład pokazuje sposób konwertowania <xref:System.Windows.Media.Imaging.BitmapSource> na format indeksowanych pikseli.</span><span class="sxs-lookup"><span data-stu-id="8672d-103">This example shows how to convert a <xref:System.Windows.Media.Imaging.BitmapSource> to an indexed pixel format.</span></span>  
  
## <a name="example"></a><span data-ttu-id="8672d-104">Przykład</span><span class="sxs-lookup"><span data-stu-id="8672d-104">Example</span></span>  
