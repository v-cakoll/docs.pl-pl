...
-   [Projekcji](../../../../docs/framework/data/adonet/query-expression-syntax-examples-projection-linq-to-dataset.md)  
  
-   [Ograniczenie](../../../../docs/framework/data/adonet/query-expression-syntax-examples-restriction-linq-to-dataset.md)  
  
-   [Podział na partycje](../../../../docs/framework/data/adonet/query-expression-syntax-examples-partitioning.md)  
  
-   [Kolejność](../../../../docs/framework/data/adonet/query-expression-syntax-examples-ordering-linq-to-dataset.md)  
  
-   [Operatory — element](../../../../docs/framework/data/adonet/query-expression-syntax-examples-element-operators.md)  
  
-   [Operatory agregacji](../../../../docs/framework/data/adonet/query-expression-syntax-examples-aggregate-operators.md)  
  
-   [Dołącz do operatorów](../../../../docs/framework/data/adonet/query-expression-syntax-examples-join-operators.md)  
  
 [Przykłady zapytań — metoda](../../../../docs/framework/data/adonet/method-based-query-examples-linq-to-dataset.md)  
 Zawiera następujące przykłady:  
