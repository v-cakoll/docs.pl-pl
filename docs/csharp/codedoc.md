...
@No__t_0 jest **wymaganym** atrybutem, który reprezentuje odwołanie do typu lub jego elementu członkowskiego, który jest dostępny w bieżącym środowisku kompilacji.
...
Narzędzia takie jak Sandcastle zapewniają obsługę dodatkowych tagów, takich jak [`<event>`](https://ewsoftware.github.io/XMLCommentsGuide/html/81bf7ad3-45dc-452f-90d5-87ce2494a182.htm), [`<note>`](https://ewsoftware.github.io/XMLCommentsGuide/html/4302a60f-e4f4-4b8d-a451-5f453c4ebd46.htm) i nawet obsługują [dokumenty przestrzeni nazw](https://ewsoftware.github.io/XMLCommentsGuide/html/BD91FAD4-188D-4697-A654-7C07FD47EF31.htm).
...
- Kompilator weryfikuje składnię `<exception>`, `<include>`, `<param>`, `<see>`, `<seealso>` i `<typeparam>`.
