...
Gdy debugujesz aplikację usługi systemu Windows, usługa i **Service Manager systemu Windows** współpracują. **Service Manager** uruchamia usługę, wywołując <xref:System.ServiceProcess.ServiceBase.OnStart%2A> metodę, a następnie czeka 30 sekund na zwrócenie <xref:System.ServiceProcess.ServiceBase.OnStart%2A> metody. Jeśli metoda nie zwróci tego czasu, Menedżer pokazuje błąd, że nie można uruchomić usługi.  
