...
ms.locfileid: "73125916"
---
# <a name="retargeting-changes-for-migration-from-net-framework-452-to-471"></a><span data-ttu-id="f8495-102">Przekierowywanie zmian dotyczących migracji z .NET Framework 4.5.2 do 4.7.1</span><span class="sxs-lookup"><span data-stu-id="f8495-102">Retargeting Changes for Migration from .NET Framework 4.5.2 to 4.7.1</span></span>

[!INCLUDE[versionselector](../../../../includes/migration-guide/retargeting/versionselector.md)]

[!INCLUDE[introduction](../../../../includes/migration-guide/retargeting/introduction.md)]

<span data-ttu-id="f8495-103">W przypadku migrowania z .NET Framework 4.5.2 do 4.7.1 zapoznaj się z następującymi tematami dotyczącymi problemów ze zgodnością aplikacji, które mogą mieć wpływ na aplikację:</span><span class="sxs-lookup"><span data-stu-id="f8495-103">If you are migrating from the .NET Framework 4.5.2 to 4.7.1, review the following topics for application compatibility issues that may affect your app:</span></span>

## <a name="aspnet"></a><span data-ttu-id="f8495-104">Platforma ASP.NET</span><span class="sxs-lookup"><span data-stu-id="f8495-104">ASP.NET</span></span>
...
## <a name="clickonce"></a><span data-ttu-id="f8495-105">ClickOnce</span><span class="sxs-lookup"><span data-stu-id="f8495-105">ClickOnce</span></span>
...
## <a name="core"></a><span data-ttu-id="f8495-106">Core</span><span class="sxs-lookup"><span data-stu-id="f8495-106">Core</span></span>
...
## <a name="entity-framework"></a><span data-ttu-id="f8495-107">Entity Framework</span><span class="sxs-lookup"><span data-stu-id="f8495-107">Entity Framework</span></span>
...
## <a name="jit"></a><span data-ttu-id="f8495-108">JIT</span><span class="sxs-lookup"><span data-stu-id="f8495-108">JIT</span></span>
...
## <a name="networking"></a><span data-ttu-id="f8495-109">Obsługa sieci</span><span class="sxs-lookup"><span data-stu-id="f8495-109">Networking</span></span>
...
## <a name="security"></a><span data-ttu-id="f8495-110">Zabezpieczenia</span><span class="sxs-lookup"><span data-stu-id="f8495-110">Security</span></span>
...
## <a name="windows-communication-foundation-wcf"></a><span data-ttu-id="f8495-111">Windows Communication Foundation (WCF)</span><span class="sxs-lookup"><span data-stu-id="f8495-111">Windows Communication Foundation (WCF)</span></span>
...
## <a name="windows-forms"></a><span data-ttu-id="f8495-112">Windows Forms</span><span class="sxs-lookup"><span data-stu-id="f8495-112">Windows Forms</span></span>
...
## <a name="windows-presentation-foundation-wpf"></a><span data-ttu-id="f8495-113">Windows Presentation Foundation (WPF)</span><span class="sxs-lookup"><span data-stu-id="f8495-113">Windows Presentation Foundation (WPF)</span></span>
...
## <a name="windows-workflow-foundation-wf"></a><span data-ttu-id="f8495-114">Program Windows Workflow Foundation (WF)</span><span class="sxs-lookup"><span data-stu-id="f8495-114">Windows Workflow Foundation (WF)</span></span>
...
## <a name="xml-xslt"></a><span data-ttu-id="f8495-115">Języki XML, XSLT</span><span class="sxs-lookup"><span data-stu-id="f8495-115">XML, XSLT</span></span>
