...
---
# <a name="overload-resolution-failed-because-no-accessible-ltgenericprocedurenamegt-accepts-this-number-of-type-arguments"></a>Ustalanie przeciążenia nie powiodło się, ponieważ nie jest dostępny "&lt;genericprocedurename&gt;" nie akceptuje tej liczby argumentów typu
