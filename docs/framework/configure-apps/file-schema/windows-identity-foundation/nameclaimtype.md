...
|Atrybut|Opis|  
|---------------|-----------------|  
|value|Ciąg określający URI, który reprezentuje typ oświadczenia oświadczenia do użycia na potrzeby <xref:System.Security.Principal.IIdentity.Name%2A> właściwości. Wymagana.|  
