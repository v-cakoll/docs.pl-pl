...
Przypomina on w systemie Linux, oczywiście. Nazwa funkcji jest takie same, ponieważ `getpid(2)` jest [POSIX](https://en.wikipedia.org/wiki/POSIX) wywołanie systemowe.
