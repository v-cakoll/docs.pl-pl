...
Iteratory nie mogą mieć parametrów out lub ref  
 ...
 Ten błąd występuje, jeśli metoda iteratora jest przyjmuje `in`, `ref`, lub `out` parametru. Aby uniknąć tego błędu, Usuń `in`, `ref`, lub `out` słowa kluczowego w podpisie metody.  
  
## <a name="example"></a>Przykład  
 Poniższy przykład spowoduje wygenerowanie CS1623:  
