...
ms.locfileid: "85621166"
---
# <a name="runtime-changes-for-migration-from-net-framework-40-to-472"></a><span data-ttu-id="953e6-102">Zmiany w środowisku uruchomieniowym dotyczące migracji z .NET Framework 4,0 do 4.7.2</span><span class="sxs-lookup"><span data-stu-id="953e6-102">Runtime Changes for Migration from .NET Framework 4.0 to 4.7.2</span></span>

[!INCLUDE[versionselector](../../../../includes/migration-guide/runtime/versionselector.md)]

<span data-ttu-id="953e6-103">W przypadku migrowania z .NET Framework 4,0 do usługi 4.7.2 zapoznaj się z następującymi tematami dotyczącymi problemów ze zgodnością aplikacji, które mogą mieć wpływ na aplikację:</span><span class="sxs-lookup"><span data-stu-id="953e6-103">If you are migrating from the .NET Framework 4.0 to 4.7.2, review the following topics for application compatibility issues that may affect your app:</span></span>

## <a name="adonet"></a><span data-ttu-id="953e6-104">ADO.NET</span><span class="sxs-lookup"><span data-stu-id="953e6-104">ADO.NET</span></span>
...
## <a name="aspnet"></a><span data-ttu-id="953e6-105">ASP.NET</span><span class="sxs-lookup"><span data-stu-id="953e6-105">ASP.NET</span></span>
...
## <a name="core"></a><span data-ttu-id="953e6-106">Core</span><span class="sxs-lookup"><span data-stu-id="953e6-106">Core</span></span>
...
## <a name="data"></a><span data-ttu-id="953e6-107">Dane</span><span class="sxs-lookup"><span data-stu-id="953e6-107">Data</span></span>
...
## <a name="entity-framework"></a><span data-ttu-id="953e6-108">Entity Framework</span><span class="sxs-lookup"><span data-stu-id="953e6-108">Entity Framework</span></span>
...
## <a name="globalization"></a><span data-ttu-id="953e6-109">Globalizacja</span><span class="sxs-lookup"><span data-stu-id="953e6-109">Globalization</span></span>
...
## <a name="linq"></a><span data-ttu-id="953e6-110">LINQ</span><span class="sxs-lookup"><span data-stu-id="953e6-110">LINQ</span></span>
...
## <a name="managed-extensibility-framework-mef"></a><span data-ttu-id="953e6-111">Managed Extensibility Framework (MEF)</span><span class="sxs-lookup"><span data-stu-id="953e6-111">Managed Extensibility Framework (MEF)</span></span>
...
## <a name="networking"></a><span data-ttu-id="953e6-112">Networking</span><span class="sxs-lookup"><span data-stu-id="953e6-112">Networking</span></span>
...
## <a name="printing"></a><span data-ttu-id="953e6-113">Drukowanie</span><span class="sxs-lookup"><span data-stu-id="953e6-113">Printing</span></span>
...
## <a name="runtime"></a><span data-ttu-id="953e6-114">Środowisko uruchomieniowe</span><span class="sxs-lookup"><span data-stu-id="953e6-114">Runtime</span></span>

[!INCLUDE[Improved WCF chain trust certificate validation for Net.Tcp certificate authentication](~/includes/migration-guide/runtime/runtime/improved-wcf-chain-trust-certificate-validation-for-nettcp-authentication.md)]

## <a name="security"></a><span data-ttu-id="953e6-115">Zabezpieczenia</span><span class="sxs-lookup"><span data-stu-id="953e6-115">Security</span></span>
...
## <a name="serialization"></a><span data-ttu-id="953e6-116">Serializacja</span><span class="sxs-lookup"><span data-stu-id="953e6-116">Serialization</span></span>
...
## <a name="setup-and-deployment"></a><span data-ttu-id="953e6-117">Instalacja i wdrożenie</span><span class="sxs-lookup"><span data-stu-id="953e6-117">Setup and Deployment</span></span>
...
## <a name="tools"></a><span data-ttu-id="953e6-118">narzędzia</span><span class="sxs-lookup"><span data-stu-id="953e6-118">Tools</span></span>

[!INCLUDE[Contract.Invariant or Contract.Requires\<TException> do not consider String.IsNullOrEmpty to be pure](~/includes/migration-guide/runtime/tools/contractinvariant-contractrequirestexception-do-not-consider.md)]

## <a name="web-applications"></a><span data-ttu-id="953e6-119">Aplikacje internetowe</span><span class="sxs-lookup"><span data-stu-id="953e6-119">Web Applications</span></span>
...
## <a name="windows-communication-foundation-wcf"></a><span data-ttu-id="953e6-120">Windows Communication Foundation (WCF)</span><span class="sxs-lookup"><span data-stu-id="953e6-120">Windows Communication Foundation (WCF)</span></span>
...
## <a name="windows-forms"></a><span data-ttu-id="953e6-121">Windows Forms</span><span class="sxs-lookup"><span data-stu-id="953e6-121">Windows Forms</span></span>
...
## <a name="windows-presentation-foundation-wpf"></a><span data-ttu-id="953e6-122">Windows Presentation Foundation (WPF)</span><span class="sxs-lookup"><span data-stu-id="953e6-122">Windows Presentation Foundation (WPF)</span></span>
...
## <a name="windows-workflow-foundation-wf"></a><span data-ttu-id="953e6-123">Program Windows Workflow Foundation (WF)</span><span class="sxs-lookup"><span data-stu-id="953e6-123">Windows Workflow Foundation (WF)</span></span>
...
## <a name="xml-xslt"></a><span data-ttu-id="953e6-124">Języki XML, XSLT</span><span class="sxs-lookup"><span data-stu-id="953e6-124">XML, XSLT</span></span>
