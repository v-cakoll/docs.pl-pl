...
|Metoda|Opis|  
|------------|-----------------|  
|[SetNotifyFilter, metoda](../../../../docs/framework/unmanaged-api/diagnostics/inotifysource2-setnotifyfilter-method.md)|Przypisuje filtr powiadomień do użycia z tym źródłem.|  
