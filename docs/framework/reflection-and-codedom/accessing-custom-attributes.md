...
2. Środowisko uruchomieniowe sprawdza, czy zdefiniowany przez użytkownika typ **WebDescriptionAttribute** , który pochodzi od **DescriptionAttribute** , jest widoczny i dostępny w ramach zestawu **System. Web. dll** , który jest dołączony do metody **GetLanguage**().  
