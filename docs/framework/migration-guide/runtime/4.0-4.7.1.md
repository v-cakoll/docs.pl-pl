...
---
# <a name="runtime-changes-for-migration-from-net-framework-40-to-471"></a>Zmiany środowiska uruchomieniowego do migracji z platformy .NET Framework 4.0 do 4.7.1

[!INCLUDE[versionselector](../../../../includes/migration-guide/runtime/versionselector.md)]

[!INCLUDE[introduction](../../../../includes/migration-guide/runtime/introduction.md)]

Migracji z programu .NET Framework 4.0 do 4.7.1, przejrzyj problemy ze zgodnością aplikacji, które mogą wpływać na Twoją aplikację w poniższych tematach:
