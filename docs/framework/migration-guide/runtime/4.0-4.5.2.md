...
---
# <a name="runtime-changes-for-migration-from-net-framework-40-to-452"></a><span data-ttu-id="106df-102">Zmiany środowiska uruchomieniowego do migracji z platformy .NET Framework 4.0 do 4.5.2</span><span class="sxs-lookup"><span data-stu-id="106df-102">Runtime Changes for Migration from .NET Framework 4.0 to 4.5.2</span></span>

[!include[versionselector](../../../../includes/migration-guide/runtime/versionselector.md)]

[!include[introduction](../../../../includes/migration-guide/runtime/introduction.md)]

<span data-ttu-id="106df-103">Jeśli w przypadku migracji z programu .NET Framework 4.0 do 4.5.2, należy przejrzeć następujące tematy dla problemów ze zgodnością aplikacji, które mogą wpływać na aplikację:</span><span class="sxs-lookup"><span data-stu-id="106df-103">If you are migrating from the .NET Framework 4.0 to 4.5.2, review the following topics for application compatibility issues that may affect your app:</span></span>

## <a name="adonet"></a><span data-ttu-id="106df-104">ADO.NET</span><span class="sxs-lookup"><span data-stu-id="106df-104">ADO.NET</span></span>
...
## <a name="aspnet"></a><span data-ttu-id="106df-105">ASP.NET</span><span class="sxs-lookup"><span data-stu-id="106df-105">ASP.NET</span></span>
...
## <a name="core"></a><span data-ttu-id="106df-106">Core</span><span class="sxs-lookup"><span data-stu-id="106df-106">Core</span></span>
...
## <a name="data"></a><span data-ttu-id="106df-107">Dane</span><span class="sxs-lookup"><span data-stu-id="106df-107">Data</span></span>
...
## <a name="debugger"></a><span data-ttu-id="106df-108">Debugger</span><span class="sxs-lookup"><span data-stu-id="106df-108">Debugger</span></span>
...
## <a name="entity-framework"></a><span data-ttu-id="106df-109">Entity Framework</span><span class="sxs-lookup"><span data-stu-id="106df-109">Entity Framework</span></span>
...
## <a name="linq"></a><span data-ttu-id="106df-110">LINQ</span><span class="sxs-lookup"><span data-stu-id="106df-110">LINQ</span></span>
...
## <a name="managed-extensibility-framework-mef"></a><span data-ttu-id="106df-111">Managed Extensibility Framework (MEF)</span><span class="sxs-lookup"><span data-stu-id="106df-111">Managed Extensibility Framework (MEF)</span></span>
...
## <a name="networking"></a><span data-ttu-id="106df-112">Obsługa sieci</span><span class="sxs-lookup"><span data-stu-id="106df-112">Networking</span></span>
...
## <a name="printing"></a><span data-ttu-id="106df-113">Drukowanie</span><span class="sxs-lookup"><span data-stu-id="106df-113">Printing</span></span>
...
## <a name="serialization"></a><span data-ttu-id="106df-114">Serializacja</span><span class="sxs-lookup"><span data-stu-id="106df-114">Serialization</span></span>
...
## <a name="web-applications"></a><span data-ttu-id="106df-115">Aplikacje sieci Web</span><span class="sxs-lookup"><span data-stu-id="106df-115">Web Applications</span></span>
...
## <a name="windows-communication-foundation-wcf"></a><span data-ttu-id="106df-116">Windows Communication Foundation (WCF)</span><span class="sxs-lookup"><span data-stu-id="106df-116">Windows Communication Foundation (WCF)</span></span>
...
## <a name="windows-forms"></a><span data-ttu-id="106df-117">Windows Forms</span><span class="sxs-lookup"><span data-stu-id="106df-117">Windows Forms</span></span>
...
## <a name="windows-presentation-foundation-wpf"></a><span data-ttu-id="106df-118">Windows Presentation Foundation (WPF)</span><span class="sxs-lookup"><span data-stu-id="106df-118">Windows Presentation Foundation (WPF)</span></span>
...
## <a name="windows-workflow-foundation-wf"></a><span data-ttu-id="106df-119">Program Windows Workflow Foundation (WF)</span><span class="sxs-lookup"><span data-stu-id="106df-119">Windows Workflow Foundation (WF)</span></span>
...
## <a name="xml-xslt"></a><span data-ttu-id="106df-120">Języki XML, XSLT</span><span class="sxs-lookup"><span data-stu-id="106df-120">XML, XSLT</span></span>
