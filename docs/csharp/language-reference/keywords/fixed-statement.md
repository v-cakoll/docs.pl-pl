...
Aby uzyskać więcej informacji, zobacz [instrukcji fixed](~/_csharplang/spec/unsafe-code.md#the-fixed-statement) części [ C# specyfikacji języka](~/_csharplang/spec/introduction.md).
