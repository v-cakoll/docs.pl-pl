...
---
# <a name="runtime-changes-for-migration-from-net-framework-452-to-46"></a>Zmiany środowiska uruchomieniowego dla migracji z programu .NET Framework 4.5.2 do 4.6
