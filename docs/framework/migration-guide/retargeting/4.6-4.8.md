...
---
# <a name="retargeting-changes-for-migration-from-net-framework-46-to-48"></a>Zmiany retargetingu migracji z .NET Framework 4.6 lub 4.8

[!INCLUDE[versionselector](../../../../includes/migration-guide/retargeting/versionselector.md)]

[!INCLUDE[introduction](../../../../includes/migration-guide/retargeting/introduction.md)]

Migracji z programu .NET Framework 4.6 do 4,8, przejrzyj problemy ze zgodnością aplikacji, które mogą wpływać na Twoją aplikację w poniższych tematach:
