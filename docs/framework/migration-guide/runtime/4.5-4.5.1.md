...
---
# <a name="runtime-changes-for-migration-from-net-framework-45-to-451"></a>Zmiany środowiska uruchomieniowego do migracji z programu .NET Framework 4.5 i 4.5.1
