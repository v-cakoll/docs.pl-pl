...
W tym temacie opisano typ języka dostawcy języka i stałe typu dokumentu, które są zdefiniowane w CorSym.idl.  
...
|CorSym_LanguageType_CSharp|Wskazuje języka C#.|  
...
|CorSym_LanguageType_ILAssembly|Wskazuje kod zestawu język pośredni (MSIL) firmy Microsoft.|  
|CorSym_LanguageType_JScript|Wskazuje języka JScript.|  
|CorSym_LanguageType_SMC|Określa język SMC.|  
|CorSym_LanguageType_MCPlusPlus|Określa język C++ włączone dla programu .NET Framework.|  
...
## <a name="document-type-constants"></a>Stałe typu dokumentu  
 W poniższej tabeli przedstawiono dokumentu stałe typów, które reprezentują identyfikatorami GUID określającymi typów dokumentów.  
  
|Symbol|Opis|  
|------------|-----------------|  
|CorSym_DocumentType_Text|Wskazuje dokument tekstowy.|  
|CorSym_DocumentType_MC|Wskazuje nietekstowych dokumentu.|  
