...
## <a name="in-this-section"></a>W tej sekcji  
 ...
 W tym artykule opisano niezarządzane interfejsy, które używa fusion interfejsu API.  
  
 [Łączenie statycznych funkcji globalnych](../../../../docs/framework/unmanaged-api/fusion/fusion-global-static-functions.md)  
 Opisuje niezarządzane statyczne funkcje globalne, używane fusion interfejsu API.  
  
 [Wyliczenia łączenia](../../../../docs/framework/unmanaged-api/fusion/fusion-enumerations.md)  
 W tym artykule opisano niezarządzane wyliczenia, używane fusion interfejsu API.  
  
 [Łączenie — struktury](../../../../docs/framework/unmanaged-api/fusion/fusion-structures.md)  
 W tym artykule opisano niezarządzane struktury, używane fusion interfejsu API.
