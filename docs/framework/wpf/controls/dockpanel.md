...
<xref:System.Windows.Controls.DockPanel> Element jest używana do pozycjonowania zawartość elementu podrzędnego wzdłuż krawędzi kontener układu.  
  
## <a name="in-this-section"></a>W tej sekcji  
 [Tematy z instrukcjami](../../../../docs/framework/wpf/controls/dockpanel-how-to-topics.md)  
