...
ms.locfileid: "86443198"
---
# <a name="runtime-changes-for-migration-from-net-framework-45-to-462"></a><span data-ttu-id="b12af-103">Zmiany w środowisku uruchomieniowym dotyczące migracji z .NET Framework 4,5 do 4.6.2</span><span class="sxs-lookup"><span data-stu-id="b12af-103">Runtime Changes for Migration from .NET Framework 4.5 to 4.6.2</span></span>

[!INCLUDE[versionselector](../../../../includes/migration-guide/runtime/versionselector.md)]

<span data-ttu-id="b12af-104">W przypadku migrowania z .NET Framework 4,5 do usługi 4.6.2 zapoznaj się z następującymi tematami dotyczącymi problemów ze zgodnością aplikacji, które mogą mieć wpływ na aplikację:</span><span class="sxs-lookup"><span data-stu-id="b12af-104">If you are migrating from the .NET Framework 4.5 to 4.6.2, review the following topics for application compatibility issues that may affect your app:</span></span>

## <a name="adonet"></a><span data-ttu-id="b12af-105">ADO.NET</span><span class="sxs-lookup"><span data-stu-id="b12af-105">ADO.NET</span></span>
...
## <a name="aspnet"></a><span data-ttu-id="b12af-106">ASP.NET</span><span class="sxs-lookup"><span data-stu-id="b12af-106">ASP.NET</span></span>
...
## <a name="core"></a><span data-ttu-id="b12af-107">Core</span><span class="sxs-lookup"><span data-stu-id="b12af-107">Core</span></span>
...
## <a name="data"></a><span data-ttu-id="b12af-108">Dane</span><span class="sxs-lookup"><span data-stu-id="b12af-108">Data</span></span>
...
## <a name="debugger"></a><span data-ttu-id="b12af-109">Debuger</span><span class="sxs-lookup"><span data-stu-id="b12af-109">Debugger</span></span>
...
## <a name="entity-framework"></a><span data-ttu-id="b12af-110">Entity Framework</span><span class="sxs-lookup"><span data-stu-id="b12af-110">Entity Framework</span></span>
...
## <a name="globalization"></a><span data-ttu-id="b12af-111">Globalizacja</span><span class="sxs-lookup"><span data-stu-id="b12af-111">Globalization</span></span>
...
## <a name="networking"></a><span data-ttu-id="b12af-112">Sieć</span><span class="sxs-lookup"><span data-stu-id="b12af-112">Networking</span></span>
...
## <a name="security"></a><span data-ttu-id="b12af-113">Zabezpieczenia</span><span class="sxs-lookup"><span data-stu-id="b12af-113">Security</span></span>
...
## <a name="serialization"></a><span data-ttu-id="b12af-114">Serializacja</span><span class="sxs-lookup"><span data-stu-id="b12af-114">Serialization</span></span>
...
## <a name="setup-and-deployment"></a><span data-ttu-id="b12af-115">Instalacja i wdrożenie</span><span class="sxs-lookup"><span data-stu-id="b12af-115">Setup and Deployment</span></span>
...
## <a name="tools"></a><span data-ttu-id="b12af-116">Narzędzia</span><span class="sxs-lookup"><span data-stu-id="b12af-116">Tools</span></span>

[!INCLUDE[Contract.Invariant or Contract.Requires\<TException> do not consider String.IsNullOrEmpty to be pure](~/includes/migration-guide/runtime/tools/contractinvariant-contractrequirestexception-do-not-consider.md)]

## <a name="windows-communication-foundation-wcf"></a><span data-ttu-id="b12af-117">Windows Communication Foundation (WCF)</span><span class="sxs-lookup"><span data-stu-id="b12af-117">Windows Communication Foundation (WCF)</span></span>
...
## <a name="windows-presentation-foundation-wpf"></a><span data-ttu-id="b12af-118">Windows Presentation Foundation (WPF)</span><span class="sxs-lookup"><span data-stu-id="b12af-118">Windows Presentation Foundation (WPF)</span></span>
