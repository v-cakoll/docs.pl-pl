...
###  <a name="WFDesigner"></a><span data-ttu-id="18cea-115">Za pomocą wyrażeń C# w Projektancie przepływów pracy</span><span class="sxs-lookup"><span data-stu-id="18cea-115">Using C# expressions in the Workflow Designer</span></span>  
...
####  <a name="BackwardCompat"></a><span data-ttu-id="18cea-124">Zapewnienia zgodności</span><span class="sxs-lookup"><span data-stu-id="18cea-124">Backwards compatibility</span></span>  
...
###  <a name="CodeWorkflows"></a><span data-ttu-id="18cea-130">Za pomocą wyrażeń C# w przepływach pracy kodu</span><span class="sxs-lookup"><span data-stu-id="18cea-130">Using C# expressions in code workflows</span></span>  
...
###  <a name="XamlWorkflows"></a><span data-ttu-id="18cea-147">Za pomocą wyrażeń C# w przepływach pracy XAML</span><span class="sxs-lookup"><span data-stu-id="18cea-147">Using C# expressions in XAML workflows</span></span>  
...
####  <a name="CompiledXaml"></a><span data-ttu-id="18cea-152">Skompilowany Xaml</span><span class="sxs-lookup"><span data-stu-id="18cea-152">Compiled Xaml</span></span>  
...
####  <a name="LooseXaml"></a><span data-ttu-id="18cea-155">Luźne Xaml</span><span class="sxs-lookup"><span data-stu-id="18cea-155">Loose Xaml</span></span>  
...
###  <a name="WFServices"></a><span data-ttu-id="18cea-162">Za pomocą wyrażeń C# w XAMLX usług przepływu pracy</span><span class="sxs-lookup"><span data-stu-id="18cea-162">Using C# expressions in XAMLX workflow services</span></span>  
