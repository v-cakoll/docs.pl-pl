...
ms.locfileid: "73194139"
---
# <a name="retargeting-changes-for-migration-from-net-framework-452-to-461"></a><span data-ttu-id="8ce9b-102">Przekierowywanie zmian dotyczących migracji z .NET Framework 4.5.2 do 4.6.1</span><span class="sxs-lookup"><span data-stu-id="8ce9b-102">Retargeting Changes for Migration from .NET Framework 4.5.2 to 4.6.1</span></span>

[!INCLUDE[versionselector](../../../../includes/migration-guide/retargeting/versionselector.md)]

<span data-ttu-id="8ce9b-103">W przypadku migrowania z .NET Framework 4.5.2 do 4.6.1 zapoznaj się z następującymi tematami dotyczącymi problemów ze zgodnością aplikacji, które mogą mieć wpływ na aplikację:</span><span class="sxs-lookup"><span data-stu-id="8ce9b-103">If you are migrating from the .NET Framework 4.5.2 to 4.6.1, review the following topics for application compatibility issues that may affect your app:</span></span>

## <a name="aspnet"></a><span data-ttu-id="8ce9b-104">Platforma ASP.NET</span><span class="sxs-lookup"><span data-stu-id="8ce9b-104">ASP.NET</span></span>
...
## <a name="clickonce"></a><span data-ttu-id="8ce9b-105">ClickOnce</span><span class="sxs-lookup"><span data-stu-id="8ce9b-105">ClickOnce</span></span>
...
## <a name="core"></a><span data-ttu-id="8ce9b-106">Core</span><span class="sxs-lookup"><span data-stu-id="8ce9b-106">Core</span></span>
...
## <a name="entity-framework"></a><span data-ttu-id="8ce9b-107">Entity Framework</span><span class="sxs-lookup"><span data-stu-id="8ce9b-107">Entity Framework</span></span>
...
## <a name="jit"></a><span data-ttu-id="8ce9b-108">JIT</span><span class="sxs-lookup"><span data-stu-id="8ce9b-108">JIT</span></span>
...
## <a name="networking"></a><span data-ttu-id="8ce9b-109">Obsługa sieci</span><span class="sxs-lookup"><span data-stu-id="8ce9b-109">Networking</span></span>
...
## <a name="windows-communication-foundation-wcf"></a><span data-ttu-id="8ce9b-110">Windows Communication Foundation (WCF)</span><span class="sxs-lookup"><span data-stu-id="8ce9b-110">Windows Communication Foundation (WCF)</span></span>
...
## <a name="windows-forms"></a><span data-ttu-id="8ce9b-111">Windows Forms</span><span class="sxs-lookup"><span data-stu-id="8ce9b-111">Windows Forms</span></span>
...
## <a name="windows-presentation-foundation-wpf"></a><span data-ttu-id="8ce9b-112">Windows Presentation Foundation (WPF)</span><span class="sxs-lookup"><span data-stu-id="8ce9b-112">Windows Presentation Foundation (WPF)</span></span>
...
## <a name="xml-xslt"></a><span data-ttu-id="8ce9b-113">Języki XML, XSLT</span><span class="sxs-lookup"><span data-stu-id="8ce9b-113">XML, XSLT</span></span>
