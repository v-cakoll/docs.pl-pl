...
ms.locfileid: "72846850"
---
# <a name="walkthrough-hosting-wpf-content-in-win32"></a>Wskazówki: Hosting zawartości WPF w Win32
[!INCLUDE[TLA#tla_winclient](../../../../includes/tlasharptla-winclient-md.md)] zapewnia rozbudowane środowisko do tworzenia aplikacji. Jeśli jednak masz znaczną inwestycję w [!INCLUDE[TLA#tla_win32](../../../../includes/tlasharptla-win32-md.md)] kodzie, może być bardziej efektywne Dodawanie funkcji [!INCLUDE[TLA2#tla_winclient](../../../../includes/tla2sharptla-winclient-md.md)] do aplikacji zamiast zapisywania oryginalnego kodu. [!INCLUDE[TLA2#tla_winclient](../../../../includes/tla2sharptla-winclient-md.md)] zapewnia bezpośredni mechanizm hostingu [!INCLUDE[TLA2#tla_winclient](../../../../includes/tla2sharptla-winclient-md.md)] zawartości w oknie [!INCLUDE[TLA2#tla_win32](../../../../includes/tla2sharptla-win32-md.md)].  
  
 W tym samouczku opisano sposób pisania przykładowej aplikacji, która udostępnia [zawartość WPF w przykładzie okna Win32](https://go.microsoft.com/fwlink/?LinkID=160004), która hostuje [!INCLUDE[TLA2#tla_winclient](../../../../includes/tla2sharptla-winclient-md.md)] zawartość w oknie [!INCLUDE[TLA2#tla_win32](../../../../includes/tla2sharptla-win32-md.md)]. Ten przykład można rozwinąć, aby hostować dowolne [!INCLUDE[TLA2#tla_win32](../../../../includes/tla2sharptla-win32-md.md)] okno. Ponieważ obejmuje mieszanie kodu zarządzanego i niezarządzanego, aplikacja jest zapisywana C++w/CLI.  

<a name="requirements"></a>   
## <a name="requirements"></a>Wymagania  
 W tym samouczku założono podstawową wiedzę na temat programowania zarówno [!INCLUDE[TLA2#tla_winclient](../../../../includes/tla2sharptla-winclient-md.md)], jak i [!INCLUDE[TLA2#tla_win32](../../../../includes/tla2sharptla-win32-md.md)]. Aby uzyskać podstawowe wprowadzenie do programowania [!INCLUDE[TLA2#tla_winclient](../../../../includes/tla2sharptla-winclient-md.md)], zobacz [wprowadzenie](../getting-started/index.md). Aby zapoznać się z wprowadzeniem do [!INCLUDE[TLA2#tla_win32](../../../../includes/tla2sharptla-win32-md.md)] programowania, należy odwołać się do dowolnej z wielu książek w temacie, w szczególności do *programowania systemu Windows* przez Charles Petzold.  
...
4. Zaakceptuj ustawienia domyślne kreatora i kliknij przycisk **Zakończ** , aby uruchomić projekt.
 ...
 Szablon tworzy podstawową aplikację [!INCLUDE[TLA2#tla_win32](../../../../includes/tla2sharptla-win32-md.md)], w tym:
...
### <a name="hosting-the-wpf-content"></a>Hosting zawartości WPF
 ...
 Kod do hostowania zawartości [!INCLUDE[TLA2#tla_winclient](../../../../includes/tla2sharptla-winclient-md.md)] jest implementowany w procedurze obsługi powiadomienia [WM_CREATE](/windows/desktop/winmsg/wm-create) w oknie hosta.
