...
---
# <a name="retargeting-changes-for-migration-from-net-framework-461-to-472"></a>Zmiany retargetingu migracji z .NET Framework 4.6.1 i 4.7.2

[!INCLUDE[versionselector](../../../../includes/migration-guide/retargeting/versionselector.md)]

[!INCLUDE[introduction](../../../../includes/migration-guide/retargeting/introduction.md)]

Migracji z programu .NET Framework 4.6.1 i 4.7.2, zobacz następujące tematy dla problemów ze zgodnością aplikacji, które mogą wpływać na Twoją aplikację:
