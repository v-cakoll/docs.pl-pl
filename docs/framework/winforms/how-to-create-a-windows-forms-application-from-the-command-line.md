...
1. W pustym pliku kodu wpisz następujące `Imports` `using` instrukcje lub:  
...
4. Dodaj `Main` metodę do klasy.
    ...
    1. Zastosuj <xref:System.STAThreadAttribute> do metody języka C#, `Main` Aby określić, że aplikacja Windows Forms jest apartamentem jednowątkowym. (Atrybut nie jest konieczny w Visual Basic, ponieważ aplikacje Windows Forms opracował z Visual Basic domyślnie korzystają z jednowątkowego modelu apartamentu).  
