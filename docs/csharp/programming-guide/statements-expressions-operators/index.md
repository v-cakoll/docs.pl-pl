...
Kod C#, który składa się z aplikacji składa się z instrukcji składają się z słów kluczowych, wyrażenia i operatory. Ta sekcja zawiera informacje dotyczące tych podstawowych elementów programu w języku C#.  
...
-   [Wyrażenia](../../../csharp/programming-guide/statements-expressions-operators/expressions.md)  
    ...
    -   [Zabudowanych wyrażenia elementów członkowskich](expression-bodied-members.md)
...
-   [Porady: użycie przeładowania operatora do utworzenia złożonej klasy liczbowej](../../../csharp/programming-guide/statements-expressions-operators/how-to-use-operator-overloading-to-create-a-complex-number-class.md)  
