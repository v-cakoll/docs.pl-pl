...
Nie jest już obsługiwana. W pliku csproj to jest określana przez nazwę pliku projektu, która jest zdefiniowana przez nazwę katalogu. Na przykład `MyProjectName.csproj`.
