...
## <a name="description"></a>Opis  
 Otrzymano zerową wiadomość (sygnalizowania zakończenie kanału) z kanału datagramowego, ale kanał nadal jest w stanie otwartym. Oznacza to błąd w kanale datagramowym i odbierać dezaktywowanie multiplexer pętli zostało przedwcześnie zakończone.  
