---
title: Zmiany retargetingu migracji z systemu .NET Framework 4.5.2 i 4.7.1
ms.date: 04/27/2018
...
ms.locfileid: "37070801"
---
# <a name="retargeting-changes-for-migration-from-net-framework-452-to-471"></a><span data-ttu-id="f9f58-102">Zmiany retargetingu migracji z systemu .NET Framework 4.5.2 i 4.7.1</span><span class="sxs-lookup"><span data-stu-id="f9f58-102">Retargeting Changes for Migration from .NET Framework 4.5.2 to 4.7.1</span></span>

[!INCLUDE[versionselector](../../../../includes/migration-guide/retargeting/versionselector.md)]

[!INCLUDE[introduction](../../../../includes/migration-guide/retargeting/introduction.md)]

<span data-ttu-id="f9f58-103">W przypadku migracji z programu .NET Framework 4.5.2 i 4.7.1, należy przejrzeć następujące tematy dla problemów ze zgodnością aplikacji, które mogą wpływać na aplikację:</span><span class="sxs-lookup"><span data-stu-id="f9f58-103">If you are migrating from the .NET Framework 4.5.2 to 4.7.1, review the following topics for application compatibility issues that may affect your app:</span></span>

## <a name="aspnet"></a><span data-ttu-id="f9f58-104">ASP.NET</span><span class="sxs-lookup"><span data-stu-id="f9f58-104">ASP.NET</span></span>
...
## <a name="clickonce"></a><span data-ttu-id="f9f58-105">ClickOnce</span><span class="sxs-lookup"><span data-stu-id="f9f58-105">ClickOnce</span></span>
...
## <a name="core"></a><span data-ttu-id="f9f58-106">Core</span><span class="sxs-lookup"><span data-stu-id="f9f58-106">Core</span></span>
...
## <a name="entity-framework"></a><span data-ttu-id="f9f58-107">Entity Framework</span><span class="sxs-lookup"><span data-stu-id="f9f58-107">Entity Framework</span></span>
...
## <a name="jit"></a><span data-ttu-id="f9f58-108">JIT</span><span class="sxs-lookup"><span data-stu-id="f9f58-108">JIT</span></span>
...
## <a name="networking"></a><span data-ttu-id="f9f58-109">Sieć</span><span class="sxs-lookup"><span data-stu-id="f9f58-109">Networking</span></span>
...
## <a name="security"></a><span data-ttu-id="f9f58-110">Zabezpieczenia</span><span class="sxs-lookup"><span data-stu-id="f9f58-110">Security</span></span>
...
## <a name="windows-communication-foundation-wcf"></a><span data-ttu-id="f9f58-111">Windows Communication Foundation (WCF)</span><span class="sxs-lookup"><span data-stu-id="f9f58-111">Windows Communication Foundation (WCF)</span></span>
...
## <a name="windows-forms"></a><span data-ttu-id="f9f58-112">Program Windows Forms</span><span class="sxs-lookup"><span data-stu-id="f9f58-112">Windows Forms</span></span>
...
## <a name="windows-presentation-foundation-wpf"></a><span data-ttu-id="f9f58-113">Program Windows Presentation Foundation (WPF)</span><span class="sxs-lookup"><span data-stu-id="f9f58-113">Windows Presentation Foundation (WPF)</span></span>
...
## <a name="windows-workflow-foundation-wf"></a><span data-ttu-id="f9f58-114">Program Windows Workflow Foundation (WF)</span><span class="sxs-lookup"><span data-stu-id="f9f58-114">Windows Workflow Foundation (WF)</span></span>
...
## <a name="xml-xslt"></a><span data-ttu-id="f9f58-115">Języki XML, XSLT</span><span class="sxs-lookup"><span data-stu-id="f9f58-115">XML, XSLT</span></span>
