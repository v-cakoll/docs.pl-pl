...
---
# <a name="retargeting-changes-for-migration-from-net-framework-462-to-471"></a>Zmiany retargetingu migracji z systemu .NET Framework 4.6.2 z dodatkiem do 4.7.1
