...
---
# <a name="runtime-changes-for-migration-from-net-framework-45-to-452"></a><span data-ttu-id="a647a-102">Zmiany środowiska uruchomieniowego do migracji z platformy .NET Framework 4.5 do 4.5.2</span><span class="sxs-lookup"><span data-stu-id="a647a-102">Runtime Changes for Migration from .NET Framework 4.5 to 4.5.2</span></span>

[!INCLUDE[versionselector](../../../../includes/migration-guide/runtime/versionselector.md)]

[!INCLUDE[introduction](../../../../includes/migration-guide/runtime/introduction.md)]

<span data-ttu-id="a647a-103">Jeśli w przypadku migracji z programu .NET Framework 4.5 do 4.5.2, należy przejrzeć następujące tematy dla problemów ze zgodnością aplikacji, które mogą wpływać na aplikację:</span><span class="sxs-lookup"><span data-stu-id="a647a-103">If you are migrating from the .NET Framework 4.5 to 4.5.2, review the following topics for application compatibility issues that may affect your app:</span></span>

## <a name="adonet"></a><span data-ttu-id="a647a-104">ADO.NET</span><span class="sxs-lookup"><span data-stu-id="a647a-104">ADO.NET</span></span>
...
## <a name="aspnet"></a><span data-ttu-id="a647a-105">ASP.NET</span><span class="sxs-lookup"><span data-stu-id="a647a-105">ASP.NET</span></span>
...
## <a name="core"></a><span data-ttu-id="a647a-106">Core</span><span class="sxs-lookup"><span data-stu-id="a647a-106">Core</span></span>
...
## <a name="data"></a><span data-ttu-id="a647a-107">Dane</span><span class="sxs-lookup"><span data-stu-id="a647a-107">Data</span></span>
...
## <a name="entity-framework"></a><span data-ttu-id="a647a-108">Entity Framework</span><span class="sxs-lookup"><span data-stu-id="a647a-108">Entity Framework</span></span>
...
## <a name="serialization"></a><span data-ttu-id="a647a-109">Serializacja</span><span class="sxs-lookup"><span data-stu-id="a647a-109">Serialization</span></span>
...
## <a name="windows-communication-foundation-wcf"></a><span data-ttu-id="a647a-110">Windows Communication Foundation (WCF)</span><span class="sxs-lookup"><span data-stu-id="a647a-110">Windows Communication Foundation (WCF)</span></span>
...
## <a name="windows-presentation-foundation-wpf"></a><span data-ttu-id="a647a-111">Windows Presentation Foundation (WPF)</span><span class="sxs-lookup"><span data-stu-id="a647a-111">Windows Presentation Foundation (WPF)</span></span>
