...
---
# <a name="compiler-error-cs0015"></a>Błąd kompilatora CS0015
Nazwa typu "type" jest za długa  
  
 W pełni kwalifikowana nazwa typu zdefiniowanego przez użytkownika musi mieć mniej niż 1024 znaków, w tym okresy.  
  
 Poniższy przykład generuje CS0015:  
