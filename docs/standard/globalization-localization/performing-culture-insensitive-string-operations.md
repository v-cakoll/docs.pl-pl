...
## <a name="in-this-section"></a>W tej sekcji  
 [Wykonywanie ciągu niezależnych od kultury porównań](../../../docs/standard/globalization-localization/performing-culture-insensitive-string-comparisons.md)  
 ...
 [Wykonywanie operacji na ciągach niezależnych od kultury w kolekcjach](../../../docs/standard/globalization-localization/performing-culture-insensitive-string-operations-in-collections.md)  
 ...
 [Wykonywanie operacji na ciągach niezależnych od kultury w tablicach](../../../docs/standard/globalization-localization/performing-culture-insensitive-string-operations-in-arrays.md)  
