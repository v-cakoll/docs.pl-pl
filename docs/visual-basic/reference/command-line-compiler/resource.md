...
|Termin|Definicja|  
|---|---|  
|`filename`|Wymagana. Nazwa pliku zasobów do osadzenia w pliku wyjściowym. Domyślnie `filename` jest publiczna w zestawie. Nazwę pliku należy ująć w znaki cudzysłowu ("") zawiera spację.|  
