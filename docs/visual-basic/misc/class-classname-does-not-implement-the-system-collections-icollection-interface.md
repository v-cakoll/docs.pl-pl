...
## <a name="to-correct-this-error"></a><span data-ttu-id="71684-105">Aby poprawić ten błąd</span><span class="sxs-lookup"><span data-stu-id="71684-105">To correct this error</span></span>  
  
1.  <span data-ttu-id="71684-106">Zainstaluj ponownie program Visual Studio.</span><span class="sxs-lookup"><span data-stu-id="71684-106">Reinstall Visual Studio.</span></span>  
  
## <a name="see-also"></a><span data-ttu-id="71684-107">Zobacz też</span><span class="sxs-lookup"><span data-stu-id="71684-107">See Also</span></span>  
