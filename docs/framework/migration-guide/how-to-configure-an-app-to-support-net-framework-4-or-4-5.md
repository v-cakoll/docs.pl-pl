...
ms.locfileid: "70779483"
---
# <a name="how-to-configure-an-app-to-support-net-framework-4-or-later-versions"></a>Instrukcje: Skonfiguruj aplikację do obsługi .NET Framework 4 lub nowszej wersji
...
2. Dodaj element supportedRuntime > w następujący sposób do pliku konfiguracji aplikacji: [ \<](../configure-apps/file-schema/startup/supportedruntime-element.md)
     ...
     *gdzie\<wersja >* określa wersję środowiska CLR, która jest wyrównana do .NET Framework wersji obsługiwanej przez aplikację. Użyj następujących ciągów:
...
|`<supportedRuntime version="v4.0"/>`|Wyświetla komunikat o błędzie, który monituje użytkownika o zainstalowanie poprawnej wersji *|Działa w wersji 4 lub nowszej|Działa w wersji 4 lub nowszej|
 ...
 \*Aby uzyskać więcej informacji o tym komunikacie o błędzie i sposobach ich [unikania, zobacz .NET Framework Błędy inicjowania: Zarządzanie czynnościami](../deployment/initialization-errors-managing-the-user-experience.md)użytkownika.
