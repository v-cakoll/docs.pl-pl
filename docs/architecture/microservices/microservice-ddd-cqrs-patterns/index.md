...
- **Eric Evans. Projektowanie oparte na domenie: Zapełnianie się złożonością oprogramowania** \
...
>[Poprzedni](../multi-container-microservice-net-applications/implement-api-gateways-with-ocelot.md)Następny
