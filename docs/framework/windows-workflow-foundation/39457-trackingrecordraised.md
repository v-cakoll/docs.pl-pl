...
## <a name="description"></a>Opis  
 Wskazuje, że TrackingRecord został zgłoszony do TrackingParticipant.  
  
## <a name="message"></a>Komunikat  
 Rekord śledzenia %1 został podniesiony do %2.  
...
|ParticipantId|xs:String|Uczestnik śledzenia.|  
