...
Adres nieustalonego wyrażenia wewnątrz inicjatora instrukcji fixed można pobrać tylko  
 ...
 Poniższy przykład pokazuje sposób wykonania adres nieustalonego wyrażenia. Poniższy przykład spowoduje wygenerowanie CS0212.  
...
```  
 ...
 Poniższy przykład również generuje CS0212 i pokazuje, jak rozwiązać błąd:  
