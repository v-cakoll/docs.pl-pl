...
##  <span data-ttu-id="3a995-112"><a name="BKMK_createapp"></a>Aby utworzyć aplikację, która działa w różnych wersjach pakietu Microsoft Office</span><span class="sxs-lookup"><span data-stu-id="3a995-112"><a name="BKMK_createapp"></a> To create an application that works with multiple versions of Microsoft Office</span></span>  
...
##  <span data-ttu-id="3a995-133"><a name="BKMK_publishapp"></a>Aby opublikować aplikację na komputerze, na którym zainstalowany jest inna wersja programu Microsoft Office</span><span class="sxs-lookup"><span data-stu-id="3a995-133"><a name="BKMK_publishapp"></a> To publish the application to a computer on which a different version of Microsoft Office is installed</span></span>  
