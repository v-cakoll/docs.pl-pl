...
```  
 ...
 Otwórz MyControl1.xaml.cs. Zmień istniejące deklaracji klasy, który ma następujące nazwy i dziedziczy <xref:System.Windows.Controls.Grid>.  
...
## <a name="see-also"></a>Zobacz też  
 ...
 [Wskazówki: Hostowanie formantu złożonego 3-WPF w formularzach systemu Windows](../../../../docs/framework/wpf/advanced/walkthrough-hosting-a-3-d-wpf-composite-control-in-windows-forms.md)
