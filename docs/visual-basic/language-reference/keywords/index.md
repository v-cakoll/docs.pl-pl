...
|[CInt](../functions/type-conversion-functions.md)|[Class Constraint](../statements/type-list.md)|[Class, instrukcja](../statements/class-statement.md)|[CLng](../functions/type-conversion-functions.md)|  
...
|[Each](../statements/for-each-next-statement.md)|[Else](../statements/else-statement.md)|[ElseIf](../statements/if-then-else-statement.md)|[End, instrukcja](../statements/end-statement.md)|  
...
|[If](../statements/if-then-else-statement.md)|[If()](../operators/if-operator.md)|[Implements](../statements/implements-clause.md)|[Implements, instrukcja](../statements/implements-statement.md)|  
|[Imports (.NET Namespace and Type)](../statements/imports-statement-net-namespace-and-type.md)|[Imports (XML Namespace)](../statements/imports-statement-xml-namespace.md)|[In](../statements/in-clause.md)|[In (modyfikator ogólny)](../modifiers/in-generic-modifier.md)|  
...
|[Narrowing](../modifiers/narrowing.md)|[New Constraint](../statements/type-list.md)|[Operator New](../operators/new-operator.md)|[Next](../statements/for-next-statement.md)|
...
|[Resume](../statements/resume-statement.md)|[Return](../statements/return-statement.md)|[SByte](../data-types/sbyte-data-type.md)|[Wybór](../statements/select-case-statement.md)|
...
|[Ciąg](../data-types/string-data-type.md)|[Structure Constraint](../statements/type-list.md)|[Structure, instrukcja](../statements/structure-statement.md)|[Sub](../statements/sub-statement.md)|
...
|[Niestandardowy](../statements/event-statement.md)|[Distinct](../queries/distinct-clause.md)|[Equals](../queries/equals-clause.md)|[Explicit](../statements/option-explicit-statement.md)|  
...
|[Take](../queries/take-clause.md)|[Take While](../queries/take-while-clause.md)|[Tekst](../statements/option-compare-statement.md)|[Unicode](../modifiers/unicode.md)|  
...
|Tytuł|Opis|  
|-----------|-----------------|  
|[Tablice — podsumowanie](arrays-summary.md)|Lists language elements that are used to create, define, and use arrays.|  
|[Obiekt stanowiący część kolekcji — podsumowanie](collection-object-summary.md)|Lists language elements that are used for collections.|  
|[Przepływ sterowania — podsumowanie](control-flow-summary.md)|Lists statements that are used for looping and controlling procedure flow.|  
|[Konwersja — podsumowanie](conversion-summary.md)|Lists functions that are used to convert numbers, dates, times, and strings.|  
|[Typy danych — podsumowanie](data-types-summary.md)|Lists data types. Also lists functions that are used to convert between data types and verify data types.|  
|[Daty i godziny — podsumowanie](dates-and-times-summary.md)|Lists language elements that are used for dates and times.|  
|[Deklaracje i stałe — podsumowanie](declarations-and-constants-summary.md)|Lists statements that are used to declare variables, constants, classes, modules, and other programming elements. Also lists language elements that are used to obtain object information, handle events, and implement inheritance.|  
|[Katalogi i pliki — podsumowanie](directories-and-files-summary.md)|Lists functions that are used to control the file system and to process files.|  
|[Błędy — podsumowanie](errors-summary.md)|Lists language elements that are used to catch and return run-time error values.|  
|[Podsumowanie finansowe](financial-summary.md)|Lists functions that are used to perform financial calculations.|  
|[Wejście i wyjście — podsumowanie](input-and-output-summary.md)|Lists functions that are used to read from and write to files, manage files, and print output.|  
|[Informacja i interakcja — podsumowanie](information-and-interaction-summary.md)|Lists functions that are used to run other programs, obtain command-line arguments, manipulate COM objects, retrieve color information, and use control dialog boxes.|  
|[Podsumowanie matematyczne](math-summary.md)|Lists functions that are used to perform trigonometric and other mathematical calculations.|  
|[Moje odwołanie](my-reference.md)|Lists the objects contained in `My`, a feature that provides access to frequently used methods, properties, and events of the computer on which the application is running, the current application, the application's resources, the application's settings, and so on.|  
|[Operatory— podsumowanie](operators-summary.md)|Lists assignment and comparison expressions and other operators.|  
|[Rejestr — podsumowanie](registry-summary.md)|Lists functions that are used to read, save, and delete program settings.|  
|[Manipulowanie ciągami — podsumowanie](string-manipulation-summary.md)|Lists functions that are used to manipulate strings.|  
