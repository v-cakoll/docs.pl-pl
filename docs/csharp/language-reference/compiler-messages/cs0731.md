...
Typ usługi przesyłania dalej dla typu "type" w zestawie "assembly" powoduje wystąpienie cyklu  
  
 Ten błąd może wystąpić tylko importowanych metadanymi niepoprawnie sformułowany. Nie można go wykonać przy tylko źródła C#.  
...
## <a name="example"></a>Przykład  
 ...
 Najpierw skompilować. Plików IL jako biblioteki, a następnie kompilacji kodu .cs odwołujące się do dwóch plików.  
