...
Moduł przekazywania dla typu „type” w zestawie „assembly” powoduje wystąpienie cyklu  
  
 Ten błąd może wystąpić tylko wtedy, gdy zaimportowane metadane są nieprawidłowo sformatowane. Nie może wystąpić w przypadku samego źródła w C#.  
  
## <a name="example"></a>Przykład  
 Poniższy przykład generuje CS0731. Przykład składa się z trzech plików:  
 ...
 Najpierw skompiluj pliki .IL jako biblioteki, a następnie kod .cs odwołujący się do obu plików.  
