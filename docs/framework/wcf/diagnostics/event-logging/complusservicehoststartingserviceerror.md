...
## <a name="description"></a>Opis  
 To zdarzenie oznacza, że wystąpił błąd podczas uruchamiania usług COM +. Zdarzenia zawiera identyfikator ClsID, Surogat wyjątek, nazwa procesu i identyfikatora procesu.  
