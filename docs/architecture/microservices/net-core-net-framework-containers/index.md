...
---
# <a name="choosing-between-net-core-and-net-framework-for-docker-containers"></a>Wybieranie między programami .NET Core i .NET Framework dla kontenerów platformy Docker
