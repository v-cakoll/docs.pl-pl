...
2.  Z listy [!INCLUDE[vbprvb](../../../../includes/vbprvb-md.md)] projektów, wybierz opcję **Biblioteka formantów systemu Windows** szablon projektu, typ `ctlClockLib` w **nazwa** , a następnie kliknij przycisk **OK**.  
