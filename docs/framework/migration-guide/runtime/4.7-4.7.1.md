...
---
# <a name="runtime-changes-for-migration-from-net-framework-47-to-471"></a><span data-ttu-id="1c8b8-102">Zmiany środowiska uruchomieniowego do migracji z systemu .NET Framework 4.7 do 4.7.1</span><span class="sxs-lookup"><span data-stu-id="1c8b8-102">Runtime Changes for Migration from .NET Framework 4.7 to 4.7.1</span></span>

[!INCLUDE[versionselector](../../../../includes/migration-guide/runtime/versionselector.md)]

[!INCLUDE[introduction](../../../../includes/migration-guide/runtime/introduction.md)]

<span data-ttu-id="1c8b8-103">Jeśli .NET Framework 4.7 są migrowane do 4.7.1, przejrzyj następujące tematy dotyczące problemów ze zgodnością aplikacji, które mogą wpływać na aplikację:</span><span class="sxs-lookup"><span data-stu-id="1c8b8-103">If you are migrating from the .NET Framework 4.7 to 4.7.1, review the following topics for application compatibility issues that may affect your app:</span></span>

## <a name="jit"></a><span data-ttu-id="1c8b8-104">JIT</span><span class="sxs-lookup"><span data-stu-id="1c8b8-104">JIT</span></span>
...
## <a name="security"></a><span data-ttu-id="1c8b8-105">Zabezpieczenia</span><span class="sxs-lookup"><span data-stu-id="1c8b8-105">Security</span></span>
...
## <a name="windows-communication-foundation-wcf"></a><span data-ttu-id="1c8b8-106">Windows Communication Foundation (WCF)</span><span class="sxs-lookup"><span data-stu-id="1c8b8-106">Windows Communication Foundation (WCF)</span></span>
...
## <a name="windows-presentation-foundation-wpf"></a><span data-ttu-id="1c8b8-107">Program Windows Presentation Foundation (WPF)</span><span class="sxs-lookup"><span data-stu-id="1c8b8-107">Windows Presentation Foundation (WPF)</span></span>
