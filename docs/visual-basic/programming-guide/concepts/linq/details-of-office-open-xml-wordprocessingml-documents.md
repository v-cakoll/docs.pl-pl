...
|Temat|Opis|  
|-----------|-----------------|  
|[Dokument WordprocessingML ze stylami](../../../../visual-basic/programming-guide/concepts/linq/wordprocessingml-document-with-styles.md)|Przedstawia części dokumentu dokumentu Office Open XML WordprocessingML.|  
|[Część stylu dokumentu WordprocessingML](../../../../visual-basic/programming-guide/concepts/linq/style-part-of-a-wordprocessingml-document.md)|Zawiera część stylu dokumentu Office Open XML WordprocessingML.|  
