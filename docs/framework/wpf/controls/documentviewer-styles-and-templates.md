...
## <a name="documentviewer-states"></a>Stany DocumentViewer  
 Poniższa tabela zawiera listę stanów wizualnych dla kontrolki <xref:System.Windows.Controls.DocumentViewer>.  
...
## <a name="documentviewer-controltemplate-example"></a>Przykład DocumentViewer ControlTemplate  
 Poniższy przykład pokazuje, jak zdefiniować <xref:System.Windows.Controls.ControlTemplate> dla kontrolki <xref:System.Windows.Controls.DocumentViewer>.  
