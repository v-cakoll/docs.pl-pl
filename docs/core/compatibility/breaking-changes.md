...
Poniższe wersje i selektory obszarów zapewniają przefiltrowaną listę mających zastosowanie istotnych zmian między różnymi wersjami programu .NET Core, ASP.NET Core i EF Core. Możesz także przeglądać wersję lub artykuły kategorii w spisie treści.
...
- W przypadku Entity Framework Core repozytorium [ASPNET/EntityFrameworkCore](https://github.com/aspnet/EntityFrameworkCore/issues?q=is%3Aopen+is%3Aissue+label%3Abreaking-change) .
