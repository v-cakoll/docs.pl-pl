...
ms.locfileid: "33514611"
---
# <a name="scenario"></a>Scenariusz
Ta sekcja zawiera przykładowe scenariusze Windows Workflow Foundation (WF).  
  
## <a name="in-this-section"></a>W tej sekcji  
 [Biblioteka działań](../../../../docs/framework/windows-workflow-foundation/samples/activity-library.md)  
 Zawiera przykłady ilustrujące scenariuszy przy użyciu biblioteka działań wbudowanych.  
  
 [Usługi](../../../../docs/framework/windows-workflow-foundation/samples/services.md)  
 Zawiera przykłady ilustrujące scenariuszy przy użyciu usługi przepływu pracy.  
 ...
 Przedstawia sposób tworzenia aplikacji, która używa funkcji systemu Windows Presentation Foundation (WPF) i Windows Workflow Foundation (WF) w jednym dokumencie XAML. W tym celu próbki korzysta z rozszerzeń systemu Windows Workflow Foundation (WF) i języka XAML.  
