...
---
# <a name="how-to-animate-a-3-d-rotation-using-rotation3danimation"></a>Jak animować rotację 3D z wykorzystaniem Rotation3DAnimation
Poniższy przykład przedstawia sposób obiektu 3D, obracanie podczas jego "wobbles" przy użyciu <xref:System.Windows.Media.Animation.Rotation3DAnimation> do animowania <xref:System.Windows.Media.Media3D.RotateTransform3D.Rotation%2A> właściwość <xref:System.Windows.Media.Media3D.RotateTransform3D> obiektu do obiektu 3D.  
