...
Niejednoznaczność między metodą "method" i innym niż metoda "niż metoda". Używanie grupy metod.  
  
 Dziedziczone elementy członkowskie z różnych interfejsów, które mają taki sam podpis, powodują wystąpienie błędu niejednoznaczności.  
