...
## <a name="services-and-the-servicecontroller-component"></a>Usługi i składnik ServiceController  
 <xref:System.ServiceProcess.ServiceController> Składnik jest używany do nawiązywania połączenia z zainstalowaną usługą i manipulowania jej stanem; za pomocą <xref:System.ServiceProcess.ServiceController> składnika można uruchamiać i zatrzymywać usługę, wstrzymywać i kontynuować działanie oraz wysyłać niestandardowe polecenia do usługi. Nie trzeba jednak używać <xref:System.ServiceProcess.ServiceController> składnika podczas tworzenia aplikacji usługi. W rzeczywistości w większości przypadków <xref:System.ServiceProcess.ServiceController> składnik powinien znajdować się w osobnej aplikacji z poziomu aplikacji usługi systemu Windows, która definiuje swoją usługę.  
...
- [Porady: debugowanie aplikacji usług systemu Windows](how-to-debug-windows-service-applications.md)
