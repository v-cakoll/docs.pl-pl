...
Długość tablicy jest wywnioskowana na podstawie liczby wyrażeń między {i}. Deklaracje zmiennej lokalnej i pola mogą być skrócone w taki sposób, aby nie trzeba było przestawiać tego typu tablicy.
