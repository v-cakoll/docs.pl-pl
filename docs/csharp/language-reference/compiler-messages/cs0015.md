...
ms.locfileid: "71332094"
---
# <a name="compiler-error-cs0015"></a><span data-ttu-id="64993-102">Błąd kompilatora CS0015</span><span class="sxs-lookup"><span data-stu-id="64993-102">Compiler Error CS0015</span></span>

<span data-ttu-id="64993-103">Nazwa typu "Type" jest za długa</span><span class="sxs-lookup"><span data-stu-id="64993-103">The name of type 'type' is too long</span></span>

 <span data-ttu-id="64993-104">W pełni kwalifikowana nazwa typu zdefiniowanego przez użytkownika musi mieć mniej niż 1024 znaków, w tym kropki.</span><span class="sxs-lookup"><span data-stu-id="64993-104">The fully qualified name of a user-defined type must have fewer than 1024 characters, including the periods.</span></span>

 <span data-ttu-id="64993-105">Poniższy przykład generuje błąd CS0015:</span><span class="sxs-lookup"><span data-stu-id="64993-105">The following sample generates CS0015:</span></span>
