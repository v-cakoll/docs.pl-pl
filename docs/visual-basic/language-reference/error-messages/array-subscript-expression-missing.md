...
<span data-ttu-id="7f241-103">Inicjowanie tablicy powoduje, że jeden lub więcej indeksów dolnych, które definiują granice tablicy.</span><span class="sxs-lookup"><span data-stu-id="7f241-103">An array initialization leaves out one or more of the subscripts that define the array bounds.</span></span> <span data-ttu-id="7f241-104">Na przykład instrukcja może zawierać wyrażenia `myArray (5,5,,10)`, który powoduje, że indeks trzecich.</span><span class="sxs-lookup"><span data-stu-id="7f241-104">For example, the statement might contain the expression `myArray (5,5,,10)`, which leaves out the third subscript.</span></span>  
 ...
 <span data-ttu-id="7f241-105">**Identyfikator błędu:** BC30306</span><span class="sxs-lookup"><span data-stu-id="7f241-105">**Error ID:** BC30306</span></span>  
  
## <a name="to-correct-this-error"></a><span data-ttu-id="7f241-106">Aby poprawić ten błąd</span><span class="sxs-lookup"><span data-stu-id="7f241-106">To correct this error</span></span>  
  
-   <span data-ttu-id="7f241-107">Podaj brakujące indeks dolny.</span><span class="sxs-lookup"><span data-stu-id="7f241-107">Supply the missing subscript.</span></span>  
  
## <a name="see-also"></a><span data-ttu-id="7f241-108">Zobacz też</span><span class="sxs-lookup"><span data-stu-id="7f241-108">See Also</span></span>  
 [<span data-ttu-id="7f241-109">Tablice</span><span class="sxs-lookup"><span data-stu-id="7f241-109">Arrays</span></span>](../../../visual-basic/programming-guide/language-features/arrays/index.md)
