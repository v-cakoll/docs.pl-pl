...
|Sugestia|W razie potrzeby im weryfikacji programu .NET Framework 4.0 sprawdzania poprawności aplikacji celem może być w wersji 4.5 (lub starszym) programu .NET Framework. W przypadku przekierowania do programu .NET Framework 4.6, jednak przeglądu kodu ma się odbywać należy upewnić się, że zduplikowane klucze złożone (zgodnie z opisem w opisie tego problemu) nie powinny do sprawdzania poprawności.|
|Zakres|Krawędź|
|Wersja|4.6|
|Typ|Przekierowania|
