...
Udostępnia właściwości i metody do pracy z dysków, plików i katalogów.  
  
## <a name="remarks"></a>Uwagi  
 Informacje dotyczące metod i właściwości `My.Computer.FileSystem` obiektów, zobacz <xref:Microsoft.VisualBasic.FileIO.FileSystem>.  
  
 Aby uzyskać więcej informacji, zobacz [dostęp do plików za pomocą Visual Basic](../../../visual-basic/developing-apps/programming/drives-directories-files/file-access.md).  
  
> [!NOTE]
>  Można również użyć klasy w <xref:System.IO?displayProperty=nameWithType> przestrzeni nazw do pracy z dysków, plików i katalogów.  
