...
|HRESULT|Opis|  
|-------------|-----------------|  
|S_OK|`IsDebuggerAttached` pomyślnie zwrócone.|  
...
## <a name="remarks"></a>Uwagi  
 `IsDebuggerAttached` umożliwia hostowi zbadanie środowiska CLR w celu określenia, czy debuger jest dołączony do procesu.  
