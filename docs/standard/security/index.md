...
## <a name="in-this-section"></a>W tej sekcji  
 ...
 W tym artykule opisano ważne zmiany w systemie zabezpieczeń .NET Framework.  
 ...
 Zawiera omówienie usług kryptograficznych usług świadczonych przez program .NET Framework. Ta sekcja ma znaczenie dla deweloperów.  
  
 [Wytyczne dotyczące bezpiecznego programowania](../../../docs/standard/security/secure-coding-guidelines.md)  
 Opisano niektóre najważniejsze wskazówki dotyczące tworzenia niezawodnych aplikacji .NET Framework. Ta sekcja ma znaczenie dla deweloperów.  
