...
## <a name="in-this-section"></a>W tej sekcji  
 ...
 [Zaawansowana obsługa błędów](../../../../docs/framework/wcf/samples/advanced-error-handling.md)  
 Pokazuje, jak usługa routingu inteligentnie odzyskiwania z błędów przy użyciu transakcji i innych bardziej złożonych pojęć obsługi wiadomości, takie jak multiemisji.
