---
title: Zmiany środowiska uruchomieniowego dla migracji z programu .NET Framework 4.5.2 do 4.8
ms.date: 07/10/2019
...
---
# <a name="runtime-changes-for-migration-from-net-framework-452-to-48"></a><span data-ttu-id="70f19-102">Zmiany środowiska uruchomieniowego dla migracji z programu .NET Framework 4.5.2 do 4.8</span><span class="sxs-lookup"><span data-stu-id="70f19-102">Runtime Changes for Migration from .NET Framework 4.5.2 to 4.8</span></span>

[!INCLUDE[versionselector](../../../../includes/migration-guide/runtime/versionselector.md)]

<span data-ttu-id="70f19-103">W przypadku migracji z programu .NET Framework 4.5.2 do 4.8 zapoznaj się z następującymi tematami dotyczącymi problemów ze zgodnością aplikacji, które mogą mieć wpływ na aplikację:</span><span class="sxs-lookup"><span data-stu-id="70f19-103">If you are migrating from the .NET Framework 4.5.2 to 4.8, review the following topics for application compatibility issues that may affect your app:</span></span>
...
## <a name="core"></a><span data-ttu-id="70f19-105">Podstawowe</span><span class="sxs-lookup"><span data-stu-id="70f19-105">Core</span></span>
...
## <a name="data"></a><span data-ttu-id="70f19-106">Dane</span><span class="sxs-lookup"><span data-stu-id="70f19-106">Data</span></span>
...
## <a name="debugger"></a><span data-ttu-id="70f19-107">Debuger</span><span class="sxs-lookup"><span data-stu-id="70f19-107">Debugger</span></span>
...
## <a name="globalization"></a><span data-ttu-id="70f19-108">Globalizacja</span><span class="sxs-lookup"><span data-stu-id="70f19-108">Globalization</span></span>
...
## <a name="networking"></a><span data-ttu-id="70f19-109">Networking</span><span class="sxs-lookup"><span data-stu-id="70f19-109">Networking</span></span>
...
## <a name="runtime"></a><span data-ttu-id="70f19-110">Środowisko uruchomieniowe</span><span class="sxs-lookup"><span data-stu-id="70f19-110">Runtime</span></span>

[!INCLUDE[Improved WCF chain trust certificate validation for Net.Tcp certificate authentication](~/includes/migration-guide/runtime/runtime/improved-wcf-chain-trust-certificate-validation-for-nettcp-authentication.md)]

## <a name="security"></a><span data-ttu-id="70f19-111">Zabezpieczenia</span><span class="sxs-lookup"><span data-stu-id="70f19-111">Security</span></span>
...
## <a name="serialization"></a><span data-ttu-id="70f19-112">Serializacja</span><span class="sxs-lookup"><span data-stu-id="70f19-112">Serialization</span></span>
...
## <a name="setup-and-deployment"></a><span data-ttu-id="70f19-113">Konfiguracja i wdrażanie</span><span class="sxs-lookup"><span data-stu-id="70f19-113">Setup and Deployment</span></span>
...
## <a name="tools"></a><span data-ttu-id="70f19-114">narzędzia</span><span class="sxs-lookup"><span data-stu-id="70f19-114">Tools</span></span>

[!INCLUDE[Contract.Invariant or Contract.Requires\<TException> do not consider String.IsNullOrEmpty to be pure](~/includes/migration-guide/runtime/tools/contractinvariant-contractrequirestexception-do-not-consider.md)]

## <a name="web-applications"></a><span data-ttu-id="70f19-115">Aplikacje internetowe</span><span class="sxs-lookup"><span data-stu-id="70f19-115">Web Applications</span></span>

[!INCLUDE["dataAnnotations:dataTypeAttribute:disableRegEx" app setting is on by default in .NET Framework 4.7.2](~/includes/migration-guide/runtime/web/dataannotationsdatatypeattributedisableregex-app-setting-on-by-default-net.md)]

## <a name="windows-communication-foundation-wcf"></a><span data-ttu-id="70f19-116">Windows Communication Foundation (WCF)</span><span class="sxs-lookup"><span data-stu-id="70f19-116">Windows Communication Foundation (WCF)</span></span>
...
## <a name="windows-presentation-foundation-wpf"></a><span data-ttu-id="70f19-117">Windows Presentation Foundation (WPF)</span><span class="sxs-lookup"><span data-stu-id="70f19-117">Windows Presentation Foundation (WPF)</span></span>
...
## <a name="windows-workflow-foundation-wf"></a><span data-ttu-id="70f19-118">Program Windows Workflow Foundation (WF)</span><span class="sxs-lookup"><span data-stu-id="70f19-118">Windows Workflow Foundation (WF)</span></span>
