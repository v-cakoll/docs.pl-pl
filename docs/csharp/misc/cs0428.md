...
---
# <a name="compiler-error-cs0428"></a>CS0428 błąd kompilatora
Nie można przekonwertować grupy metod 'Identyfikator' do 'typ' typ niedelegowany.  Czy zamierzane było wywołanie metody?  
  
 Ten błąd występuje podczas konwertowania na typ niedelegowany lub nastąpi próba wywołania metody bez użycia nawiasów grupy metod.  
  
## <a name="example"></a>Przykład  
 Poniższy przykład spowoduje wygenerowanie CS0428:  
