...
---
# <a name="runtime-changes-for-migration-from-net-framework-461-to-471"></a>Zmiany środowiska uruchomieniowego do migracji z platformy .NET Framework 4.6.1 i 4.7.1

[!INCLUDE[versionselector](../../../../includes/migration-guide/runtime/versionselector.md)]

[!INCLUDE[introduction](../../../../includes/migration-guide/runtime/introduction.md)]

Migracji z programu .NET Framework 4.6.1 i 4.7.1, zobacz następujące tematy dla problemów ze zgodnością aplikacji, które mogą wpływać na Twoją aplikację:
