...
- **Programowanie aplikacji**: możesz wybierać spośród wielu języków podczas kompilowania aplikacji uruchamianych w kontenerach. Ten przewodnik koncentruje się na [platformie .NET](https://www.microsoft.com/net), ale można opracowywać aplikacje oparte na kontenerach za pomocą innych języków, takich jak Node. js, Python, sprężyny/Java lub go.
