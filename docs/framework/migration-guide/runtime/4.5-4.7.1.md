...
---
# <a name="runtime-changes-for-migration-from-net-framework-45-to-471"></a>Zmiany środowiska uruchomieniowego do migracji z platformy .NET Framework 4.5 lub 4.7.1

[!INCLUDE[versionselector](../../../../includes/migration-guide/runtime/versionselector.md)]

[!INCLUDE[introduction](../../../../includes/migration-guide/runtime/introduction.md)]

Jeśli do 4.7.1 przeprowadzenia migracji z programu .NET Framework 4.5, należy zapoznać się w poniższych tematach problemy ze zgodnością aplikacji, które mogą wpływać na Twoją aplikację:
