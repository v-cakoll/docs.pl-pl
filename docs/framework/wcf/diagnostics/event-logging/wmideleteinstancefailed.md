...
## <a name="description"></a>Opis  
 To zdarzenie wskazuje, czy żądanie WMI DeleteInstance nie została przetworzona. Zdarzenie Wyświetla listę wyjątków, nazwa procesu i identyfikatora procesu.  
