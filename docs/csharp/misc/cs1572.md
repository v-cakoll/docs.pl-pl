...
Komentarz XML dla elementu "konstrukcja" ma tag param dla parametru "parameter", ale nie ma parametru o takiej nazwie  
 ...
 W przypadku korzystania z opcji kompilatora [/doc](../language-reference/compiler-options/doc-compiler-option.md) , komentarz został określony dla parametru, który nie istnieje dla metody. Zmień wartość przekazaną do atrybutu Name lub Usuń jedną z wierszy komentarza.  
