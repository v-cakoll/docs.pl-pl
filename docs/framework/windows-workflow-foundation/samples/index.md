...
---
# <a name="windows-workflow-wf-samples"></a>Przykłady przepływu pracy (WF) systemu Windows
...
## <a name="in-this-section"></a>W tej sekcji  
 [Aplikacji](../../../../docs/framework/windows-workflow-foundation/samples/application.md)  
 Zawiera przykłady, które są związane z aplikacjami przepływów pracy.  
  
 [Podstawowe](../../../../docs/framework/windows-workflow-foundation/samples/basic.md)  
