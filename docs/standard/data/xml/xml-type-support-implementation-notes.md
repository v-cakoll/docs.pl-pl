...
> [!NOTE]
> `xs` Prefiks jest mapowany na identyfikator URI <https://www.w3.org/2001/XMLSchema> i przestrzeń nazw.
...
### <a name="systemtimespan-and-xsduration"></a>Wartość System. TimeSpan i xs: duration  
 ...
 Aby uzyskać więcej informacji na `xs:duration` temat typu, zobacz [część 2 W3C XML schematu: rekomendacja typów](https://www.w3.org/TR/xmlschema-2/)danych.
