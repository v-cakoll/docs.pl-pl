...
|Argument|Opis|  
|--------------|-----------------|  
|*nazwaZestawu*|Nazwa zestawu Można podać nazwę częściowo określonego zestawu, taką jak `myAssembly` lub nazwę w pełni określonego zestawu, taką jak `myAssembly, Version=2.0.0.0, Culture=neutral, PublicKeyToken=0038abc9deabfle5`.|  
