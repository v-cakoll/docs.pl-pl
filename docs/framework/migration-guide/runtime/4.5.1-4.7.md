---
title: Zmiany środowiska uruchomieniowego dla migracji z programu .NET Framework 4.5.1 do 4.7
ms.date: 07/10/2019
...
ms.locfileid: "73196153"
---
# <a name="runtime-changes-for-migration-from-net-framework-451-to-47"></a><span data-ttu-id="ec4bc-102">Zmiany środowiska uruchomieniowego dla migracji z programu .NET Framework 4.5.1 do 4.7</span><span class="sxs-lookup"><span data-stu-id="ec4bc-102">Runtime Changes for Migration from .NET Framework 4.5.1 to 4.7</span></span>

[!INCLUDE[versionselector](../../../../includes/migration-guide/runtime/versionselector.md)]

<span data-ttu-id="ec4bc-103">W przypadku migracji z programu .NET Framework 4.5.1 do 4.7 zapoznaj się z następującymi tematami dotyczącymi problemów ze zgodnością aplikacji, które mogą mieć wpływ na aplikację:</span><span class="sxs-lookup"><span data-stu-id="ec4bc-103">If you are migrating from the .NET Framework 4.5.1 to 4.7, review the following topics for application compatibility issues that may affect your app:</span></span>

## <a name="aspnet"></a><span data-ttu-id="ec4bc-104">ASP.NET</span><span class="sxs-lookup"><span data-stu-id="ec4bc-104">ASP.NET</span></span>
...
## <a name="core"></a><span data-ttu-id="ec4bc-105">Podstawowe</span><span class="sxs-lookup"><span data-stu-id="ec4bc-105">Core</span></span>
...
## <a name="data"></a><span data-ttu-id="ec4bc-106">Dane</span><span class="sxs-lookup"><span data-stu-id="ec4bc-106">Data</span></span>
...
## <a name="debugger"></a><span data-ttu-id="ec4bc-107">Debuger</span><span class="sxs-lookup"><span data-stu-id="ec4bc-107">Debugger</span></span>
...
## <a name="entity-framework"></a><span data-ttu-id="ec4bc-108">Entity Framework</span><span class="sxs-lookup"><span data-stu-id="ec4bc-108">Entity Framework</span></span>
...
## <a name="globalization"></a><span data-ttu-id="ec4bc-109">Globalizacja</span><span class="sxs-lookup"><span data-stu-id="ec4bc-109">Globalization</span></span>
...
## <a name="jit"></a><span data-ttu-id="ec4bc-110">JIT</span><span class="sxs-lookup"><span data-stu-id="ec4bc-110">JIT</span></span>
...
## <a name="networking"></a><span data-ttu-id="ec4bc-111">Networking</span><span class="sxs-lookup"><span data-stu-id="ec4bc-111">Networking</span></span>
...
## <a name="security"></a><span data-ttu-id="ec4bc-112">Zabezpieczenia</span><span class="sxs-lookup"><span data-stu-id="ec4bc-112">Security</span></span>
...
## <a name="serialization"></a><span data-ttu-id="ec4bc-113">Serializacja</span><span class="sxs-lookup"><span data-stu-id="ec4bc-113">Serialization</span></span>
...
## <a name="setup-and-deployment"></a><span data-ttu-id="ec4bc-114">Konfiguracja i wdrażanie</span><span class="sxs-lookup"><span data-stu-id="ec4bc-114">Setup and Deployment</span></span>
...
## <a name="tools"></a><span data-ttu-id="ec4bc-115">narzędzia</span><span class="sxs-lookup"><span data-stu-id="ec4bc-115">Tools</span></span>

[!INCLUDE[Contract.Invariant or Contract.Requires\<TException> do not consider String.IsNullOrEmpty to be pure](~/includes/migration-guide/runtime/tools/contractinvariant-contractrequirestexception-do-not-consider.md)]

## <a name="windows-communication-foundation-wcf"></a><span data-ttu-id="ec4bc-116">Windows Communication Foundation (WCF)</span><span class="sxs-lookup"><span data-stu-id="ec4bc-116">Windows Communication Foundation (WCF)</span></span>
...
## <a name="windows-presentation-foundation-wpf"></a><span data-ttu-id="ec4bc-117">Windows Presentation Foundation (WPF)</span><span class="sxs-lookup"><span data-stu-id="ec4bc-117">Windows Presentation Foundation (WPF)</span></span>
...
## <a name="windows-workflow-foundation-wf"></a><span data-ttu-id="ec4bc-118">Program Windows Workflow Foundation (WF)</span><span class="sxs-lookup"><span data-stu-id="ec4bc-118">Windows Workflow Foundation (WF)</span></span>
