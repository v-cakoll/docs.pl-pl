...
ms.locfileid: "33472251"
---
# <a name="calls-failed"></a>Wywołania zakończone niepowodzeniem
Nazwa licznika: Wywołania zakończone niepowodzeniem  
  
## <a name="description"></a>Opis  
 Liczba wywołań z nieobsługiwanymi wyjątkami w tej operacji. Ten licznik jest zwiększany zawsze, gdy jest nieobsługiwany w tej operacji.  
