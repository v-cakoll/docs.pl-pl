...
## <a name="in-this-section"></a>W tej sekcji  
 ...
 [Instrukcje: Dołączanie formantu MenuStrip do nadrzędnego okna MDI](how-to-append-a-menustrip-to-an-mdi-parent-window-windows-forms.md)  
 ...
 [Instrukcje: Usuwanie elementu ToolStripMenuItem z Menu rozwijanego MDI](how-to-remove-a-toolstripmenuitem-from-an-mdi-drop-down-menu-windows-forms.md)  
 ...
 [Instrukcje: MenuStrip — Konfiguracja marginesów zaznaczania i marginesów obrazu](how-to-configure-menustrip-check-margins-and-image-margins.md)  
 ...
 [Instrukcje: Wyświetlanie przycisków opcji w formancie MenuStrip](how-to-display-option-buttons-in-a-menustrip-windows-forms.md)  
