...
---
# <a name="runtime-changes-for-migration-from-net-framework-452-to-462"></a><span data-ttu-id="b55ce-102">Zmiany środowiska uruchomieniowego do migracji z systemu .NET Framework 4.5.2 i 4.6.2</span><span class="sxs-lookup"><span data-stu-id="b55ce-102">Runtime Changes for Migration from .NET Framework 4.5.2 to 4.6.2</span></span>

[!include[versionselector](../../../../includes/migration-guide/runtime/versionselector.md)]

[!include[introduction](../../../../includes/migration-guide/runtime/introduction.md)]

<span data-ttu-id="b55ce-103">W przypadku migracji z programu .NET Framework 4.5.2 i 4.6.2, należy przejrzeć następujące tematy dla problemów ze zgodnością aplikacji, które mogą wpływać na aplikację:</span><span class="sxs-lookup"><span data-stu-id="b55ce-103">If you are migrating from the .NET Framework 4.5.2 to 4.6.2, review the following topics for application compatibility issues that may affect your app:</span></span>

## <a name="aspnet"></a><span data-ttu-id="b55ce-104">ASP.NET</span><span class="sxs-lookup"><span data-stu-id="b55ce-104">ASP.NET</span></span>
...
## <a name="core"></a><span data-ttu-id="b55ce-105">Core</span><span class="sxs-lookup"><span data-stu-id="b55ce-105">Core</span></span>
...
## <a name="data"></a><span data-ttu-id="b55ce-106">Dane</span><span class="sxs-lookup"><span data-stu-id="b55ce-106">Data</span></span>
...
## <a name="debugger"></a><span data-ttu-id="b55ce-107">Debugger</span><span class="sxs-lookup"><span data-stu-id="b55ce-107">Debugger</span></span>
...
## <a name="globalization"></a><span data-ttu-id="b55ce-108">Globalizacja</span><span class="sxs-lookup"><span data-stu-id="b55ce-108">Globalization</span></span>
...
## <a name="networking"></a><span data-ttu-id="b55ce-109">Obsługa sieci</span><span class="sxs-lookup"><span data-stu-id="b55ce-109">Networking</span></span>
...
## <a name="security"></a><span data-ttu-id="b55ce-110">Zabezpieczenia</span><span class="sxs-lookup"><span data-stu-id="b55ce-110">Security</span></span>
...
## <a name="serialization"></a><span data-ttu-id="b55ce-111">Serializacja</span><span class="sxs-lookup"><span data-stu-id="b55ce-111">Serialization</span></span>
...
## <a name="setup-and-deployment"></a><span data-ttu-id="b55ce-112">Instalacji i wdrażania</span><span class="sxs-lookup"><span data-stu-id="b55ce-112">Setup and Deployment</span></span>
...
## <a name="tools"></a><span data-ttu-id="b55ce-113">Narzędzia</span><span class="sxs-lookup"><span data-stu-id="b55ce-113">Tools</span></span>

[!include[Contract.Invariant or Contract.Requires<TException> do not consider String.IsNullOrEmpty to be pure](~/includes/migration-guide/runtime/tools/contractinvariant-contractrequirestexception-do-not-consider.md)]

## <a name="windows-communication-foundation-wcf"></a><span data-ttu-id="b55ce-114">Windows Communication Foundation (WCF)</span><span class="sxs-lookup"><span data-stu-id="b55ce-114">Windows Communication Foundation (WCF)</span></span>
...
## <a name="windows-presentation-foundation-wpf"></a><span data-ttu-id="b55ce-115">Windows Presentation Foundation (WPF)</span><span class="sxs-lookup"><span data-stu-id="b55ce-115">Windows Presentation Foundation (WPF)</span></span>
