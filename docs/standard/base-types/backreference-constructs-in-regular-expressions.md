...
description: Dowiedz się, jak rozpoznają elementy tekstowe powtarzanych przy użyciu konstrukcje dopasowywania wstecznego w wyrażeniach regularnych.
ms.date: 03/30/2017
