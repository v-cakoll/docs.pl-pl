...
Jeśli operacja, która będzie zająć dużo czasu, i nie ma interfejsu użytkownika (UI) przestanie odpowiadać lub do blokowania, możesz użyć <xref:System.ComponentModel.BackgroundWorker> klasy do wykonywania operacji na inny wątek.
...
## <a name="create-a-form-that-uses-a-background-operation"></a>Tworzenie formularza korzystającego z operacji w tle

1. W programie Visual Studio Utwórz projekt aplikacji systemu Windows o nazwie `BackgroundWorkerExample` (**pliku** > **New** > **projektu**  >  **Visual C#**  lub **języka Visual Basic** > **Classic Desktop** > **Windows Forms Aplikacja**).
...
## <a name="create-a-backgroundworker-with-the-designer"></a>Tworzenie BackgroundWorker przy użyciu narzędzia Projektant
...
## <a name="add-asynchronous-event-handlers"></a>Dodawanie obsługi zdarzeń asynchronicznych
...
### <a name="implement-progress-reporting"></a>Implementowanie raportowania postępu
...
### <a name="implement-support-for-cancellation"></a>Zapewnia obsługę anulowania
