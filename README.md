...
Aby uczestniczyć we współtworzeniu, zapoznaj się z [projektami dla współpracowników ze społeczności platformy .NET](https://github.com/dotnet/docs/projects/35). [Przewodnik współautora](CONTRIBUTING.md) zawiera instrukcje dotyczące procedur, których używamy. 

Jeśli interesuje Cię pomoc w migracji istniejącego kodu, który jest przeznaczony dla .NET Framework z witryny z [galerii wycofywanych kodu](https://docs.microsoft.com/teamblog/msdn-code-gallery-retired) do aplikacji .NET Core przechowywanych w naszym [repozytorium przykładów](https://github.com/dotnet/samples) i do pobrania z [przeglądarki przykładów](https://docs.microsoft.com/samples/browse), zobacz projekt [migracji galerii kodu](https://github.com/dotnet/docs/projects/88) . Przykłady z galerii kodu zostały przeniesione do organizacji [archiwum firmy Microsoft](https://github.com/microsoftarchive?q=msdn-code-gallery) .
