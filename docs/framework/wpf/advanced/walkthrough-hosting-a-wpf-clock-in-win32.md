...
Ten samouczek koncentruje się na ważnych krokach tworzenia aplikacji międzyoperacyjnej. Ten samouczek jest obsługiwany przez przykładową próbkę [Międzyoperacyjną z zegarem Win32](https://github.com/Microsoft/WPF-Samples/tree/master/Migration%20and%20Interoperability/Win32Clock), ale ten przykład stanowi odbicie produktu końcowego. W tym samouczku przedstawiono kroki, tak jakby były uruchamiane z istniejącym projektem Win32, prawdopodobnie istniejącym projektem i dodano hostowaną [!INCLUDE[TLA2#tla_winclient](../../../../includes/tla2sharptla-winclient-md.md)] do aplikacji. Możesz porównać produkt końcowy z [próbką międzyoperacyjną zegara Win32](https://github.com/Microsoft/WPF-Samples/tree/master/Migration%20and%20Interoperability/Win32Clock).
...
(Nie musisz używać programu Visual Studio, aby używać <xref:System.Windows.Interop.HwndSource>, i nie musisz używać C++ do pisania programów Win32, ale jest to dość typowy sposób na to, i dowiesz się również, jak najlepiej wykonać krokowe wyjaśnienie samouczka).
...
1. Włącz Wywoływanie kodu zarządzanego ( **/CLR**) w projekcie Win32 przez zmianę ustawień projektu w programie Visual Studio.
...
5. Użyj systemu Win32, aby zdecydować, gdzie umieścić Właściwość HWND w większej aplikacji Win32

## <a name="clr"></a>/CLR

Pierwszym krokiem jest włączenie tego niezarządzanego projektu Win32 do takiego, który może wywołać kod zarządzany. Używasz opcji kompilatora/CLR, która będzie łączyć się z niezbędnymi bibliotekami DLL, których chcesz użyć, i Dostosuj metodę Main do użycia z [!INCLUDE[TLA2#tla_winclient](../../../../includes/tla2sharptla-winclient-md.md)].
...
Projekt [!INCLUDE[TLA2#tla_winclient](../../../../includes/tla2sharptla-winclient-md.md)] dll można następnie połączyć z projektem Win32 (jedno rozwiązanie zawierające dwa projekty) — kliknij prawym przyciskiem myszy rozwiązanie, a następnie wybierz pozycję **projekt Add\Existing**.

Aby użyć tej [!INCLUDE[TLA2#tla_winclient](../../../../includes/tla2sharptla-winclient-md.md)] dll z projektu Win32, należy dodać odwołanie:
...
Teraz, gdy masz Właściwość HWND, która zawiera zegar [!INCLUDE[TLA2#tla_winclient](../../../../includes/tla2sharptla-winclient-md.md)], musisz umieścić ten element HWND wewnątrz okna dialogowego Win32. Jeśli wiesz tylko, gdzie umieścić Właściwość HWND, wystarczy przekazać ten rozmiar i lokalizację do zdefiniowanej wcześniej funkcji `GetHwnd`. Jednak w celu zdefiniowania okna dialogowego użyto pliku zasobów, dlatego nie należy dokładnie sprawdzić, gdzie są umieszczone dowolne z tych elementów. Możesz użyć edytora okna dialogowego programu Visual Studio, aby umieścić STATYCZNy formant Win32 w miejscu, w którym ma się znajdować zegar ("Wstaw zegar tutaj") i użyć, aby ustawić zegar [!INCLUDE[TLA2#tla_winclient](../../../../includes/tla2sharptla-winclient-md.md)].
...
Aby porównać wynik końcowy z kodem, który wygenerował ten zrzut ekranu, zobacz [przykład międzyoperacyjna](https://github.com/Microsoft/WPF-Samples/tree/master/Migration%20and%20Interoperability/Win32Clock)w systemie Win32.

## <a name="see-also"></a>Zobacz też

- <xref:System.Windows.Interop.HwndSource>
- [WPF i Win32 — współdziałanie](wpf-and-win32-interoperation.md)
- [Przykład międzyoperacyjności zegara Win32](https://github.com/Microsoft/WPF-Samples/tree/master/Migration%20and%20Interoperability/Win32Clock)
