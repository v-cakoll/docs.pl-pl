...
|Metoda|Opis|  
|------------|-----------------|  
|[Next, metoda](../../../../docs/framework/unmanaged-api/debugging/icordebugprocessenum-next-method.md)|Pobiera określoną liczbę wystąpień `ICorDebugProcess` z wyliczenia, rozpoczynając od bieżącego położenia.|  
