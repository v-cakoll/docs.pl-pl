...
## <a name="in-this-section"></a>W tej sekcji  
 ...
 [Caspol.exe (Narzędzie zasad zabezpieczeń dostępu kodu)](../../../docs/framework/tools/caspol-exe-code-access-security-policy-tool.md)  
 ...
 [MageUI.exe (Narzędzie generowania i edytowania manifestu, klient grafiki)](../../../docs/framework/tools/mageui-exe-manifest-generation-and-editing-tool-graphical-client.md)  
