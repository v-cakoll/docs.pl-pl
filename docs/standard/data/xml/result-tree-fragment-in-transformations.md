...
```  
 ...
 Gdy zmienna jest powiązana z wynikowego fragmentu drzewa, zamiast jednej z czterech podstawowych typów danych XPath, to jest jedyny raz, że zapytanie XPath zwraca typ, który nie jest jedną z czterech typów obiektów języka XPath. Ich zachowanie i fragmenty drzewa wynik zostały omówione w specyfikacji World Wide Web Consortium (W3C) na www.w3.org/XSLT, fragmenty drzewa wynik sekcji 11.1 za pomocą sekcji 11.6 przekazywania parametrów do szablonów. Ponadto sekcji 1 wprowadzenie w tym artykule omówiono sposób szablony mogą zawierać elementy z przestrzeni nazw XSLT, które zwracają lub utworzyć fragmenty drzewa wynik.  
