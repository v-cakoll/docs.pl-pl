...
Tematy w tej sekcji przedstawia wskazówki dotyczące i elementów do uwzględnienia podczas tworzenia bezpiecznego [!INCLUDE[indigo1](../../../../includes/indigo1-md.md)] aplikacji. [!INCLUDE[crabout](../../../../includes/crabout-md.md)]Windows Server AppFabric i zabezpieczeń, zobacz, [zabezpieczeń modelu dla systemu Windows Server AppFabric](http://go.microsoft.com/fwlink/?LinkID=201279&clcid=0x409)  
