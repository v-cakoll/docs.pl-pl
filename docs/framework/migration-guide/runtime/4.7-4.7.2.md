...
---
# <a name="runtime-changes-for-migration-from-net-framework-47-to-472"></a>Zmiany środowiska uruchomieniowego do migracji z systemu .NET Framework 4.7 lub 4.7.2
