...
|Drugi argument zestaw węzłów funkcji dokument jest pusty i odwołanie do identyfikatora URI jest względna|Odzyskiwanie|Errata e14|  
 ...
 Sekcje z errata znajdują się w sieci World Wide Web Consortium (W3C) przekształcenia XSL (XSLT) w wersji 1.0 specyfikacji Errata, znajdujący się w www.w3.org/1999/11/REC-xslt-19991116-errata.  
...
|Wartość liczbowa|Wartości liczbowe są traktowane jako liczby XML Path Language (XPath) i są sortowane zgodnie ze szczegółami przedstawione zalecenia w wersji 1.0 W3C XML Path Language (XPath), sekcja 3.5 (www.w3.org/TR/xpath.html#numbers).|  
