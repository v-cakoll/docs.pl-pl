...
#### <a name="parameters"></a>Parametry  
 `FileToken`  
 Identyfikator zestawu, do którego będzie można znaleźć skrót.  
  
 `ppvHash`  
 Odbiera wynikowego obiektu blob generowania skrótu.  
  
 `pcbHash`  
 Odbiera rozmiar w bajtach obiektu blob generowania skrótu.  
