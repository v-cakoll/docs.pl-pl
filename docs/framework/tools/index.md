...
## <a name="in-this-section"></a>W tej sekcji  
 ...
 [Aximp.exe (Importer kontrolki ActiveX formularzy systemu Windows)](../../../docs/framework/tools/aximp-exe-windows-forms-activex-control-importer.md)  
 ...
 [Certmgr.exe (Menedżer certyfikatów narzędzie)](../../../docs/framework/tools/certmgr-exe-certificate-manager-tool.md)  
 ...
 [Fuslogvw.exe zasobów (Podgląd dziennika powiązań)](../../../docs/framework/tools/fuslogvw-exe-assembly-binding-log-viewer.md)  
 ...
 [MDbg.exe (debuger wiersza polecenia platformy .NET Framework)](../../../docs/framework/tools/mdbg-exe.md)  
 ...
 [SecAnnotate.exe (narzędzie adnotacji zabezpieczeń .NET)](../../../docs/framework/tools/secannotate-exe-net-security-annotator-tool.md)  
 ...
 [Storeadm.exe (narzędzie izolowanego magazynu)](../../../docs/framework/tools/storeadm-exe-isolated-storage-tool.md)  
 ...
 [Winmdexp.exe (narzędzie eksportowania metadanych środowiska wykonawczego systemu Windows)](../../../docs/framework/tools/winmdexp-exe-windows-runtime-metadata-export-tool.md)  
