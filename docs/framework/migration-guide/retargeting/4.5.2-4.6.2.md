---
title: Zmiany retargetingu migracji z programu .NET Framework 4.5.2 do 4.6.2
ms.date: 07/10/2019
...
---
# <a name="retargeting-changes-for-migration-from-net-framework-452-to-462"></a><span data-ttu-id="7f188-102">Zmiany retargetingu migracji z programu .NET Framework 4.5.2 do 4.6.2</span><span class="sxs-lookup"><span data-stu-id="7f188-102">Retargeting Changes for Migration from .NET Framework 4.5.2 to 4.6.2</span></span>

[!INCLUDE[versionselector](../../../../includes/migration-guide/retargeting/versionselector.md)]

<span data-ttu-id="7f188-103">W przypadku migracji z programu .NET Framework 4.5.2 do 4.6.2 zapoznaj się z następującymi tematami dotyczącymi problemów ze zgodnością aplikacji, które mogą mieć wpływ na aplikację:</span><span class="sxs-lookup"><span data-stu-id="7f188-103">If you are migrating from the .NET Framework 4.5.2 to 4.6.2, review the following topics for application compatibility issues that may affect your app:</span></span>

## <a name="aspnet"></a><span data-ttu-id="7f188-104">ASP.NET</span><span class="sxs-lookup"><span data-stu-id="7f188-104">ASP.NET</span></span>
...
## <a name="clickonce"></a><span data-ttu-id="7f188-105">ClickOnce</span><span class="sxs-lookup"><span data-stu-id="7f188-105">ClickOnce</span></span>
...
## <a name="core"></a><span data-ttu-id="7f188-106">Podstawowe</span><span class="sxs-lookup"><span data-stu-id="7f188-106">Core</span></span>
...
## <a name="entity-framework"></a><span data-ttu-id="7f188-107">Entity Framework</span><span class="sxs-lookup"><span data-stu-id="7f188-107">Entity Framework</span></span>
...
## <a name="jit"></a><span data-ttu-id="7f188-108">JIT</span><span class="sxs-lookup"><span data-stu-id="7f188-108">JIT</span></span>
...
## <a name="networking"></a><span data-ttu-id="7f188-109">Networking</span><span class="sxs-lookup"><span data-stu-id="7f188-109">Networking</span></span>
...
## <a name="security"></a><span data-ttu-id="7f188-110">Zabezpieczenia</span><span class="sxs-lookup"><span data-stu-id="7f188-110">Security</span></span>
...
## <a name="windows-communication-foundation-wcf"></a><span data-ttu-id="7f188-111">Windows Communication Foundation (WCF)</span><span class="sxs-lookup"><span data-stu-id="7f188-111">Windows Communication Foundation (WCF)</span></span>
...
## <a name="windows-forms"></a><span data-ttu-id="7f188-112">Windows Forms</span><span class="sxs-lookup"><span data-stu-id="7f188-112">Windows Forms</span></span>
...
## <a name="windows-presentation-foundation-wpf"></a><span data-ttu-id="7f188-113">Windows Presentation Foundation (WPF)</span><span class="sxs-lookup"><span data-stu-id="7f188-113">Windows Presentation Foundation (WPF)</span></span>
...
## <a name="xml-xslt"></a><span data-ttu-id="7f188-114">Języki XML, XSLT</span><span class="sxs-lookup"><span data-stu-id="7f188-114">XML, XSLT</span></span>
