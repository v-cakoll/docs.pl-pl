...
Lista ograniczeń zawiera zarówno [operatora New](../../visual-basic/language-reference/operators/new-operator.md) ograniczenia i [struktury (Visual Basic)](http://msdn.microsoft.com/en-us/263ce115-ac36-4c05-8cb7-0e0eead5c6d0) ograniczenia.  
