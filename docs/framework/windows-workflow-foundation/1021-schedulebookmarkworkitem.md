...
## <a name="description"></a>Opis  
 Wskazuje, że zaplanowano element roboczy BookmarkWorkItem.  
  
## <a name="message"></a>Komunikat  
 Zaplanowano element roboczy BookmarkWorkItem dla działania %1, nazwa wyświetlana: %2, identyfikator wystąpienia: '%3'.  Nazwa zakładki: %4, zakres zakładek: %5.  
