---
title: "Zmiany środowiska uruchomieniowego do migracji z platformy .NET Framework 4.5.2 i 4.6"
ms.date: 06/16/2017
...
---
# <a name="runtime-changes-for-migration-from-net-framework-452-to-46"></a><span data-ttu-id="1b829-102">Zmiany środowiska uruchomieniowego do migracji z platformy .NET Framework 4.5.2 i 4.6</span><span class="sxs-lookup"><span data-stu-id="1b829-102">Runtime Changes for Migration from .NET Framework 4.5.2 to 4.6</span></span>

[!include[versionselector](../../../../includes/migration-guide/runtime/versionselector.md)]

[!include[introduction](../../../../includes/migration-guide/runtime/introduction.md)]

<span data-ttu-id="1b829-103">W przypadku migracji z programu .NET Framework 4.5.2 i 4.6, przejrzyj następujące tematy dotyczące problemów ze zgodnością aplikacji, które mogą wpływać na aplikację:</span><span class="sxs-lookup"><span data-stu-id="1b829-103">If you are migrating from the .NET Framework 4.5.2 to 4.6, review the following topics for application compatibility issues that may affect your app:</span></span>

## <a name="aspnet"></a><span data-ttu-id="1b829-104">ASP.NET</span><span class="sxs-lookup"><span data-stu-id="1b829-104">ASP.NET</span></span>
...
## <a name="core"></a><span data-ttu-id="1b829-105">Core</span><span class="sxs-lookup"><span data-stu-id="1b829-105">Core</span></span>
...
## <a name="data"></a><span data-ttu-id="1b829-106">Dane</span><span class="sxs-lookup"><span data-stu-id="1b829-106">Data</span></span>
...
## <a name="debugger"></a><span data-ttu-id="1b829-107">Debuger</span><span class="sxs-lookup"><span data-stu-id="1b829-107">Debugger</span></span>
...
## <a name="networking"></a><span data-ttu-id="1b829-108">Obsługa sieci</span><span class="sxs-lookup"><span data-stu-id="1b829-108">Networking</span></span>
...
## <a name="serialization"></a><span data-ttu-id="1b829-109">Serializacja</span><span class="sxs-lookup"><span data-stu-id="1b829-109">Serialization</span></span>
...
## <a name="setup-and-deployment"></a><span data-ttu-id="1b829-110">Instalacji i wdrażania</span><span class="sxs-lookup"><span data-stu-id="1b829-110">Setup and Deployment</span></span>
...
## <a name="windows-communication-foundation-wcf"></a><span data-ttu-id="1b829-111">Windows Communication Foundation (WCF)</span><span class="sxs-lookup"><span data-stu-id="1b829-111">Windows Communication Foundation (WCF)</span></span>
...
## <a name="windows-forms"></a><span data-ttu-id="1b829-112">Windows Forms</span><span class="sxs-lookup"><span data-stu-id="1b829-112">Windows Forms</span></span>
...
## <a name="windows-presentation-foundation-wpf"></a><span data-ttu-id="1b829-113">Windows Presentation Foundation (WPF)</span><span class="sxs-lookup"><span data-stu-id="1b829-113">Windows Presentation Foundation (WPF)</span></span>
