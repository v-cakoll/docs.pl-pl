...
Aby uzyskać przykład pracy ze strumieniami asynchronicznie, zobacz [asynchroniczne We/Wy](asynchronous-file-i-o.md).
...
Zobacz [jak: Odczytywanie tekstu z pliku](how-to-read-text-from-a-file.md), [jak: Zapisywanie tekstu do pliku](how-to-write-text-to-a-file.md), [jak: Odczytywanie znaków z ciągu](how-to-read-characters-from-a-string.md), i [jak: Zapisywanie znaków w ciągu](how-to-write-characters-to-a-string.md).
...
Aby uzyskać więcej informacji, zobacz [asynchroniczne We/Wy](asynchronous-file-i-o.md).
...
Zobacz [Isolated Storage](isolated-storage.md).

## <a name="io-operations-in-windows-store-apps"></a>Operacje We/Wy w aplikacjach Windows Store
...
- [Asynchroniczne We/Wy pliku](asynchronous-file-i-o.md)\
