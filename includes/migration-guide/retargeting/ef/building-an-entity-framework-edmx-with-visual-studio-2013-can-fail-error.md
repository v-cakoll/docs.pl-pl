...
|Sugestia|Pliki obiektów docelowych Entity Framework są naprawione do pracy z nowym układem MSBuild począwszy od wersji .NET Framework 4.6. Uaktualnienie do tej wersji platformy Framework rozwiąże ten problem. Alternatywnie [to obejście](https://stackoverflow.com/a/24249247/131944) może służyć do bezpośredniego instalowania plików obiektów docelowych.|
|Zakres|Duży|
|Wersja|4.5.1|
|Typ|Przekierowanie|
