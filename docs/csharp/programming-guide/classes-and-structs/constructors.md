...
## <a name="see-also"></a>Zobacz też  
 ...
 [Dlaczego są inicjatory uruchamiane w kolejności przeciwną jako konstruktorów? Część 1](https://blogs.msdn.microsoft.com/ericlippert/2008/02/15/why-do-initializers-run-in-the-opposite-order-as-constructors-part-one)
