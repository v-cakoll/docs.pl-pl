...
-   **Niejawne konwersje**: nie specjalnej składni jest wymagany, ponieważ konwersja jest bezpiecznym typem, a żadne dane nie zostaną utracone. Przykłady obejmują konwersji z mniejszych na większych typów całkowitych i konwersje z klasy podstawowej w klasach pochodnych.  
  
-   **Konwersje jawne (rzutowania)**: jawne konwersje wymaga operatora rzutowania. Rzutowanie jest wymagane, gdy informacji może zostać utracone podczas konwersji, lub gdy Konwersja może się nie powieść z innych przyczyn.  Typowe przykłady obejmują numerycznej konwersji do typu, który ma mniejszą dokładność i mniejszy zakres i konwersja wystąpienia klasy bazowej do klasy pochodnej.  
...
## <a name="type-conversion-exceptions-at-run-time"></a>Wyjątki konwersji typu w czasie wykonywania  
 ...
 C# zawiera [jest](../../../csharp/language-reference/keywords/is.md) i [jako](../../../csharp/language-reference/keywords/as.md) operatorów umożliwiających testowanie zgodności przed wykonaniem faktycznie rzutowania. Aby uzyskać więcej informacji, zobacz [porady: bezpieczne rzutowanie za pomocą jako operatorów i is](../../../csharp/programming-guide/types/how-to-safely-cast-by-using-as-and-is-operators.md).  
...
## <a name="see-also"></a>Zobacz też  
 ...
 [Konwersja uogólnionych typów](http://msdn.microsoft.com/library/49253ae6-7657-4810-82ab-1176a6feeada)  
 [Konwersja typu wyeksportowanego](http://msdn.microsoft.com/library/1dfe55f4-07a2-4b61-aabf-a8cf65783a6b)  
