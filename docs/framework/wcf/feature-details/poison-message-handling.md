...
- <xref:System.ServiceModel.NetMsmqBinding>. Wiązanie .NET Framework odpowiednia do przeprowadzania komunikacji z innymi punktami końcowymi programu WCF z kolejki.  
