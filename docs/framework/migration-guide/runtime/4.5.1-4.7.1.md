...
---
# <a name="runtime-changes-for-migration-from-net-framework-451-to-471"></a><span data-ttu-id="207b9-102">Zmiany środowiska uruchomieniowego do migracji z systemu .NET Framework 4.5.1 lub 4.7.1</span><span class="sxs-lookup"><span data-stu-id="207b9-102">Runtime Changes for Migration from .NET Framework 4.5.1 to 4.7.1</span></span>

[!include[versionselector](../../../../includes/migration-guide/runtime/versionselector.md)]

[!include[introduction](../../../../includes/migration-guide/runtime/introduction.md)]

<span data-ttu-id="207b9-103">W przypadku migracji z programu .NET Framework 4.5.1 lub 4.7.1, należy przejrzeć następujące tematy dla problemów ze zgodnością aplikacji, które mogą wpływać na aplikację:</span><span class="sxs-lookup"><span data-stu-id="207b9-103">If you are migrating from the .NET Framework 4.5.1 to 4.7.1, review the following topics for application compatibility issues that may affect your app:</span></span>

## <a name="aspnet"></a><span data-ttu-id="207b9-104">ASP.NET</span><span class="sxs-lookup"><span data-stu-id="207b9-104">ASP.NET</span></span>
...
## <a name="core"></a><span data-ttu-id="207b9-105">Core</span><span class="sxs-lookup"><span data-stu-id="207b9-105">Core</span></span>
...
## <a name="data"></a><span data-ttu-id="207b9-106">Dane</span><span class="sxs-lookup"><span data-stu-id="207b9-106">Data</span></span>
...
## <a name="debugger"></a><span data-ttu-id="207b9-107">Debuger</span><span class="sxs-lookup"><span data-stu-id="207b9-107">Debugger</span></span>
...
## <a name="entity-framework"></a><span data-ttu-id="207b9-108">Entity Framework</span><span class="sxs-lookup"><span data-stu-id="207b9-108">Entity Framework</span></span>
...
## <a name="globalization"></a><span data-ttu-id="207b9-109">Globalizacja</span><span class="sxs-lookup"><span data-stu-id="207b9-109">Globalization</span></span>
...
## <a name="networking"></a><span data-ttu-id="207b9-110">Obsługa sieci</span><span class="sxs-lookup"><span data-stu-id="207b9-110">Networking</span></span>
...
## <a name="security"></a><span data-ttu-id="207b9-111">Zabezpieczenia</span><span class="sxs-lookup"><span data-stu-id="207b9-111">Security</span></span>
...
## <a name="serialization"></a><span data-ttu-id="207b9-112">Serializacja</span><span class="sxs-lookup"><span data-stu-id="207b9-112">Serialization</span></span>
...
## <a name="setup-and-deployment"></a><span data-ttu-id="207b9-113">Instalacji i wdrażania</span><span class="sxs-lookup"><span data-stu-id="207b9-113">Setup and Deployment</span></span>
...
## <a name="tools"></a><span data-ttu-id="207b9-114">Narzędzia</span><span class="sxs-lookup"><span data-stu-id="207b9-114">Tools</span></span>

[!include[Contract.Invariant or Contract.Requires<TException> do not consider String.IsNullOrEmpty to be pure](~/includes/migration-guide/runtime/tools/contractinvariant-contractrequirestexception-do-not-consider.md)]

## <a name="windows-communication-foundation-wcf"></a><span data-ttu-id="207b9-115">Windows Communication Foundation (WCF)</span><span class="sxs-lookup"><span data-stu-id="207b9-115">Windows Communication Foundation (WCF)</span></span>
...
## <a name="windows-forms"></a><span data-ttu-id="207b9-116">Windows Forms</span><span class="sxs-lookup"><span data-stu-id="207b9-116">Windows Forms</span></span>
...
## <a name="windows-presentation-foundation-wpf"></a><span data-ttu-id="207b9-117">Windows Presentation Foundation (WPF)</span><span class="sxs-lookup"><span data-stu-id="207b9-117">Windows Presentation Foundation (WPF)</span></span>
...
## <a name="windows-workflow-foundation-wf"></a><span data-ttu-id="207b9-118">Program Windows Workflow Foundation (WF)</span><span class="sxs-lookup"><span data-stu-id="207b9-118">Windows Workflow Foundation (WF)</span></span>
