...
### <a name="to-copy-a-control"></a>Aby skopiować formantu  
  
1.  Wybierz kontrolkę i z **Edytuj** menu wybierz **kopiowania**.  
  
 Teraz można wkleić do dowolnego formularza, który akceptuje tego typu formantu tego formantu. Ponadto dodano formant do Schowka.  
