...
## <a name="description"></a>Opis  
 To zdarzenie oznacza, że nieobsługiwany wyjątek został zgłoszony podczas przetwarzania zdarzenia automatu stanów. Listy zdarzeń identyfikator transakcji, Nazwa maszyny stanu, bieżący stan, historii, identyfikator rejestracji, wyjątek, nazwa procesu i proces identyfikatora.  
