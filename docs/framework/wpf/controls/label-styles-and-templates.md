...
W tym temacie opisano, style i szablonów dla <xref:System.Windows.Controls.Label> formantu. Można zmodyfikować domyślne <xref:System.Windows.Controls.ControlTemplate> umożliwiają unikatowego wyglądu formantu. Aby uzyskać więcej informacji, zobacz [Dostosowywanie wyglądu formant tworząc ControlTemplate](../../../../docs/framework/wpf/controls/customizing-the-appearance-of-an-existing-control.md).  
  
## <a name="label-parts"></a>Części etykiety  
 <xref:System.Windows.Controls.Label> Formant nie ma żadnych części o nazwie.  
  
## <a name="label-states"></a>Etykieta zawiera  
 W poniższej tabeli wymieniono stany wizualne dla <xref:System.Windows.Controls.Label> formantu.  
...
## <a name="label-controltemplate-example"></a>Przykład ControlTemplate etykiety  
 Poniższy przykład przedstawia sposób definiowania <xref:System.Windows.Controls.ControlTemplate> dla <xref:System.Windows.Controls.Label> formantu.  
