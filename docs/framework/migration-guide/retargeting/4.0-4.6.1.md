...
ms.locfileid: "37071434"
---
# <a name="retargeting-changes-for-migration-from-net-framework-40-to-461"></a><span data-ttu-id="50af8-102">Zmiany retargetingu migracji z systemu .NET Framework 4.0 do wersji 4.6.1</span><span class="sxs-lookup"><span data-stu-id="50af8-102">Retargeting Changes for Migration from .NET Framework 4.0 to 4.6.1</span></span>

[!INCLUDE[versionselector](../../../../includes/migration-guide/retargeting/versionselector.md)]

[!INCLUDE[introduction](../../../../includes/migration-guide/retargeting/introduction.md)]

<span data-ttu-id="50af8-103">Jeśli w przypadku migracji z programu .NET Framework 4.0 do wersji 4.6.1, należy przejrzeć następujące tematy dla problemów ze zgodnością aplikacji, które mogą wpływać na aplikację:</span><span class="sxs-lookup"><span data-stu-id="50af8-103">If you are migrating from the .NET Framework 4.0 to 4.6.1, review the following topics for application compatibility issues that may affect your app:</span></span>

## <a name="adonet"></a><span data-ttu-id="50af8-104">ADO.NET</span><span class="sxs-lookup"><span data-stu-id="50af8-104">ADO.NET</span></span>
...
## <a name="aspnet"></a><span data-ttu-id="50af8-105">ASP.NET</span><span class="sxs-lookup"><span data-stu-id="50af8-105">ASP.NET</span></span>
...
## <a name="clickonce"></a><span data-ttu-id="50af8-106">ClickOnce</span><span class="sxs-lookup"><span data-stu-id="50af8-106">ClickOnce</span></span>
...
## <a name="core"></a><span data-ttu-id="50af8-107">Core</span><span class="sxs-lookup"><span data-stu-id="50af8-107">Core</span></span>
...
## <a name="entity-framework"></a><span data-ttu-id="50af8-108">Entity Framework</span><span class="sxs-lookup"><span data-stu-id="50af8-108">Entity Framework</span></span>
...
## <a name="jit"></a><span data-ttu-id="50af8-109">JIT</span><span class="sxs-lookup"><span data-stu-id="50af8-109">JIT</span></span>
...
## <a name="msbuild"></a><span data-ttu-id="50af8-110">MSBuild</span><span class="sxs-lookup"><span data-stu-id="50af8-110">MSBuild</span></span>
...
## <a name="networking"></a><span data-ttu-id="50af8-111">Sieć</span><span class="sxs-lookup"><span data-stu-id="50af8-111">Networking</span></span>
...
## <a name="visual-basic-net"></a><span data-ttu-id="50af8-112">Visual Basic .NET</span><span class="sxs-lookup"><span data-stu-id="50af8-112">Visual Basic .NET</span></span>

[!INCLUDE[VB.NET no longer supports partial namespace qualification for System.Windows APIs](~/includes/migration-guide/retargeting/vb/vbnet-no-longer-supports-partial-namespace-qualification-for-systemwindows.md)]

## <a name="windows-communication-foundation-wcf"></a><span data-ttu-id="50af8-113">Windows Communication Foundation (WCF)</span><span class="sxs-lookup"><span data-stu-id="50af8-113">Windows Communication Foundation (WCF)</span></span>
...
## <a name="windows-forms"></a><span data-ttu-id="50af8-114">Program Windows Forms</span><span class="sxs-lookup"><span data-stu-id="50af8-114">Windows Forms</span></span>
...
## <a name="windows-presentation-foundation-wpf"></a><span data-ttu-id="50af8-115">Program Windows Presentation Foundation (WPF)</span><span class="sxs-lookup"><span data-stu-id="50af8-115">Windows Presentation Foundation (WPF)</span></span>
...
## <a name="windows-workflow-foundation-wf"></a><span data-ttu-id="50af8-116">Program Windows Workflow Foundation (WF)</span><span class="sxs-lookup"><span data-stu-id="50af8-116">Windows Workflow Foundation (WF)</span></span>
...
## <a name="xml-xslt"></a><span data-ttu-id="50af8-117">Języki XML, XSLT</span><span class="sxs-lookup"><span data-stu-id="50af8-117">XML, XSLT</span></span>
