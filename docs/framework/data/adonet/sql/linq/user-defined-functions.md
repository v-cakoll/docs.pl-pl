...
## <a name="in-this-section"></a>W tej sekcji  
 [Porady: Użyj funkcji skalarnej zdefiniowanej przez użytkownika](../../../../../../docs/framework/data/adonet/sql/linq/how-to-use-scalar-valued-user-defined-functions.md)  
 Zawiera opis sposobu implementacji funkcji, która zwraca wartości skalarnych.  
  
 [Porady: Użyj przechowywanymi w tabeli funkcji zdefiniowanej przez użytkownika](../../../../../../docs/framework/data/adonet/sql/linq/how-to-use-table-valued-user-defined-functions.md)  
 Zawiera opis sposobu implementacji funkcji zwracającej tabelę wartości.  
  
 [Porady: wywołanie wbudowane funkcje zdefiniowane przez użytkownika](../../../../../../docs/framework/data/adonet/sql/linq/how-to-call-user-defined-functions-inline.md)  
