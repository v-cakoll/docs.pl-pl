...
---
# <a name="runtime-changes-for-migration-from-net-framework-40-to-45"></a>Zmiany w czasie wykonywania migracji z .NET Framework 4,0 do 4,5

[!INCLUDE[versionselector](../../../../includes/migration-guide/runtime/versionselector.md)]

W przypadku migrowania z .NET Framework 4,0 do 4,5 zapoznaj się z następującymi tematami dotyczącymi problemów ze zgodnością aplikacji, które mogą mieć wpływ na aplikację:
