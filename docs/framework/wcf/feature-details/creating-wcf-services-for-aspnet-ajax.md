...
-   Dodawanie punktu końcowego interfejsu AJAX do [!INCLUDE[indigo2](../../../../includes/indigo2-md.md)] za pomocą konfiguracji usługi. Aby uzyskać więcej informacji, zobacz [porady: Użyj konfiguracji można dodać punktu końcowego AJAX ASP.NET](../../../../docs/framework/wcf/feature-details/how-to-use-configuration-to-add-an-aspnet-ajax-endpoint.md).  
