...
|     | Opis |
| --- | ----------- |
| [**\<clear>** dla**\<configSections>**](clear-element-for-configsections.md) | Czyści wszystkie wcześniej zdefiniowane sekcje i grupy sekcji. |
...
| [**\<remove>** dla**\<configSections>**](remove-element-for-configsections.md) | Usuwa wstępnie zdefiniowaną sekcję lub grupę sekcji. |
| [**\<section>** dla **\<configSections>** i**\<sectionGroup>**](section-element.md) | Zawiera deklarację sekcji konfiguracyjnej. |
| [**\<sectionGroup>** dla**\<configSections>**](sectiongroup-element-for-configsections.md) | Definiuje przestrzeń nazw dla sekcji konfiguracyjnych. |
