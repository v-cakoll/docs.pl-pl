...
> [!NOTE]
>  Funkcja IntelliSense w [!INCLUDE[vsprvslong](../../../includes/vsprvslong-md.md)] Wyświetla parametry `BeginInvoke` i `EndInvoke`. Jeśli nie używasz programu Visual Studio lub podobnego narzędzia lub jeśli używasz języka C# za pomocą [!INCLUDE[vsprvslong](../../../includes/vsprvslong-md.md)], zobacz [modelu programowania asynchronicznego (APM)](../../../docs/standard/asynchronous-programming-patterns/asynchronous-programming-model-apm.md) opis parametrów określonych dla tych metod.  
