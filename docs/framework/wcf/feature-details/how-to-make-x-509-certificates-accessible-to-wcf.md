...
1. Podaj konto, na którym działa funkcja WCF z dostępem do odczytu do pliku, który zawiera klucz prywatny skojarzony z certyfikatem X. 509.  
    ...
    3. Określ, gdzie klucz prywatny certyfikatu znajduje się na komputerze przy użyciu narzędzia [FindPrivateKey](../samples/findprivatekey.md) .  
         ...
         Poniższy przykład kodu używa narzędzia [FindPrivateKey](../samples/findprivatekey.md) do określenia lokalizacji klucza prywatnego certyfikatu w `My` magazynie przy `CurrentUser` użyciu odcisku palca `46 dd 0e 7a ed 0b 7a 31 9b 02 a3 a0 43 7a d8 3f 60 40 92 9d` .  
