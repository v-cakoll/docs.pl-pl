...
ms.locfileid: "66379350"
---
# <a name="runtime-changes-for-migration-from-net-framework-45-to-471"></a><span data-ttu-id="4c0ea-102">Zmiany środowiska uruchomieniowego do migracji z platformy .NET Framework 4.5 lub 4.7.1</span><span class="sxs-lookup"><span data-stu-id="4c0ea-102">Runtime Changes for Migration from .NET Framework 4.5 to 4.7.1</span></span>

[!INCLUDE[versionselector](../../../../includes/migration-guide/runtime/versionselector.md)]

[!INCLUDE[introduction](../../../../includes/migration-guide/runtime/introduction.md)]

<span data-ttu-id="4c0ea-103">Jeśli do 4.7.1 przeprowadzenia migracji z programu .NET Framework 4.5, należy zapoznać się w poniższych tematach problemy ze zgodnością aplikacji, które mogą wpływać na Twoją aplikację:</span><span class="sxs-lookup"><span data-stu-id="4c0ea-103">If you are migrating from the .NET Framework 4.5 to 4.7.1, review the following topics for application compatibility issues that may affect your app:</span></span>

## <a name="adonet"></a><span data-ttu-id="4c0ea-104">ADO.NET</span><span class="sxs-lookup"><span data-stu-id="4c0ea-104">ADO.NET</span></span>
...
## <a name="aspnet"></a><span data-ttu-id="4c0ea-105">ASP.NET</span><span class="sxs-lookup"><span data-stu-id="4c0ea-105">ASP.NET</span></span>
...
## <a name="core"></a><span data-ttu-id="4c0ea-106">Core</span><span class="sxs-lookup"><span data-stu-id="4c0ea-106">Core</span></span>
...
## <a name="data"></a><span data-ttu-id="4c0ea-107">Dane</span><span class="sxs-lookup"><span data-stu-id="4c0ea-107">Data</span></span>
...
## <a name="debugger"></a><span data-ttu-id="4c0ea-108">Debuger</span><span class="sxs-lookup"><span data-stu-id="4c0ea-108">Debugger</span></span>
...
## <a name="entity-framework"></a><span data-ttu-id="4c0ea-109">Entity Framework</span><span class="sxs-lookup"><span data-stu-id="4c0ea-109">Entity Framework</span></span>
...
## <a name="globalization"></a><span data-ttu-id="4c0ea-110">Globalizacja</span><span class="sxs-lookup"><span data-stu-id="4c0ea-110">Globalization</span></span>
...
## <a name="networking"></a><span data-ttu-id="4c0ea-111">Obsługa sieci</span><span class="sxs-lookup"><span data-stu-id="4c0ea-111">Networking</span></span>
...
## <a name="security"></a><span data-ttu-id="4c0ea-112">Zabezpieczenia</span><span class="sxs-lookup"><span data-stu-id="4c0ea-112">Security</span></span>
...
## <a name="serialization"></a><span data-ttu-id="4c0ea-113">Serializacja</span><span class="sxs-lookup"><span data-stu-id="4c0ea-113">Serialization</span></span>
...
## <a name="setup-and-deployment"></a><span data-ttu-id="4c0ea-114">Instalacja i wdrożenie</span><span class="sxs-lookup"><span data-stu-id="4c0ea-114">Setup and Deployment</span></span>
...
## <a name="tools"></a><span data-ttu-id="4c0ea-115">Narzędzia</span><span class="sxs-lookup"><span data-stu-id="4c0ea-115">Tools</span></span>

[!INCLUDE[Contract.Invariant or Contract.Requires\<TException> do not consider String.IsNullOrEmpty to be pure](~/includes/migration-guide/runtime/tools/contractinvariant-contractrequirestexception-do-not-consider.md)]

## <a name="windows-communication-foundation-wcf"></a><span data-ttu-id="4c0ea-116">Windows Communication Foundation (WCF)</span><span class="sxs-lookup"><span data-stu-id="4c0ea-116">Windows Communication Foundation (WCF)</span></span>
...
## <a name="windows-presentation-foundation-wpf"></a><span data-ttu-id="4c0ea-117">Windows Presentation Foundation (WPF)</span><span class="sxs-lookup"><span data-stu-id="4c0ea-117">Windows Presentation Foundation (WPF)</span></span>
...
## <a name="windows-workflow-foundation-wf"></a><span data-ttu-id="4c0ea-118">Program Windows Workflow Foundation (WF)</span><span class="sxs-lookup"><span data-stu-id="4c0ea-118">Windows Workflow Foundation (WF)</span></span>
