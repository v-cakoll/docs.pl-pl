...
-   Konwencje nazewnictwa dla obiektów, zmienne i procedur.  
 ...
 Poniższe tematy zawierają zestaw wytycznych programowania dla programów Visual Basic, wraz z przykładem użycia dobra.  
...
## <a name="in-this-section"></a>W tej sekcji  
 ...
 Zawiera omówienie elementy wchodzące w skład programu Visual Basic.  
 ...
 Przedstawia sposób zwijanie i ukrywanie fragmentów kodu w języku Visual Basic edytora kodu.  
 ...
 W tym artykule opisano sposób użycia nawiasów (`[]`) do rozdzielenia nazwy zmiennych, które są również słowa kluczowe Visual Basic.  
  
 [Me, My, MyBase i MyClass](../../../visual-basic/programming-guide/program-structure/me-my-mybase-and-myclass.md)  
 W tym artykule opisano różne sposoby odwołań do elementów programu Visual Basic.  
  
 [Ograniczenia Visual Basic](../../../visual-basic/programming-guide/program-structure/limitations.md)  
 W tym artykule omówiono usunięcia znanych ograniczeń programowania w języku Visual Basic.  
  
## <a name="related-sections"></a>Sekcje pokrewne  
 [Konwencje związane z typografią i kodami](../../../visual-basic/language-reference/typographic-and-code-conventions.md)  
 Udostępnia standardowej konwencji kodowania w języku Visual Basic.  
