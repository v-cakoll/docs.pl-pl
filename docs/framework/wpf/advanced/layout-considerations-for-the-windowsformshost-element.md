...
## <a name="see-also"></a>Zobacz też  
 ...
 [Wskazówki: Rozmieszczanie formantów formularzy systemu Windows na platformie WPF](../../../../docs/framework/wpf/advanced/walkthrough-arranging-windows-forms-controls-in-wpf.md)  
