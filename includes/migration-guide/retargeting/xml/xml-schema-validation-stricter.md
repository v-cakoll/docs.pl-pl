...
|Sugestia|W razie potrzeby im weryfikacji programu .NET Framework 4.0 sprawdzania poprawności aplikacji można kierować programu .NET Framework w wersji 4.0. W przypadku przekierowania do .NET 4.5, jednak przeglądu kodu ma się odbywać należy upewnić się, że nieprawidłowe identyfikatory URI (ze spacjami) nie powinny jako wartości atrybutu z typem danych anyURI.|
|Zakres|Pomocnicza|
|Wersja|4.5|
|Typ|Przekierowania|
