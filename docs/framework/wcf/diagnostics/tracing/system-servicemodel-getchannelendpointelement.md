...
## <a name="description"></a>Opis  
 Ślad jest emitowany podczas konstruowania fabryki kanałów, na poziomie informacji. Zawiera on opis punktu końcowego, który rozmawia klient (na przykład adres zdalny, powiązanie, Nazwa kontraktu).  
