...
|**b**[**reak**] [*ClassName.Method* &#124; *FileName:LineNo*]|Ustawia punkt przerwania w określonej metodzie. Moduły są skanowane sekwencyjnie.<br /><br /> -   **podział** *Nrwiersza* ustawia punkt przerwania w określonej lokalizacji w źródle.<br />-   **podział** *~ numer* ustawia punkt przerwania przy symbolu, który został ostatnio wyświetlony za pomocą **x** polecenia.<br />-   **podział** *modułu! ClassName.Method+IlOffset* ustawia punkt przerwania w pełni kwalifikowanej lokalizacji.|  
...
|**Lo**[**ad**] *assemblyName*|Ładuje rozszerzenie w następujący sposób: Określony zestaw jest ładowany, a następnie podejmowana jest próba uruchomienia statycznej metody `LoadExtension` z `Microsoft.Tools.Mdbg.Extension.Extension` typu.|  
...
|**newo**[**bj**] *typeName* [*arguments...*]|Tworzy nowy obiekt typu *typeName*.|  
...
|**p**[**rint**] [*var*] &#124; [`-d`]|Drukuje wszystkie zmienne w zakresie (**drukowanie**), drukuje określoną zmienną (**drukowanie** *var*), lub drukuje zmienne debugera (**drukowanie** `-d`).|  
