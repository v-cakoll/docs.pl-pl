...
## <a name="description"></a>Opis  
 To zdarzenie oznacza, że wpis dziennika odzyskiwania uczestnika był uszkodzony i nie można rozszeregować. Z tego błędu może spowodować utratę danych. Listy zdarzeń identyfikator transakcji, dane odzyskiwania (kodowanie Base64), wyjątek, nazwa procesu i procesu identyfikatora.  
