...
Można również utworzyć nowej metody dla wyliczenia przy użyciu metody rozszerzenia. Aby uzyskać więcej informacji, zobacz [porady: utworzenie nowej metody wyliczania](../../csharp/programming-guide/classes-and-structs/how-to-create-a-new-method-for-an-enumeration.md).
