...
## <a name="description"></a>Opis  
 Liczba wywołań z nieobsługiwanych wyjątków w tym punkcie końcowym. Ten licznik jest zwiększona za każdym, gdy ma nieobsługiwany wyjątek w tym punkcie końcowym.  
