...
Usługa protokołu WS-Atomic Transaction pomyślnie zarejestrowane z koordynatorem dla protokołu sterowania.  
  
## <a name="description"></a>Opis  
 Śledzone, gdy lokalny Menedżer transakcji został pomyślnie zarejestrowany za pomocą jego TransactionManage wyższego poziomu  
