...
## <a name="description"></a>Opis  
 Wskazuje, że element roboczy CancelActivityWorkItem została ukończona.  
  
## <a name="message"></a>Komunikat  
 Ukończono element roboczy CancelActivityWorkItem dla działania %1, nazwa wyświetlana: %2, identyfikator wystąpienia: '%3'.  
