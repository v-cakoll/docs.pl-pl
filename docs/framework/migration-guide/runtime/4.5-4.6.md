...
ms.locfileid: "59180716"
---
# <a name="runtime-changes-for-migration-from-net-framework-45-to-46"></a><span data-ttu-id="161de-102">Zmiany środowiska uruchomieniowego w przypadku migracji z .NET Framework 4.5 i 4.6</span><span class="sxs-lookup"><span data-stu-id="161de-102">Runtime Changes for Migration from .NET Framework 4.5 to 4.6</span></span>

[!INCLUDE[versionselector](../../../../includes/migration-guide/runtime/versionselector.md)]

[!INCLUDE[introduction](../../../../includes/migration-guide/runtime/introduction.md)]

<span data-ttu-id="161de-103">Jeśli są migrowane z programu .NET Framework 4.5, 4.6, przejrzyj problemy ze zgodnością aplikacji, które mogą wpływać na Twoją aplikację w poniższych tematach:</span><span class="sxs-lookup"><span data-stu-id="161de-103">If you are migrating from the .NET Framework 4.5 to 4.6, review the following topics for application compatibility issues that may affect your app:</span></span>

## <a name="adonet"></a><span data-ttu-id="161de-104">ADO.NET</span><span class="sxs-lookup"><span data-stu-id="161de-104">ADO.NET</span></span>
...
## <a name="aspnet"></a><span data-ttu-id="161de-105">ASP.NET</span><span class="sxs-lookup"><span data-stu-id="161de-105">ASP.NET</span></span>
...
## <a name="core"></a><span data-ttu-id="161de-106">Core</span><span class="sxs-lookup"><span data-stu-id="161de-106">Core</span></span>
...
## <a name="data"></a><span data-ttu-id="161de-107">Dane</span><span class="sxs-lookup"><span data-stu-id="161de-107">Data</span></span>
...
## <a name="debugger"></a><span data-ttu-id="161de-108">Debuger</span><span class="sxs-lookup"><span data-stu-id="161de-108">Debugger</span></span>
...
## <a name="entity-framework"></a><span data-ttu-id="161de-109">Entity Framework</span><span class="sxs-lookup"><span data-stu-id="161de-109">Entity Framework</span></span>
...
## <a name="networking"></a><span data-ttu-id="161de-110">Obsługa sieci</span><span class="sxs-lookup"><span data-stu-id="161de-110">Networking</span></span>
...
## <a name="serialization"></a><span data-ttu-id="161de-111">Serializacja</span><span class="sxs-lookup"><span data-stu-id="161de-111">Serialization</span></span>
...
## <a name="setup-and-deployment"></a><span data-ttu-id="161de-112">Instalacja i wdrożenie</span><span class="sxs-lookup"><span data-stu-id="161de-112">Setup and Deployment</span></span>
...
## <a name="windows-communication-foundation-wcf"></a><span data-ttu-id="161de-113">Windows Communication Foundation (WCF)</span><span class="sxs-lookup"><span data-stu-id="161de-113">Windows Communication Foundation (WCF)</span></span>
...
## <a name="windows-presentation-foundation-wpf"></a><span data-ttu-id="161de-114">Windows Presentation Foundation (WPF)</span><span class="sxs-lookup"><span data-stu-id="161de-114">Windows Presentation Foundation (WPF)</span></span>
