...
---
# <a name="runtime-changes-for-migration-from-net-framework-451-to-462"></a><span data-ttu-id="3c8b5-102">Zmiany środowiska uruchomieniowego do migracji z systemu .NET Framework 4.5.1 lub 4.6.2</span><span class="sxs-lookup"><span data-stu-id="3c8b5-102">Runtime Changes for Migration from .NET Framework 4.5.1 to 4.6.2</span></span>

[!INCLUDE[versionselector](../../../../includes/migration-guide/runtime/versionselector.md)]

[!INCLUDE[introduction](../../../../includes/migration-guide/runtime/introduction.md)]

<span data-ttu-id="3c8b5-103">W przypadku migracji z programu .NET Framework 4.5.1 lub 4.6.2, należy przejrzeć następujące tematy dla problemów ze zgodnością aplikacji, które mogą wpływać na aplikację:</span><span class="sxs-lookup"><span data-stu-id="3c8b5-103">If you are migrating from the .NET Framework 4.5.1 to 4.6.2, review the following topics for application compatibility issues that may affect your app:</span></span>

## <a name="aspnet"></a><span data-ttu-id="3c8b5-104">ASP.NET</span><span class="sxs-lookup"><span data-stu-id="3c8b5-104">ASP.NET</span></span>
...
## <a name="core"></a><span data-ttu-id="3c8b5-105">Core</span><span class="sxs-lookup"><span data-stu-id="3c8b5-105">Core</span></span>
...
## <a name="data"></a><span data-ttu-id="3c8b5-106">Dane</span><span class="sxs-lookup"><span data-stu-id="3c8b5-106">Data</span></span>
...
## <a name="debugger"></a><span data-ttu-id="3c8b5-107">Debugger</span><span class="sxs-lookup"><span data-stu-id="3c8b5-107">Debugger</span></span>
...
## <a name="entity-framework"></a><span data-ttu-id="3c8b5-108">Entity Framework</span><span class="sxs-lookup"><span data-stu-id="3c8b5-108">Entity Framework</span></span>
...
## <a name="globalization"></a><span data-ttu-id="3c8b5-109">Globalizacja</span><span class="sxs-lookup"><span data-stu-id="3c8b5-109">Globalization</span></span>
...
## <a name="networking"></a><span data-ttu-id="3c8b5-110">Obsługa sieci</span><span class="sxs-lookup"><span data-stu-id="3c8b5-110">Networking</span></span>
...
## <a name="security"></a><span data-ttu-id="3c8b5-111">Zabezpieczenia</span><span class="sxs-lookup"><span data-stu-id="3c8b5-111">Security</span></span>
...
## <a name="serialization"></a><span data-ttu-id="3c8b5-112">Serializacja</span><span class="sxs-lookup"><span data-stu-id="3c8b5-112">Serialization</span></span>
...
## <a name="setup-and-deployment"></a><span data-ttu-id="3c8b5-113">Instalacji i wdrażania</span><span class="sxs-lookup"><span data-stu-id="3c8b5-113">Setup and Deployment</span></span>
...
## <a name="tools"></a><span data-ttu-id="3c8b5-114">Narzędzia</span><span class="sxs-lookup"><span data-stu-id="3c8b5-114">Tools</span></span>

[!INCLUDE[Contract.Invariant or Contract.Requires<TException> do not consider String.IsNullOrEmpty to be pure](~/includes/migration-guide/runtime/tools/contractinvariant-contractrequirestexception-do-not-consider.md)]

## <a name="windows-communication-foundation-wcf"></a><span data-ttu-id="3c8b5-115">Windows Communication Foundation (WCF)</span><span class="sxs-lookup"><span data-stu-id="3c8b5-115">Windows Communication Foundation (WCF)</span></span>
...
## <a name="windows-presentation-foundation-wpf"></a><span data-ttu-id="3c8b5-116">Windows Presentation Foundation (WPF)</span><span class="sxs-lookup"><span data-stu-id="3c8b5-116">Windows Presentation Foundation (WPF)</span></span>
