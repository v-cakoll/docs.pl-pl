...
## <a name="in-this-section"></a>W tej sekcji  
 ...
 Pokazuje, jak włączyć automatyczne wybieranie formatu (XML lub JSON) z [!INCLUDE[indigo2](../../../../includes/indigo2-md.md)] programowania modelu, a także sposobu jawnie ustawić format w kodzie operacji HTTP sieci Web.  
  
 [Podstawowa usługa HTTP](../../../../docs/framework/wcf/samples/basic-http-service.md)  
 Pokazuje, jak wdrożyć usługi oparte na protokole HTTP, opartego na protokole RPC - popularly określonych jako "POX" (zwykły starego XML) usługi — przy użyciu [!INCLUDE[indigo2](../../../../includes/indigo2-md.md)] model programowania protokołu HTTP sieci Web.  
  
 [Podstawowa usługa obsługi zasobów](../../../../docs/framework/wcf/samples/basic-resource-service.md)  
 Pokazuje, jak wdrożenie oparte na protokole HTTP usługi za pomocą [!INCLUDE[indigo2](../../../../includes/indigo2-md.md)] model programowania protokołu HTTP sieci Web, który udostępnia kolekcję klientów obsługuje pobieranie, dodawanie, usuwanie i zamienianie operacji.  
  
 [AspNetRouteIntegration](../../../../docs/framework/wcf/samples/aspnetrouteintegration.md)  
 Pokazuje, jak udostępniać [!INCLUDE[indigo2](../../../../includes/indigo2-md.md)] kieruje usługi sieci Web HTTP przy użyciu platformy ASP.NET.  
