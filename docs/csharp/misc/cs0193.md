 ...
 **\*** Lub **->** operator został użyty z typem nonpointer. Aby uzyskać więcej informacji, zobacz [typów wskaźnikowych](../../csharp/programming-guide/unsafe-code-pointers/pointer-types.md).  
