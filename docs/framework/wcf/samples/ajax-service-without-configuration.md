...
> Procedura instalacji i instrukcje dotyczące kompilacji dla tego przykładu znajdują się na końcu tego tematu.
 ...
 Ten przykład kompiluje się w usłudze AJAX przy użyciu protokołu HTTP POST. Zgodnie z opisem w [podstawowej próbce usługi AJAX](../../../../docs/framework/wcf/samples/basic-ajax-service.md) <xref:System.ServiceModel.Activation.WebScriptServiceHostFactory> jest używany do hostowania usługi.
