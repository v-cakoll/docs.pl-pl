...
## <a name="related-sections"></a>Sekcje pokrewne  
 ...
 W tym artykule omówiono różnice w aplikacjach MFC i formularze systemu Windows.  
  
 [Uzyskiwanie dostępu do danych w programie Visual Studio](/visualstudio/data-tools/accessing-data-in-visual-studio)  
 W tym artykule omówiono zawierające funkcje dostępu do danych w aplikacji.  
  
 [Aplikacje Windows Forms](/visualstudio/debugger/debugging-preparation-windows-forms-applications)  
 W tym artykule omówiono proces debugowanie aplikacji utworzonych za pomocą szablonu projektu aplikacji systemu Windows, a także sposobu zmiany konfiguracje Debug i Release.  
  
 [Wdrażanie aplikacji, usług i składników](https://msdn.microsoft.com/library/wtzawcsz)  
 W tym artykule opisano proces, za pomocą którego można dystrybuować Zakończono aplikację lub składnik można zainstalować na innych komputerach.  
  
 [Tworzenie aplikacji konsoli](../../../docs/standard/building-console-apps.md)  
 W tym artykule opisano tworzenie aplikacji konsoli przy użyciu <xref:System.Console> klasy.
