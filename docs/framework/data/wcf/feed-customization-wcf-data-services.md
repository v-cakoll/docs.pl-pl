...
## <a name="customizing-feeds-with-the-entity-framework-provider"></a>Dostosowywanie kanałów informacyjnych za pomocą dostawcy Entity Framework  
 ...
 Aby uzyskać więcej informacji, zobacz [jak: Dostosuj źródła danych za pomocą dostawcy](how-to-customize-feeds-with-ef-provider-wcf-data-services.md)Entity Framework.  
...
> [!NOTE]
> Model danych dla tego przykładu został zdefiniowany w temacie [How to: Utwórz usługę danych przy użyciu dostawcy](create-a-data-service-using-rp-wcf-data-services.md)odbicia.  
 ...
 Aby uzyskać więcej informacji, zobacz [jak: Dostosuj źródła danych za pomocą dostawcy](how-to-customize-feeds-with-the-reflection-provider-wcf-data-services.md)odbicia.  
