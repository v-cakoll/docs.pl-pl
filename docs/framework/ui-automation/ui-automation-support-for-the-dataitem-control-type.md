...
|<xref:System.Windows.Automation.Provider.ISelectionItemProvider>|Tak|All data items must support the Selection Item pattern to indicate when the item is selected.|  
