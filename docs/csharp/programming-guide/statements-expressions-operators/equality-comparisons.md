...
|[Jak zdefiniować równość wartości dla typu](./how-to-define-value-equality-for-a-type.md)|Opisuje, jak zapewnić niestandardową definicję równości wartości dla typu.|  
