...
|Atrybut|Opis|
|---------------|-----------------|
|`faultSourceActivityName`|Ciąg określający nazwę działanie procedury obsługi błędów, błędów. Wartość domyślna to \*, co oznacza, że dla wszystkich działań zwracane są rekordy propagacji błędów.|
