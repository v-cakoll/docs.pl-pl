...
|Atrybut|Opis|  
|---------------|-----------------|  
|Akcja|Ciąg, który określa akcję, która ma zostać podjęta po wystąpieniu nieobsługiwanego wyjątku. Ten atrybut jest typu <xref:System.ServiceModel.Activities.Description.WorkflowUnhandledExceptionAction>|  
