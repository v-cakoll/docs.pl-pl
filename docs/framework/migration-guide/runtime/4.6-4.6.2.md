...
---
# <a name="runtime-changes-for-migration-from-net-framework-46-to-462"></a><span data-ttu-id="93af6-102">Zmiany środowiska uruchomieniowego dla migracji z programu .NET Framework 4.6 do 4.6.2</span><span class="sxs-lookup"><span data-stu-id="93af6-102">Runtime Changes for Migration from .NET Framework 4.6 to 4.6.2</span></span>

[!INCLUDE[versionselector](../../../../includes/migration-guide/runtime/versionselector.md)]

<span data-ttu-id="93af6-103">W przypadku migracji z programu .NET Framework 4.6 do 4.6.2 zapoznaj się z następującymi tematami dotyczącymi problemów ze zgodnością aplikacji, które mogą mieć wpływ na aplikację:</span><span class="sxs-lookup"><span data-stu-id="93af6-103">If you are migrating from the .NET Framework 4.6 to 4.6.2, review the following topics for application compatibility issues that may affect your app:</span></span>

## <a name="data"></a><span data-ttu-id="93af6-104">Dane</span><span class="sxs-lookup"><span data-stu-id="93af6-104">Data</span></span>
...
## <a name="globalization"></a><span data-ttu-id="93af6-105">Globalizacja</span><span class="sxs-lookup"><span data-stu-id="93af6-105">Globalization</span></span>
...
## <a name="security"></a><span data-ttu-id="93af6-106">Zabezpieczenia</span><span class="sxs-lookup"><span data-stu-id="93af6-106">Security</span></span>
...
## <a name="tools"></a><span data-ttu-id="93af6-107">narzędzia</span><span class="sxs-lookup"><span data-stu-id="93af6-107">Tools</span></span>

[!INCLUDE[Contract.Invariant or Contract.Requires\<TException> do not consider String.IsNullOrEmpty to be pure](~/includes/migration-guide/runtime/tools/contractinvariant-contractrequirestexception-do-not-consider.md)]

## <a name="windows-communication-foundation-wcf"></a><span data-ttu-id="93af6-108">Windows Communication Foundation (WCF)</span><span class="sxs-lookup"><span data-stu-id="93af6-108">Windows Communication Foundation (WCF)</span></span>
...
## <a name="windows-presentation-foundation-wpf"></a><span data-ttu-id="93af6-109">Windows Presentation Foundation (WPF)</span><span class="sxs-lookup"><span data-stu-id="93af6-109">Windows Presentation Foundation (WPF)</span></span>
