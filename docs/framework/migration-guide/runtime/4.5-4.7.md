...
ms.locfileid: "86443588"
---
# <a name="runtime-changes-for-migration-from-net-framework-45-to-47"></a><span data-ttu-id="b5a4f-103">Zmiany w czasie wykonywania migracji z .NET Framework 4,5 do 4,7</span><span class="sxs-lookup"><span data-stu-id="b5a4f-103">Runtime Changes for Migration from .NET Framework 4.5 to 4.7</span></span>

[!INCLUDE[versionselector](../../../../includes/migration-guide/runtime/versionselector.md)]

<span data-ttu-id="b5a4f-104">W przypadku migrowania z .NET Framework 4,5 do 4,7 zapoznaj się z następującymi tematami dotyczącymi problemów ze zgodnością aplikacji, które mogą mieć wpływ na aplikację:</span><span class="sxs-lookup"><span data-stu-id="b5a4f-104">If you are migrating from the .NET Framework 4.5 to 4.7, review the following topics for application compatibility issues that may affect your app:</span></span>

## <a name="adonet"></a><span data-ttu-id="b5a4f-105">ADO.NET</span><span class="sxs-lookup"><span data-stu-id="b5a4f-105">ADO.NET</span></span>
...
## <a name="aspnet"></a><span data-ttu-id="b5a4f-106">ASP.NET</span><span class="sxs-lookup"><span data-stu-id="b5a4f-106">ASP.NET</span></span>
...
## <a name="core"></a><span data-ttu-id="b5a4f-107">Core</span><span class="sxs-lookup"><span data-stu-id="b5a4f-107">Core</span></span>
...
## <a name="data"></a><span data-ttu-id="b5a4f-108">Dane</span><span class="sxs-lookup"><span data-stu-id="b5a4f-108">Data</span></span>
...
## <a name="debugger"></a><span data-ttu-id="b5a4f-109">Debuger</span><span class="sxs-lookup"><span data-stu-id="b5a4f-109">Debugger</span></span>
...
## <a name="entity-framework"></a><span data-ttu-id="b5a4f-110">Entity Framework</span><span class="sxs-lookup"><span data-stu-id="b5a4f-110">Entity Framework</span></span>
...
## <a name="globalization"></a><span data-ttu-id="b5a4f-111">Globalizacja</span><span class="sxs-lookup"><span data-stu-id="b5a4f-111">Globalization</span></span>
...
## <a name="jit"></a><span data-ttu-id="b5a4f-112">JIT</span><span class="sxs-lookup"><span data-stu-id="b5a4f-112">JIT</span></span>
...
## <a name="networking"></a><span data-ttu-id="b5a4f-113">Sieć</span><span class="sxs-lookup"><span data-stu-id="b5a4f-113">Networking</span></span>
...
## <a name="security"></a><span data-ttu-id="b5a4f-114">Zabezpieczenia</span><span class="sxs-lookup"><span data-stu-id="b5a4f-114">Security</span></span>
...
## <a name="serialization"></a><span data-ttu-id="b5a4f-115">Serializacja</span><span class="sxs-lookup"><span data-stu-id="b5a4f-115">Serialization</span></span>
...
## <a name="setup-and-deployment"></a><span data-ttu-id="b5a4f-116">Instalacja i wdrożenie</span><span class="sxs-lookup"><span data-stu-id="b5a4f-116">Setup and Deployment</span></span>
...
## <a name="tools"></a><span data-ttu-id="b5a4f-117">Narzędzia</span><span class="sxs-lookup"><span data-stu-id="b5a4f-117">Tools</span></span>

[!INCLUDE[Contract.Invariant or Contract.Requires\<TException> do not consider String.IsNullOrEmpty to be pure](~/includes/migration-guide/runtime/tools/contractinvariant-contractrequirestexception-do-not-consider.md)]

## <a name="windows-communication-foundation-wcf"></a><span data-ttu-id="b5a4f-118">Windows Communication Foundation (WCF)</span><span class="sxs-lookup"><span data-stu-id="b5a4f-118">Windows Communication Foundation (WCF)</span></span>
...
## <a name="windows-presentation-foundation-wpf"></a><span data-ttu-id="b5a4f-119">Windows Presentation Foundation (WPF)</span><span class="sxs-lookup"><span data-stu-id="b5a4f-119">Windows Presentation Foundation (WPF)</span></span>
...
## <a name="windows-workflow-foundation-wf"></a><span data-ttu-id="b5a4f-120">Program Windows Workflow Foundation (WF)</span><span class="sxs-lookup"><span data-stu-id="b5a4f-120">Windows Workflow Foundation (WF)</span></span>
