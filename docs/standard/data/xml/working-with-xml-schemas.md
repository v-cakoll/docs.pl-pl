...
## <a name="in-this-section"></a>W tej sekcji  
 ...
 W tym artykule omówiono model obiektów schematu (SOM) w przestrzeni nazw <xref:System.Xml.Schema?displayProperty=nameWithType>, który udostępnia zestaw klas, które umożliwiają odczytywanie schematu języka definicji schematu (XSD) z pliku lub programowo Tworzenie schematu w pamięci.  
  
 [Klasa XmlSchemaSet na potrzeby kompilacji schematu](../../../../docs/standard/data/xml/xmlschemaset-for-schema-compilation.md)  
 W tym artykule omówiono klasę <xref:System.Xml.Schema.XmlSchemaSet>, która jest pamięcią podręczną, w której można przechowywać i sprawdzać schematy XSD.  
 ...
 Omawia <xref:System.Xml.Schema.XmlSchemaValidator> klasy, która zapewnia wydajny mechanizm o wysokiej wydajności służący do sprawdzania poprawności danych XML względem schematów XSD w sposób oparty na wypychaniu.  
  
 [Wnioskowanie schematu XML](../../../../docs/standard/data/xml/inferring-an-xml-schema.md)  
 W tym artykule omówiono sposób użycia klasy <xref:System.Xml.Schema.XmlSchemaInference> do wywnioskowania schematu XSD ze struktury dokumentu XML.  
...
## <a name="related-sections"></a>Sekcje pokrewne  
 ...
 W tym artykule omówiono sposób weryfikowania i edytowania kodu XML przy użyciu klasy <xref:System.Xml.XPath.XPathNavigator>.
