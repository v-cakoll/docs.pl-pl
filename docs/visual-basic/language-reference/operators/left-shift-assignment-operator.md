...
## <a name="parts"></a>Części  
 `variableorproperty`  
 Wymagany. Variable or property of an integral type (`SByte`, `Byte`, `Short`, `UShort`, `Integer`, `UInteger`, `Long`, or `ULong`).  
  
 `amount`  
 Wymagany. Numeric expression of a data type that widens to `Integer`.  
