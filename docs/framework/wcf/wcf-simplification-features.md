...
## <a name="contract-first-development"></a>Programowanie Contract-First  
 Usługi WCF dodano wsparcie dla programowania z wymogiem wcześniejszego zawarcia kontraktu. Narzędzie svcutl.exe ma przełącznik /serviceContract, który umożliwia generowanie kontraktów usług i danych z dokumentu WSDL.  
