...
ms.locfileid: "73086309"
---
# <a name="runtime-changes-for-migration-from-net-framework-461-to-471"></a><span data-ttu-id="9ba59-102">Zmiany w czasie wykonywania migracji z .NET Framework 4.6.1 do 4.7.1</span><span class="sxs-lookup"><span data-stu-id="9ba59-102">Runtime Changes for Migration from .NET Framework 4.6.1 to 4.7.1</span></span>

[!INCLUDE[versionselector](../../../../includes/migration-guide/runtime/versionselector.md)]

[!INCLUDE[introduction](../../../../includes/migration-guide/runtime/introduction.md)]

<span data-ttu-id="9ba59-103">Jeśli przeprowadzasz migrację z .NET Framework 4.6.1 do 4.7.1, zapoznaj się z następującymi tematami dotyczącymi problemów ze zgodnością aplikacji, które mogą mieć wpływ na aplikację:</span><span class="sxs-lookup"><span data-stu-id="9ba59-103">If you are migrating from the .NET Framework 4.6.1 to 4.7.1, review the following topics for application compatibility issues that may affect your app:</span></span>

## <a name="data"></a><span data-ttu-id="9ba59-104">Dane</span><span class="sxs-lookup"><span data-stu-id="9ba59-104">Data</span></span>
...
## <a name="globalization"></a><span data-ttu-id="9ba59-105">Globalizacja</span><span class="sxs-lookup"><span data-stu-id="9ba59-105">Globalization</span></span>
...
## <a name="security"></a><span data-ttu-id="9ba59-106">Zabezpieczenia</span><span class="sxs-lookup"><span data-stu-id="9ba59-106">Security</span></span>
...
## <a name="windows-communication-foundation-wcf"></a><span data-ttu-id="9ba59-107">Windows Communication Foundation (WCF)</span><span class="sxs-lookup"><span data-stu-id="9ba59-107">Windows Communication Foundation (WCF)</span></span>
...
## <a name="windows-presentation-foundation-wpf"></a><span data-ttu-id="9ba59-108">Windows Presentation Foundation (WPF)</span><span class="sxs-lookup"><span data-stu-id="9ba59-108">Windows Presentation Foundation (WPF)</span></span>
...
## <a name="windows-workflow-foundation-wf"></a><span data-ttu-id="9ba59-109">Program Windows Workflow Foundation (WF)</span><span class="sxs-lookup"><span data-stu-id="9ba59-109">Windows Workflow Foundation (WF)</span></span>
