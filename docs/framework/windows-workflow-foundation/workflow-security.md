...
-   ServiceSecurityContext komunikatu przychodzącego jest również dostępne z poziomu przepływów pracy, uzyskując dostęp do elementu OperationContext.  Zobacz [uzyskiwania dostępu do elementu OperationContext w usłudze przepływu pracy](../../../docs/framework/wcf/feature-details/accessing-operationcontext-from-a-workflow-service.md) Aby uzyskać szczegółowe informacje.  
...
Aby uzyskać więcej informacji i Pobierz CTP pakietu programu WF zabezpieczeń, zobacz: [CTP pakietu zabezpieczeń WF](http://wf.codeplex.com/releases/view/48114)