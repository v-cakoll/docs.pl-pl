...
## <a name="description"></a>Opis  
 Rejestrowanie komunikatów zostało włączone. Mogą być rejestrowane informacje poufne, nawet jeśli były zaszyfrowane w sieci. Na przykład wiadomości treści. Zdarzenia wyświetlane AppID, wyjątek, nazwa procesu i identyfikatora procesu.  
