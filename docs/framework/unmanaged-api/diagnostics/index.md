...
API magazynu symboli diagnostycznych umożliwia kompilatorowi generowanie informacji o symbolach do użycia przez debuger.  
  
## <a name="in-this-section"></a>W tej sekcji  
 [Interfejsy magazynu symboli diagnostycznych](../../../../docs/framework/unmanaged-api/diagnostics/diagnostics-symbol-store-interfaces.md)  
 W tym artykule opisano niezarządzane interfejsy, które używa magazynu symboli diagnostycznych interfejsu API.  
 ...
 W tym artykule opisano niezarządzane wyliczenia, które używa magazynu symboli diagnostycznych interfejsu API.  
 ...
 W tym artykule opisano niezarządzane struktury, których używa magazynu symboli diagnostycznych interfejsu API.
