...
---
# <a name="how-to-find-descendants-with-a-specific-element-name-visual-basic"></a>Instrukcje: Znajdź elementy podrzędne z określoną nazwą elementu (Visual Basic)
