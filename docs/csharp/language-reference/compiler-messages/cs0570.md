...
Właściwość, indeksator lub zdarzenie "name" nie jest obsługiwane przez język; Spróbuj bezpośrednio wywołać metodę dostępu "name!"  
 ...
 Ten błąd występuje, przy użyciu importowanych metadanych, wygenerowanych przez inny kompilator. Podjęto próbę użycia elementu członkowskiego klasy, której kodu nie udało się przetworzyć.  
  
## <a name="example"></a>Przykład  
 Następujący program C++ używa atrybutu, RequiredAttributeAttribute, którego nie można używać w innych językach.  
