...
ms.locfileid: "73086280"
---
# <a name="runtime-changes-for-migration-from-net-framework-461-to-462"></a><span data-ttu-id="eb4ea-102">Zmiany w czasie wykonywania migracji z .NET Framework 4.6.1 do 4.6.2</span><span class="sxs-lookup"><span data-stu-id="eb4ea-102">Runtime Changes for Migration from .NET Framework 4.6.1 to 4.6.2</span></span>

[!INCLUDE[versionselector](../../../../includes/migration-guide/runtime/versionselector.md)]

[!INCLUDE[introduction](../../../../includes/migration-guide/runtime/introduction.md)]

<span data-ttu-id="eb4ea-103">Jeśli przeprowadzasz migrację z .NET Framework 4.6.1 do 4.6.2, zapoznaj się z następującymi tematami dotyczącymi problemów ze zgodnością aplikacji, które mogą mieć wpływ na aplikację:</span><span class="sxs-lookup"><span data-stu-id="eb4ea-103">If you are migrating from the .NET Framework 4.6.1 to 4.6.2, review the following topics for application compatibility issues that may affect your app:</span></span>

## <a name="data"></a><span data-ttu-id="eb4ea-104">Dane</span><span class="sxs-lookup"><span data-stu-id="eb4ea-104">Data</span></span>
...
## <a name="globalization"></a><span data-ttu-id="eb4ea-105">Globalizacja</span><span class="sxs-lookup"><span data-stu-id="eb4ea-105">Globalization</span></span>
...
## <a name="security"></a><span data-ttu-id="eb4ea-106">Zabezpieczenia</span><span class="sxs-lookup"><span data-stu-id="eb4ea-106">Security</span></span>
...
## <a name="windows-communication-foundation-wcf"></a><span data-ttu-id="eb4ea-107">Windows Communication Foundation (WCF)</span><span class="sxs-lookup"><span data-stu-id="eb4ea-107">Windows Communication Foundation (WCF)</span></span>
...
## <a name="windows-presentation-foundation-wpf"></a><span data-ttu-id="eb4ea-108">Windows Presentation Foundation (WPF)</span><span class="sxs-lookup"><span data-stu-id="eb4ea-108">Windows Presentation Foundation (WPF)</span></span>
