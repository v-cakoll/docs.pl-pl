...
## <a name="example"></a>Przykład  
 Poniższy przykład pokazuje, jak za pomocą metody <xref:System.Data.Services.Client.DataServiceQuery%601.AddQueryOption%2A> utworzyć <xref:System.Data.Services.Client.DataServiceQuery%601>, który jest równoważny z poprzednimi przykładami.  
...
## <a name="example"></a>Przykład  
 Poniższy przykład pokazuje, jak używać opcji zapytania `$orderby` do filtrowania i zamawiania zwracanych obiektów Orders przez właściwość fracht.  
