# [Schemat konfiguracji programu Windows Workflow Foundation](index.md)
## [<system.serviceModel>](system-servicemodel-of-workflow.md)
### [<behaviors>](behaviors-of-workflow.md)
#### [<serviceBehaviors>](servicebehaviors-of-workflow.md)
##### [<behavior> dla <serviceBehaviors>](behavior-of-servicebehaviors-of-workflow.md)
...
######## [<states>](states.md)
######### [<state>](state.md)
###### [Używanie adnotacji w zapytaniach](using-annotation-in-queries.md)
## [Dodatkowa zarządzana dokumentacja](additional-managed-reference.md)
