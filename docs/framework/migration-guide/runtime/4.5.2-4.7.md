...
---
# <a name="runtime-changes-for-migration-from-net-framework-452-to-47"></a>Zmiany w czasie wykonywania migracji z .NET Framework 4.5.2 do 4,7

[!INCLUDE[versionselector](../../../../includes/migration-guide/runtime/versionselector.md)]

W przypadku migrowania z .NET Framework 4.5.2 do 4,7 zapoznaj się z następującymi tematami dotyczącymi problemów ze zgodnością aplikacji, które mogą mieć wpływ na aplikację:
