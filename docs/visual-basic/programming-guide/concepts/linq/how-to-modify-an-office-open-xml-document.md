...
```  
 ...
 W przypadku otwarcia `SampleDoc.docx` po uruchomieniu tego programu można zobaczyć, że ten program przekonwertował pierwszy akapit w dokumencie na wielkie litery.  
