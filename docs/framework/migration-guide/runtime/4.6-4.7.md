---
title: Zmiany w czasie wykonywania migracji z .NET Framework 4,6 do 4,7
description: Znajdź informacje o problemach ze zgodnością aplikacji w czasie wykonywania, które mogą mieć wpływ na aplikację podczas migracji z .NET Framework 4,6 do 4,7.
ms.date: 07/10/2019
...
ms.locfileid: "86444030"
---
# <a name="runtime-changes-for-migration-from-net-framework-46-to-47"></a><span data-ttu-id="ae35b-103">Zmiany w czasie wykonywania migracji z .NET Framework 4,6 do 4,7</span><span class="sxs-lookup"><span data-stu-id="ae35b-103">Runtime Changes for Migration from .NET Framework 4.6 to 4.7</span></span>

[!INCLUDE[versionselector](../../../../includes/migration-guide/runtime/versionselector.md)]

<span data-ttu-id="ae35b-104">W przypadku migrowania z .NET Framework 4,6 do 4,7 zapoznaj się z następującymi tematami dotyczącymi problemów ze zgodnością aplikacji, które mogą mieć wpływ na aplikację:</span><span class="sxs-lookup"><span data-stu-id="ae35b-104">If you are migrating from the .NET Framework 4.6 to 4.7, review the following topics for application compatibility issues that may affect your app:</span></span>

## <a name="data"></a><span data-ttu-id="ae35b-105">Dane</span><span class="sxs-lookup"><span data-stu-id="ae35b-105">Data</span></span>
...
## <a name="globalization"></a><span data-ttu-id="ae35b-106">Globalizacja</span><span class="sxs-lookup"><span data-stu-id="ae35b-106">Globalization</span></span>
...
## <a name="jit"></a><span data-ttu-id="ae35b-107">JIT</span><span class="sxs-lookup"><span data-stu-id="ae35b-107">JIT</span></span>
...
## <a name="security"></a><span data-ttu-id="ae35b-108">Zabezpieczenia</span><span class="sxs-lookup"><span data-stu-id="ae35b-108">Security</span></span>
...
## <a name="tools"></a><span data-ttu-id="ae35b-109">Narzędzia</span><span class="sxs-lookup"><span data-stu-id="ae35b-109">Tools</span></span>

[!INCLUDE[Contract.Invariant or Contract.Requires\<TException> do not consider String.IsNullOrEmpty to be pure](~/includes/migration-guide/runtime/tools/contractinvariant-contractrequirestexception-do-not-consider.md)]

## <a name="windows-communication-foundation-wcf"></a><span data-ttu-id="ae35b-110">Windows Communication Foundation (WCF)</span><span class="sxs-lookup"><span data-stu-id="ae35b-110">Windows Communication Foundation (WCF)</span></span>
...
## <a name="windows-presentation-foundation-wpf"></a><span data-ttu-id="ae35b-111">Windows Presentation Foundation (WPF)</span><span class="sxs-lookup"><span data-stu-id="ae35b-111">Windows Presentation Foundation (WPF)</span></span>
...
## <a name="windows-workflow-foundation-wf"></a><span data-ttu-id="ae35b-112">Program Windows Workflow Foundation (WF)</span><span class="sxs-lookup"><span data-stu-id="ae35b-112">Windows Workflow Foundation (WF)</span></span>
