...
## <a name="in-this-section"></a>W tej sekcji  
 ...
 [Funkcje daty i godziny](../../../../../docs/framework/data/adonet/ef/date-and-time-functions.md)  
  
 [Funkcje matematyczne](../../../../../docs/framework/data/adonet/ef/mathematical-functions.md)  
  
 [Funkcje ciągów](../../../../../docs/framework/data/adonet/ef/string-functions.md)  
