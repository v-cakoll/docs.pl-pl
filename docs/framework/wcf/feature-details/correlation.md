...
## <a name="in-this-section"></a>W tej sekcji  
 ...
 Zawiera omówienie typów korelacji dostępne w [!INCLUDE[netfx_current_long](../../../../includes/netfx-current-long-md.md)].  
  
 [Wymiana kontekstu](../../../../docs/framework/wcf/feature-details/context-exchange-correlation.md)  
 W tym artykule opisano korelacja wymiany kontekstu.  
