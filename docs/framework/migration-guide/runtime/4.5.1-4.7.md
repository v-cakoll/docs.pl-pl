...
ms.locfileid: "62033335"
---
# <a name="runtime-changes-for-migration-from-net-framework-451-to-47"></a><span data-ttu-id="a1e6d-102">Zmiany środowiska uruchomieniowego w przypadku migracji z .NET Framework 4.5.1 — 4.7</span><span class="sxs-lookup"><span data-stu-id="a1e6d-102">Runtime Changes for Migration from .NET Framework 4.5.1 to 4.7</span></span>

[!INCLUDE[versionselector](../../../../includes/migration-guide/runtime/versionselector.md)]

[!INCLUDE[introduction](../../../../includes/migration-guide/runtime/introduction.md)]

<span data-ttu-id="a1e6d-103">Migracji z programu .NET Framework 4.5.1 — 4.7, przejrzyj problemy ze zgodnością aplikacji, które mogą wpływać na Twoją aplikację w poniższych tematach:</span><span class="sxs-lookup"><span data-stu-id="a1e6d-103">If you are migrating from the .NET Framework 4.5.1 to 4.7, review the following topics for application compatibility issues that may affect your app:</span></span>

## <a name="aspnet"></a><span data-ttu-id="a1e6d-104">ASP.NET</span><span class="sxs-lookup"><span data-stu-id="a1e6d-104">ASP.NET</span></span>
...
## <a name="core"></a><span data-ttu-id="a1e6d-105">Core</span><span class="sxs-lookup"><span data-stu-id="a1e6d-105">Core</span></span>
...
## <a name="data"></a><span data-ttu-id="a1e6d-106">Dane</span><span class="sxs-lookup"><span data-stu-id="a1e6d-106">Data</span></span>
...
## <a name="debugger"></a><span data-ttu-id="a1e6d-107">Debuger</span><span class="sxs-lookup"><span data-stu-id="a1e6d-107">Debugger</span></span>
...
## <a name="entity-framework"></a><span data-ttu-id="a1e6d-108">Entity Framework</span><span class="sxs-lookup"><span data-stu-id="a1e6d-108">Entity Framework</span></span>
...
## <a name="globalization"></a><span data-ttu-id="a1e6d-109">Globalizacja</span><span class="sxs-lookup"><span data-stu-id="a1e6d-109">Globalization</span></span>
...
## <a name="jit"></a><span data-ttu-id="a1e6d-110">JIT</span><span class="sxs-lookup"><span data-stu-id="a1e6d-110">JIT</span></span>
...
## <a name="networking"></a><span data-ttu-id="a1e6d-111">Obsługa sieci</span><span class="sxs-lookup"><span data-stu-id="a1e6d-111">Networking</span></span>
...
## <a name="security"></a><span data-ttu-id="a1e6d-112">Zabezpieczenia</span><span class="sxs-lookup"><span data-stu-id="a1e6d-112">Security</span></span>
...
## <a name="serialization"></a><span data-ttu-id="a1e6d-113">Serializacja</span><span class="sxs-lookup"><span data-stu-id="a1e6d-113">Serialization</span></span>
...
## <a name="setup-and-deployment"></a><span data-ttu-id="a1e6d-114">Instalacja i wdrożenie</span><span class="sxs-lookup"><span data-stu-id="a1e6d-114">Setup and Deployment</span></span>
...
## <a name="tools"></a><span data-ttu-id="a1e6d-115">Narzędzia</span><span class="sxs-lookup"><span data-stu-id="a1e6d-115">Tools</span></span>

[!INCLUDE[Contract.Invariant or Contract.Requires\<TException> do not consider String.IsNullOrEmpty to be pure](~/includes/migration-guide/runtime/tools/contractinvariant-contractrequirestexception-do-not-consider.md)]

## <a name="windows-communication-foundation-wcf"></a><span data-ttu-id="a1e6d-116">Windows Communication Foundation (WCF)</span><span class="sxs-lookup"><span data-stu-id="a1e6d-116">Windows Communication Foundation (WCF)</span></span>
...
## <a name="windows-presentation-foundation-wpf"></a><span data-ttu-id="a1e6d-117">Windows Presentation Foundation (WPF)</span><span class="sxs-lookup"><span data-stu-id="a1e6d-117">Windows Presentation Foundation (WPF)</span></span>
...
## <a name="windows-workflow-foundation-wf"></a><span data-ttu-id="a1e6d-118">Program Windows Workflow Foundation (WF)</span><span class="sxs-lookup"><span data-stu-id="a1e6d-118">Windows Workflow Foundation (WF)</span></span>
