...
## <a name="why-the-new-compiler-performance-applies-to-your-app"></a>Dlaczego nowe wydajne kompilatora ma zastosowanie do aplikacji  
 ...
 Aby uzyskać więcej informacji na temat platformy Roslyn kompilatory, odwiedź stronę [dotnet/roslyn](https://github.com/dotnet/roslyn) repozytorium w witrynie GitHub.
