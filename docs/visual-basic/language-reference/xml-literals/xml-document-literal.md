...
|Termin|Definicja|  
|---|---|  
|`encoding`|Opcjonalny. Używa literały tekstowe zadeklarowanie, które kodowania dokumentu.|  
|`standalone`|Opcjonalny. Literały tekstowe. Musi być "tak" lub "no".|  
...
> [!NOTE]
>  Literał XML może obejmować wiele wierszy bez użycia znaki kontynuacji wiersza. Dzięki temu można kopiować zawartości z dokumentu XML i wklej go bezpośrednio do [!INCLUDE[vbprvb](~/includes/vbprvb-md.md)] program.  
  
 [!INCLUDE[vbprvb](~/includes/vbprvb-md.md)] Kompilatora konwertuje literał dokumentu XML na wywołania <xref:System.Xml.Linq.XDocument.%23ctor%2A> i <xref:System.Xml.Linq.XDeclaration.%23ctor%2A> konstruktorów.  
...
## <a name="see-also"></a>Zobacz też  
 ...
 [Literał instrukcji przetwarzania XML](../../../visual-basic/language-reference/xml-literals/xml-processing-instruction-literal.md)  
