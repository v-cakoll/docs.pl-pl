...
---
# <a name="runtime-changes-for-migration-from-net-framework-451-to-461"></a><span data-ttu-id="881a0-102">Zmiany środowiska uruchomieniowego do migracji z systemu .NET Framework 4.5.1 wersji 4.6.1</span><span class="sxs-lookup"><span data-stu-id="881a0-102">Runtime Changes for Migration from .NET Framework 4.5.1 to 4.6.1</span></span>

[!include[versionselector](../../../../includes/migration-guide/runtime/versionselector.md)]

[!include[introduction](../../../../includes/migration-guide/runtime/introduction.md)]

<span data-ttu-id="881a0-103">W przypadku migracji z programu .NET Framework 4.5.1 lub 4.6.1, należy przejrzeć następujące tematy dla problemów ze zgodnością aplikacji, które mogą wpływać na aplikację:</span><span class="sxs-lookup"><span data-stu-id="881a0-103">If you are migrating from the .NET Framework 4.5.1 to 4.6.1, review the following topics for application compatibility issues that may affect your app:</span></span>

## <a name="aspnet"></a><span data-ttu-id="881a0-104">ASP.NET</span><span class="sxs-lookup"><span data-stu-id="881a0-104">ASP.NET</span></span>
...
## <a name="core"></a><span data-ttu-id="881a0-105">Core</span><span class="sxs-lookup"><span data-stu-id="881a0-105">Core</span></span>
...
## <a name="data"></a><span data-ttu-id="881a0-106">Dane</span><span class="sxs-lookup"><span data-stu-id="881a0-106">Data</span></span>
...
## <a name="debugger"></a><span data-ttu-id="881a0-107">Debuger</span><span class="sxs-lookup"><span data-stu-id="881a0-107">Debugger</span></span>
...
## <a name="entity-framework"></a><span data-ttu-id="881a0-108">Entity Framework</span><span class="sxs-lookup"><span data-stu-id="881a0-108">Entity Framework</span></span>
...
## <a name="networking"></a><span data-ttu-id="881a0-109">Obsługa sieci</span><span class="sxs-lookup"><span data-stu-id="881a0-109">Networking</span></span>
...
## <a name="serialization"></a><span data-ttu-id="881a0-110">Serializacja</span><span class="sxs-lookup"><span data-stu-id="881a0-110">Serialization</span></span>
...
## <a name="setup-and-deployment"></a><span data-ttu-id="881a0-111">Instalacji i wdrażania</span><span class="sxs-lookup"><span data-stu-id="881a0-111">Setup and Deployment</span></span>
...
## <a name="tools"></a><span data-ttu-id="881a0-112">Narzędzia</span><span class="sxs-lookup"><span data-stu-id="881a0-112">Tools</span></span>

[!include[Contract.Invariant or Contract.Requires<TException> do not consider String.IsNullOrEmpty to be pure](~/includes/migration-guide/runtime/tools/contractinvariant-contractrequirestexception-do-not-consider.md)]

## <a name="windows-communication-foundation-wcf"></a><span data-ttu-id="881a0-113">Windows Communication Foundation (WCF)</span><span class="sxs-lookup"><span data-stu-id="881a0-113">Windows Communication Foundation (WCF)</span></span>
...
## <a name="windows-forms"></a><span data-ttu-id="881a0-114">Windows Forms</span><span class="sxs-lookup"><span data-stu-id="881a0-114">Windows Forms</span></span>
...
## <a name="windows-presentation-foundation-wpf"></a><span data-ttu-id="881a0-115">Windows Presentation Foundation (WPF)</span><span class="sxs-lookup"><span data-stu-id="881a0-115">Windows Presentation Foundation (WPF)</span></span>
