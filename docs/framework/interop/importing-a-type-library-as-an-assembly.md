...
-   Otoki niestandardowe  
    ...
    -   Znajomość reguły biblioteki do zestawu konwersji typu.  
     ...
     Pisanie niestandardowych otoki jest zaawansowanych technik. Aby uzyskać dodatkowe informacje na temat generowania otoki niestandardowe, zobacz [dostosowywanie standardowych otoki](http://msdn.microsoft.com/en-us/c40d089b-6a3c-41b5-a20d-d760c215e49d).  
  
 Aby uzyskać więcej informacji na temat procesu importowania międzyoperacyjnego COM zobacz [biblioteki typów na zestaw konwersja — Podsumowanie](http://msdn.microsoft.com/en-us/bf3f90c5-4770-4ab8-895c-3ba1055cc958).  
