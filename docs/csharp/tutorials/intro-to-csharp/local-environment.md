...
[Interpolacja ciągów](interpolated-strings-local.md) samouczku przedstawiono sposób wstawiania wartości do ciągu. Dowiesz się, jak utworzyć ciągu interpolowanego z osadzonymi C# wyrażeń i jak sterują formatowaniem ciągu wynikowego.

W tym samouczku założono, że zakończono [Witaj, świecie](hello-world.yml), [liczby w elemencie C# ](numbers-in-csharp-local.md), i [gałęzie i pętle](branches-and-loops-local.md) lekcje.
