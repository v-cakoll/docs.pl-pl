...
Aby włączyć funkcje takie jak wstępne renderowanie po stronie serwera i ponowne załadowanie modułu dynamicznego, zapoznaj się z dokumentacją odpowiedniej struktury SPA. Funkcje w `Microsoft.AspNetCore.SpaServices.Extensions` *nie* są przestarzałe i będą nadal obsługiwane.
