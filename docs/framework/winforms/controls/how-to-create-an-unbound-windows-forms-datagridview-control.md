...
Poniższy przykład kodu demonstruje, jak wypełnić formant <xref:System.Windows.Forms.DataGridView> programowo bez powiązania go ze źródłem danych. Jest to przydatne, gdy masz niewielką ilość danych, które mają być wyświetlane w formacie tabeli.  
  
 Aby uzyskać kompletny opis tego przykładu kodu, zobacz [Przewodnik: Tworzenie niepowiązanej kontrolki DataGridView Windows Forms](walkthrough-creating-an-unbound-windows-forms-datagridview-control.md).  
