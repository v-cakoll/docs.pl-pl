...
ms.locfileid: "86443237"
---
# <a name="runtime-changes-for-migration-from-net-framework-45-to-461"></a><span data-ttu-id="a0013-103">Zmiany w czasie wykonywania migracji z .NET Framework 4,5 do 4.6.1</span><span class="sxs-lookup"><span data-stu-id="a0013-103">Runtime Changes for Migration from .NET Framework 4.5 to 4.6.1</span></span>

[!INCLUDE[versionselector](../../../../includes/migration-guide/runtime/versionselector.md)]

<span data-ttu-id="a0013-104">W przypadku migrowania z .NET Framework 4,5 do 4.6.1 zapoznaj się z następującymi tematami dotyczącymi problemów ze zgodnością aplikacji, które mogą mieć wpływ na aplikację:</span><span class="sxs-lookup"><span data-stu-id="a0013-104">If you are migrating from the .NET Framework 4.5 to 4.6.1, review the following topics for application compatibility issues that may affect your app:</span></span>

## <a name="adonet"></a><span data-ttu-id="a0013-105">ADO.NET</span><span class="sxs-lookup"><span data-stu-id="a0013-105">ADO.NET</span></span>
...
## <a name="aspnet"></a><span data-ttu-id="a0013-106">ASP.NET</span><span class="sxs-lookup"><span data-stu-id="a0013-106">ASP.NET</span></span>
...
## <a name="core"></a><span data-ttu-id="a0013-107">Core</span><span class="sxs-lookup"><span data-stu-id="a0013-107">Core</span></span>
...
## <a name="data"></a><span data-ttu-id="a0013-108">Dane</span><span class="sxs-lookup"><span data-stu-id="a0013-108">Data</span></span>
...
## <a name="debugger"></a><span data-ttu-id="a0013-109">Debuger</span><span class="sxs-lookup"><span data-stu-id="a0013-109">Debugger</span></span>
...
## <a name="entity-framework"></a><span data-ttu-id="a0013-110">Entity Framework</span><span class="sxs-lookup"><span data-stu-id="a0013-110">Entity Framework</span></span>
...
## <a name="networking"></a><span data-ttu-id="a0013-111">Sieć</span><span class="sxs-lookup"><span data-stu-id="a0013-111">Networking</span></span>
...
## <a name="serialization"></a><span data-ttu-id="a0013-112">Serializacja</span><span class="sxs-lookup"><span data-stu-id="a0013-112">Serialization</span></span>
...
## <a name="setup-and-deployment"></a><span data-ttu-id="a0013-113">Instalacja i wdrożenie</span><span class="sxs-lookup"><span data-stu-id="a0013-113">Setup and Deployment</span></span>
...
## <a name="tools"></a><span data-ttu-id="a0013-114">Narzędzia</span><span class="sxs-lookup"><span data-stu-id="a0013-114">Tools</span></span>

[!INCLUDE[Contract.Invariant or Contract.Requires\<TException> do not consider String.IsNullOrEmpty to be pure](~/includes/migration-guide/runtime/tools/contractinvariant-contractrequirestexception-do-not-consider.md)]

## <a name="windows-communication-foundation-wcf"></a><span data-ttu-id="a0013-115">Windows Communication Foundation (WCF)</span><span class="sxs-lookup"><span data-stu-id="a0013-115">Windows Communication Foundation (WCF)</span></span>
...
## <a name="windows-presentation-foundation-wpf"></a><span data-ttu-id="a0013-116">Windows Presentation Foundation (WPF)</span><span class="sxs-lookup"><span data-stu-id="a0013-116">Windows Presentation Foundation (WPF)</span></span>
