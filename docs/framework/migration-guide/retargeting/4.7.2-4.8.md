---
title: Zmiana celu migracji z programu .NET Framework 4.7.2 do 4.8
ms.date: 07/10/2019
...
ms.locfileid: "79400072"
---
# <a name="retargeting-changes-for-migration-from-net-framework-472-to-48"></a><span data-ttu-id="3847c-102">Zmiana celu migracji z programu .NET Framework 4.7.2 do 4.8</span><span class="sxs-lookup"><span data-stu-id="3847c-102">Retargeting Changes for Migration from .NET Framework 4.7.2 to 4.8</span></span>

[!INCLUDE[versionselector](../../../../includes/migration-guide/retargeting/versionselector.md)]

<span data-ttu-id="3847c-103">W przypadku migracji z programu .NET Framework 4.7.2 do 4.8 zapoznaj się z następującymi tematami dotyczącymi problemów ze zgodnością aplikacji, które mogą mieć wpływ na aplikację:</span><span class="sxs-lookup"><span data-stu-id="3847c-103">If you are migrating from the .NET Framework 4.7.2 to 4.8, review the following topics for application compatibility issues that may affect your app:</span></span>

## <a name="core"></a><span data-ttu-id="3847c-104">Podstawowe</span><span class="sxs-lookup"><span data-stu-id="3847c-104">Core</span></span>
...
## <a name="windows-forms"></a><span data-ttu-id="3847c-105">Windows Forms</span><span class="sxs-lookup"><span data-stu-id="3847c-105">Windows Forms</span></span>
...
## <a name="windows-presentation-foundation-wpf"></a><span data-ttu-id="3847c-106">Windows Presentation Foundation (WPF)</span><span class="sxs-lookup"><span data-stu-id="3847c-106">Windows Presentation Foundation (WPF)</span></span>
...
## <a name="windows-workflow-foundation-wf"></a><span data-ttu-id="3847c-107">Program Windows Workflow Foundation (WF)</span><span class="sxs-lookup"><span data-stu-id="3847c-107">Windows Workflow Foundation (WF)</span></span>
