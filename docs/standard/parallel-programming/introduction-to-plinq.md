...
<xref:System.Linq.ParallelEnumerable> obejmuje implementacje wszystkich standardowych operatorów zapytań, które LINQ to Objects obsługiwane, chociaż nie podejmuje próby zrównoleglanie każdego z nich. Jeśli nie znasz [!INCLUDE[vbteclinq](../../../includes/vbteclinq-md.md)], zobacz [Introduction to LINQC#()](../../csharp/programming-guide/concepts/linq/index.md) i [Introduction to LINQ (Visual Basic)](../../visual-basic/programming-guide/concepts/linq/introduction-to-linq.md).
