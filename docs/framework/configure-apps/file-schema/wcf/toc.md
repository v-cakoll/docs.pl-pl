# [Schemat konfiguracji programu WCF](index.md)
...
######## [<add> dla <defaultPorts>](add-of-defaultports.md)
...
####### [<connectionPoolSettings> dla <namedPipeTransport>](connectionpoolsettings.md)
...
##### [<add> dla <namespaceTable>](add-of-namespacetable.md)
