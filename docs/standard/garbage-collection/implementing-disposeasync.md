...
## <a name="disposeasync-and-disposeasynccore"></a><span data-ttu-id="8805d-111">DisposeAsync () i DisposeAsyncCore ()</span><span class="sxs-lookup"><span data-stu-id="8805d-111">DisposeAsync() and DisposeAsyncCore()</span></span>
