...
![Pole wyboru przy użyciu domyślnego szablonu kontrolki. ](./media/ndp-checkboxdefault.png "NDP_CheckBoxDefault") pole wyboru, która korzysta z domyślnego szablonu kontrolki

![Pole wyboru przy użyciu szablonu kontrolki niestandardowej. ](./media/ndp-checkboxcustom.png "NDP_CheckBoxCustom") pole wyboru, który używa szablonu kontrolki niestandardowej
...
![Numericupdown — formant niestandardowy. ](./media/ndp-numericupdown.png "NDP_NumericUPDown") niestandardowy formant NumericUpDown
