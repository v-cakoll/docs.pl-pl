...
|Znak|Opis|  
|---|---|  
|Nie|— przestrzeń nazw<br /><br /> Nie można dodać komentarzy do dokumentacji do przestrzeni nazw, ale możesz wprowadzić do nich odwołania CREF, jeśli są obsługiwane.|  
