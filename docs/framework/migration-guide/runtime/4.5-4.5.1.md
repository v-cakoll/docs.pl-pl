...
---
# <a name="runtime-changes-for-migration-from-net-framework-45-to-451"></a><span data-ttu-id="3b564-102">Zmiany środowiska uruchomieniowego do migracji z systemu .NET Framework 4.5 i 4.5.1</span><span class="sxs-lookup"><span data-stu-id="3b564-102">Runtime Changes for Migration from .NET Framework 4.5 to 4.5.1</span></span>

[!include[versionselector](../../../../includes/migration-guide/runtime/versionselector.md)]

[!include[introduction](../../../../includes/migration-guide/runtime/introduction.md)]

<span data-ttu-id="3b564-103">Jeśli w przypadku migracji z programu .NET Framework 4.5 do 4.5.1, należy przejrzeć następujące tematy dla problemów ze zgodnością aplikacji, które mogą wpływać na aplikację:</span><span class="sxs-lookup"><span data-stu-id="3b564-103">If you are migrating from the .NET Framework 4.5 to 4.5.1, review the following topics for application compatibility issues that may affect your app:</span></span>

## <a name="adonet"></a><span data-ttu-id="3b564-104">ADO.NET</span><span class="sxs-lookup"><span data-stu-id="3b564-104">ADO.NET</span></span>
...
## <a name="core"></a><span data-ttu-id="3b564-105">Core</span><span class="sxs-lookup"><span data-stu-id="3b564-105">Core</span></span>
...
## <a name="serialization"></a><span data-ttu-id="3b564-106">Serializacja</span><span class="sxs-lookup"><span data-stu-id="3b564-106">Serialization</span></span>
...
## <a name="windows-communication-foundation-wcf"></a><span data-ttu-id="3b564-107">Windows Communication Foundation (WCF)</span><span class="sxs-lookup"><span data-stu-id="3b564-107">Windows Communication Foundation (WCF)</span></span>
...
## <a name="windows-presentation-foundation-wpf"></a><span data-ttu-id="3b564-108">Windows Presentation Foundation (WPF)</span><span class="sxs-lookup"><span data-stu-id="3b564-108">Windows Presentation Foundation (WPF)</span></span>
