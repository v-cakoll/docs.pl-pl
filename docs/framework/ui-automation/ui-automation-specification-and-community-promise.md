...
## <a name="see-also"></a><span data-ttu-id="b1c08-104">Zobacz też</span><span class="sxs-lookup"><span data-stu-id="b1c08-104">See Also</span></span>  
 [<span data-ttu-id="b1c08-105">Specyfikacja automatyzacji interfejsu użytkownika</span><span class="sxs-lookup"><span data-stu-id="b1c08-105">UI Automation Specification</span></span>](http://go.microsoft.com/fwlink/?LinkId=108541)  
 [<span data-ttu-id="b1c08-106">Obietnica dla społeczności automatyzacji interfejsu użytkownika</span><span class="sxs-lookup"><span data-stu-id="b1c08-106">UI Automation Community Promise</span></span>](http://go.microsoft.com/fwlink/?LinkId=108542)
