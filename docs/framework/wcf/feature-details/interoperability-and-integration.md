...
## <a name="in-this-section"></a>W tej sekcji  
 ...
 W tym artykule omówiono różne metody dla aplikacji modelu COM, aby wywołać [!INCLUDE[indigo2](../../../../includes/indigo2-md.md)] usług.  
 ...
 Opisuje sposób [!INCLUDE[indigo2](../../../../includes/indigo2-md.md)] mogą być używane z [!INCLUDE[dnprdnshort](../../../../includes/dnprdnshort-md.md)] komunikacji zdalnej.  
 ...
 Opisuje sposób [!INCLUDE[indigo2](../../../../includes/indigo2-md.md)] zapewnia usług i klientów, którzy używają "XML starego zwykły" (POX) wiadomości.  
