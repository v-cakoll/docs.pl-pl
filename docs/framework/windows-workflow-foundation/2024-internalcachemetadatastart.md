...
## <a name="description"></a>Opis  
 Wskazuje początek wykonywanie metody InternalCacheMetadata w działaniu.  
  
## <a name="message"></a>Komunikat  
 Rozpoczęto wykonywanie metody InternalCacheMetadata w działaniu '%1'.  
