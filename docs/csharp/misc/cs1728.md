...
Nie można powiązać delegata z "członek", ponieważ jest on członkiem "type"  
  
 Nie można powiązać obiekty delegowane członkowie `Nullable` typów.  
  
## <a name="example"></a>Przykład  
 Poniższy przykład spowoduje wygenerowanie CS1728:  
