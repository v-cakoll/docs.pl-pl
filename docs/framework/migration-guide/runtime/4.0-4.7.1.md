...
---
# <a name="runtime-changes-for-migration-from-net-framework-40-to-471"></a><span data-ttu-id="45160-102">Zmiany środowiska uruchomieniowego do migracji z systemu .NET Framework 4.0 do 4.7.1</span><span class="sxs-lookup"><span data-stu-id="45160-102">Runtime Changes for Migration from .NET Framework 4.0 to 4.7.1</span></span>

[!INCLUDE[versionselector](../../../../includes/migration-guide/runtime/versionselector.md)]

[!INCLUDE[introduction](../../../../includes/migration-guide/runtime/introduction.md)]

<span data-ttu-id="45160-103">Jeśli w przypadku migracji z programu .NET Framework 4.0 do 4.7.1, należy przejrzeć następujące tematy dla problemów ze zgodnością aplikacji, które mogą wpływać na aplikację:</span><span class="sxs-lookup"><span data-stu-id="45160-103">If you are migrating from the .NET Framework 4.0 to 4.7.1, review the following topics for application compatibility issues that may affect your app:</span></span>

## <a name="adonet"></a><span data-ttu-id="45160-104">ADO.NET</span><span class="sxs-lookup"><span data-stu-id="45160-104">ADO.NET</span></span>
...
## <a name="aspnet"></a><span data-ttu-id="45160-105">ASP.NET</span><span class="sxs-lookup"><span data-stu-id="45160-105">ASP.NET</span></span>
...
## <a name="core"></a><span data-ttu-id="45160-106">Core</span><span class="sxs-lookup"><span data-stu-id="45160-106">Core</span></span>
...
## <a name="data"></a><span data-ttu-id="45160-107">Dane</span><span class="sxs-lookup"><span data-stu-id="45160-107">Data</span></span>
...
## <a name="entity-framework"></a><span data-ttu-id="45160-108">Entity Framework</span><span class="sxs-lookup"><span data-stu-id="45160-108">Entity Framework</span></span>
...
## <a name="globalization"></a><span data-ttu-id="45160-109">Globalizacja</span><span class="sxs-lookup"><span data-stu-id="45160-109">Globalization</span></span>
...
## <a name="linq"></a><span data-ttu-id="45160-110">LINQ</span><span class="sxs-lookup"><span data-stu-id="45160-110">LINQ</span></span>
...
## <a name="managed-extensibility-framework-mef"></a><span data-ttu-id="45160-111">Managed Extensibility Framework (MEF)</span><span class="sxs-lookup"><span data-stu-id="45160-111">Managed Extensibility Framework (MEF)</span></span>
...
## <a name="networking"></a><span data-ttu-id="45160-112">Obsługa sieci</span><span class="sxs-lookup"><span data-stu-id="45160-112">Networking</span></span>
...
## <a name="printing"></a><span data-ttu-id="45160-113">Drukowanie</span><span class="sxs-lookup"><span data-stu-id="45160-113">Printing</span></span>
...
## <a name="security"></a><span data-ttu-id="45160-114">Zabezpieczenia</span><span class="sxs-lookup"><span data-stu-id="45160-114">Security</span></span>
...
## <a name="serialization"></a><span data-ttu-id="45160-115">Serializacja</span><span class="sxs-lookup"><span data-stu-id="45160-115">Serialization</span></span>
...
## <a name="setup-and-deployment"></a><span data-ttu-id="45160-116">Instalacji i wdrażania</span><span class="sxs-lookup"><span data-stu-id="45160-116">Setup and Deployment</span></span>
...
## <a name="tools"></a><span data-ttu-id="45160-117">Narzędzia</span><span class="sxs-lookup"><span data-stu-id="45160-117">Tools</span></span>

[!INCLUDE[Contract.Invariant or Contract.Requires<TException> do not consider String.IsNullOrEmpty to be pure](~/includes/migration-guide/runtime/tools/contractinvariant-contractrequirestexception-do-not-consider.md)]

## <a name="web-applications"></a><span data-ttu-id="45160-118">Aplikacje sieci Web</span><span class="sxs-lookup"><span data-stu-id="45160-118">Web Applications</span></span>
...
## <a name="windows-communication-foundation-wcf"></a><span data-ttu-id="45160-119">Windows Communication Foundation (WCF)</span><span class="sxs-lookup"><span data-stu-id="45160-119">Windows Communication Foundation (WCF)</span></span>
...
## <a name="windows-forms"></a><span data-ttu-id="45160-120">Windows Forms</span><span class="sxs-lookup"><span data-stu-id="45160-120">Windows Forms</span></span>
...
## <a name="windows-presentation-foundation-wpf"></a><span data-ttu-id="45160-121">Windows Presentation Foundation (WPF)</span><span class="sxs-lookup"><span data-stu-id="45160-121">Windows Presentation Foundation (WPF)</span></span>
...
## <a name="windows-workflow-foundation-wf"></a><span data-ttu-id="45160-122">Program Windows Workflow Foundation (WF)</span><span class="sxs-lookup"><span data-stu-id="45160-122">Windows Workflow Foundation (WF)</span></span>
...
## <a name="xml-xslt"></a><span data-ttu-id="45160-123">Języki XML, XSLT</span><span class="sxs-lookup"><span data-stu-id="45160-123">XML, XSLT</span></span>
