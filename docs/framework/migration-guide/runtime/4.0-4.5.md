...
ms.locfileid: "61977486"
---
# <a name="runtime-changes-for-migration-from-net-framework-40-to-45"></a><span data-ttu-id="18476-102">Zmiany środowiska uruchomieniowego w przypadku migracji z .NET Framework 4.0 lub 4.5</span><span class="sxs-lookup"><span data-stu-id="18476-102">Runtime Changes for Migration from .NET Framework 4.0 to 4.5</span></span>

[!INCLUDE[versionselector](../../../../includes/migration-guide/runtime/versionselector.md)]

[!INCLUDE[introduction](../../../../includes/migration-guide/runtime/introduction.md)]

<span data-ttu-id="18476-103">Jeśli są migrowane z programu .NET Framework 4.0, 4.5, przejrzyj problemy ze zgodnością aplikacji, które mogą wpływać na Twoją aplikację w poniższych tematach:</span><span class="sxs-lookup"><span data-stu-id="18476-103">If you are migrating from the .NET Framework 4.0 to 4.5, review the following topics for application compatibility issues that may affect your app:</span></span>

## <a name="aspnet"></a><span data-ttu-id="18476-104">ASP.NET</span><span class="sxs-lookup"><span data-stu-id="18476-104">ASP.NET</span></span>
...
## <a name="core"></a><span data-ttu-id="18476-105">Core</span><span class="sxs-lookup"><span data-stu-id="18476-105">Core</span></span>
...
## <a name="data"></a><span data-ttu-id="18476-106">Dane</span><span class="sxs-lookup"><span data-stu-id="18476-106">Data</span></span>
...
## <a name="debugger"></a><span data-ttu-id="18476-107">Debuger</span><span class="sxs-lookup"><span data-stu-id="18476-107">Debugger</span></span>
...
## <a name="entity-framework"></a><span data-ttu-id="18476-108">Entity Framework</span><span class="sxs-lookup"><span data-stu-id="18476-108">Entity Framework</span></span>
...
## <a name="linq"></a><span data-ttu-id="18476-109">LINQ</span><span class="sxs-lookup"><span data-stu-id="18476-109">LINQ</span></span>
...
## <a name="managed-extensibility-framework-mef"></a><span data-ttu-id="18476-110">Managed Extensibility Framework (MEF)</span><span class="sxs-lookup"><span data-stu-id="18476-110">Managed Extensibility Framework (MEF)</span></span>
...
## <a name="networking"></a><span data-ttu-id="18476-111">Obsługa sieci</span><span class="sxs-lookup"><span data-stu-id="18476-111">Networking</span></span>
...
## <a name="printing"></a><span data-ttu-id="18476-112">Drukowanie</span><span class="sxs-lookup"><span data-stu-id="18476-112">Printing</span></span>
...
## <a name="serialization"></a><span data-ttu-id="18476-113">Serializacja</span><span class="sxs-lookup"><span data-stu-id="18476-113">Serialization</span></span>
...
## <a name="web-applications"></a><span data-ttu-id="18476-114">Aplikacje internetowe</span><span class="sxs-lookup"><span data-stu-id="18476-114">Web Applications</span></span>
...
## <a name="windows-communication-foundation-wcf"></a><span data-ttu-id="18476-115">Windows Communication Foundation (WCF)</span><span class="sxs-lookup"><span data-stu-id="18476-115">Windows Communication Foundation (WCF)</span></span>
...
## <a name="windows-forms"></a><span data-ttu-id="18476-116">Windows Forms</span><span class="sxs-lookup"><span data-stu-id="18476-116">Windows Forms</span></span>
...
## <a name="windows-presentation-foundation-wpf"></a><span data-ttu-id="18476-117">Windows Presentation Foundation (WPF)</span><span class="sxs-lookup"><span data-stu-id="18476-117">Windows Presentation Foundation (WPF)</span></span>
...
## <a name="windows-workflow-foundation-wf"></a><span data-ttu-id="18476-118">Program Windows Workflow Foundation (WF)</span><span class="sxs-lookup"><span data-stu-id="18476-118">Windows Workflow Foundation (WF)</span></span>
...
## <a name="xml-xslt"></a><span data-ttu-id="18476-119">Języki XML, XSLT</span><span class="sxs-lookup"><span data-stu-id="18476-119">XML, XSLT</span></span>
