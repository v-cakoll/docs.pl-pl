...
---
# <a name="compiler-error-cs1521"></a>CS1521 błąd kompilatora
Nieprawidłowy typ podstawowy  
  
 A [podstawowy](../../csharp/language-reference/keywords/base.md) Specyfikacja klasy został niewłaściwie sformatowany.  
  
 Poniższy przykład spowoduje wygenerowanie CS1521:  
