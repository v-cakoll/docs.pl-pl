...
## <a name="text-input"></a>Wprowadzanie tekstu
 ...
 W tym przykładzie logika obsługi są zapisywane dwa razy — raz dla CTRL + O, a następnie dla przycisku kliknij zdarzenie. Może to uproszczona, za pomocą poleceń, a nie bezpośrednio obsługi zdarzenia wejściowe.  Polecenia zostały omówione w tym omówieniu, a w [polecenia Przegląd](../../../../docs/framework/wpf/advanced/commanding-overview.md).
...
-   <xref:System.Windows.UIElement.LostTouchCapture>
 ...
 Podobnie jak w przypadku zdarzeń klawiatury oraz myszy zdarzenia dotykowe są zdarzenia trasowane. Zdarzenia, które zaczynają się od `Preview` są tunelowanie zdarzeń i zdarzeń, które zaczynają się od `Touch` są zdarzenia propagacji. Aby uzyskać więcej informacji na temat zdarzenia trasowane, zobacz [Przegląd zdarzeń kierowane](../../../../docs/framework/wpf/advanced/routed-events-overview.md). Podczas obsługi tych zdarzeń, pozycja danych wejściowych, względem dowolnego elementu można uzyskać przez wywołanie metody <xref:System.Windows.Input.TouchEventArgs.GetTouchPoint%2A> lub <xref:System.Windows.Input.TouchEventArgs.GetIntermediateTouchPoints%2A> metody.
 ...
 ![Kolejność zdarzeń touch. ](../../../../docs/framework/wpf/advanced/media/ndp-touchevents.png "NDP_TouchEvents") zdarzenia dotykowe
...
#### <a name="the-execution-path-of-manipulation-events"></a>Ścieżki wykonywania do manipulowania zdarzenia
 ...
 ![Sekwencja do manipulowania zdarzenia. ](../../../../docs/framework/wpf/advanced/media/ndp-manipulationevents.png "NDP_ManipulationEvents") do manipulowania zdarzenia
...
### <a name="the-relationship-between-touch-and-manipulation-events"></a>Relacja między Dotyk i manipulowania zdarzenia
 ...
 ![Relacja między zdarzeniami Dotyk i manipulowania](../../../../docs/framework/wpf/advanced/media/ndp-touchmanipulateevents.png "NDP_TouchManipulateEvents") Dotyk i manipulowania zdarzenia
...
### <a name="keyboard-focus"></a>Fokus klawiatury
 ...
 Aby uzyskać więcej informacji na temat fokus klawiatury, zobacz [Przegląd fokus](../../../../docs/framework/wpf/advanced/focus-overview.md).
...
### <a name="logical-focus"></a>Fokus logiczny
 ...
 Aby uzyskać więcej informacji na temat fokus logiczny zobacz [Przegląd fokus](../../../../docs/framework/wpf/advanced/focus-overview.md).
...
## <a name="commands"></a>Polecenia
 ...
 Aby uzyskać więcej informacji na temat poleceń w [!INCLUDE[TLA2#tla_winclient](../../../../includes/tla2sharptla-winclient-md.md)], zobacz [polecenia Przegląd](../../../../docs/framework/wpf/advanced/commanding-overview.md).
