...
Ta sekcja zawiera przykłady ilustrujące podstawowych funkcji Windows Workflow Foundation (WF).  
...
## <a name="in-this-section"></a>W tej sekcji  
 ...
 Zawiera przykłady ilustrujące tworzenia działań niestandardowych.  
 ...
 Zawiera przykłady ilustrujące wykonywania przepływów pracy.  
  
 [Wyrażenia](../../../../docs/framework/windows-workflow-foundation/samples/expressions.md)  
 Zawiera przykłady ilustrujące wyrażenia Windows Workflow Foundation (WF).  
  
 [Migracja](../../../../docs/framework/windows-workflow-foundation/samples/migration.md)  
 Zawiera przykłady ilustrujące Migrowanie przepływy pracy utworzone w poprzednich wersjach systemu Windows Workflow Foundation (WF).  
  
 [Trwałość](../../../../docs/framework/windows-workflow-foundation/samples/persistence.md)  
 Zawiera przykłady ilustrujące utrwalanie przepływy pracy w celu trwałego nośnika.  
  
 [Przykłady reguł](../../../../docs/framework/windows-workflow-foundation/samples/rules-samples.md)  
 Zawiera przykłady ilustrujące przy użyciu reguł aparatu przepływu pracy z [!INCLUDE[netfx35_short](../../../../includes/netfx35-short-md.md)].  
  
 [Usługi](../../../../docs/framework/windows-workflow-foundation/samples/services.md)  
 Zawiera przykłady ilustrujące usług przepływu pracy.  
  
 [Śledzenie](../../../../docs/framework/windows-workflow-foundation/samples/tracking.md)  
 Zawiera przykłady ilustrujące śledzenia przepływu pracy.  
 ...
 Zawiera przykłady ilustrujące weryfikacji w programie Windows Workflow Foundation.  
