...
Ta sekcja zawiera informacje o wyjątkach w następujących obszarach generowane przez Windows Communication Foundation (WCF):  
 ...
 [Kanał elementu równorzędnego](../../../../../docs/framework/wcf/diagnostics/exceptions-reference/peer-channel.md)  
 ...
 [Wyjątki zabezpieczeń](../../../../../docs/framework/wcf/diagnostics/exceptions-reference/security-exceptions.md)  
  
 [Struktura usługi](../../../../../docs/framework/wcf/diagnostics/exceptions-reference/service-framework.md)  
  
 [Dane struktury usługi](../../../../../docs/framework/wcf/diagnostics/exceptions-reference/service-framework-data.md)  
  
 [Element formatujący transakcji](../../../../../docs/framework/wcf/diagnostics/exceptions-reference/transaction-formatter.md)  
