...
---
# <a name="runtime-changes-for-migration-from-net-framework-452-to-471"></a>Zmiany środowiska uruchomieniowego do migracji z systemu .NET Framework 4.5.2 i 4.7.1

[!INCLUDE[versionselector](../../../../includes/migration-guide/runtime/versionselector.md)]

[!INCLUDE[introduction](../../../../includes/migration-guide/runtime/introduction.md)]

W przypadku migracji z programu .NET Framework 4.5.2 i 4.7.1, należy przejrzeć następujące tematy dla problemów ze zgodnością aplikacji, które mogą wpływać na aplikację:
