---
title: Zmiany środowiska uruchomieniowego do migracji z .NET Framework 4.7.2 do 4.8
ms.date: 04/18/2019
...
ms.locfileid: "59982290"
---
# <a name="runtime-changes-for-migration-from-net-framework-472-to-48"></a><span data-ttu-id="3e6b4-102">Zmiany środowiska uruchomieniowego do migracji z .NET Framework 4.7.2 do 4.8</span><span class="sxs-lookup"><span data-stu-id="3e6b4-102">Runtime Changes for Migration from .NET Framework 4.7.2 to 4.8</span></span>

[!INCLUDE[versionselector](../../../../includes/migration-guide/runtime/versionselector.md)]

[!INCLUDE[introduction](../../../../includes/migration-guide/runtime/introduction.md)]

<span data-ttu-id="3e6b4-103">Migracji z programu .NET Framework 4.7.2 do 4,8, zobacz następujące tematy dla problemów ze zgodnością aplikacji, które mogą wpływać na Twoją aplikację:</span><span class="sxs-lookup"><span data-stu-id="3e6b4-103">If you are migrating from the .NET Framework 4.7.2 to 4.8, review the following topics for application compatibility issues that may affect your app:</span></span>

## <a name="aspnet"></a><span data-ttu-id="3e6b4-104">ASP.NET</span><span class="sxs-lookup"><span data-stu-id="3e6b4-104">ASP.NET</span></span>
...
## <a name="core"></a><span data-ttu-id="3e6b4-105">Core</span><span class="sxs-lookup"><span data-stu-id="3e6b4-105">Core</span></span>
...
## <a name="windows-communication-foundation-wcf"></a><span data-ttu-id="3e6b4-106">Windows Communication Foundation (WCF)</span><span class="sxs-lookup"><span data-stu-id="3e6b4-106">Windows Communication Foundation (WCF)</span></span>
...
## <a name="windows-presentation-foundation-wpf"></a><span data-ttu-id="3e6b4-107">Windows Presentation Foundation (WPF)</span><span class="sxs-lookup"><span data-stu-id="3e6b4-107">Windows Presentation Foundation (WPF)</span></span>
