...
## <a name="example"></a>Przykład  
 W tym przykładzie użyto <xref:System.Linq.Queryable.Union%2A> celu zwrócenia sekwencji wszystkich krajach/regionach, w którym istnieją albo `Customers` lub `Employees`.  
