...
---
# <a name="visual-basic-runtime-library-members"></a><span data-ttu-id="20ec7-102">Elementy członkowskie biblioteki wykonawczej programu Visual Basic</span><span class="sxs-lookup"><span data-stu-id="20ec7-102">Visual Basic Runtime Library Members</span></span>

<span data-ttu-id="20ec7-103">`Microsoft.VisualBasic`Przestrzeń nazw zawiera klasy, moduły, stałe i wyliczenia, które stanowią bibliotekę środowiska uruchomieniowego Visual Basic.</span><span class="sxs-lookup"><span data-stu-id="20ec7-103">The `Microsoft.VisualBasic` namespace contains the classes, modules, constants, and enumerations that constitute the Visual Basic runtime library.</span></span> <span data-ttu-id="20ec7-104">Te elementy członkowskie biblioteki udostępniają procedury, właściwości i wartości stałe, których można użyć w kodzie.</span><span class="sxs-lookup"><span data-stu-id="20ec7-104">These library members provide procedures, properties, and constant values you can use in your code.</span></span> <span data-ttu-id="20ec7-105">Każdy moduł i Klasa przedstawiają określoną kategorię funkcji.</span><span class="sxs-lookup"><span data-stu-id="20ec7-105">Each module and class represents a particular category of functionality.</span></span>  
  
## <a name="microsoftvisualbasiccollection-class"></a><span data-ttu-id="20ec7-106">Microsoft. VisualBasic. Collection — Klasa</span><span class="sxs-lookup"><span data-stu-id="20ec7-106">Microsoft.VisualBasic.Collection Class</span></span>  
...
## <a name="microsoftvisualbasiccomclassattribute-class"></a><span data-ttu-id="20ec7-107">Microsoft. VisualBasic. ComClassAttribute — Klasa</span><span class="sxs-lookup"><span data-stu-id="20ec7-107">Microsoft.VisualBasic.ComClassAttribute Class</span></span>  
...
## <a name="microsoftvisualbasiccontrolchars-class"></a><span data-ttu-id="20ec7-108">Microsoft. VisualBasic. ControlChars, Klasa</span><span class="sxs-lookup"><span data-stu-id="20ec7-108">Microsoft.VisualBasic.ControlChars Class</span></span>  
...
## <a name="microsoftvisualbasicconstants-class"></a><span data-ttu-id="20ec7-109">Microsoft. VisualBasic. stałe — Klasa</span><span class="sxs-lookup"><span data-stu-id="20ec7-109">Microsoft.VisualBasic.Constants Class</span></span>  
...
## <a name="microsoftvisualbasicconversion-module"></a><span data-ttu-id="20ec7-110">Moduł Microsoft. VisualBasic. Conversion</span><span class="sxs-lookup"><span data-stu-id="20ec7-110">Microsoft.VisualBasic.Conversion Module</span></span>  
...
## <a name="microsoftvisualbasicdateandtime-module"></a><span data-ttu-id="20ec7-111">Microsoft. VisualBasic. DateAndTime — moduł</span><span class="sxs-lookup"><span data-stu-id="20ec7-111">Microsoft.VisualBasic.DateAndTime Module</span></span>  
...
## <a name="microsoftvisualbasicerrobject-class"></a><span data-ttu-id="20ec7-112">Microsoft. VisualBasic. ErrObject, Klasa</span><span class="sxs-lookup"><span data-stu-id="20ec7-112">Microsoft.VisualBasic.ErrObject Class</span></span>  
...
## <a name="microsoftvisualbasicfilesystem-module"></a><span data-ttu-id="20ec7-113">Microsoft. VisualBasic. system plików — moduł</span><span class="sxs-lookup"><span data-stu-id="20ec7-113">Microsoft.VisualBasic.FileSystem Module</span></span>  
...
## <a name="microsoftvisualbasicfinancial-module"></a><span data-ttu-id="20ec7-114">Microsoft. VisualBasic. Financial — moduł</span><span class="sxs-lookup"><span data-stu-id="20ec7-114">Microsoft.VisualBasic.Financial Module</span></span>  
...
## <a name="microsoftvisualbasicglobals-module"></a><span data-ttu-id="20ec7-115">Microsoft. VisualBasic. Globals — moduł</span><span class="sxs-lookup"><span data-stu-id="20ec7-115">Microsoft.VisualBasic.Globals Module</span></span>  
...
## <a name="microsoftvisualbasichidemodulenameattribute-class"></a><span data-ttu-id="20ec7-116">Microsoft. VisualBasic. HideModuleNameAttribute, Klasa</span><span class="sxs-lookup"><span data-stu-id="20ec7-116">Microsoft.VisualBasic.HideModuleNameAttribute Class</span></span>  
  
|||||  
|---|---|---|---|  
|<xref:Microsoft.VisualBasic.HideModuleNameAttribute>||||  
  
## <a name="microsoftvisualbasicinformation-module"></a><span data-ttu-id="20ec7-117">Microsoft. VisualBasic. Information — moduł</span><span class="sxs-lookup"><span data-stu-id="20ec7-117">Microsoft.VisualBasic.Information Module</span></span>  
...
## <a name="microsoftvisualbasicinteraction-module"></a><span data-ttu-id="20ec7-118">Moduł Microsoft. VisualBasic. Interaction</span><span class="sxs-lookup"><span data-stu-id="20ec7-118">Microsoft.VisualBasic.Interaction Module</span></span>  
...
## <a name="microsoftvisualbasicmygroupcollectionattribute-class"></a><span data-ttu-id="20ec7-119">Microsoft. VisualBasic. atrybut MyGroupCollectionAttribute, Klasa</span><span class="sxs-lookup"><span data-stu-id="20ec7-119">Microsoft.VisualBasic.MyGroupCollectionAttribute Class</span></span>  
...
## <a name="microsoftvisualbasicstrings-module"></a><span data-ttu-id="20ec7-120">Microsoft. VisualBasic. Strings — moduł</span><span class="sxs-lookup"><span data-stu-id="20ec7-120">Microsoft.VisualBasic.Strings Module</span></span>  
...
## <a name="microsoftvisualbasicvbfixedarrayattribute-class"></a><span data-ttu-id="20ec7-121">Microsoft. VisualBasic. VBFixedArrayAttribute, Klasa</span><span class="sxs-lookup"><span data-stu-id="20ec7-121">Microsoft.VisualBasic.VBFixedArrayAttribute Class</span></span>  
  
|||||  
|---|---|---|---|  
|<xref:Microsoft.VisualBasic.VBFixedArrayAttribute.Bounds%2A>|<xref:Microsoft.VisualBasic.VBFixedArrayAttribute.Length%2A>|||  
  
## <a name="microsoftvisualbasicvbfixedstringattribute-class"></a><span data-ttu-id="20ec7-122">Microsoft. VisualBasic. VBFixedStringAttribute, Klasa</span><span class="sxs-lookup"><span data-stu-id="20ec7-122">Microsoft.VisualBasic.VBFixedStringAttribute Class</span></span>  
  
|||||  
|---|---|---|---|  
|<xref:Microsoft.VisualBasic.VBFixedStringAttribute.Length%2A>||||  
  
## <a name="microsoftvisualbasicvbmath-module"></a><span data-ttu-id="20ec7-123">Microsoft. VisualBasic. VbMath — moduł</span><span class="sxs-lookup"><span data-stu-id="20ec7-123">Microsoft.VisualBasic.VbMath Module</span></span>  
  
|||||  
|---|---|---|---|  
|<xref:Microsoft.VisualBasic.VBMath.Randomize%2A>|<xref:Microsoft.VisualBasic.VBMath.Rnd%2A>|||  
  
## <a name="microsoftvisualbasic-constants-and-enumerations"></a><span data-ttu-id="20ec7-124">Stałe i wyliczenia Microsoft. VisualBasic</span><span class="sxs-lookup"><span data-stu-id="20ec7-124">Microsoft.VisualBasic Constants and Enumerations</span></span>  

 <span data-ttu-id="20ec7-125">`Microsoft.VisualBasic`Przestrzeń nazw zawiera stałe i wyliczenia w ramach Visual Basic biblioteki wykonawczej.</span><span class="sxs-lookup"><span data-stu-id="20ec7-125">The `Microsoft.VisualBasic` namespace provides constants and enumerations as part of the Visual Basic run-time library.</span></span> <span data-ttu-id="20ec7-126">Możesz użyć tych stałych wartości w kodzie.</span><span class="sxs-lookup"><span data-stu-id="20ec7-126">You can use these constant values in your code.</span></span> <span data-ttu-id="20ec7-127">Każde Wyliczenie reprezentuje konkretną kategorię funkcji.</span><span class="sxs-lookup"><span data-stu-id="20ec7-127">Each enumeration represents a particular category of functionality.</span></span> <span data-ttu-id="20ec7-128">Aby uzyskać więcej informacji, zobacz [stałe i wyliczenia](constants-and-enumerations.md).</span><span class="sxs-lookup"><span data-stu-id="20ec7-128">For more information, see [Constants and Enumerations](constants-and-enumerations.md).</span></span>  
  
## <a name="see-also"></a><span data-ttu-id="20ec7-129">Zobacz też</span><span class="sxs-lookup"><span data-stu-id="20ec7-129">See also</span></span>

- [<span data-ttu-id="20ec7-130">Stałe i wyliczenia</span><span class="sxs-lookup"><span data-stu-id="20ec7-130">Constants and Enumerations</span></span>](constants-and-enumerations.md)
- [<span data-ttu-id="20ec7-131">Słowa kluczowe</span><span class="sxs-lookup"><span data-stu-id="20ec7-131">Keywords</span></span>](keywords/index.md)
