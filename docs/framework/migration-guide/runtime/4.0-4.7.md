...
---
# <a name="runtime-changes-for-migration-from-net-framework-40-to-47"></a>Zmiany środowiska uruchomieniowego do migracji z systemu .NET Framework 4.0 do 4.7

[!include[versionselector](../../../../includes/migration-guide/runtime/versionselector.md)]

[!include[introduction](../../../../includes/migration-guide/runtime/introduction.md)]

Jeśli w przypadku migracji z programu .NET Framework 4.0 do 4.7, należy przejrzeć następujące tematy dla problemów ze zgodnością aplikacji, które mogą wpływać na aplikację:
