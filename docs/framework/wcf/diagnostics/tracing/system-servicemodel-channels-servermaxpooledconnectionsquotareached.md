...
## <a name="description"></a>Opis  
 Został osiągnięty limit przydziału MaxOutboundConnectionsPerEndpoint, więc połączenie zostało zamknięte i nie jest ponownie przez odbiornik.  
