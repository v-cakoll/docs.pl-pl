...
ms.locfileid: "37071984"
---
# <a name="runtime-changes-for-migration-from-net-framework-45-to-462"></a><span data-ttu-id="9319d-102">Zmiany środowiska uruchomieniowego do migracji z systemu .NET Framework 4.5 do 4.6.2</span><span class="sxs-lookup"><span data-stu-id="9319d-102">Runtime Changes for Migration from .NET Framework 4.5 to 4.6.2</span></span>

[!INCLUDE[versionselector](../../../../includes/migration-guide/runtime/versionselector.md)]

[!INCLUDE[introduction](../../../../includes/migration-guide/runtime/introduction.md)]

<span data-ttu-id="9319d-103">Jeśli w przypadku migracji z programu .NET Framework 4.5 do 4.6.2, należy przejrzeć następujące tematy dla problemów ze zgodnością aplikacji, które mogą wpływać na aplikację:</span><span class="sxs-lookup"><span data-stu-id="9319d-103">If you are migrating from the .NET Framework 4.5 to 4.6.2, review the following topics for application compatibility issues that may affect your app:</span></span>

## <a name="adonet"></a><span data-ttu-id="9319d-104">ADO.NET</span><span class="sxs-lookup"><span data-stu-id="9319d-104">ADO.NET</span></span>
...
## <a name="aspnet"></a><span data-ttu-id="9319d-105">ASP.NET</span><span class="sxs-lookup"><span data-stu-id="9319d-105">ASP.NET</span></span>
...
## <a name="core"></a><span data-ttu-id="9319d-106">Core</span><span class="sxs-lookup"><span data-stu-id="9319d-106">Core</span></span>
...
## <a name="data"></a><span data-ttu-id="9319d-107">Dane</span><span class="sxs-lookup"><span data-stu-id="9319d-107">Data</span></span>
...
## <a name="debugger"></a><span data-ttu-id="9319d-108">Debugger</span><span class="sxs-lookup"><span data-stu-id="9319d-108">Debugger</span></span>
...
## <a name="entity-framework"></a><span data-ttu-id="9319d-109">Entity Framework</span><span class="sxs-lookup"><span data-stu-id="9319d-109">Entity Framework</span></span>
...
## <a name="globalization"></a><span data-ttu-id="9319d-110">Globalizacja</span><span class="sxs-lookup"><span data-stu-id="9319d-110">Globalization</span></span>
...
## <a name="networking"></a><span data-ttu-id="9319d-111">Sieć</span><span class="sxs-lookup"><span data-stu-id="9319d-111">Networking</span></span>
...
## <a name="security"></a><span data-ttu-id="9319d-112">Zabezpieczenia</span><span class="sxs-lookup"><span data-stu-id="9319d-112">Security</span></span>
...
## <a name="serialization"></a><span data-ttu-id="9319d-113">Serializacja</span><span class="sxs-lookup"><span data-stu-id="9319d-113">Serialization</span></span>
...
## <a name="setup-and-deployment"></a><span data-ttu-id="9319d-114">Instalacji i wdrażania</span><span class="sxs-lookup"><span data-stu-id="9319d-114">Setup and Deployment</span></span>
...
## <a name="tools"></a><span data-ttu-id="9319d-115">Narzędzia</span><span class="sxs-lookup"><span data-stu-id="9319d-115">Tools</span></span>

[!INCLUDE[Contract.Invariant or Contract.Requires<TException> do not consider String.IsNullOrEmpty to be pure](~/includes/migration-guide/runtime/tools/contractinvariant-contractrequirestexception-do-not-consider.md)]

## <a name="windows-communication-foundation-wcf"></a><span data-ttu-id="9319d-116">Windows Communication Foundation (WCF)</span><span class="sxs-lookup"><span data-stu-id="9319d-116">Windows Communication Foundation (WCF)</span></span>
...
## <a name="windows-presentation-foundation-wpf"></a><span data-ttu-id="9319d-117">Program Windows Presentation Foundation (WPF)</span><span class="sxs-lookup"><span data-stu-id="9319d-117">Windows Presentation Foundation (WPF)</span></span>
