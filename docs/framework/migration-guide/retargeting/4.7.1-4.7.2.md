---
title: Zmiany retargetingu migracji z systemu .NET Framework 4.7.1 i 4.7.2
ms.date: 04/27/2018
...
ms.locfileid: "37070814"
---
# <a name="retargeting-changes-for-migration-from-net-framework-471-to-472"></a><span data-ttu-id="6a94e-102">Zmiany retargetingu migracji z systemu .NET Framework 4.7.1 i 4.7.2</span><span class="sxs-lookup"><span data-stu-id="6a94e-102">Retargeting Changes for Migration from .NET Framework 4.7.1 to 4.7.2</span></span>

[!INCLUDE[versionselector](../../../../includes/migration-guide/retargeting/versionselector.md)]

[!INCLUDE[introduction](../../../../includes/migration-guide/retargeting/introduction.md)]

<span data-ttu-id="6a94e-103">W przypadku migracji z programu .NET Framework 4.7.1 i 4.7.2 Przejrzyj następujące tematy dotyczące problemów ze zgodnością aplikacji, które mogą wpływać na aplikację:</span><span class="sxs-lookup"><span data-stu-id="6a94e-103">If you are migrating from the .NET Framework 4.7.1 to 4.7.2, review the following topics for application compatibility issues that may affect your app:</span></span>

## <a name="core"></a><span data-ttu-id="6a94e-104">Core</span><span class="sxs-lookup"><span data-stu-id="6a94e-104">Core</span></span>
...
## <a name="windows-forms"></a><span data-ttu-id="6a94e-105">Program Windows Forms</span><span class="sxs-lookup"><span data-stu-id="6a94e-105">Windows Forms</span></span>
...
## <a name="windows-presentation-foundation-wpf"></a><span data-ttu-id="6a94e-106">Program Windows Presentation Foundation (WPF)</span><span class="sxs-lookup"><span data-stu-id="6a94e-106">Windows Presentation Foundation (WPF)</span></span>
...
## <a name="windows-workflow-foundation-wf"></a><span data-ttu-id="6a94e-107">Program Windows Workflow Foundation (WF)</span><span class="sxs-lookup"><span data-stu-id="6a94e-107">Windows Workflow Foundation (WF)</span></span>
