...
---
# <a name="runtime-changes-for-migration-from-net-framework-40-to-452"></a>Zmiany środowiska uruchomieniowego do migracji z .NET Framework 4.0 i 4.5.2

[!INCLUDE[versionselector](../../../../includes/migration-guide/runtime/versionselector.md)]

[!INCLUDE[introduction](../../../../includes/migration-guide/runtime/introduction.md)]

Migracji z programu .NET Framework 4.0 do 4.5.2, przejrzyj problemy ze zgodnością aplikacji, które mogą wpływać na Twoją aplikację w poniższych tematach:
