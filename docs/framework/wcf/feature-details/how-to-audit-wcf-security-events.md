...
[!INCLUDE[indigo1](../../../../includes/indigo1-md.md)]Umożliwia rejestrowanie zdarzeń zabezpieczeń w dzienniku zdarzeń systemu Windows można wyświetlić za pomocą Podglądu zdarzeń systemu Windows. W tym temacie wyjaśniono, jak skonfigurować aplikację tak, aby go dzienniki zdarzeń zabezpieczeń. [!INCLUDE[crabout](../../../../includes/crabout-md.md)][!INCLUDE[indigo2](../../../../includes/indigo2-md.md)] inspekcji, zobacz [inspekcji](../../../../docs/framework/wcf/feature-details/auditing-security-events.md).  
