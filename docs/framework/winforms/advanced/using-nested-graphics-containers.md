...
## <a name="clipping-in-nested-containers"></a>Przycinanie zagnieżdżone kontenery  
 ...
 Poniższa ilustracja przedstawia dwa wiersze obciętych.  
  
 ![Zagnieżdżone kontenera](./media/nestedcontainers2.png "nestedcontainers2")  
...
## <a name="several-layers-of-nested-containers"></a>Kilka warstw zagnieżdżone kontenery  
 ...
 ![Zagnieżdżone kontenery](./media/nestedcontainers3.png "nestedcontainers3")  
