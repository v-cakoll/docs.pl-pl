...
---
# <a name="using-the-iteration-variable-in-a-query-expression-may-have-unexpected-results"></a>Użycie zmiennej iteracji w wyrażeniu zapytania może spowodować nieoczekiwane wyniki.
