...
## <a name="parameters"></a>Parametry  
 ...
 `dwImplFlags`  
 podczas Kombinacja wartości wyliczenia [CorMethodImpl —](../../../../docs/framework/unmanaged-api/metadata/cormethodimpl-enumeration.md) , która określa funkcje implementacji metody.  
