...
|Temat|Opis|  
|-----------|-----------------|  
|[LINQ do programowania w języku XML-Przegląd (Visual Basic)](../../../../visual-basic/programming-guide/concepts/linq/linq-to-xml-programming-overview.md)|Zawiera omówienie [!INCLUDE[sqltecxlinq](~/includes/sqltecxlinq-md.md)] klasy i szczegółowe informacje na temat trzy najważniejsze klas: <xref:System.Xml.Linq.XElement>, <xref:System.Xml.Linq.XAttribute>, i <xref:System.Xml.Linq.XDocument>.|  
|[Tworzenie drzewa XML (Visual Basic)](../../../../visual-basic/programming-guide/concepts/linq/creating-xml-trees.md)|Zawiera informacje koncepcyjne i oparty na zadaniach dotyczących tworzenia drzewa XML. Można utworzyć drzewa XML za pomocą funkcjonalności konstruowania lub za analizowanie tekstu XML z ciągu lub pliku. Można również użyć <xref:System.Xml.XmlReader> do wypełnienia drzewo XML.|  
|[Praca z przestrzeni nazw XML (Visual Basic)](../../../../visual-basic/programming-guide/concepts/linq/working-with-xml-namespaces.md)|Zawiera szczegółowe informacje o tworzeniu drzew XML, które używają przestrzenie nazw.|  
|[Serializacja drzewa XML (Visual Basic)](../../../../visual-basic/programming-guide/concepts/linq/serializing-xml-trees.md)|Opisano wiele sposobów serializacji drzewo XML i zawiera wskazówki dotyczące rozwiązania do użycia.|  
|[LINQ do osi XML (Visual Basic)](../../../../visual-basic/programming-guide/concepts/linq/linq-to-xml-axes.md)|Wylicza oraz opis [!INCLUDE[sqltecxlinq](~/includes/sqltecxlinq-md.md)] osi metody, które należy poznać przed przystąpieniem do napisania [!INCLUDE[sqltecxlinq](~/includes/sqltecxlinq-md.md)] zapytania.|  
|[Wykonywanie zapytania drzewa XML (Visual Basic)](../../../../visual-basic/programming-guide/concepts/linq/querying-xml-trees.md)|Przykłady typowych kwerendy drzewa XML.|  
