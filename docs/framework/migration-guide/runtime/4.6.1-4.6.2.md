...
---
# <a name="runtime-changes-for-migration-from-net-framework-461-to-462"></a>Zmiany środowiska uruchomieniowego w przypadku migracji z .NET Framework 4.6.1 i 4.6.2

[!INCLUDE[versionselector](../../../../includes/migration-guide/runtime/versionselector.md)]

[!INCLUDE[introduction](../../../../includes/migration-guide/runtime/introduction.md)]

W przypadku migracji z programu .NET Framework 4.6.1 i 4.6.2, zobacz następujące tematy dla problemów ze zgodnością aplikacji, które mogą wpływać na Twoją aplikację:
