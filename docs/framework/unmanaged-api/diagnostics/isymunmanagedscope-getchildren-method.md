...
## <a name="parameters"></a>Parametry  
 `cChildren`  
 podczas `ULONG32`, który wskazuje rozmiar tablicy `children`.  
  
 `pcChildren`  
 określoną Wskaźnik do `ULONG32`, który odbiera rozmiar buforu wymaganego do zawierania elementów podrzędnych.  
