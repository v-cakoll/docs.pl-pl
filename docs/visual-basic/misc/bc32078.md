...
Zdarzenia ogólne, właściwość lub procedura próbuje zaimplementować członka podobne zdefiniowane w interfejsie, ale mają one różne ograniczenia list na ich parametrów typu.  
 ...
 Aby uzyskać więcej informacji o implementacji interfejsu, zobacz [NOT IN kompilacji: Implements — słowo kluczowe i Implements — instrukcja](http://msdn.microsoft.com/en-us/b96560f7-6413-480f-a1e2-f80253bab5be).  
...
## <a name="see-also"></a>Zobacz też  
 ...
 [NIE w kompilacji: Przykłady implementacji interfejsu w języku Visual Basic](http://msdn.microsoft.com/en-us/50bf2a30-73b6-4126-a921-075fd6eec278)
