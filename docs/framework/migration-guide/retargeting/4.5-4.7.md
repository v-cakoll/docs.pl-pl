---
title: Przekierowywanie zmian dotyczących migracji z .NET Framework 4,5 do 4,7
description: Znajdź informacje o problemach ze zgodnością aplikacji, które mogą mieć wpływ na aplikację podczas migracji z .NET Framework 4,5 do 4,7.
ms.date: 07/10/2019
...
ms.locfileid: "86444342"
---
# <a name="retargeting-changes-for-migration-from-net-framework-45-to-47"></a><span data-ttu-id="0ee89-103">Przekierowywanie zmian dotyczących migracji z .NET Framework 4,5 do 4,7</span><span class="sxs-lookup"><span data-stu-id="0ee89-103">Retargeting Changes for Migration from .NET Framework 4.5 to 4.7</span></span>

[!INCLUDE[versionselector](../../../../includes/migration-guide/retargeting/versionselector.md)]

<span data-ttu-id="0ee89-104">W przypadku migrowania z .NET Framework 4,5 do 4,7 zapoznaj się z następującymi tematami dotyczącymi problemów ze zgodnością aplikacji, które mogą mieć wpływ na aplikację:</span><span class="sxs-lookup"><span data-stu-id="0ee89-104">If you are migrating from the .NET Framework 4.5 to 4.7, review the following topics for application compatibility issues that may affect your app:</span></span>

## <a name="adonet"></a><span data-ttu-id="0ee89-105">ADO.NET</span><span class="sxs-lookup"><span data-stu-id="0ee89-105">ADO.NET</span></span>
...
## <a name="aspnet"></a><span data-ttu-id="0ee89-106">ASP.NET</span><span class="sxs-lookup"><span data-stu-id="0ee89-106">ASP.NET</span></span>
...
## <a name="clickonce"></a><span data-ttu-id="0ee89-107">ClickOnce</span><span class="sxs-lookup"><span data-stu-id="0ee89-107">ClickOnce</span></span>
...
## <a name="core"></a><span data-ttu-id="0ee89-108">Core</span><span class="sxs-lookup"><span data-stu-id="0ee89-108">Core</span></span>
...
## <a name="jit"></a><span data-ttu-id="0ee89-109">JIT</span><span class="sxs-lookup"><span data-stu-id="0ee89-109">JIT</span></span>
...
## <a name="msbuild"></a><span data-ttu-id="0ee89-110">MSBuild</span><span class="sxs-lookup"><span data-stu-id="0ee89-110">MSBuild</span></span>
...
## <a name="networking"></a><span data-ttu-id="0ee89-111">Sieć</span><span class="sxs-lookup"><span data-stu-id="0ee89-111">Networking</span></span>
...
## <a name="security"></a><span data-ttu-id="0ee89-112">Zabezpieczenia</span><span class="sxs-lookup"><span data-stu-id="0ee89-112">Security</span></span>
...
## <a name="visual-basic-net"></a><span data-ttu-id="0ee89-113">Visual Basic .NET</span><span class="sxs-lookup"><span data-stu-id="0ee89-113">Visual Basic .NET</span></span>

[!INCLUDE[VB.NET no longer supports partial namespace qualification for System.Windows APIs](~/includes/migration-guide/retargeting/vb/vbnet-no-longer-supports-partial-namespace-qualification-for-systemwindows.md)]

## <a name="windows-communication-foundation-wcf"></a><span data-ttu-id="0ee89-114">Windows Communication Foundation (WCF)</span><span class="sxs-lookup"><span data-stu-id="0ee89-114">Windows Communication Foundation (WCF)</span></span>
...
## <a name="windows-forms"></a><span data-ttu-id="0ee89-115">Windows Forms</span><span class="sxs-lookup"><span data-stu-id="0ee89-115">Windows Forms</span></span>
...
## <a name="windows-presentation-foundation-wpf"></a><span data-ttu-id="0ee89-116">Windows Presentation Foundation (WPF)</span><span class="sxs-lookup"><span data-stu-id="0ee89-116">Windows Presentation Foundation (WPF)</span></span>
...
## <a name="windows-workflow-foundation-wf"></a><span data-ttu-id="0ee89-117">Program Windows Workflow Foundation (WF)</span><span class="sxs-lookup"><span data-stu-id="0ee89-117">Windows Workflow Foundation (WF)</span></span>
...
## <a name="xml-xslt"></a><span data-ttu-id="0ee89-118">Języki XML, XSLT</span><span class="sxs-lookup"><span data-stu-id="0ee89-118">XML, XSLT</span></span>
