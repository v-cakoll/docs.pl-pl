...
Domyślnie nazwa elementu XML jest określana przez nazwę klasy lub składowej. W prostej klasie o `Book`nazwie pole o nazwie `ISBN` będzie generować tag \<elementu XML>, jak pokazano w poniższym przykładzie.
