...
---
# <a name="runtime-changes-for-migration-from-net-framework-461-to-472"></a>Zmiany środowiska uruchomieniowego do migracji z systemu .NET Framework 4.6.1 do 4.7.2
