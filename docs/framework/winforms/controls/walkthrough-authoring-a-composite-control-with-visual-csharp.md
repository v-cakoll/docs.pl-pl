...
2.  Wybierz z listy projektów Visual C#, **Biblioteka formantów formularzy systemu Windows** szablon projektu, typ `ctlClockLib` w **nazwa** , a następnie kliknij przycisk **OK**.  
