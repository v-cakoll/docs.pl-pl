...
---
# <a name="runtime-changes-for-migration-from-net-framework-461-to-47"></a>Zmiany środowiska uruchomieniowego do migracji z .NET Framework 4.6.1 i 4.7

[!INCLUDE[versionselector](../../../../includes/migration-guide/runtime/versionselector.md)]

[!INCLUDE[introduction](../../../../includes/migration-guide/runtime/introduction.md)]

Migracji z programu .NET Framework 4.6.1 i 4.7, przejrzyj problemy ze zgodnością aplikacji, które mogą wpływać na Twoją aplikację w poniższych tematach:
