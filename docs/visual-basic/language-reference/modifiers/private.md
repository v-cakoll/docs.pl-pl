...
- [](./protected-friend.md)[Poziomy dostępu do chronionych znajomych w Visual Basic](../../../visual-basic/programming-guide/language-features/declared-elements/access-levels.md)
