...
ms.locfileid: "54532001"
---
# <a name="microsofttransactionstransactionbridgeprotocolstarted"></a>Microsoft.Transactions.TransactionBridge.ProtocolStarted
Uruchomiono usługę protokołu WS-Atomic Transaction.  
  
## <a name="description"></a>Opis  
 Śledzone podczas uruchamiania Menedżera transakcji, aby wskazać, który protokół zostało uruchomione pomyślnie.  
