...
## <a name="to-correct-this-error"></a><span data-ttu-id="6733a-104">Aby poprawić ten błąd</span><span class="sxs-lookup"><span data-stu-id="6733a-104">To correct this error</span></span>  
  
-   <span data-ttu-id="6733a-105">Usuń literę dysku ze ścieżki plików.</span><span class="sxs-lookup"><span data-stu-id="6733a-105">Remove the drive letter from the file path.</span></span>