...
3.  Informacje o wersji należy przypisać do używanego zestawu. Aby uzyskać więcej informacji, zobacz [przechowywanie wersji zestawu](https://msdn.microsoft.com/library/51ket42z).  
