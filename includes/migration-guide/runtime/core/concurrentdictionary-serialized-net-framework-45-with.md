### <a name="a-concurrentdictionary-serialized-in-net-framework-45-with-netdatacontractserializer-cannot-be-deserialized-by-net-framework-451-or-452"></a>Obiekt ConcurrentDictionary zserializowane w .NET Framework 4.5 z NetDataContractSerializer nie można przeprowadzić deserializacji przez program .NET Framework 4.5.1 lub 4.5.2
