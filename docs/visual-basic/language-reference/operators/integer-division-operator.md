...
## <a name="result"></a>Wynik  
 Wynikiem jest iloraz wartości całkowitej `expression1` podzielony przez `expression2`, która odrzuca resztę i zachowuje tylko część całkowitą. Jest to tzw. *obcinanie*.  
