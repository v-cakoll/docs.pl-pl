...
ms.locfileid: "68237898"
---
# <a name="runtime-changes-for-migration-from-net-framework-461-to-462"></a><span data-ttu-id="daea9-102">Zmiany środowiska uruchomieniowego w przypadku migracji z .NET Framework 4.6.1 i 4.6.2</span><span class="sxs-lookup"><span data-stu-id="daea9-102">Runtime Changes for Migration from .NET Framework 4.6.1 to 4.6.2</span></span>

[!INCLUDE[versionselector](../../../../includes/migration-guide/runtime/versionselector.md)]

[!INCLUDE[introduction](../../../../includes/migration-guide/runtime/introduction.md)]

<span data-ttu-id="daea9-103">W przypadku migracji z programu .NET Framework 4.6.1 i 4.6.2, zobacz następujące tematy dla problemów ze zgodnością aplikacji, które mogą wpływać na Twoją aplikację:</span><span class="sxs-lookup"><span data-stu-id="daea9-103">If you are migrating from the .NET Framework 4.6.1 to 4.6.2, review the following topics for application compatibility issues that may affect your app:</span></span>

## <a name="data"></a><span data-ttu-id="daea9-104">Dane</span><span class="sxs-lookup"><span data-stu-id="daea9-104">Data</span></span>
...
## <a name="globalization"></a><span data-ttu-id="daea9-105">Globalizacja</span><span class="sxs-lookup"><span data-stu-id="daea9-105">Globalization</span></span>
...
## <a name="security"></a><span data-ttu-id="daea9-106">Zabezpieczenia</span><span class="sxs-lookup"><span data-stu-id="daea9-106">Security</span></span>
...
## <a name="windows-communication-foundation-wcf"></a><span data-ttu-id="daea9-107">Windows Communication Foundation (WCF)</span><span class="sxs-lookup"><span data-stu-id="daea9-107">Windows Communication Foundation (WCF)</span></span>
...
## <a name="windows-presentation-foundation-wpf"></a><span data-ttu-id="daea9-108">Windows Presentation Foundation (WPF)</span><span class="sxs-lookup"><span data-stu-id="daea9-108">Windows Presentation Foundation (WPF)</span></span>
