...
-   *\<SystemColor>* ColorKey  
 ...
 Kolor systemu jest <xref:System.Windows.Media.Color> strukturę, która może służyć do konfigurowania pędzla. Na przykład można utworzyć przy użyciu kolorów systemowych, ustawiając gradientu <xref:System.Windows.Media.GradientStop.Color%2A> właściwości <xref:System.Windows.Media.LinearGradientBrush> ograniczniki gradientu obiektu za pomocą kolorów systemowych. Aby uzyskać przykład, zobacz [Użyj kolorów systemowych w gradiencie](../../../../docs/framework/wpf/graphics-multimedia/how-to-use-system-colors-in-a-gradient.md).  
...
## <a name="example"></a>Przykład  
 ...
 Na przykład przedstawiający sposób użycia kolorów systemowych w gradiencie zobacz [Użyj kolorów systemowych w gradiencie](../../../../docs/framework/wpf/graphics-multimedia/how-to-use-system-colors-in-a-gradient.md).  
