...
```
 ...
 Konfiguracja usługi zawiera następujące właściwości trujących komunikatów: `receiveRetryCount`, `maxRetryCycles`, `retryCycleDelay`i `receiveErrorHandling`, jak pokazano w poniższym pliku konfiguracyjnym.
