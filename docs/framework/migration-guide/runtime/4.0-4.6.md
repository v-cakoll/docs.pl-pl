...
---
# <a name="runtime-changes-for-migration-from-net-framework-40-to-46"></a>Zmiany środowiska uruchomieniowego do migracji z platformy .NET Framework 4.0 lub 4.6
