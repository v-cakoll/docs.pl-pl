...
Ta lokacja zawiera [specyfikację Visual Basic 11](../../../../_vblang/spec/introduction.md). Jest on skompilowany na podstawie plików promocji zawartych w [repozytorium dotnet/vblang](https://github.com/dotnet/vblang/blob/master/spec/README.md)w witrynie GitHub.
