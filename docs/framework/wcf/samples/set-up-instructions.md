...
Ten zbiór tematów zawiera opis sposobu konfigurowania usług, które są wymagane do uruchamiania usługi Windows Communication Foundation (WCF).  
...
## <a name="in-this-section"></a>W tej sekcji  
 ...
 Omówiono kroki wymagane do skonfigurowania zapory systemu Windows do usług WCF funkcji.  
 ...
 Opisano kroki umożliwiające tworzenie, przykładów programu WCF.  
  
 [Uruchamianie przykładów programu Windows Communication Foundation](../../../../docs/framework/wcf/samples/running-the-samples.md)  
 Opisano kroki dotyczące uruchamiania przykładów programu WCF na tym samym komputerze i na komputerach.  
  
 [Włączanie usług równorzędnych](http://msdn.microsoft.com/library/e7a0fcf4-b0e5-4b26-a7e3-f0f37b60a1f9)  
 Zawiera opis czynności w celu zainstalowania składnika Windows Peer-to-Peer, wbudowany mechanizm rozpoznawania dla usług obsługi wiadomości peer-to-peer.  
  
 [Instalowanie usługi kolejkowania komunikatów (MSMQ)](../../../../docs/framework/wcf/samples/installing-message-queuing-msmq.md)  
 Opisano czynności związane z instalowaniem usługi kolejkowania komunikatów.  
