...
Obiekt `My.Computer.FileSystem` udostępnia narzędzia do pracy z plikami i folderami. Jego właściwości, metody i zdarzenia umożliwiają tworzenie, kopiowanie, przenoszenie, badanie i usuwanie plików i folderów. `My.Computer.FileSystem`zapewnia lepszą wydajność niż`FileOpen`starsze `FileClose` `Input`funkcje ( , , `InputString`, , `LineInput`itp.), które są dostarczane przez program Visual Basic w celu zapewnienia zgodności z powrotem.  
  
## <a name="in-this-section"></a>W tej sekcji  

 [Odczyt z plików](../../../../visual-basic/developing-apps/programming/drives-directories-files/reading-from-files.md)  
 Wyświetla listę tematów `My.Computer.FileSystem` dotyczących używania obiektu do odczytywania z plików  
  
 [Zapisywanie w plikach](../../../../visual-basic/developing-apps/programming/drives-directories-files/writing-to-files.md)  
 Wyświetla listę tematów `My.Computer.FileSystem` dotyczących używania obiektu do zapisywania w plikach  
 ...
 Wyświetla listę tematów `My.Computer.FileSystem` dotyczących używania obiektu do tworzenia, kopiowania, usuwania i przenoszenia plików i folderów.  
 ...
 W tym artykule `TextFieldReader` omówiono sposób korzystania z do analizowania plików tekstowych, takich jak dzienniki.  
  
 [Kodowanie pliku](../../../../visual-basic/developing-apps/programming/drives-directories-files/file-encodings.md)  
 Opisuje kodowanie plików i ich użycie.  
 ...
 Pokazuje, jak utworzyć narzędzie, które raportuje informacje o plikach i folderach.  
 ...
 Wyświetla listę typowych problemów napotkanych podczas czytania i zapisywania do plików tekstowych i sugeruje środki zaradcze dla każdego z nich.
