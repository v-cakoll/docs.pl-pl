...
---
# <a name="compiler-error-cs0731"></a>Błąd kompilatora CS0731
Typ usługi przesyłania dla typu "type" w zestawie "assembly" powoduje wystąpienie cyklu  
  
 Ten błąd może wystąpić tylko pracując z niepoprawnie sformułowanymi importowanymi metadanymi. Nie można go otrzymać korzystając z samego źródła języka C#.  
  
## <a name="example"></a>Przykład  
 Poniższy przykład generuje CS0731. Przykład obejmuje trzy pliki:  
 ...
 Najpierw skompiluj pliki .IL jako biblioteki, a następnie kod .cs odwołujący się do dwóch plików. 
