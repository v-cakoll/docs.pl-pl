...
|Uzyskiwanie dostępu do elementów zasobów.|[My.Resources, obiekt](../../../visual-basic/language-reference/objects/my-resources-object.md)|  
|Dostęp do bieżącej odpowiedzi sieci web.|[My.Response, obiekt](../../../visual-basic/language-reference/objects/my-response-object.md)|  
|Uzyskiwanie dostępu do ustawienia na poziomie użytkownika i aplikacji.|[My.Settings, obiekt](../../../visual-basic/language-reference/objects/my-settings-object.md)|  
...
|Uzyskiwanie dostępu do usług XML sieci Web odwołuje się do bieżącego projektu.|[My.WebServices, obiekt](../../../visual-basic/language-reference/objects/my-webservices-object.md)|  
