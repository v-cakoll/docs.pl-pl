...
Parametr typu jest używana jako argument dla [operatora Is](../../visual-basic/language-reference/operators/is-operator.md) Jeśli parametr typu jest zdefiniowana bez [klasy (Visual Basic)](https://msdn.microsoft.com/library/0777c6e6-46bc-451b-ad70-57b49d4ef4f7) — słowo kluczowe lub nazwa klasy określonych na liście ograniczeń.  
