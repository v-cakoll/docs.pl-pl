...
Wszystko, co jest standardowe, z wyjątkiem właściwości `data`. Możesz sprawdzić komunikat i użyć `eventType` i `dataVersion` do deserializacji niestandardowej części ładunku.
