...
---
# <a name="plinq-data-sample"></a><span data-ttu-id="2acb8-102">Próbka danych PLINQ</span><span class="sxs-lookup"><span data-stu-id="2acb8-102">PLINQ Data Sample</span></span>
<span data-ttu-id="2acb8-103">Ten przykład zawiera przykładowe dane w formacie csv, wraz z metodami, które przekształcają go w kolekcje w pamięci klientów, produkty, zamówienia i szczegóły zamówienia.</span><span class="sxs-lookup"><span data-stu-id="2acb8-103">This sample contains example data in .csv format, together with methods that transform it into in-memory collections of Customers, Products, Orders, and Order Details.</span></span> <span data-ttu-id="2acb8-104">Aby dalej eksperymentować z PLINQ, można wkleić przykłady kodu z niektórych `Main` innych tematów do kodu w tym temacie i wywołać go z metody.</span><span class="sxs-lookup"><span data-stu-id="2acb8-104">To further experiment with PLINQ, you can paste code examples from certain other topics into the code in this topic and invoke it from the `Main` method.</span></span> <span data-ttu-id="2acb8-105">Można również użyć tych danych z własnymi zapytaniami PLINQ.</span><span class="sxs-lookup"><span data-stu-id="2acb8-105">You can also use this data with your own PLINQ queries.</span></span>  
  
 <span data-ttu-id="2acb8-106">Dane reprezentują podzbiór bazy danych Northwind.</span><span class="sxs-lookup"><span data-stu-id="2acb8-106">The data represents a subset of the Northwind database.</span></span> <span data-ttu-id="2acb8-107">Uwzględniono pięćdziesiąt (50) rekordów odbiorców, ale nie wszystkie pola.</span><span class="sxs-lookup"><span data-stu-id="2acb8-107">Fifty (50) customer records are included, but not all fields.</span></span> <span data-ttu-id="2acb8-108">Uwzględniono podzbiór wierszy z Zamówień i odpowiadające im dane Order_Detail dla każdego Klienta.</span><span class="sxs-lookup"><span data-stu-id="2acb8-108">A subset of the rows from the Orders and corresponding Order_Detail data for every Customer is included.</span></span> <span data-ttu-id="2acb8-109">Wszystkie produkty są wliczone w cenę.</span><span class="sxs-lookup"><span data-stu-id="2acb8-109">All Products are included.</span></span>  
  
> [!NOTE]
> <span data-ttu-id="2acb8-110">Zestaw danych nie jest wystarczająco duży, aby wykazać, że PLINQ jest szybszy niż LINQ do obiektów dla kwerend, które zawierają tylko podstawowe `where` i `select` klauzule.</span><span class="sxs-lookup"><span data-stu-id="2acb8-110">The data set is not large enough to demonstrate that PLINQ is faster than LINQ to Objects for queries that contain just basic `where` and `select` clauses.</span></span> <span data-ttu-id="2acb8-111">Aby zaobserwować wzrost szybkości dla małych zestawów danych, takich jak ten, należy użyć kwerend, które zawierają obliczeniowo kosztowne operacje na każdym elemencie w zestawie danych.</span><span class="sxs-lookup"><span data-stu-id="2acb8-111">To observe speed increases for small data sets such as this, use queries that contain computationally expensive operations on every element in the data set.</span></span>  
  
### <a name="to-set-up-this-sample"></a><span data-ttu-id="2acb8-112">Aby skonfigurować tę próbkę</span><span class="sxs-lookup"><span data-stu-id="2acb8-112">To set up this sample</span></span>  
  
1. <span data-ttu-id="2acb8-113">Tworzenie projektu aplikacji konsoli Visual Basic lub Visual C#.</span><span class="sxs-lookup"><span data-stu-id="2acb8-113">Create a Visual Basic or Visual C# console application project.</span></span>  
  
2. <span data-ttu-id="2acb8-114">Zastąp zawartość module1.vb lub Program.cs, używając kodu, który następuje po wykonaniu tych kroków.</span><span class="sxs-lookup"><span data-stu-id="2acb8-114">Replace the contents of Module1.vb or Program.cs by using the code that follows these steps.</span></span>  
  
3. <span data-ttu-id="2acb8-115">W menu **Projekt** kliknij polecenie **Dodaj nowy element**.</span><span class="sxs-lookup"><span data-stu-id="2acb8-115">On the **Project** menu, click **Add New Item**.</span></span> <span data-ttu-id="2acb8-116">Zaznacz pozycję **Plik tekstowy,** a następnie kliknij przycisk **OK**.</span><span class="sxs-lookup"><span data-stu-id="2acb8-116">Select **Text File** and then click **OK**.</span></span> <span data-ttu-id="2acb8-117">Skopiuj dane w tym temacie, a następnie wklej go do nowego pliku tekstowego.</span><span class="sxs-lookup"><span data-stu-id="2acb8-117">Copy the data in this topic and then paste it in the new text file.</span></span> <span data-ttu-id="2acb8-118">W menu **Plik** kliknij polecenie **Zapisz**, nazwij plik Plinqdata.csv, a następnie zapisz go w folderze zawierającym pliki kodu źródłowego.</span><span class="sxs-lookup"><span data-stu-id="2acb8-118">On the **File** menu, click **Save**, name the file Plinqdata.csv, and then save it in the folder that contains your source code files.</span></span>  
  
4. <span data-ttu-id="2acb8-119">Naciśnij klawisz F5, aby sprawdzić, czy projekt tworzy i działa poprawnie.</span><span class="sxs-lookup"><span data-stu-id="2acb8-119">Press F5 to verify that the project builds and runs correctly.</span></span> <span data-ttu-id="2acb8-120">W oknie konsoli powinny być wyświetlane następujące dane wyjściowe.</span><span class="sxs-lookup"><span data-stu-id="2acb8-120">The following output should be displayed in the console window.</span></span>  
...
## <a name="data"></a><span data-ttu-id="2acb8-121">Dane</span><span class="sxs-lookup"><span data-stu-id="2acb8-121">Data</span></span>  
...
## <a name="see-also"></a><span data-ttu-id="2acb8-122">Zobacz też</span><span class="sxs-lookup"><span data-stu-id="2acb8-122">See also</span></span>

- [<span data-ttu-id="2acb8-123">Równoległe LINQ (PLINQ)</span><span class="sxs-lookup"><span data-stu-id="2acb8-123">Parallel LINQ (PLINQ)</span></span>](../../../docs/standard/parallel-programming/introduction-to-plinq.md)
