...
## <a name="remarks"></a>Uwagi  
 ...
 Po ustawieniu na `Option Infer` `On`wartość można zadeklarować zmienne lokalne bez jawnego wypełniania typu danych. Kompilator wnioskuje typ danych zmiennej z typu wyrażenia inicjującego.  
...
> [!NOTE]
> Gdy zmienna jest zadeklarowana jako `Object`, typ czasu wykonywania może ulec zmianie, gdy program jest uruchomiony. Visual Basic wykonuje operacje nazywane opakowaniem i rozpakowywaniem w celu `Object` konwersji między i typu wartości, co powoduje wolniejsze wykonywanie. Aby uzyskać informacje na temat pakowania i rozpakowywania, zobacz [Specyfikacja języka Visual Basic](~/_vblang/spec/conversions.md#value-type-conversions).
...
## <a name="example"></a>Przykład  
 W poniższych przykładach pokazano, `Option Infer` jak instrukcja włącza wnioskowanie typu lokalnego.  
