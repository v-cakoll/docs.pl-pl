...
Niszczy PInvoke organizowanie podpisu metadanych dla obiekt odwołuje się określony token.  
...
#### <a name="parameters"></a>Parametry  
 `tk`  
 [in] `mdFieldDef` Lub `mdParamDef` token, który reprezentuje pole lub parametr, dla której chcesz usunąć kierowania podpisu metadanych.  
