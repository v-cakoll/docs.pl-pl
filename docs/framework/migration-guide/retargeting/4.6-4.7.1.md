...
---
# <a name="retargeting-changes-for-migration-from-net-framework-46-to-471"></a>Zmiany retargetingu dla migracji z programu .NET Framework 4.6 do 4.7.1

[!INCLUDE[versionselector](../../../../includes/migration-guide/retargeting/versionselector.md)]

W przypadku migracji z programu .NET Framework 4.6 do 4.7.1 zapoznaj się z następującymi tematami dotyczącymi problemów ze zgodnością aplikacji, które mogą mieć wpływ na aplikację:
