...
|`&#124;(([0-9a-z]`|Jeśli pierwszy znak nie jest znak cudzysłowu, dopasowuje dowolny znak alfabetyczne, od do z i od A do Z (porównanie nie uwzględnia wielkości liter) lub dowolnego znaku numerycznego od 0 do 9.|  
...
|``&#124;[-!#\$%&'\*\+/=\?\^`{}\&#124;~\w]``|Jeśli następny znak nie jest okres, zgodne dowolny znak słowa lub jeden z następujących znaków:-! #$%'*+=?^'{} &#124; ~.|  
|``((\.(?!\.))&#124;[-!#\$%'\*\+/=\?\^`{}\&#124;~\w])*``|Jest zgodna z wzorcem wyrażenia warunkowe (okres następuje z systemem innym niż okres lub jeden z wielu znaków) zero lub więcej razy.|  
|`@`|Dopasowanie znaku @.|  
