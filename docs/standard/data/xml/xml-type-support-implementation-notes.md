...
> [!NOTE]
>  `xs` Prefiks jest zamapowana http://www.w3.org/2001/XMLSchema i identyfikator URI przestrzeni nazw.  
...
### <a name="systemtimespan-and-xsduration"></a>Obiekt System.TimeSpan i DURATION  
 ...
 Aby uzyskać więcej informacji na temat `xs:duration` typu, zobacz część 2 W3C XML schematu: typy danych zalecenie w http://www.w3.org/TR/xmlschema-2/.  
