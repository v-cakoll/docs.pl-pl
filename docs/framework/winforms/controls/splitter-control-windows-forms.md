...
> [!NOTE]
>  Mimo że <xref:System.Windows.Forms.SplitContainer> zastępuje i dodaje funkcje do `Splitter` kontrolę nad poprzednie wersje `Splitter` są przechowywane dla zgodności z poprzednimi wersjami i użycia w przyszłości, jeśli zostanie wybrana.  
  
## <a name="in-this-section"></a>W tej sekcji  
 [Splitter, kontrolka — omówienie](../../../../docs/framework/winforms/controls/splitter-control-overview-windows-forms.md)  
