...
ms.locfileid: "54558608"
---
# <a name="sample-xml-file-customers-and-orders-in-a-namespace"></a><span data-ttu-id="8aab1-102">Przykładowy plik XML: Klienci i zamówienia w Namespace</span><span class="sxs-lookup"><span data-stu-id="8aab1-102">Sample XML File: Customers and Orders in a Namespace</span></span>
<span data-ttu-id="8aab1-103">Następujący plik XML jest używany w różne przykłady w [!INCLUDE[sqltecxlinq](~/includes/sqltecxlinq-md.md)] dokumentacji.</span><span class="sxs-lookup"><span data-stu-id="8aab1-103">The following XML file is used in various examples in the [!INCLUDE[sqltecxlinq](~/includes/sqltecxlinq-md.md)] documentation.</span></span> <span data-ttu-id="8aab1-104">Ten plik zawiera klienci i zamówienia.</span><span class="sxs-lookup"><span data-stu-id="8aab1-104">This file contains customers and orders.</span></span> <span data-ttu-id="8aab1-105">Kod XML jest w przestrzeni nazw.</span><span class="sxs-lookup"><span data-stu-id="8aab1-105">The XML is in a namespace.</span></span>  
  
## <a name="customersordersinnamespacexml"></a><span data-ttu-id="8aab1-106">CustomersOrdersInNamespace.xml</span><span class="sxs-lookup"><span data-stu-id="8aab1-106">CustomersOrdersInNamespace.xml</span></span>  
...
## <a name="see-also"></a><span data-ttu-id="8aab1-107">Zobacz także</span><span class="sxs-lookup"><span data-stu-id="8aab1-107">See also</span></span>
- [<span data-ttu-id="8aab1-108">Przykładowe dokumenty XML (LINQ to XML)</span><span class="sxs-lookup"><span data-stu-id="8aab1-108">Sample XML Documents (LINQ to XML)</span></span>](../../../../visual-basic/programming-guide/concepts/linq/sample-xml-documents-linq-to-xml.md)
