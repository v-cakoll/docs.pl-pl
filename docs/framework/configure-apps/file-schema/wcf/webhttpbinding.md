...
|writeEncoding|Określa, że kodowania znaków, która jest używana dla treści wiadomości. Prawidłowe wartości są następujące:<br /><br /> UnicodeFffeTextEncoding: Unicode BigEndian kodowania.<br /><br /> Utf16TextEncoding: 16-bitowego kodowania.<br /><br /> Utf8TextEncoding: 8-bitowego kodowania.<br /><br /> Wartość domyślna to Utf8TextEncoding.|  
