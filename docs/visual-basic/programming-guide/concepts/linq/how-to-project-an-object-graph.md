...
---
# <a name="how-to-project-an-object-graph-visual-basic"></a><span data-ttu-id="c5198-102">Instrukcje: Tworzenie projektu grafu obiektów (Visual Basic)</span><span class="sxs-lookup"><span data-stu-id="c5198-102">How to: Project an Object Graph (Visual Basic)</span></span>
<span data-ttu-id="c5198-103">W tym temacie pokazano, jak projektować i wypełniać Graf obiektów z pliku XML.</span><span class="sxs-lookup"><span data-stu-id="c5198-103">This topic illustrates how to project, or populate, an object graph from XML.</span></span>  
  
## <a name="example"></a><span data-ttu-id="c5198-104">Przykład</span><span class="sxs-lookup"><span data-stu-id="c5198-104">Example</span></span>  
 <span data-ttu-id="c5198-105">Poniższy kod wypełnia wykres obiektu za pomocą klas `Address`, `PurchaseOrder`i `PurchaseOrderItem` z [przykładowego pliku XML: typowy dokument XML zamówienia zakupu (LINQ to XML)](../../../../visual-basic/programming-guide/concepts/linq/sample-xml-file-typical-purchase-order-linq-to-xml.md) .</span><span class="sxs-lookup"><span data-stu-id="c5198-105">The following code populates an object graph with the `Address`, `PurchaseOrder`, and `PurchaseOrderItem` classes from the [Sample XML File: Typical Purchase Order (LINQ to XML)](../../../../visual-basic/programming-guide/concepts/linq/sample-xml-file-typical-purchase-order-linq-to-xml.md) XML document.</span></span>  
...
```  
 ...
 <span data-ttu-id="c5198-106">W tym przykładzie wynik kwerendy [!INCLUDE[vbteclinq](~/includes/vbteclinq-md.md)] jest zwracany jako <xref:System.Collections.Generic.IEnumerable%601> `PurchaseOrderItem`.</span><span class="sxs-lookup"><span data-stu-id="c5198-106">In this example, the result of the [!INCLUDE[vbteclinq](~/includes/vbteclinq-md.md)] query is returned as an <xref:System.Collections.Generic.IEnumerable%601> of `PurchaseOrderItem`.</span></span> <span data-ttu-id="c5198-107">Elementy w klasie `PurchaseOrder` są typu <xref:System.Collections.Generic.IEnumerable%601> `PurchaseOrderItem`.</span><span class="sxs-lookup"><span data-stu-id="c5198-107">The items in the `PurchaseOrder` class are of type <xref:System.Collections.Generic.IEnumerable%601> of `PurchaseOrderItem`.</span></span> <span data-ttu-id="c5198-108">Kod używa metody rozszerzenia <xref:System.Linq.Enumerable.ToList%2A>, aby utworzyć kolekcję <xref:System.Collections.Generic.List%601> z wyników zapytania.</span><span class="sxs-lookup"><span data-stu-id="c5198-108">The code uses the <xref:System.Linq.Enumerable.ToList%2A> extension method to create a <xref:System.Collections.Generic.List%601> collection from the results of the query.</span></span>  
  
 <span data-ttu-id="c5198-109">Przykład generuje następujące dane wyjściowe:</span><span class="sxs-lookup"><span data-stu-id="c5198-109">The example produces the following output:</span></span>  
...
## <a name="see-also"></a><span data-ttu-id="c5198-110">Zobacz także</span><span class="sxs-lookup"><span data-stu-id="c5198-110">See also</span></span>

- <xref:System.Linq.Enumerable.Select%2A>
- <xref:System.Linq.Enumerable.ToList%2A>
- [<span data-ttu-id="c5198-111">Projekcje i przekształcenia (LINQ to XML) (Visual Basic)</span><span class="sxs-lookup"><span data-stu-id="c5198-111">Projections and Transformations (LINQ to XML) (Visual Basic)</span></span>](../../../../visual-basic/programming-guide/concepts/linq/projections-and-transformations-linq-to-xml.md)
