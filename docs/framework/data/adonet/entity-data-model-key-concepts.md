...
## <a name="property"></a>Właściwość  
 ...
 Właściwość może zawierać dane pierwotne (takie jak ciąg, liczba całkowita lub wartość logiczna) lub dane strukturalne (takie jak typ złożony). Aby uzyskać więcej informacji, zobacz [Entity Data Model: typy danych pierwotnych](entity-data-model-primitive-data-types.md).  
