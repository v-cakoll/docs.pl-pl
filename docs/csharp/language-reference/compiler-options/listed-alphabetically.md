...
|[-langversion:\<ciąg >](langversion-compiler-option.md)|Określ wersję języka: default, ISO-1, ISO-2, 3, 4, 5, 6, 7, 7,1, 7,2, 7,3 lub Najnowsza |
...
- [Element > kompilatora \<](../../../framework/configure-apps/file-schema/compiler/compiler-element.md)
