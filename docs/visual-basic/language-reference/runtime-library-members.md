...
---
# <a name="visual-basic-runtime-library-members"></a><span data-ttu-id="479f0-102">Elementy członkowskie biblioteki wykonawczej programu Visual Basic</span><span class="sxs-lookup"><span data-stu-id="479f0-102">Visual Basic Runtime Library Members</span></span>
<span data-ttu-id="479f0-103">`Microsoft.VisualBasic` Przestrzeń nazw zawiera klasy, moduły, stałe i wyliczenia wchodzących w skład Biblioteka środowiska uruchomieniowego języka Visual Basic.</span><span class="sxs-lookup"><span data-stu-id="479f0-103">The `Microsoft.VisualBasic` namespace contains the classes, modules, constants, and enumerations that constitute the Visual Basic runtime library.</span></span> <span data-ttu-id="479f0-104">Te elementy członkowskie biblioteki zawierają procedury, właściwości i wartości stałe, których można użyć w kodzie.</span><span class="sxs-lookup"><span data-stu-id="479f0-104">These library members provide procedures, properties, and constant values you can use in your code.</span></span> <span data-ttu-id="479f0-105">Każdy moduł i klasa reprezentuje określoną kategorię funkcji.</span><span class="sxs-lookup"><span data-stu-id="479f0-105">Each module and class represents a particular category of functionality.</span></span>  
  
## <a name="microsoftvisualbasiccollection-class"></a><span data-ttu-id="479f0-106">Klasa Microsoft.VisualBasic.Collection</span><span class="sxs-lookup"><span data-stu-id="479f0-106">Microsoft.VisualBasic.Collection Class</span></span>  
...
## <a name="microsoftvisualbasiccomclassattribute-class"></a><span data-ttu-id="479f0-107">Microsoft.VisualBasic.ComClassAttribute Class</span><span class="sxs-lookup"><span data-stu-id="479f0-107">Microsoft.VisualBasic.ComClassAttribute Class</span></span>  
...
## <a name="microsoftvisualbasiccontrolchars-class"></a><span data-ttu-id="479f0-108">Microsoft.VisualBasic.ControlChars Class</span><span class="sxs-lookup"><span data-stu-id="479f0-108">Microsoft.VisualBasic.ControlChars Class</span></span>  
...
## <a name="microsoftvisualbasicconstants-class"></a><span data-ttu-id="479f0-109">Microsoft.VisualBasic.Constants Class</span><span class="sxs-lookup"><span data-stu-id="479f0-109">Microsoft.VisualBasic.Constants Class</span></span>  
...
## <a name="microsoftvisualbasicconversion-module"></a><span data-ttu-id="479f0-110">Moduł Microsoft.VisualBasic.Conversion</span><span class="sxs-lookup"><span data-stu-id="479f0-110">Microsoft.VisualBasic.Conversion Module</span></span>  
...
## <a name="microsoftvisualbasicdateandtime-module"></a><span data-ttu-id="479f0-111">Microsoft.VisualBasic.DateAndTime Module</span><span class="sxs-lookup"><span data-stu-id="479f0-111">Microsoft.VisualBasic.DateAndTime Module</span></span>  
...
## <a name="microsoftvisualbasicerrobject-class"></a><span data-ttu-id="479f0-112">Microsoft.VisualBasic.ErrObject Class</span><span class="sxs-lookup"><span data-stu-id="479f0-112">Microsoft.VisualBasic.ErrObject Class</span></span>  
...
## <a name="microsoftvisualbasicfilesystem-module"></a><span data-ttu-id="479f0-113">Microsoft.VisualBasic.FileSystem Module</span><span class="sxs-lookup"><span data-stu-id="479f0-113">Microsoft.VisualBasic.FileSystem Module</span></span>  
...
## <a name="microsoftvisualbasicfinancial-module"></a><span data-ttu-id="479f0-114">Moduł Microsoft.VisualBasic.Financial</span><span class="sxs-lookup"><span data-stu-id="479f0-114">Microsoft.VisualBasic.Financial Module</span></span>  
...
## <a name="microsoftvisualbasicglobals-module"></a><span data-ttu-id="479f0-115">Microsoft.VisualBasic.Globals Module</span><span class="sxs-lookup"><span data-stu-id="479f0-115">Microsoft.VisualBasic.Globals Module</span></span>  
...
## <a name="microsoftvisualbasichidemodulenameattribute-class"></a><span data-ttu-id="479f0-116">Klasa Microsoft.VisualBasic.HideModuleNameAttribute</span><span class="sxs-lookup"><span data-stu-id="479f0-116">Microsoft.VisualBasic.HideModuleNameAttribute Class</span></span>  
  
|||||  
|---|---|---|---|  
|<xref:Microsoft.VisualBasic.HideModuleNameAttribute>||||  
  
## <a name="microsoftvisualbasicinformation-module"></a><span data-ttu-id="479f0-117">Moduł Microsoft.VisualBasic.Information</span><span class="sxs-lookup"><span data-stu-id="479f0-117">Microsoft.VisualBasic.Information Module</span></span>  
...
## <a name="microsoftvisualbasicinteraction-module"></a><span data-ttu-id="479f0-118">Moduł Microsoft.VisualBasic.Interaction</span><span class="sxs-lookup"><span data-stu-id="479f0-118">Microsoft.VisualBasic.Interaction Module</span></span>  
...
## <a name="microsoftvisualbasicmygroupcollectionattribute-class"></a><span data-ttu-id="479f0-119">Microsoft.VisualBasic.MyGroupCollectionAttribute Class</span><span class="sxs-lookup"><span data-stu-id="479f0-119">Microsoft.VisualBasic.MyGroupCollectionAttribute Class</span></span>  
...
## <a name="microsoftvisualbasicstrings-module"></a><span data-ttu-id="479f0-120">Microsoft.VisualBasic.Strings Module</span><span class="sxs-lookup"><span data-stu-id="479f0-120">Microsoft.VisualBasic.Strings Module</span></span>  
...
## <a name="microsoftvisualbasicvbfixedarrayattribute-class"></a><span data-ttu-id="479f0-121">Klasa Microsoft.VisualBasic.VBFixedArrayAttribute</span><span class="sxs-lookup"><span data-stu-id="479f0-121">Microsoft.VisualBasic.VBFixedArrayAttribute Class</span></span>  
  
|||||  
|---|---|---|---|  
|<xref:Microsoft.VisualBasic.VBFixedArrayAttribute.Bounds%2A>|<xref:Microsoft.VisualBasic.VBFixedArrayAttribute.Length%2A>|||  
  
## <a name="microsoftvisualbasicvbfixedstringattribute-class"></a><span data-ttu-id="479f0-122">Klasa Microsoft.VisualBasic.VBFixedStringAttribute</span><span class="sxs-lookup"><span data-stu-id="479f0-122">Microsoft.VisualBasic.VBFixedStringAttribute Class</span></span>  
  
|||||  
|---|---|---|---|  
|<xref:Microsoft.VisualBasic.VBFixedStringAttribute.Length%2A>||||  
  
## <a name="microsoftvisualbasicvbmath-module"></a><span data-ttu-id="479f0-123">Moduł Microsoft.VisualBasic.VbMath</span><span class="sxs-lookup"><span data-stu-id="479f0-123">Microsoft.VisualBasic.VbMath Module</span></span>  
  
|||||  
|---|---|---|---|  
|<xref:Microsoft.VisualBasic.VBMath.Randomize%2A>|<xref:Microsoft.VisualBasic.VBMath.Rnd%2A>|||  
  
## <a name="microsoftvisualbasic-constants-and-enumerations"></a><span data-ttu-id="479f0-124">Microsoft.VisualBasic stałe i wyliczenia</span><span class="sxs-lookup"><span data-stu-id="479f0-124">Microsoft.VisualBasic Constants and Enumerations</span></span>  
 <span data-ttu-id="479f0-125">`Microsoft.VisualBasic` Przestrzeń nazw zapewnia stałe i wyliczenia jako część biblioteki wykonawczej języka Visual Basic.</span><span class="sxs-lookup"><span data-stu-id="479f0-125">The `Microsoft.VisualBasic` namespace provides constants and enumerations as part of the Visual Basic run-time library.</span></span> <span data-ttu-id="479f0-126">Te wartości stałych można użyć w kodzie.</span><span class="sxs-lookup"><span data-stu-id="479f0-126">You can use these constant values in your code.</span></span> <span data-ttu-id="479f0-127">Każde wyliczenie reprezentuje określoną kategorię funkcji.</span><span class="sxs-lookup"><span data-stu-id="479f0-127">Each enumeration represents a particular category of functionality.</span></span> <span data-ttu-id="479f0-128">Aby uzyskać więcej informacji, zobacz [stałe i wyliczenia](../../visual-basic/language-reference/constants-and-enumerations.md).</span><span class="sxs-lookup"><span data-stu-id="479f0-128">For more information, see [Constants and Enumerations](../../visual-basic/language-reference/constants-and-enumerations.md).</span></span>  
  
## <a name="see-also"></a><span data-ttu-id="479f0-129">Zobacz także</span><span class="sxs-lookup"><span data-stu-id="479f0-129">See also</span></span>
- [<span data-ttu-id="479f0-130">Stałe i wyliczenia</span><span class="sxs-lookup"><span data-stu-id="479f0-130">Constants and Enumerations</span></span>](../../visual-basic/language-reference/constants-and-enumerations.md)
- [<span data-ttu-id="479f0-131">Słowa kluczowe</span><span class="sxs-lookup"><span data-stu-id="479f0-131">Keywords</span></span>](../../visual-basic/language-reference/keywords/index.md)
