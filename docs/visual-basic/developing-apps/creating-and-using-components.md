...
## <a name="when-to-create-a-component"></a>Kiedy należy utworzyć składnik  
 ...
 Klasy <xref:System.ComponentModel.Component> i <xref:System.ComponentModel.MarshalByValueComponent> to podstawowe implementacje <xref:System.ComponentModel.IComponent> interfejsu. Główna różnica między tymi klasami polega na tym <xref:System.ComponentModel.Component> , że Klasa jest organizowana przez odwołanie <xref:System.ComponentModel.IComponent> , podczas gdy jest organizowane przez wartość. Poniższa lista zawiera szczegółowe wskazówki dotyczące implementacji.  
...
## <a name="related-sections"></a>Sekcje pokrewne  
 ...
 [Rozwiązywanie problemów związanych z formantami oraz autoryzacją elementów](../../framework/winforms/controls/troubleshooting-control-and-component-authoring.md)  
