...
<span data-ttu-id="562ac-103">Czasami chcesz znaleźć wszystkie elementy, które mają określony atrybut.</span><span class="sxs-lookup"><span data-stu-id="562ac-103">Sometimes you want to find all elements that have a specific attribute.</span></span> <span data-ttu-id="562ac-104">Nie masz obawy zawartości atrybutu.</span><span class="sxs-lookup"><span data-stu-id="562ac-104">You are not concerned about the contents of the attribute.</span></span> <span data-ttu-id="562ac-105">Zamiast tego chcesz wybrać na podstawie istnienia atrybutu.</span><span class="sxs-lookup"><span data-stu-id="562ac-105">Instead, you want to select based on the existence of the attribute.</span></span>  
 ...
 <span data-ttu-id="562ac-106">Wyrażenie XPath jest:</span><span class="sxs-lookup"><span data-stu-id="562ac-106">The XPath expression is:</span></span>  
  
 `./*[@Select]`  
  
## <a name="example"></a><span data-ttu-id="562ac-107">Przykład</span><span class="sxs-lookup"><span data-stu-id="562ac-107">Example</span></span>  
 <span data-ttu-id="562ac-108">Poniższy kod wybiera tylko elementów, które mają `Select` atrybutu.</span><span class="sxs-lookup"><span data-stu-id="562ac-108">The following code selects just the elements that have the `Select` attribute.</span></span>  
...
```  
 ...
 <span data-ttu-id="562ac-109">Ten przykład generuje następujące wyniki:</span><span class="sxs-lookup"><span data-stu-id="562ac-109">This example produces the following output:</span></span>  
...
## <a name="see-also"></a><span data-ttu-id="562ac-110">Zobacz też</span><span class="sxs-lookup"><span data-stu-id="562ac-110">See Also</span></span>  
 [<span data-ttu-id="562ac-111">LINQ do XML dla wyrażenia XPath użytkowników (Visual Basic)</span><span class="sxs-lookup"><span data-stu-id="562ac-111">LINQ to XML for XPath Users (Visual Basic)</span></span>](../../../../visual-basic/programming-guide/concepts/linq/linq-to-xml-for-xpath-users.md)
