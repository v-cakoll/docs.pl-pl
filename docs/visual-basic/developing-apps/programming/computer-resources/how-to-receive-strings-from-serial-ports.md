...
3. Use the `My.Computer.Ports.OpenSerialPort` method to obtain a reference to the port. Aby uzyskać więcej informacji, zobacz <xref:Microsoft.VisualBasic.Devices.Ports.OpenSerialPort%2A>.  
