...
---
# <a name="headers-element"></a>\<nagłówki > element
Zawiera kolekcję nagłówków adresów, które są wymagane w celu prawidłowego adresowania wystawcy lokalnego. Możesz użyć słowa kluczowego, `add` aby dodać nagłówek do tej kolekcji.  
