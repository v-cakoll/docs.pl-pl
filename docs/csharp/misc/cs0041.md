...
W pełni kwalifikowana nazwa "type" jest za długa dla informacji debugowania. Skompiluj bez opcji "/ debug".  
 ...
 Ten błąd może wystąpić w przypadku korzystania z [/debug](../../csharp/language-reference/compiler-options/debug-compiler-option.md) — opcja kompilatora. Jeśli wystąpi ten błąd, spróbuj usunąć pliki PDB w katalogu bin i ponownej kompilacji. Jeśli nadal napotkasz ten błąd, może być konieczne naprawienie lub ponowne zainstalowanie programu Visual Studio.
