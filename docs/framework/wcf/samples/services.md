...
## <a name="in-this-section"></a>W tej sekcji  
 ...
 [Fabryka kanałów konfiguracji](../../../../docs/framework/wcf/samples/configuration-channel-factory.md)  
 ...
 Pokazuje, jak zdefiniować <<!--zz xref:System.ServiceModel.WsHttpBinding --> `xref:System.ServiceModel.WsHttpBinding`> usługi przy użyciu kodu, zamiast definiować `wsHttpBinding` powiązanie w konfiguracji.  
