...
- Plik kodu języka Visual Basic, wygenerowany na podstawie bazy danych Northwind.  
     ...
     Ten plik można wygenerować za pomocą Object Relational Designer lub narzędzie SQLMetal. Ten instruktaż został napisany za pomocą narzędzia SQLMetal za pomocą następującego polecenia:  
