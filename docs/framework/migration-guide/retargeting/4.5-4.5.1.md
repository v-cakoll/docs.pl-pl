...
---
# <a name="retargeting-changes-for-migration-from-net-framework-45-to-451"></a>Zmiany retargetingu migracji z programu .NET Framework 4.5 i 4.5.1

[!INCLUDE[versionselector](../../../../includes/migration-guide/retargeting/versionselector.md)]

[!INCLUDE[introduction](../../../../includes/migration-guide/retargeting/introduction.md)]

Migracji z programu .NET Framework 4.5 do wersji 4.5.1, przejrzyj problemy ze zgodnością aplikacji, które mogą wpływać na Twoją aplikację w poniższych tematach:
