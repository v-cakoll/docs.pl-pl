...
- [Poziomy ułatwień](./accessibility-levels.md)dostępu: aby zadeklarować sześć poziomów dostępności, użyj czterech modyfikatorów dostępu.  
...
- [Słowa kluczowe dostępu](base.md)
