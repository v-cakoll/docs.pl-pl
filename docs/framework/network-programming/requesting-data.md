...
## <a name="see-also"></a>Zobacz też  
 ...
 [Porady: żądania strony sieci Web i pobieraniem ich wyników jako strumienia](../../../docs/framework/network-programming/how-to-request-a-web-page-and-retrieve-the-results-as-a-stream.md)  
 [Porady: pobieranie WebResponse specyficzne dla protokołu, który odpowiada WebRequest](../../../docs/framework/network-programming/how-to-retrieve-a-protocol-specific-webresponse-that-matches-a-webrequest.md)
