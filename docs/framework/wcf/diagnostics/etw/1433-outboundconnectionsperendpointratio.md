...
## <a name="description"></a>Opis  
 To zdarzenie jest emitowany do zapewnienia połączeń wychodzących na punkt końcowy stosunek informacji.  
  
## <a name="message"></a>Komunikat  
 Punkt końcowy współczynnik połączeń wychodzących na: %1 / %2  
