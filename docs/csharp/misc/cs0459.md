...
> [!NOTE]
> Kompilator Roslyn został zaktualizowany i ten błąd kompilatora został usunięty z programu Visual Studio 2017 15,5, dlatego poprzedni kod zostanie pomyślnie skompilowany z tą wersją i nowszą.
