...
-   [<span data-ttu-id="7ea2a-104">Mapowanie przestrzeni nazw między programami WIF 3.5 i WIF 4.5</span><span class="sxs-lookup"><span data-stu-id="7ea2a-104">Namespace Mapping between WIF 3.5 and WIF 4.5</span></span>](../../../docs/framework/security/namespace-mapping-between-wif-3-5-and-wif-4-5.md)  
  
## <a name="see-also"></a><span data-ttu-id="7ea2a-105">Zobacz też</span><span class="sxs-lookup"><span data-stu-id="7ea2a-105">See Also</span></span>  
 [<span data-ttu-id="7ea2a-106">Windows Identity Foundation</span><span class="sxs-lookup"><span data-stu-id="7ea2a-106">Windows Identity Foundation</span></span>](../../../docs/framework/security/index.md)
