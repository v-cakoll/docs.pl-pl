...
## <a name="description"></a>Opis  
 To zdarzenie oznacza, że usługi autoryzacji powiodło się. Zdarzenie Wyświetla listę usług, działania, tożsamość klienta kontekst autoryzacji, identyfikator działania i ServiceAuthorizationManager.  
