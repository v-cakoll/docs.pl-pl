...
## <a name="remarks"></a>Uwagi  
 ...
 W poniższym przykładzie słowo kluczowe `Alias` jest używane do określenia nazwy funkcji w advapi32.dll, `GetUserNameA`, że `getUserName` jest używany zamiast w tym przykładzie. Funkcja `getUserName` jest wywoływana w sub `getUser`, która zawiera nazwę bieżącego użytkownika.  
