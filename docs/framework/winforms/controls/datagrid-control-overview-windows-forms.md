...
-   Dowolny składnik, który implementuje <xref:System.ComponentModel.IBindingList> interfejsu.  
 ...
 Aby uzyskać więcej informacji na temat źródeł danych, zobacz [źródła danych obsługiwane przez formularze Windows](../../../../docs/framework/winforms/data-sources-supported-by-windows-forms.md).  
