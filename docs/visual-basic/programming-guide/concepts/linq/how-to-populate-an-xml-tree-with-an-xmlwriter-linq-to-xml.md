...
---
# <a name="how-to-populate-an-xml-tree-with-an-xmlwriter-linq-to-xml-visual-basic"></a>Porady: wypełnianie drzewa XML elementem XmlWriter (LINQ to XML) (Visual Basic)
