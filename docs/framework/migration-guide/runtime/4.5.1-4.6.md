...
ms.locfileid: "86443536"
---
# <a name="runtime-changes-for-migration-from-net-framework-451-to-46"></a><span data-ttu-id="dae67-103">Zmiany w środowisku uruchomieniowym dotyczące migracji z .NET Framework 4.5.1 do 4,6</span><span class="sxs-lookup"><span data-stu-id="dae67-103">Runtime Changes for Migration from .NET Framework 4.5.1 to 4.6</span></span>

[!INCLUDE[versionselector](../../../../includes/migration-guide/runtime/versionselector.md)]

<span data-ttu-id="dae67-104">W przypadku migrowania z .NET Framework 4.5.1 do 4,6 zapoznaj się z następującymi tematami dotyczącymi problemów ze zgodnością aplikacji, które mogą mieć wpływ na aplikację:</span><span class="sxs-lookup"><span data-stu-id="dae67-104">If you are migrating from the .NET Framework 4.5.1 to 4.6, review the following topics for application compatibility issues that may affect your app:</span></span>

## <a name="aspnet"></a><span data-ttu-id="dae67-105">ASP.NET</span><span class="sxs-lookup"><span data-stu-id="dae67-105">ASP.NET</span></span>
...
## <a name="core"></a><span data-ttu-id="dae67-106">Core</span><span class="sxs-lookup"><span data-stu-id="dae67-106">Core</span></span>
...
## <a name="data"></a><span data-ttu-id="dae67-107">Dane</span><span class="sxs-lookup"><span data-stu-id="dae67-107">Data</span></span>
...
## <a name="debugger"></a><span data-ttu-id="dae67-108">Debuger</span><span class="sxs-lookup"><span data-stu-id="dae67-108">Debugger</span></span>
...
## <a name="entity-framework"></a><span data-ttu-id="dae67-109">Entity Framework</span><span class="sxs-lookup"><span data-stu-id="dae67-109">Entity Framework</span></span>
...
## <a name="networking"></a><span data-ttu-id="dae67-110">Sieć</span><span class="sxs-lookup"><span data-stu-id="dae67-110">Networking</span></span>
...
## <a name="serialization"></a><span data-ttu-id="dae67-111">Serializacja</span><span class="sxs-lookup"><span data-stu-id="dae67-111">Serialization</span></span>
...
## <a name="setup-and-deployment"></a><span data-ttu-id="dae67-112">Instalacja i wdrożenie</span><span class="sxs-lookup"><span data-stu-id="dae67-112">Setup and Deployment</span></span>
...
## <a name="windows-communication-foundation-wcf"></a><span data-ttu-id="dae67-113">Windows Communication Foundation (WCF)</span><span class="sxs-lookup"><span data-stu-id="dae67-113">Windows Communication Foundation (WCF)</span></span>
...
## <a name="windows-presentation-foundation-wpf"></a><span data-ttu-id="dae67-114">Windows Presentation Foundation (WPF)</span><span class="sxs-lookup"><span data-stu-id="dae67-114">Windows Presentation Foundation (WPF)</span></span>
