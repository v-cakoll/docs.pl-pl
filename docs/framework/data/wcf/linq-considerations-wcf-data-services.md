...
|<xref:System.Linq.Expressions.Expression?qualifyHint=False&autoUpgrade=True>Element członkowski|Obsługiwane [!INCLUDE[ssODataShort](../../../../includes/ssodatashort-md.md)] — funkcja|  
|---------------------------------------------------------------------------------------------------------------------------------------------------------|-------------------------------------------------------------------------------------|  
