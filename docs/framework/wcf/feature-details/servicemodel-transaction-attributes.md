...
ms.locfileid: "33500834"
---
# <a name="servicemodel-transaction-attributes"></a>Atrybuty transakcji elementu ServiceModel
Windows Communication Foundation (WCF) zapewnia właściwości na trzy standard <xref:System.ServiceModel> atrybuty, które umożliwiają konfigurowanie zachowania transakcji usługi WCF:  
