...
|.NET Framework 4.5. x jest już częścią tego systemu operacyjnego, ale jest obecnie wyłączony (tylko[!INCLUDE[winserver8](../../../includes/winserver8-md.md)]).| Włącz **lub wyłącz funkcje systemu Windows** w **Panelu sterowania** , aby włączyć .NET Framework 4.5. x. |  
