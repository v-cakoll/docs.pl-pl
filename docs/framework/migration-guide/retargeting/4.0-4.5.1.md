...
ms.locfileid: "61871179"
---
# <a name="retargeting-changes-for-migration-from-net-framework-40-to-451"></a><span data-ttu-id="bf7d7-102">Zmiany retargetingu migracji z programu .NET Framework 4.0 lub 4.5.1</span><span class="sxs-lookup"><span data-stu-id="bf7d7-102">Retargeting Changes for Migration from .NET Framework 4.0 to 4.5.1</span></span>

[!INCLUDE[versionselector](../../../../includes/migration-guide/retargeting/versionselector.md)]

[!INCLUDE[introduction](../../../../includes/migration-guide/retargeting/introduction.md)]

<span data-ttu-id="bf7d7-103">Migracji z programu .NET Framework 4.0 do wersji 4.5.1, przejrzyj problemy ze zgodnością aplikacji, które mogą wpływać na Twoją aplikację w poniższych tematach:</span><span class="sxs-lookup"><span data-stu-id="bf7d7-103">If you are migrating from the .NET Framework 4.0 to 4.5.1, review the following topics for application compatibility issues that may affect your app:</span></span>

## <a name="adonet"></a><span data-ttu-id="bf7d7-104">ADO.NET</span><span class="sxs-lookup"><span data-stu-id="bf7d7-104">ADO.NET</span></span>
...
## <a name="aspnet"></a><span data-ttu-id="bf7d7-105">ASP.NET</span><span class="sxs-lookup"><span data-stu-id="bf7d7-105">ASP.NET</span></span>
...
## <a name="clickonce"></a><span data-ttu-id="bf7d7-106">ClickOnce</span><span class="sxs-lookup"><span data-stu-id="bf7d7-106">ClickOnce</span></span>
...
## <a name="core"></a><span data-ttu-id="bf7d7-107">Core</span><span class="sxs-lookup"><span data-stu-id="bf7d7-107">Core</span></span>
...
## <a name="entity-framework"></a><span data-ttu-id="bf7d7-108">Entity Framework</span><span class="sxs-lookup"><span data-stu-id="bf7d7-108">Entity Framework</span></span>
...
## <a name="msbuild"></a><span data-ttu-id="bf7d7-109">MSBuild</span><span class="sxs-lookup"><span data-stu-id="bf7d7-109">MSBuild</span></span>
...
## <a name="windows-forms"></a><span data-ttu-id="bf7d7-110">Windows Forms</span><span class="sxs-lookup"><span data-stu-id="bf7d7-110">Windows Forms</span></span>
...
## <a name="windows-presentation-foundation-wpf"></a><span data-ttu-id="bf7d7-111">Windows Presentation Foundation (WPF)</span><span class="sxs-lookup"><span data-stu-id="bf7d7-111">Windows Presentation Foundation (WPF)</span></span>
...
## <a name="windows-workflow-foundation-wf"></a><span data-ttu-id="bf7d7-112">Program Windows Workflow Foundation (WF)</span><span class="sxs-lookup"><span data-stu-id="bf7d7-112">Windows Workflow Foundation (WF)</span></span>
...
## <a name="xml-xslt"></a><span data-ttu-id="bf7d7-113">Języki XML, XSLT</span><span class="sxs-lookup"><span data-stu-id="bf7d7-113">XML, XSLT</span></span>
