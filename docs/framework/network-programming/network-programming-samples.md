...
## <a name="in-this-section"></a>W tej sekcji  
 [Pobierz próbkę technologii ze wskaźnikiem postępu](https://docs.microsoft.com/previous-versions/dotnet/netframework-3.0/t8w6294a(v=vs.85))  
 ...
 [Przykład aplikacji hosta odbiornika HTTPLISTENER aspx](https://docs.microsoft.com/previous-versions/visualstudio/visual-studio-2008/dd767375(v%3dvs.90)) Pokazuje, jak używać funkcji <xref:System.Net.HttpListener?displayProperty=nameWithType> klasy do tworzenia serwera http, który kieruje wywołania do hostowanej aplikacji ASP.NET.
 ...
 [Przykład technologii narzędzia netstat](https://docs.microsoft.com/previous-versions/dotnet/netframework-3.0/ks32hs88(v=vs.85))  
 ...
 [Przykład polecenia ping dla technologii klienta](https://docs.microsoft.com/previous-versions/dotnet/netframework-3.0/5253acs7(v=vs.85))  
 ...
 [Przykład bezpiecznych strumieni](https://docs.microsoft.com/previous-versions/dotnet/netframework-3.0/ms180980(v=vs.85))  
 Pokazuje, jak używać bezpiecznego strumienia do komunikacji między klientem a serwerem.  
  
 [Przykład protokołu IPv6 Sockets](https://docs.microsoft.com/previous-versions/dotnet/netframework-3.0/ms180981(v=vs.85))  
