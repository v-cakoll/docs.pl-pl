...
## <a name="in-this-section"></a>W tej sekcji  
 ...
 [Sprawdzanie poprawności XmlSchemaValidator wypychania](../../../../docs/standard/data/xml/xmlschemavalidator-push-based-validation.md)  
...
## <a name="related-sections"></a>Sekcje pokrewne  
 [Sprawdzanie poprawności dokumentu XML w modelu DOM](../../../../docs/standard/data/xml/validating-an-xml-document-in-the-dom.md)  
