...
## <a name="see-also"></a><span data-ttu-id="5ae8b-105">Zobacz też</span><span class="sxs-lookup"><span data-stu-id="5ae8b-105">See Also</span></span>  
 [<span data-ttu-id="5ae8b-106">Model DOM (XML Document Object Model)</span><span class="sxs-lookup"><span data-stu-id="5ae8b-106">XML Document Object Model (DOM)</span></span>](../../../../docs/standard/data/xml/xml-document-object-model-dom.md)
