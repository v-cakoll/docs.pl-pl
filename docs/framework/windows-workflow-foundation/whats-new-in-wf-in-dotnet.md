...
---
# <a name="what39s-new-in-windows-workflow-foundation-in-net-45"></a>Jaki &#39; s nowe w programie Windows Workflow Foundation programu .NET 4.5
...
###  <a name="BKMK_DesignerSearch"></a>Wyszukiwanie projektanta  
 Aby większych przepływy pracy łatwiejsze w obsłudze, przepływy pracy teraz można przeszukiwać według słów kluczowych. Ta funkcja jest dostępna tylko w [!INCLUDE[vs_current_short](../../../includes/vs-current-short-md.md)]; ta funkcja nie jest dostępna w Projektancie rehosted. Dostępne są dwa rodzaje wyszukiwania:  
