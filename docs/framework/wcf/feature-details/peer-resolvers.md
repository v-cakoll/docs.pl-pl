...
## <a name="supported-peer-resolvers"></a>Mechanizmy rozpoznawania elementów równorzędnych obsługiwane  
 Kanał elementu równorzędnego obsługuje dwa typy rozwiązujący: protokół Instrumentacji zarządzania Windows (PNRP, Peer Name Resolution Protocol) i usługi niestandardowym programem rozpoznawania nazw.  
...
### <a name="custom-resolver-services"></a>Niestandardowym programem rozpoznawania nazw usługi  
