---
title: Zmiany środowiska uruchomieniowego dla migracji z programu .NET Framework 4.7.2 do 4.8
ms.date: 07/10/2019
...
ms.locfileid: "73195972"
---
# <a name="runtime-changes-for-migration-from-net-framework-472-to-48"></a><span data-ttu-id="f4cbb-102">Zmiany środowiska uruchomieniowego dla migracji z programu .NET Framework 4.7.2 do 4.8</span><span class="sxs-lookup"><span data-stu-id="f4cbb-102">Runtime Changes for Migration from .NET Framework 4.7.2 to 4.8</span></span>

[!INCLUDE[versionselector](../../../../includes/migration-guide/runtime/versionselector.md)]

<span data-ttu-id="f4cbb-103">W przypadku migracji z programu .NET Framework 4.7.2 do 4.8 zapoznaj się z następującymi tematami dotyczącymi problemów ze zgodnością aplikacji, które mogą mieć wpływ na aplikację:</span><span class="sxs-lookup"><span data-stu-id="f4cbb-103">If you are migrating from the .NET Framework 4.7.2 to 4.8, review the following topics for application compatibility issues that may affect your app:</span></span>

## <a name="aspnet"></a><span data-ttu-id="f4cbb-104">ASP.NET</span><span class="sxs-lookup"><span data-stu-id="f4cbb-104">ASP.NET</span></span>
...
## <a name="core"></a><span data-ttu-id="f4cbb-105">Podstawowe</span><span class="sxs-lookup"><span data-stu-id="f4cbb-105">Core</span></span>
...
## <a name="windows-communication-foundation-wcf"></a><span data-ttu-id="f4cbb-106">Windows Communication Foundation (WCF)</span><span class="sxs-lookup"><span data-stu-id="f4cbb-106">Windows Communication Foundation (WCF)</span></span>
...
## <a name="windows-presentation-foundation-wpf"></a><span data-ttu-id="f4cbb-107">Windows Presentation Foundation (WPF)</span><span class="sxs-lookup"><span data-stu-id="f4cbb-107">Windows Presentation Foundation (WPF)</span></span>
