...
## <a name="example"></a>Przykład  
 Aplikacja będzie się powtarzał właściwości zakresu aplikacji i przywraca je z magazynu izolowanego. Izolowany magazyn jest obszar chronionego magazynu, który bezpiecznie mogą być używane przez aplikacje bez uprawnienia dostępu do pliku.  
