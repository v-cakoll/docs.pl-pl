---
title: Zmiany retargetingu w przypadku migracji z .NET Framework 4.5.2 i 4.6.2
ms.date: 04/27/2018
...
ms.locfileid: "59973282"
---
# <a name="retargeting-changes-for-migration-from-net-framework-452-to-462"></a><span data-ttu-id="68672-102">Zmiany retargetingu w przypadku migracji z .NET Framework 4.5.2 i 4.6.2</span><span class="sxs-lookup"><span data-stu-id="68672-102">Retargeting Changes for Migration from .NET Framework 4.5.2 to 4.6.2</span></span>

[!INCLUDE[versionselector](../../../../includes/migration-guide/retargeting/versionselector.md)]

[!INCLUDE[introduction](../../../../includes/migration-guide/retargeting/introduction.md)]

<span data-ttu-id="68672-103">Migracji z programu .NET Framework 4.5.2 i 4.6.2, przejrzyj problemy ze zgodnością aplikacji, które mogą wpływać na Twoją aplikację w poniższych tematach:</span><span class="sxs-lookup"><span data-stu-id="68672-103">If you are migrating from the .NET Framework 4.5.2 to 4.6.2, review the following topics for application compatibility issues that may affect your app:</span></span>

## <a name="aspnet"></a><span data-ttu-id="68672-104">ASP.NET</span><span class="sxs-lookup"><span data-stu-id="68672-104">ASP.NET</span></span>
...
## <a name="clickonce"></a><span data-ttu-id="68672-105">ClickOnce</span><span class="sxs-lookup"><span data-stu-id="68672-105">ClickOnce</span></span>
...
## <a name="core"></a><span data-ttu-id="68672-106">Core</span><span class="sxs-lookup"><span data-stu-id="68672-106">Core</span></span>
...
## <a name="entity-framework"></a><span data-ttu-id="68672-107">Entity Framework</span><span class="sxs-lookup"><span data-stu-id="68672-107">Entity Framework</span></span>
...
## <a name="jit"></a><span data-ttu-id="68672-108">JIT</span><span class="sxs-lookup"><span data-stu-id="68672-108">JIT</span></span>
...
## <a name="networking"></a><span data-ttu-id="68672-109">Obsługa sieci</span><span class="sxs-lookup"><span data-stu-id="68672-109">Networking</span></span>
...
## <a name="security"></a><span data-ttu-id="68672-110">Zabezpieczenia</span><span class="sxs-lookup"><span data-stu-id="68672-110">Security</span></span>
...
## <a name="windows-communication-foundation-wcf"></a><span data-ttu-id="68672-111">Windows Communication Foundation (WCF)</span><span class="sxs-lookup"><span data-stu-id="68672-111">Windows Communication Foundation (WCF)</span></span>
...
## <a name="windows-forms"></a><span data-ttu-id="68672-112">Windows Forms</span><span class="sxs-lookup"><span data-stu-id="68672-112">Windows Forms</span></span>
...
## <a name="windows-presentation-foundation-wpf"></a><span data-ttu-id="68672-113">Windows Presentation Foundation (WPF)</span><span class="sxs-lookup"><span data-stu-id="68672-113">Windows Presentation Foundation (WPF)</span></span>
...
## <a name="xml-xslt"></a><span data-ttu-id="68672-114">Języki XML, XSLT</span><span class="sxs-lookup"><span data-stu-id="68672-114">XML, XSLT</span></span>
