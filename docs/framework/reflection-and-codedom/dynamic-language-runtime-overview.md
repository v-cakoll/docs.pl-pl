...
Celem DLR jest aby włączyć system języków dynamicznych do uruchamiania na .NET Framework i nadaj im współdziałaniu .NET. DLR dodaje obiektów dynamicznych do języka C# i Visual Basic do obsługi dynamicznego działania w tych językach i włączanie ich współdziałanie języków dynamicznych.
...
## <a name="dlr-architecture"></a>Architektura DLR
 ...
 ![Dynamiczny przegląd architektury środowiska uruchomieniowego języka](../../../docs/framework/reflection-and-codedom/media/dlr-archoverview.png "DLR_ArchOverview") DLR architektury
