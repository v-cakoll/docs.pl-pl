...
> [!NOTE]
>  <xref:System.Windows.Media.Effects.DropShadowBitmapEffect> Zapewnia bogaty zestaw funkcji do prezentowania efekty. Aby uzyskać więcej informacji, zobacz [Utwórz tekst z cieniem](../../../../docs/framework/wpf/advanced/how-to-create-text-with-a-shadow.md).  
