...
W tym temacie zostaną objęte następujące artykuły:

1. [Przegląd obiektów delegowanych](delegates-overview.md)

    W tym artykule przedstawiono omówienie obiektów delegowanych.

2. [System.Delegate i `delegate` — słowo kluczowe](delegate-class.md)
...
4. [Wspólne wzorce dla delegatów](delegates-patterns.md)

    W tym artykule omówiono typowe rozwiązania dla obiektów delegowanych.

5. [Przegląd zdarzeń](events-overview.md)
...
8. [Wyróżniającą delegatów ze zdarzeń](distinguish-delegates-events.md)

    W tym artykule opisano, jak powinna wskazywać między przy użyciu zdarzeń i delegatów w projektach.
