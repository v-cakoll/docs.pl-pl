...
> [!NOTE]
>  [!INCLUDE[crabout](../../../includes/crabout-md.md)]transakcje i kompensacji, zobacz [transakcji](../../../docs/framework/windows-workflow-foundation/workflow-transactions.md) i [kompensacji](../../../docs/framework/windows-workflow-foundation/compensation.md).  
