...
ms.locfileid: "61665094"
---
# <a name="runtime-changes-for-migration-from-net-framework-45-to-461"></a><span data-ttu-id="ab707-102">Zmiany środowiska uruchomieniowego do migracji z programu .NET Framework 4.5, 4.6.1</span><span class="sxs-lookup"><span data-stu-id="ab707-102">Runtime Changes for Migration from .NET Framework 4.5 to 4.6.1</span></span>

[!INCLUDE[versionselector](../../../../includes/migration-guide/runtime/versionselector.md)]

[!INCLUDE[introduction](../../../../includes/migration-guide/runtime/introduction.md)]

<span data-ttu-id="ab707-103">Jeśli są migrowane z programu .NET Framework 4.5, aby 4.6.1, należy zapoznać się w poniższych tematach problemy ze zgodnością aplikacji, które mogą wpływać na Twoją aplikację:</span><span class="sxs-lookup"><span data-stu-id="ab707-103">If you are migrating from the .NET Framework 4.5 to 4.6.1, review the following topics for application compatibility issues that may affect your app:</span></span>

## <a name="adonet"></a><span data-ttu-id="ab707-104">ADO.NET</span><span class="sxs-lookup"><span data-stu-id="ab707-104">ADO.NET</span></span>
...
## <a name="aspnet"></a><span data-ttu-id="ab707-105">ASP.NET</span><span class="sxs-lookup"><span data-stu-id="ab707-105">ASP.NET</span></span>
...
## <a name="core"></a><span data-ttu-id="ab707-106">Core</span><span class="sxs-lookup"><span data-stu-id="ab707-106">Core</span></span>
...
## <a name="data"></a><span data-ttu-id="ab707-107">Dane</span><span class="sxs-lookup"><span data-stu-id="ab707-107">Data</span></span>
...
## <a name="debugger"></a><span data-ttu-id="ab707-108">Debuger</span><span class="sxs-lookup"><span data-stu-id="ab707-108">Debugger</span></span>
...
## <a name="entity-framework"></a><span data-ttu-id="ab707-109">Entity Framework</span><span class="sxs-lookup"><span data-stu-id="ab707-109">Entity Framework</span></span>
...
## <a name="networking"></a><span data-ttu-id="ab707-110">Obsługa sieci</span><span class="sxs-lookup"><span data-stu-id="ab707-110">Networking</span></span>
...
## <a name="serialization"></a><span data-ttu-id="ab707-111">Serializacja</span><span class="sxs-lookup"><span data-stu-id="ab707-111">Serialization</span></span>
...
## <a name="setup-and-deployment"></a><span data-ttu-id="ab707-112">Instalacja i wdrożenie</span><span class="sxs-lookup"><span data-stu-id="ab707-112">Setup and Deployment</span></span>
...
## <a name="tools"></a><span data-ttu-id="ab707-113">Narzędzia</span><span class="sxs-lookup"><span data-stu-id="ab707-113">Tools</span></span>

[!INCLUDE[Contract.Invariant or Contract.Requires\<TException> do not consider String.IsNullOrEmpty to be pure](~/includes/migration-guide/runtime/tools/contractinvariant-contractrequirestexception-do-not-consider.md)]

## <a name="windows-communication-foundation-wcf"></a><span data-ttu-id="ab707-114">Windows Communication Foundation (WCF)</span><span class="sxs-lookup"><span data-stu-id="ab707-114">Windows Communication Foundation (WCF)</span></span>
...
## <a name="windows-presentation-foundation-wpf"></a><span data-ttu-id="ab707-115">Windows Presentation Foundation (WPF)</span><span class="sxs-lookup"><span data-stu-id="ab707-115">Windows Presentation Foundation (WPF)</span></span>
