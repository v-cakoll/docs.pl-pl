...
#### <a name="parameters"></a>Parametry  
 `ppChain`  
 [out] Wskaźnik do adresu ICorDebugChain obiekt, który reprezentuje łańcuch następnej ramki dla wątku. Jeśli ten łańcuch jest ostatnim łańcucha `ppChain` ma wartość null.  
