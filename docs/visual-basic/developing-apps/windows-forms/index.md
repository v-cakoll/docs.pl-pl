...
|Zadanie|Zobacz|  
|--------|---------|  
|Tworzenie nowej aplikacji Windows Forms przy użyciu programu Visual Studio|[Wskazówki: Tworzenie formularza Windows prosty](http://msdn.microsoft.com/library/2d9daec0-0543-41d0-acb1-964f685bddbb)|  
