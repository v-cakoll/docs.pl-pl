...
## <a name="to-correct-this-error"></a><span data-ttu-id="5c410-104">Aby poprawić ten błąd</span><span class="sxs-lookup"><span data-stu-id="5c410-104">To correct this error</span></span>  
  
1.  <span data-ttu-id="5c410-105">Usuń albo `Before` lub `After` argumentu.</span><span class="sxs-lookup"><span data-stu-id="5c410-105">Remove either the `Before` or `After` argument.</span></span>  
  
## <a name="see-also"></a><span data-ttu-id="5c410-106">Zobacz też</span><span class="sxs-lookup"><span data-stu-id="5c410-106">See Also</span></span>  
