...
## <a name="hosting-windows-forms-controls-in-wpf"></a>Hosting Windows formantów formularzy na platformie WPF  
 Są obsługiwane następujące scenariusze współdziałanie podczas [!INCLUDE[TLA2#tla_winclient](../../../../includes/tla2sharptla-winclient-md.md)] formantu obsługuje formantu formularzy systemu Windows:  
...
## <a name="hosting-wpf-controls-in-windows-forms"></a>Hosting formantów WPF w formularzach systemu Windows  
 Gdy hosty formantu formularzy systemu Windows, obsługiwane są następujące scenariusze współdziałanie [!INCLUDE[TLA2#tla_winclient](../../../../includes/tla2sharptla-winclient-md.md)] sterowania:  
