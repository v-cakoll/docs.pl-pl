...
## <a name="in-this-section"></a>W tej sekcji  
 ...
 Ogólne pojęcia związane z <xref:System.Windows.Forms.SaveFileDialog> składnika, dzięki czemu można wyświetlić okna dialogowego wstępnie skonfigurowane przez użytkowników służy do zapisania pliku w określonej lokalizacji.  
