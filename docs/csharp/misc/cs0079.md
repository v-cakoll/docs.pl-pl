...
Zdarzenie "event" może występować tylko po lewej stronie znaków += lub-=  
 ...
 [Zdarzeń](../../csharp/language-reference/keywords/event.md) została niepoprawnie wywołana. Aby uzyskać więcej informacji, zobacz [zdarzenia](../../csharp/programming-guide/events/index.md) i [delegatów](../../csharp/programming-guide/delegates/index.md).  
  
 Poniższy przykład spowoduje wygenerowanie CS0079:  
