...
Klasa nie implementuje `System.Collections.ICollection` interfejs, który definiuje metody rozmiar, wyliczenia i synchronizacji dla wszystkich zbiorów. Może być konieczne ponowne zainstalowanie [!INCLUDE[vsprvs](~/includes/vsprvs-md.md)].  
  
## <a name="to-correct-this-error"></a>Aby poprawić ten błąd  
  
1.  Zainstaluj ponownie [!INCLUDE[vsprvs](~/includes/vsprvs-md.md)].  
