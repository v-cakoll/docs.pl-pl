...
### <a name="creating-a-style-for-a-control"></a>Tworzenie stylu dla formantu  
 ...
 Można również zastosować styl do określonych formantów określonego typu, przypisując klucz stylu i określający tego klucza w `Style` właściwości formantu.  Aby uzyskać więcej informacji na temat style zobacz [Tworzenie szablonów i stylów](styling-and-templating.md).  
