...
|Materializacji obiekty|Umiarkowane<sup>3</sup>|Jeden raz dla każdego obiektu zwracanego przez zapytanie. <sup>4</sup>|Proces odczytywania zwróconego obiektu <xref:System.Data.Common.DbDataReader> i tworzenia obiektów oraz ustawiania wartości właściwości, które są oparte na wartościach w każdym wystąpieniu klasy <xref:System.Data.Common.DbDataRecord>. Jeśli obiekt już istnieje w <xref:System.Data.Objects.ObjectContext> a zapytanie używa opcji scalania <xref:System.Data.Objects.MergeOption.AppendOnly> lub <xref:System.Data.Objects.MergeOption.PreserveChanges>, ten etap nie ma wpływu na wydajność. Aby uzyskać więcej informacji, zobacz [rozpoznawanie tożsamości, zarządzanie stanami i Change Tracking](https://docs.microsoft.com/previous-versions/dotnet/netframework-4.0/bb896269(v=vs.100)).|  
