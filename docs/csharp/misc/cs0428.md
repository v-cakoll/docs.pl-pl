...
Nie można przekonwertować grupy metod "identyfikator' na typ 'type' Niedelegowany.  Czy zamierzasz wywołać metodę?  
  
 Ten błąd występuje podczas konwertowania na typ niedelegowany lub próba wywołania metody bez użycia nawiasów grupy metod.  
