...
2. Użyj <xref:System.CodeDom.CodeCommentStatement.%23ctor%2A> konstruktora z `docComment` parametrem ustawionym na `true` , aby utworzyć elementy komentarza dokumentacji XML i tekst.  
