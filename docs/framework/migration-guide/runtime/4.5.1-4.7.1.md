...
---
# <a name="runtime-changes-for-migration-from-net-framework-451-to-471"></a>Zmiany środowiska uruchomieniowego dla migracji z programu .NET Framework 4.5.1 do 4.7.1
